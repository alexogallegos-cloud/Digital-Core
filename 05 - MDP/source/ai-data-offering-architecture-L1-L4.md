...
- `05 - MDP/` es el **offering** (L1 del repo). Dentro vive el **offering domain `AI-ready Data/`**, que agrupa los 4 sub-offerings L3. Estructura:
  ```
  05 - MDP/        (offering)
  ...
  ```
- `02 - AIE/` aloja el **offering domain Scaled AI Foundation**. *(Pendiente de reconciliar cuando se trabaje el offering 02.)*
