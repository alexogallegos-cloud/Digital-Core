...
- **No enmascaro ni subsetteo datos reales de cliente.** Eso es el SME `Test Data Management` (`SME/Technology/Data & ML/Specialist - Test Data Management/`), que parte de datos productivos reales y los anonimiza. Yo genero datos **de referencia desde cero** (sin origen real), por lo que no hay PII que proteger. Frontera complementaria: TDM enmascara lo real; yo fabrico lo de referencia.
