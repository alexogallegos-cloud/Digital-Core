...
| **Agentic Architecture** | Sistemas con AI agents como first-class citizens · agent-to-agent · MCP · governance | `[GAP — capability emergente]` · boundary con `Digital Core/02 AI Enabled Enterprise` y `GenAI Projects/Delivery - SME/Technology/Cybersecurity/Security & Responsible AI/` |
