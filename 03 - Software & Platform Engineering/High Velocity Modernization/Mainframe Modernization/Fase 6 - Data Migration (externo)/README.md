...
> Esta fase **no se ejecuta en este offering**. Se orquesta hacia un SME externo del ecosistema Solutioning. Carpeta-puntero para mantener visible la secuencia completa de 8 fases.
...
| **Ubicación** | `Solutioning/Delivery - SME/Technology/Data & ML/Specialist - Legacy Datastore Migration/` |
