...
ventanas de 4 min (carga sostenida, no ráfagas de 1 min), **todos los días** (hábiles y no hábiles
...
- **P70/P90 por canal, por separado — sin combinado**: cada canal conserva su propio P70 (alerta)
  ...
  **zona de riesgo** = ambos canales ≥ su propio P70 a la vez; **incidencia inminente** = ambos ≥
  su P90; **top-5 concurrencia sin caída en ventanas de 4 min** = capacidad demostrada por canal.
- **Umbrales actuales (julio 2026, txn/min)**: SPEI P70 **2,051** / P90 **2,445**; Autorizador
  P70 **2,984** / P90 **3,184**; zona de riesgo **20.1%** del tiempo operativo; r=**0.77**.
  Capacidad sostenida demostrada (top-5): Autorizador **~3,276** (coincide con el SLA e-Global de
  3,240 txn/min de la arquitectura AS-IS) y SPEI **~4,031**.
- **Evolución 2025→2026**: SPEI P70 +34% (1,526→2,051, ~+19%/año), Autorizador P70 +20%
  (2,492→2,984, ~+9%/año) por el crecimiento orgánico; cada canal cruza su P70/P90 cada vez más
