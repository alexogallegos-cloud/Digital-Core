...
| `bdisolic` | `ss_prestamosgrupo` | 1 SPs | 0 SPs | Cross-DB → API interna en target |
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdicheq_*.sql (análisis estático de 70 archivos SQL) · análisis estático de archivos SQL*
