...
| `sp_abono_sd_pbajlh` | 560 | 0 | `BDICHEQ:sc_tarjeta`  ⚠️ext, `bdicheq:sc_movdia`  ⚠️ext, `bdinteg:`  ⚠️ext, `bdisolic:ss_prestamosgrupo`  ⚠️ext | — |
...
- `bdisolic:ss_prestamosgrupo` (R) — desde `sp_abono_sd_pbajlh`
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdicheq_*.sql (análisis estático de 70 archivos SQL) · análisis estático de cláusulas FROM/INSERT/UPDATE/DELETE*
