# D07 · Aclaraciones — Procesos Batch y Schedulers
...
|----|-----|--------------------|--------------------|--------|
| `sp_aplica_cierre_preventivo` | 1979 | [SME-PENDING] — validar en scheduler AIX | Step Function orquestado (pasos atómicos) | 🔴 ALTO |
| `sp_acl_reporte_log` | 1555 | [SME-PENDING] — diario o semanal | AWS Glue / Lambda + S3 + QuickSight | 🟢 BAJO |
| `sp_acl_regulatorio27` | 265 | [SME-PENDING] — validar en scheduler AIX | Lambda + SFN + notificación SNS a regulador | 🔴 ALTO |
| `sp_acl_regulatorio27_mx` | 252 | [SME-PENDING] — validar en scheduler AIX | Lambda + SFN + notificación SNS a regulador | 🔴 ALTO |
| `sp_actualiza_folio_error_cierre` | 111 | [SME-PENDING] — validar en scheduler AIX | Step Function orquestado (pasos atómicos) | 🔴 ALTO |

## Detalle por proceso batch


### `sp_aplica_cierre_preventivo` (1979 LOC)

| Atributo | Valor |
|----------|-------|
| Parámetros | [SME-PENDING] — extraer firma del SP |
| Retorna | [SME-PENDING] |
| Tablas afectadas | Lectura: `ACL_RECUPERACION_SALDOS`, `acl_aclaracion`, `acl_cat_tipo_aclaracion`, `acl_documento`, `acl_estatus_corporativo` · Escritura: `acl_aclaracion`, `acl_entrada_bitacora`, `acl_movimiento` |
...
### `sp_acl_reporte_log` (1555 LOC)

| Atributo | Valor |
|----------|-------|
| Parámetros | [SME-PENDING] — extraer firma del SP |
| Retorna | [SME-PENDING] |
| Tablas afectadas | Lectura: `TABLE`, `acl_aclaracion`, `acl_cat_bines`, `acl_cat_datosnoconv`, `acl_cat_tokenPY` · Escritura: `acl_aclaracion` |
...
### `sp_acl_regulatorio27` (265 LOC)

| Atributo | Valor |
|----------|-------|
| Parámetros | [SME-PENDING] — extraer firma del SP |
| Retorna | [SME-PENDING] |
| Tablas afectadas | Lectura: `acl_aclaracion`, `acl_estatus_aclaracion`, `acl_estatus_corporativo`, `acl_movimiento`, `acl_origen_evento` · Escritura: `acl_regulatorio27` |
| Frecuencia estimada | [SME-PENDING] — validar en scheduler AIX |
| Scheduler actual | [SME-PENDING] ¿UC4 / Control-M / cron AIX? |
| Target recomendado | Lambda + SFN + notificación SNS a regulador |
| Riesgo | 🔴 ALTO — Proceso regulatorio/contable — equivalencia exacta requerida |


### `sp_acl_regulatorio27_mx` (252 LOC)
...
### `sp_actualiza_folio_error_cierre` (111 LOC)

| Atributo | Valor |
|----------|-------|
| Parámetros | [SME-PENDING] — extraer firma del SP |
| Retorna | [SME-PENDING] |
| Tablas afectadas | Lectura: `bdinteg:si_sucursales` · Escritura: — |
| Frecuencia estimada | [SME-PENDING] — validar en scheduler AIX |
| Scheduler actual | [SME-PENDING] ¿UC4 / Control-M / cron AIX? |
| Target recomendado | Step Function orquestado (pasos atómicos) |
| Riesgo | 🔴 ALTO — Proceso regulatorio/contable — equivalencia exacta requerida |
...
# Buscar referencias a SPs del dominio bdiaclaracion:
grep -r "bdiaclaracion" /var/spool/cron/ 2>/dev/null

# Si usan UC4 / Control-M: extraer jobs con filtro "bdiaclaracion"
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdiaclaracion_*.sql (análisis estático de 70 archivos SQL) · análisis de patrones de nombres + código*
