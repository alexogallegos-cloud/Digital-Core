...
|---------------------|--------------------|--------------------|-----|
| `sp_split_cadena` | `legacycore.bdicnweb.split_cadena.latency` | `legacycore.bdicnweb.split_cadena.errors` | [SME-PENDING] ms |
| `sp_ope_consultarutalmacenamientoxml` | `legacycore.bdicnweb.ope_consultarutalmacenamientoxml.latency` | `legacycore.bdicnweb.ope_consultarutalmacenamientoxml.errors` | [SME-PENDING] ms |
| `sp_bitacora` | `legacycore.bdicnweb.bitacora.latency` | `legacycore.bdicnweb.bitacora.errors` | [SME-PENDING] ms |
...
| `legacycore.bdicnweb.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdicnweb.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdicnweb", "latency.p50"], ["legacycore/bdicnweb", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdicnweb", "errors.total"], ["legacycore/bdicnweb", "errors.l4"]]},
...
```
DETECTAR: Alarma legacycore.bdicnweb.errors.l4 > 0
ACCIÓN INMEDIATA:
