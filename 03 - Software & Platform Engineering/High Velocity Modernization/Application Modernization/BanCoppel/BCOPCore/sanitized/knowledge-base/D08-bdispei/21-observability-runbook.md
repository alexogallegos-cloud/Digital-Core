# D08 · SPEI — Observabilidad y Runbook
...
|---------------------|--------------------|--------------------|-----|
| `sp_validafecha` | `legacycore.bdispei.validafecha.latency` | `legacycore.bdispei.validafecha.errors` | [SME-PENDING] ms |
| `spei_recerrorescodi` | `legacycore.bdispei.spei_recerrorescodi.latency` | `legacycore.bdispei.spei_recerrorescodi.errors` | [SME-PENDING] ms |
| `sp_regordenctecte_pp` | `legacycore.bdispei.regordenctecte_pp.latency` | `legacycore.bdispei.regordenctecte_pp.errors` | [SME-PENDING] ms |
...
| `legacycore.bdispei.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdispei.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdispei", "latency.p50"], ["legacycore/bdispei", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdispei", "errors.total"], ["legacycore/bdispei", "errors.l4"]]},
...
### INC-D08-01: Alta latencia en endpoints
...
### INC-D08-02: Divergencias financieras (L4)

```
DETECTAR: Alarma legacycore.bdispei.errors.l4 > 0
ACCIÓN INMEDIATA:
...
### INC-D08-03: Falla total del microservicio
