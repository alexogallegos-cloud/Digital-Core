...
| **CONDUSEF** | Ley del Deudor — suspensión de cobranza durante aclaración | Si un cliente en cobranza presenta una aclaración ante CONDUSEF o ante LegacyCore, la gestión de cobranza debe suspenderse durante la duración de la aclaración. El target debe integrar esta validación con D07-bdiaclaracion. | 🟠 MEDIO |
| **LFPDPPP** | Despachos de cobranza externos | Si LegacyCore traslada gestiones de cobranza a despachos externos, estos reciben datos PII (nombre, RFC, CURP, monto adeudado, datos de contacto). Cada despacho debe tener DPA firmado. El target debe auditar qué datos se comparten con cada despacho. | 🔴 ALTO |
