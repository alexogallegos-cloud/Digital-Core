...
- **CONDUSEF** (`Solutioning/Delivery - SME/Regulatory/CONDUSEF/`) — 34 reglas · LTOSF Art.17 (CAT) + RECO — comisión debe estar registrada
- **SAT** (`Solutioning/Delivery - SME/Regulatory/SAT/`) — 4 reglas · LIVA — IVA sobre comisiones (16% / 8% frontera)
