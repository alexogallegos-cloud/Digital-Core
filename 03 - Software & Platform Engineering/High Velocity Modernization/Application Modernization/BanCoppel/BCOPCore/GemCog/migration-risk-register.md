...
**Descripción**: Defecto activo en producción en el componente P655. Detalles pendientes de sesión de validación con DBA IBM Informix y Core Banking.

**Mitigación**: [PENDIENTE — sesión de validación requerida con DBA IBM Informix antes de clasificar]
...
**Descripción**: Segundo defecto activo en producción en el componente P655. Detalles pendientes de sesión de validación.
