...
json.dump(DATA, open(BASE+"generations-data.json","w",encoding="utf-8"), ensure_ascii=False, separators=(",",":"))
...
open(BASE+"generations-bcop.html","w",encoding="utf-8").write(HTML)
