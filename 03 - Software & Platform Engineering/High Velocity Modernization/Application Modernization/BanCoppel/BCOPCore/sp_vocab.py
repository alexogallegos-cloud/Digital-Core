...
CAT = {
 ...
 "beneficiarios":("ENTIDAD","beneficiarios","conf"),"bts":("ENTIDAD","beneficiarios (BTS)","inf"),
 ...
 "sac":("ENTIDAD","Servicios de Atención al Cliente — subsistema de atención en sucursal (ventanilla, domiciliación, abonos ATM, remesas WU); base de datos propia bdisac: con tabla sac_movimientoshistorial","inf"),"ref":("AMBIGUO","referencia","inf"),
