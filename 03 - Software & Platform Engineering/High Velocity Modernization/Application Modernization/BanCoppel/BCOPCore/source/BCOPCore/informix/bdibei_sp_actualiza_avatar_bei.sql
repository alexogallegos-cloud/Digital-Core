CREATE PROCEDURE "informix".sp_actualiza_avatar_bei(pIdUsuario INTEGER,pNumCliente CHAR(9),pIdAvatar SMALLINT,pNumIntento SMALLINT)
	RETURNING CHAR(5);
	...
	BEGIN
		...
		SET id_avatar = pIdAvatar,
		    numintento = pNumIntento,
		    f_modifica = CURRENT
