CREATE PROCEDURE "informix".sp_replicainformacionvisacredito_20084__pba(dFecha1 DATETIME year to fraction(5),dFecha2 DATETIME year to fraction(5),cTrimestre cHAR(5),iMes INTEGER)
...
--Set debug file to "/resplogifx/sp_replicainformacionvisacredito_20084_PBA.out";
--trace on;
