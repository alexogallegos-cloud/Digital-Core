CREATE PROCEDURE "informix".corresp_revpagotdc_pba( psucursal char(4), pusuario char(8), pfolio char(16) )
RETURNING CHAR(5);
    ...
    --- SET DEBUG FILE TO "./corresp_revpagotdc.out";
    --- TRACE ON;
    ...
    ON EXCEPTION SET sql_err, isam_err
        IF (sql_err <> 0) THEN
            --- SET DEBUG FILE TO "./corresp_revpagotdc.err";
            --- TRACE ON;
