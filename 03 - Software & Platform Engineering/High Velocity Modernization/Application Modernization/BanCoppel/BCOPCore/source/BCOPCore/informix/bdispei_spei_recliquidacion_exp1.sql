CREATE PROCEDURE "informix".spei_recliquidacion_exp1(pvchrclaverastreo CHAR(30)) -- clave de rastreo
...
RETURNING CHAR(5); -- codigo de retorno
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/spei_recliquidacion.out";
    --- TRACE ON;
