CREATE PROCEDURE "informix".sp_reporteliquidacioncardif(pConvenio CHAR(5))
...
LET iCuantos	= 0;
	...
	--SET DEBUG FILE TO '/respaldosbd/hugovaz/sp_reporteliquidacioncardif.out';
	--TRACE ON;
	...
	BEGIN
		ON EXCEPTION SET iSqlErr, iIsamErr, cInfoErr
			IF iSqlErr <> 0 THEN
				...
				EXECUTE PROCEDURE "informix".sp_sac_GuardaMensajeerror (iSqlErr, iIsamErr, cInfoErr, "sp_reporteliquidacioncardif");
			END IF;
		END EXCEPTION;
