CREATE PROCEDURE "informix".corresp_pagotdc_pba( pc_costos CHAR(4),      --- SUCURSAL
...
RETURNING CHAR(3),  --- CODIGO DE RETORNO
    ...
    -- SET DEBUG FILE TO "/tmp/corresp_pagotdc.out";
    -- TRACE ON;
    ...
    IF (vlim_cuenta < vnomaxudis) THEN
        ...
        INTO vcodret1, vremanente, vintmorcob, vintvencob, vcapvencob, vintvigcob, vcapvigcob, vimpcob, vcomcob, vsegcob;
        ...
        IF vcodret1 = '000' THEN 
            ...
            END IF;
        ELSE 
            IF vcodret1 = '008' THEN
                LET vcodret1 = '008';
            ELIF vcodret1 = '301' THEN
                LET vcodret1 = '009';
            ELIF vcodret1 = '110' OR
               vcodret1 = '00100' OR
               vcodret1 = '100' OR
               vcodret1 = '099' THEN
                LET vcodret1 = '301';
