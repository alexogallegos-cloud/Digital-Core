CREATE PROCEDURE "informix".sp_replicacredito_especial(dFecha1 DATETIME year to fraction(5),dFecha2 DATETIME year to fraction(5),cTrimestre cHAR(5),iMes INTEGER)
...
--INFORMACION DE CREDITO
	...
	and prodind='02' and codigoiso='00' and movreversado='F' and esnacional='V' and transaccionorigen = '1234' and numtarjeta matches '4268*'
	...
	from intercard:movimiento where fechahorainauth >=dFecha1 and fechahorainauth <=dFecha2
	and prodind='02' and codigoiso='00' and movreversado='F' and esnacional='F'  and transaccionorigen = '1234' and numtarjeta matches '4268*'
	and formato <> '0420' and movconciliado='V' and metodocaptura='90' ;
	...
	and prodind='01' and codigoiso='00' and movreversado='F' and esnacional='V' and trancajeropropio='F' and transaccionorigen = '1234' and numtarjeta matches '4268*'
	and formato <> '0420'
	and movconciliado='V' ;
	...
	from intercard:movimiento 
	where  fechahorainauth >=dFecha1 and fechahorainauth <=dFecha2
	and prodind='01' and codigoiso='00' and movreversado='F' and esnacional='F' and trancajeropropio='F' and transaccionorigen = '1234' and numtarjeta matches '4268*'
	and formato <> '0420'
	and movconciliado='V' ;
	...
	from intercard:movimiento 
	where  fechahorainauth >=dFecha1 and fechahorainauth <=dFecha2
	and prodind='01' and codigoiso='00' and movreversado='F' and esnacional='V' and trancajeropropio='V' and transaccionorigen = '1234' and numtarjeta matches '4268*'
	and formato <> '0420'
	and movconciliado='V' ;
...
--Esta informacion solo se corre si es final de trimestre
	IF iMes = 3 OR iMes = 6 OR iMes = 9 OR iMes = 12 THEN
       ...
       /*
		...
		and status_cred <> 'CV'
		and status_cred <> 'FF'
		and num_credito in (select num_credito from bdicred:sd_tarjeta where numcte <> '');
