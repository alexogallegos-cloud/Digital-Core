CREATE PROCEDURE "informix".consnomtarcred_web(pEmpresa char(3), pTarjeta char(20))
...
LET vNumProd = "";
        ...
        SELECT
                b.num_producto, c.numcte, c.num_credito, a.apell_paterno, a.apell_materno, a.nombre1, a.nombre2, a.rfc, d.monto_otorgado
        INTO
        ...
        WHERE
                a.empresa = pEmpresa AND c.num_credito = b.num_credito and c.numcte = a.numcte and c.num_tarjeta = pTarjeta and c.num_credito = d.num_credito;
