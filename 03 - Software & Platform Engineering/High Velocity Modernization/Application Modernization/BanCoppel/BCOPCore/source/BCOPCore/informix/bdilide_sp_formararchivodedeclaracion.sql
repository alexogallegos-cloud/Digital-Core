CREATE PROCEDURE "informix".sp_formararchivodedeclaracion(p_cFechaXML VARCHAR(6), p_cDeclaracion CHAR(1),p_cTipoDeclaracion CHAR(1))
...
BEGIN
	...
	--SET DEBUG FILE TO "/triad/entrada/lflores/jairo/trace/sp_formararchivodedeclaracion.out";
	--TRACE ON;
