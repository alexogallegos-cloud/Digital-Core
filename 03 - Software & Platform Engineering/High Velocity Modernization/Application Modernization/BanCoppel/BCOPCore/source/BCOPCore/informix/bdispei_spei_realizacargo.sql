CREATE PROCEDURE "informix".spei_realizacargo(pvchrclaverastreo CHAR(30),      -- clave de rastreo
                                              pvchrcuentaord    CHAR(20),      -- numero de cuenta del ordenante
                                              pmnyimporte       DECIMAL(17,2), -- importe de la operación
                                              pintrefnumerica   CHAR(7),       -- referencia numérica
...
RETURNING CHAR(30); -- folio
    ...
    ON EXCEPTION SET vSqlErr, vIsamErr
        SET DEBUG FILE TO "/resplogifx/conciliachq/spei/spei_realizacargo.err";
        TRACE ON;
        IF vSqlErr != 0 THEN
    ...
    IF wexisteclave is null OR wexisteclave = '' THEN
        ...
        /* ##################################################################################################################
        IF vproducto NOT IN('1300','1700','1400','9900','9901','8000','1200','1600','2200','2600','2700','2800') THEN
            SELECT mnycomision
