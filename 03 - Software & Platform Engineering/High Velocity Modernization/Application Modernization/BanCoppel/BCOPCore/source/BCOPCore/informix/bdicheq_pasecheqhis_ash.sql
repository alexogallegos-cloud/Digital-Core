create procedure "informix".pasecheqhis_ash(pempresa char(3),
				        pfechahoy date)
       returning char(5);
...
--jom ini
    select cuenta, sucursal, producto, transacc, monto_tot, cancelad
    from sc_movhis
    where empresa = pempresa
    and fech_alt = pfechahoy into temp his1 with no log;

    create index inx_temp on his1(cuenta);
...
--       and fech_alt = pfechahoy
          --and md.cuenta in("10000129955", "10009453755")
     union all
