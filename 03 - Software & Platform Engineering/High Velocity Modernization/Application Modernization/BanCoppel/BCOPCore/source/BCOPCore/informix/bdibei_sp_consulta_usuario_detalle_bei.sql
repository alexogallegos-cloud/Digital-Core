CREATE PROCEDURE "informix".sp_consulta_usuario_detalle_bei(pIdMancomunidad Integer)
   returning char(5), Integer, Integer,CHAR(50),CHAR(50),CHAR(150),CHAR(15),SMALLINT,CHAR(50),INTEGER;
...
--***************************************************************************************************
  ...
  BEGIN
   ...
   ON EXCEPTION SET sql_err
      IF sql_err <> 0 THEN
            let cod_ret = sql_err;
            RETURN cod_ret, sIdAdminManco, sTipoMov, sUsuario, sPass, sNombre, sTelCelular, sCiaCel, sEmail, sIdPerfil;
      END IF ;
   END EXCEPTION ;
...
--**************************************************************************************************************
    ...
    Select id_admin_manco, tipo_mov,usuario_bei,pass,nombre_user, tel_celular,cia_cel,e_mail,id_perfil
	Into sIdAdminManco, sTipoMov ,sUsuario, sPass, sNombre, sTelCelular, sCiaCel, sEmail, sIdPerfil 
