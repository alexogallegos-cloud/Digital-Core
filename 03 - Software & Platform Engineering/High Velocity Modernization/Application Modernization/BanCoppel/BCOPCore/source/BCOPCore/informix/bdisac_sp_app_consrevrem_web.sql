CREATE PROCEDURE "informix".sp_app_consrevrem_web(pSucursal CHAR(4), pFolio CHAR(16))
	...
	BEGIN
		...
		IF NVL(pSucursal,'') = '' OR NVL(pFolio,'') = '' THEN
			LET cCodRet =   '00001'; --Faltan parametros
			RETURN cCodRet,cRemesa,cSucursal,cNumEmpleado,cFolioSuc,cStatusCancel;
		END IF;
...
CREATE PROCEDURE "informix".sp_consdatosticketapp_web (pFoli_suc CHAR(20))
RETURNING 
CHAR(5)  AS Cod_Ret,
CHAR(16) AS Num_Ref,
CHAR(40) AS Nombre1,
...
'FOLIO:230142-1542',
'DESCRIPCION: Su funcionalidad es para obtener los datos para la reimpresiÃÂ³n del ticket',
'FECHA:2016/04/18',
