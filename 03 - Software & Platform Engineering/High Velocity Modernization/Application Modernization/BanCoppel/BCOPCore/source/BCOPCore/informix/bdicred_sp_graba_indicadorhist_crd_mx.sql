CREATE PROCEDURE "informix".sp_graba_indicadorhist_crd_mx()
...
DEFINE vContador    INTEGER; 
  ...
  SET DEBUG FILE TO '/tmp/sp_graba_indicadorhist_crd.trc';
  TRACE ON;
...
BEGIN
  ...
  LET vtoday        = today;
    ...
    UPDATE statistics medium FOR TABLE "informix".sd_indicador_cred_crd_hist;   -- SOLOT COMENTAR PARA TEST MACF
