CREATE PROCEDURE "informix".sp_user_manc_aut_bei(
												pNumCliente CHAR(9),
												pIdUser integer,
												pNoReg integer,
												pRegIni integer,
   ...
   CHAR(5),   INTEGER,   INTEGER,    CHAR(9),    CHAR(250),     CHAR(150),     CHAR(15),
    SMALLINT,     CHAR(50),    SMALLINT,    SMALLINT,    CHAR(50),    INTEGER;
...
--**************************************************************************************************************
    	IF NVL(pIdTipoMov,99) <> 99 THEN
         ...
         -- RETURN cod_ret, iTotalReg,NVL(sIdUsuario,-1), sNumCliente,sUserNom,sNombre,sTelCelular,sCiaCel,sEmail,sIdStatus,sIdTipoUser,sUserNomAdmin,sIdAdminManco,sTipoMov WITH RESUME;
