CREATE PROCEDURE "informix".sp_depura_ss_detalle_modelo()
       RETURNING char(6);
...
DEFINE dFecha		DATE;	
	...
	--SET DEBUG FILE TO "/resplogifx/archivoscartera/Cut/sp_depura_ss_detalle_modelo.out";
    --TRACE ON; 
    ...
    FOREACH WITH HOLD
		...
		BEGIN WORK;
			...
			delete from bdicred:"informix".temp_creditos_depurar3 where num_credito = VlNumCredito;
