...
RETURNING CHAR(5),       --- CODIGO DE RETORNO 
          ...
          CHAR(16),       --- 4 ULTIMOS DIGITOS TARJETA
    ...
    FOREACH 
        SELECT trj.num_tarjeta--, mae.sdo_actual - ( mae.sdo_retenido + mae.sdo_cong + mae.imp_chq_sbg )
         ...
         WHERE trj.cuenta = mae.cuenta
           ...
           --- AND ( mae.sdo_actual - ( mae.sdo_retenido + mae.sdo_cong + mae.imp_chq_sbg ) ) > 0.00 se quito para que pudera entrar a más condiciones
...
END PROCEDURE
DOCUMENT
'Consulta las tarjetas disponibles del cliente para el servicio wstransferenciascloud',
'AUTOR : Luis Fernando Trapero Soto',
'FECHA :MAYO/2024',
'BD    : bdicheq',
'--------------------------------------------------------------------------------------',
'Se agrega consulta a la tabla si_cliente para verificar si existe registro tras no encontrarlo',
'en la si_relacion_ctebcplcpl',
'AUTOR : Luis Fernando Trapero Soto',
'FECHA :JULIO/2024',
'BD    : bdicheq';
