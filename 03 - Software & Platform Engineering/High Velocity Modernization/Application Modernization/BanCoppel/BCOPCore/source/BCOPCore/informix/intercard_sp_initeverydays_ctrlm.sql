CREATE PROCEDURE "informix".sp_initeverydays_ctrlm ()
RETURNING VARCHAR(6) as Cod_ret,VARCHAR(80) as Men_ret;
 ...
 -- SET DEBUG FILE TO "/RESPALDOSNEW/sp_initeverydays_ctrlm.out";
 -- TRACE ON;
...
DOCUMENT
'DESCRIPCION: Se optimiza el SP para reducir tiempos de ejecucion.',
'EJECUTADO O LLAMADO POR: Job 831 Malla Control-M. (initeveryday).',
'AUTOR: LGMR',
'FECHA: 21/Julio/2022',

'DESCRIPCION: OptimizaciÃ³n realizada por equipo Softtek ().',
'EJECUTADO O LLAMADO POR: Job 831 Malla Control-M. (initeveryday).',
'AUTOR: LGMR',
'FECHA: 21/Julio/2022',
