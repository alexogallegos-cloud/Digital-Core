CREATE PROCEDURE "informix".sp_ipab_rangoctes_temp_esp()
RETURNING CHAR(5);
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, iDesErr
        SET DEBUG FILE TO "/resplogifx/conciliachq/sp_ipab_rangoctes_temp_esp.err";
        TRACE ON;
        IF iSqlErr <> 0 THEN
            LET cCodRet = iSqlErr;
    ...
    ---	SET DEBUG FILE TO "/resplogifx/conciliachq/sp_ipab_rangoctes_temp_esp.out";
    ---	TRACE ON;
