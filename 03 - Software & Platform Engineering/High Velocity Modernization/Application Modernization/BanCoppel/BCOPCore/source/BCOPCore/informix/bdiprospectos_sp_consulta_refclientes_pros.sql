CREATE PROCEDURE "informix".sp_consulta_refclientes_pros(
                                                    sEmpresa    CHAR(3),
                                                    sNumCte     CHAR(20),
                                                    sParentesco CHAR(2),
                                                    sTelefono   CHAR(13),
...
--SET DEBUG FILE TO "/tmp/sp_consulta_refclientes.out";
--TRACE ON;
...
BEGIN
    ...
    IF (sNumCte <> ' ' AND sNumCte IS NOT NULL) THEN
            ...
            SELECT ref.empresa, ref.num_solicitud, ref.numcte_pros, ref.sucursal, ref.secuencia, ref.apell_paterno, ref.apell_materno, ref.nombre1, 
            ...
            FROM "informix".pr_refclientes ref 
            LEFT OUTER JOIN "informix".pr_refdirecciones refdir 
                 ON (refdir.numcte_pros = ref.numcte_pros
