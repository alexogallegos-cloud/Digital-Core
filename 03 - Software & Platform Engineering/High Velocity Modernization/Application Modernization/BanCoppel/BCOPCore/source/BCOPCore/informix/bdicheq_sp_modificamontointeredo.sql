CREATE PROCEDURE "informix".sp_modificamontointeredo( pParametro CHAR(20), pValor CHAR(60), pUsuario CHAR(20) )
RETURNING CHAR(5);
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/altamasempnet/sp_modificamontointeredo.out";
    --- TRACE ON;
    
    BEGIN
    
    ON EXCEPTION SET viSqlErr, viIsamErr, vcDescErr
        SET DEBUG FILE TO "/resplogifx/conciliachq/altamasempnet/sp_modificamontointeredo.err";
        TRACE ON;
        IF viSqlErr <> 0 THEN
    ...
    IF ( pValor is not null AND pValor != '' ) THEN
        ...
        IF ( dbinfo('sqlca.sqlerrd2') > 0 ) THEN
            INSERT INTO sc_montos_interedo(fecha_mod, usuario_mod, monto_anterior, monto_actual)
