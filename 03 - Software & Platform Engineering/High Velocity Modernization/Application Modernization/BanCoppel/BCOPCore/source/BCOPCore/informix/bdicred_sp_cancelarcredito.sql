CREATE PROCEDURE "informix".sp_cancelarcredito(pEmpresa CHAR(3), pNumCredito CHAR(20), pMotivoCancel CHAR(3), pEjecutivo CHAR(8),
...
--SET DEBUG FILE TO "/tmp/sp_cancelarcredito.out";
--TRACE ON;
	...
	END IF
	-- AAME 31012017 Se agregan los productos de crÃ©dito platino y oro para que se contemplen en la cancelaciÃÂ³n de crÃÂ©ditos
...
-- OBTIENE LA FECHA DEL DIA
	...
	ELIF cStaCredito = 'CV' THEN
		LET cCodRet = '00012'; -- CREDITO VENDIDO
	...
	IF cCodRet='00000' THEN 
	      ...
	      END IF
			...
			IF cCodRet = '00000' THEN
				...
				-- VALIDA QUE NO HAYA TENIDO ERROR LA GENERACIÃN DEL FOLIO NOMINA.
				...
				-- Realiza validaciÃ³n, si al credito le corresponde devolucion de comision por anualidad, termina proceso de cancelacion. 
				...
				-- VALIDAMOS LA SESION DE LA CANCELACIÃN SI ES DE CENTRAL O SUCURSAL.
				...
				--AAME 21032019 INC 27 116 Se considera cancelar todos los plÃ¡sticos diferente de CANCELADAS
				FOREACH
			...
			--AAME 21032019 INC 27 116 Se valida que el estatus para cancelar sea A o I
				...
				FOREACH
					...
					--Se busca el nÃºmero de tarjeta con la marca que se encuentre en estatus INA y se contempla ciclo por que hay casos que tienen mas de un plÃÂ¡stico solicitado en INA
					FOREACH
						-- OBTIENE EL CODIGO DE PRODUCTO DE TARJETA DE INTERCARD
...
'FECHA DE MODIFICACIÃN: 22 de Noviembre del 2011',
...
'			  se quito la condiciÃ³n del nÃºmero de cliente, para cancelar la tarjeta titular y las tarjetas adicionales',
'FECHA DE MODIFICACIÃN: 17 de Octubre del 2012',
'VERSION: 20121017.1726',
'BD: BDICRED',
'MODIFICÃ: Carlos Ochoa Valenzuela',
'DESCRIPCION: Se agrega una validaciÃ³n para comprobar si los crÃ©ditos con estatus FF estan solo saldados o cancelados.',
'             Se agregan cÃ³digos de retorno para los estatus BA,BT,FC y FF.',
...
'DESCRIPCION: Se agrego una nueva variable, debido a la modificaciÃ³n de los datos de salida del sp: cancelatarjeta.sql.', 
'FECHA DE MODIFICACIÃN: 29 de Julio del 2014',
