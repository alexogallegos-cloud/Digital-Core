CREATE PROCEDURE "informix".detmauxsuc(pempresa char(3), pfecha_hoy date)
...
DEFINE tnomaux            CHAR(50);
   ...
   FOREACH
      ...
      ORDER BY
           ...
           ccsssubsub, sector, ciudad, sucursal, auxiliar, moneda
      ...
      INSERT INTO co_detmaenca
         VALUES(tempresa,
                ...
                tccsssubsub,tsector,tciudad,tsucursal,tnro_auxiliar,tmoneda,
