CREATE PROCEDURE "informix".sp_validaproducto1(pNumProd CHAR(4), pNumTarjeta CHAR(16), pNumOpc CHAR(1),pClave CHAR(3),Tipot CHAR(1) )
...
BEGIN
           ...
           SELECT codproductotarjeta,clave_tipotarjeta,bin  INTO cCodProd,cCodClaveTar,cCodBin FROM intercard:tipotarjeta WHERE clave = pClave AND Tipo = Tipot AND flagsolicitud = 1;
