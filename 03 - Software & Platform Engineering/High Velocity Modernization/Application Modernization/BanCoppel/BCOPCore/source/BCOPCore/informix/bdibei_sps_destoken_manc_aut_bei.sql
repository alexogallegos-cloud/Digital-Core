CREATE PROCEDURE "informix".sps_destoken_manc_aut_bei(
												pNumCliente char(9),
												pIdUser integer,
												pNoReg integer,
												pRegIni integer)
  ...
  BEGIN
   ...
   ON EXCEPTION SET sql_err
      IF sql_err <> 0 THEN
            ...
            sIdStatusToken,
            sUserNomAdmin,
            sIdMancomunidad,sUserNom,sIdUser,sIdUserAdmin;
      END IF ;
   END EXCEPTION ;
...
--**************************************************************************************************************
  ...
  SET LOCK MODE TO WAIT 4;
     ...
     IF iTotalReg == 0 THEN
         ...
         RETURN cod_ret, iTotalReg,sNsToken,sIdStatusToken,sUserNomAdmin,sIdMancomunidad,sUserNom,sIdUser,sIdUserAdmin;
      END IF ;
...
--**************************************************************************************************************
          ...
          FOREACH
            SELECT  SKIP pRegIni FIRST pNoReg usu.ns_token,usu.id_status_token,usu.id_admin_manco
           , usu.id_usuario,usu.id_usuario_admin
            INTO  sNsToken, sIdStatusToken,sIdMancomunidad,sIdUser,sIdUserAdmin
            FROM bdibei:"informix".bei_admin_manco_temp  usu
           ...
           RETURN cod_ret, iTotalReg,sNsToken,sIdStatusToken,sUserNomAdmin,sIdMancomunidad,sUserNom,sIdUser,sIdUserAdmin WITH RESUME;
          END FOREACH;
