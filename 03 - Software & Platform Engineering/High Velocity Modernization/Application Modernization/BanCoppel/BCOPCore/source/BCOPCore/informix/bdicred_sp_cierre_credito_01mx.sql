CREATE PROCEDURE "informix".sp_cierre_credito_01mx(pEmpresa CHAR(3))
RETURNING
   CHAR(6)        AS Cod_Ret,
   CHAR(80)       AS Mens_Ret;
...
-- Fecha: 2010/01/20
-- Comentario: * Se agrega la actualizaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n del campo capital_status_ant
--             * Se agrega la actualizaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n del campo mto_fin_ven_trasp
--             * Se agrega la actualizaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n del campo dias_acum_mora
--             * Se agrega la actualizaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n del campo dias_acum_cap
--             * Se modifica el calculo de el parÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡metro de la tasa
...
-- Modifico: Paul Ivan Quintero Varela
-- Fecha: 12/02/2010
-- Comentario: * Se agrega validaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n para que la inserciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n del historico de saldos (tabla sd_maesdoshistcrd)
--               tambien se realice en su facturaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n.
--             * Se modifica para que la condiciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n del traspaso a los 90 dias no este ligado a que sea realizada siempre
...
-- *******************************************************
--  VALIDACIONES DE EJECUCIÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂN DE PROCESO                 *
-- *******************************************************
SELECT a.empresa 
  INTO cEmpresa
...
-- *******************************************************
--  INSERTA PARA EJECUCIÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂN DE PROCESO                 *
-- *******************************************************
--INI CAS
...
IF NVL(cCodTipCred,"") = "" THEN 
     LET cCodRet     = "000002";
     LET cMensajeRet = "El tipo de crÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©dito indicado no existe";
     RETURN cCodRet, cMensajeRet;
END IF;
...
-- *******************************************************
--  SELECCIÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂN DE CRÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂDITOS PARA PROCESAR                  *
-- *******************************************************
...
-- *******************************************************
--  IDENTIFICACIÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂN DE PROCESOS POR REALIZAR              *
-- *******************************************************

          -- ValidaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n para identificar un (Cierre de Mes).
          IF dtFechaHoy = dtFechaFinMes THEN  
            LET cIdProc1 = "C";
          END IF;			

          -- Validaciones para dÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ­as inhabiles y cambios de mes. (FacturaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n)
         ...
         --FMV 9ene13 Validacion 4o. Proceso, Provision a fin de mes cuando el siguiente dia es inhabil              
          IF (cIdProc1 = "C" AND dtFechaHoyAux > DATE(dtFechaHoy+1) AND iDiaCorte = 2) THEN
             ...
             --LET iDiasInt = iDiasInt - 1;  --Se quita un dia ya que provisionarÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡ los q no tienen vencimiento el dia 2
          END IF;
...
-- *******************************************************
   ...
   --FMV 20-ENE-11  Calcula el interes sobre el saldo capital sin el monto de traspaso ya calculado en la facturacion
           ...
           END IF;      
                  ...
                  --Se actualiza la fecha del prÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ximo proceso
                  UPDATE "informix".sd_maecredanexocrd
                     SET fecha_proceso  = dtFechaProx
                   WHERE num_credito    = cNumCredito
                     AND empresa        = cEmpresa;
...
-- *******************************************************
--  PROVISIÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂN POR FIN DE MES EN DIA INHABIL SIGUIENTE    *
-- *******************************************************
 ...
 LET dProvInt_inh = dSdoInt_inh;
	IF dTasaInter > 0 THEN   --FMV 26-AGO-14: Si la tasa de interes es mayor a cero, genero calculo de interes Real.
	  ...
	  IF cCodRet <> "000000" THEN
			LET cCodRet      = "000005";
			LET cMensajeRet  = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al realizar calculo de iva de interes";
			ROLLBACK WORK;
			RETURN cCodRet,cMensajeRet;
	  END IF;
	END IF;  --FMV
...
---Se genera la provision de interes en fin de mes o Facturacion
                ...
                IF (cCodRet <> "000000") THEN
                       LET cCodRet      = "000006";
                       LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar la provisiÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n de interes";
                       ROLLBACK WORK;
                       RETURN cCodRet,cMensajeRet;    
                END IF;
...
---Se genera la provision de iva de interes real en fin de mes o Facturacion
                        ...
                        IF (cCodRet <> "000000") THEN
                               LET cCodRet      = "000007";
                               LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar la provisiÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n de iva de interes";
                               ROLLBACK WORK;
                               RETURN cCodRet,cMensajeRet;    
                        END IF;
                END IF;
---ini cas, Se agrega el movimiento aplicativo de interes gravable y exento
                ...
                IF dIntGrav_inh>0 THEN
                        ...
                        IF (cCodRet <> "000000") THEN
                               LET cCodRet      = "000007";
                               LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar el InterÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©s Gravado";
                               ROLLBACK WORK;
                               RETURN cCodRet,cMensajeRet;    
                        END IF;
                END IF;
                IF dIntExen_inh>0 THEN
                        ...
                        IF (cCodRet <> "000000") THEN
                               LET cCodRet      = "000007";
                               LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar el InterÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©s Exento";
                               ROLLBACK WORK;
                               RETURN cCodRet,cMensajeRet;    
                        END IF;
                END IF;
...
END IF;
-- **********************************************************************
--  FIN DE PROVISIÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂN POR REGISTROS DE MOVTO EN FIN MES POR DIA INHABIL  *
-- **********************************************************************
...
-- *******************************************************
--  PROVISIÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂN                                            *
-- *******************************************************
...
-- FACTURACIÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂN                                           *
-- *******************************************************

-- FMV 25-ENE-2011: RealizarÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡ la facturaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n siempre y cuando la suma de Saldos vencidos sean mayores a cero
                     ...
                     where empresa             = cEmpresa
                       ...
                       IF dIvaPeriodo IS NULL THEN LET dIvaPeriodo=0; END IF;
                        ...
                        IF dIntPeriodo>0 THEN
                                ...
                                IF (cCodRet <> "000000") THEN
                                       LET cCodRet      = "000007";
                                       LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar el InterÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ©s Periodo";
                                       ROLLBACK WORK;
                                       RETURN cCodRet,cMensajeRet;    
                                END IF;
                        END IF;
           ...
           IF dTraspCap>0 THEN
             ...
             --FMV 25Abr13: Actualiza indicador del 1er. vencido y dias de atraso
              ...
              -- Traspaso capital vigente a transitorio.
               ...
               IF (cCodRet <> "000000") THEN
                      LET cCodRet      = "000009";
                      LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar traspaso capital vigente a transitorio";
                      ROLLBACK WORK;
                      RETURN cCodRet,cMensajeRet;  
                END IF;
                     ...
                     WHERE empresa        = cEmpresa 
                      ...
                      IF (dSdoCapital - dTraspCap)>0 THEN
                          ...
                          RETURNING cCodRet,cMensajeRet;
                            ...
                            IF (cCodRet <> "000000") THEN
                                   LET cCodRet      = "000010";
                                   LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar traspaso capital vigente a vdo no exigible";
                                   ROLLBACK WORK;
                                   RETURN cCodRet,cMensajeRet;    
                            END IF;
                      END IF;
                      ...
                      IF dMntVencido>0 THEN
                          ...
                          RETURNING cCodRet,cMensajeRet;
                            ...
                            IF (cCodRet <> "000000") THEN
                                   LET cCodRet      = "000011";
                                   LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar traspaso capital transitorio a exigible";
                                   ROLLBACK WORK;
                                   RETURN cCodRet,cMensajeRet;    
                            END IF;
                      END IF;
                      ...
                      IF dIntVdo>0 THEN
                          ...
                          RETURNING cCodRet,cMensajeRet;
                            ...
                            IF (cCodRet <> "000000") THEN
                                   LET cCodRet      = "000012";
                                   LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar traspaso interes vigente a vdo";
                                   ROLLBACK WORK;
                                   RETURN cCodRet,cMensajeRet;    
                            END IF;
                      END IF;
                /*      -- ProvisiÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n de interes ordinario a provisiÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n de cartera vencida
                      ...
                      RETURNING cCodRet,cMensajeRet;
                        ...
                        IF (cCodRet <> "000000") THEN
                               LET cCodRet      = "000013";
                               LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar provisiÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n de interes ordinario";
                               IF cBegin = "S" THEN
                                  ROLLBACK WORK;
                               END IF;
                               RETURN cCodRet,cMensajeRet;    
               ...
               WHERE num_credito   = cNumCredito
                ...
                /*      CALL "informix".genmovcrd(cEmpresa,cNumCredito, cNumProducto , 2, 
                  ...
                  RETURNING cCodRet,cMensajeRet;
                    ...
                    IF (cCodRet <> "000000") THEN
                           LET cCodRet      = "000014";
                           LET cMensajeRet = "OcurriÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³ un error al registrar traspaso capital vencido no exigible a vencido exigible";
                           ROLLBACK WORK;
                           RETURN cCodRet,cMensajeRet;    
                    END IF;             
           END IF;
...
-- *******************************************************
-- RESPALDO DE INFORMACIÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂN CONTABILIDAD A FIN DE MES     *
-- *******************************************************
     IF cIdProc1 = "C"  or day(dtFechaHoy)=20 THEN
           INSERT INTO "informix".sd_maesdoscontcrd
                SELECT dtFechaHoy, *
...
-- *******************************************************	
	...
	--ActualizaciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n a FIN DE MES.
	IF cIdProc1 = "C" THEN
		UPDATE "informix".sd_indicador_cred_crd 
