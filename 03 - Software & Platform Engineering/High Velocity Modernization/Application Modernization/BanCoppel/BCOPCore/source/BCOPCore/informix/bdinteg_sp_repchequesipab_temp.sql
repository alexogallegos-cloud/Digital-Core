CREATE PROCEDURE "informix".sp_repchequesipab_temp( pNumCliente  CHAR(20), 
                                                    pFechaIni    DATE, 
                                                    pFechaFin    DATE, 
...
RETURNING CHAR(5);
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, cDesErr
        SET DEBUG FILE TO '/resplogifx/conciliachq/ipab/sp_repchequesipab_temp.err';
        TRACE ON;
        LET cCodRet  = iSqlErr;
    ...
    --- SET DEBUG FILE TO '/resplogifx/conciliachq/ipab/sp_repchequesipab_temp.out';
    --- TRACE ON;
