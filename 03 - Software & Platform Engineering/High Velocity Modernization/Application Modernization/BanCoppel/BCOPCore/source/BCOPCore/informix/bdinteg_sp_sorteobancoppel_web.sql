CREATE PROCEDURE "informix".sp_sorteobancoppel_web(p_canal INT,
												p_tpoper INT,
												p_producto INT,
												p_numcte CHAR(9),
												p_sucursal CHAR(4),
												...
												p_fecha DATE)
RETURNING CHAR(5) AS cod_Ret,CHAR(80) AS mensaje,INTEGER AS rango_ini,INTEGER AS rango_fin;
...
-- jom	FOREACH
	...
	IF v_cvesorteo = '' OR v_cvesorteo IS NULL THEN
		LET P_COD_RET = '00116';   -- FMV 24sep10 Se adiciona codigo
	...
	ELSE                
		...
		ELSE
			LET v_RangoIni = 0;
			LET v_RangoFin = 0;
			LET P_COD_RET = '00117';  -- FMV 24sep10 Se adiciona codigo
