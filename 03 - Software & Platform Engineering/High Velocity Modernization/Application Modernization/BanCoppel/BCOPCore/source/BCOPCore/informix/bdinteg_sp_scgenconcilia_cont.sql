...
--			 chrc_ccsssub IS NULL OR chrc_ccssssub IS NULL OR chrc_sector) THEN
...
---		 IF  NOT (chra_ccmayor IS NULL OR chra_ccsub IS NULL OR  chra_ccsubsub IS NULL OR  chra_ccsssub  IS NULL OR 
--                chra_ccssssub IS NULL OR  chra_sector) THEN
			--
			INSERT INTO bdicont:co_conciliamovs(empresa, sistema, fecha,transac,
												ccmayor, ccsub, ccsubsub,
												ccssubsub, ccsssubsub, sector,
