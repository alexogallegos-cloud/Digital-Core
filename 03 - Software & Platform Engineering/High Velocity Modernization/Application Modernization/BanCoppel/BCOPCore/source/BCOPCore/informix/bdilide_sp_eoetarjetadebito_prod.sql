CREATE PROCEDURE "informix".sp_eoetarjetadebito_prod(pEmpresa CHAR(3), pFechaProceso DATE, pCve_Usuario CHAR(8))
RETURNING CHAR(4);
        ...
        FOREACH  
			SELECT maechq.num_cte, movdia.num_serial, cliente.rfc, movdia.cuenta, movdia.fech_alt, 
             ...
             WHERE movdia.fech_alt = pFechaProceso
               AND movdia.num_serial > 0
               AND movdia.cancelad <> 'S'
               AND movdia.transacc_suc IN ( SELECT valor 
