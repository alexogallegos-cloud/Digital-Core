CREATE PROCEDURE "informix".sp_conssolicitudescredito(pTipo INTEGER, pEmpresa CHAR(3), pSucursal CHAR(20), pSolicitudes SMALLINT,
	...
	BEGIN
		...
		ELSE
			...
			IF iConsultaSP = 2 OR vCantReg1 < 11 THEN 					
					...
					FOREACH
						EXECUTE PROCEDURE "informix".envia_monitorsol_pp_ss(
