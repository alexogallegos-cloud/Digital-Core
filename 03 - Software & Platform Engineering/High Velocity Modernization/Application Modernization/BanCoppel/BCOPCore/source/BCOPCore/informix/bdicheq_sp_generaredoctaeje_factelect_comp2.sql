CREATE PROCEDURE "informix".sp_generaredoctaeje_factelect_comp2( pEmpresa char(3) )
RETURNING CHAR(5);
    ...
    ON EXCEPTION SET vsqlerr, iIsamErr, cErrorInfo
        IF vsqlerr != 0 THEN
            SET DEBUG FILE TO "/resplogifx/conciliachq/edoctacfd/sp_generaredoctaeje_factelect_comp2.err";
            TRACE ON;
            LET vcodret = vsqlerr;
    ...
    --SET DEBUG FILE TO '/resplogifx/conciliachq/edoctacfd/sp_generaredoctaeje_factelect_comp2.out';
    --TRACE ON;
