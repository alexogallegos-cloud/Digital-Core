CREATE PROCEDURE "informix".sps_session_invalida_bpi(pEmpresa CHAR(3), pIdUsuario CHAR(11),pIp CHAR(15),pUsuarioIngresado CHAR(50),pPassIngresado CHAR(50),pSucursal CHAR(4),pNavegador CHAR(100))
...
BEGIN
	...
	INSERT INTO "informix".si_bpibitacora_loginvalido (fecha_oper, id_operacion, sucursal, id_usuario, ipusuario, fecha_aplic, sec_transaccion, cgenerico1, cgenerico2, navegador) 	            
