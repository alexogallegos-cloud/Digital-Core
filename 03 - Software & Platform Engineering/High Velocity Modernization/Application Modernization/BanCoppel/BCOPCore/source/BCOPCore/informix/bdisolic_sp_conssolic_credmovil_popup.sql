CREATE PROCEDURE "informix".sp_conssolic_credmovil_popup(pTipo 				INTEGER,
														pEmpresa 			CHAR(3),
														pSucursal 			CHAR(20),
...
RETURNING
	...
	INTEGER 	AS Factor_piso;	 --	factor piso. Identificadores: 1.- TDC Coppel, 2.- Crédito Motos Coppel, 3.-Ambos.
		...
		ELSE
			...
			ELIF pTipo = 5 THEN
				...
				-- TDC coppel pay
					...
					FOREACH
						EXECUTE PROCEDURE "informix".envia_monitorsol_cjunk_ss_CoppelAPlazos(
										  pEmpresa,pSucursal,0,pNumCte,'','',0,pFechaIni,pFechaFin)
						INTO  cValRetorno,s_numsol,s_numcte,s_nombre,s_rfc,s_fechasol,s_fechaaut,s_Producto,
							  s_ProdDes,s_linea,s_status,s_stdesc,s_comentario,s_diacorte,s_divisa,s_ingreso,
							  cCausaSol,vDescCausaSol,vdias_vigencia
