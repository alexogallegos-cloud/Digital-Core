CREATE PROCEDURE "informix".sp_respalda_credito_rr(pEmpresa CHAR(3),
                                                   pNumCred CHAR(20),
                                                   pUsuario CHAR(20))
RETURNING CHAR(6);
...
-- Fecha: 18/15/2010.
-- Comentario: Se modifico para considerar el manejo se una sola transaccion
...
--SET DEBUG FILE TO "/tmp/respalda_credito_pp.out";
--TRACE ON;
...
SET LOCK MODE TO WAIT 3;
   ...
   INSERT INTO "informix".sd_secpago(empresa, num_credito, folio_suc, secuencia)
        VALUES (g_empresa, g_NumCredito, g_Folio, iSecuenciaPago);

-------------------------------------------------------
--    RESPALDO DE MAECREDCRD                         --
-------------------------------------------------------
    INSERT INTO "informix".sd_maecredrevcrd
...
----------------------------------------------------------
    INSERT INTO "informix".sd_maesdosrevcrd
...
----------------------------------------------------------
     INSERT INTO "informix".sd_amortiza_creditorevcrd
...
-------------------------------------------------------
      ...
      INSERT INTO "informix".sd_maecredanexorevcrd
...
'En el pago de reestructuras, para poder efectuar su reversion',
'AUTOR : FMV',
'FECHA : 14/05/2010',
'BD    : BDICRED';
