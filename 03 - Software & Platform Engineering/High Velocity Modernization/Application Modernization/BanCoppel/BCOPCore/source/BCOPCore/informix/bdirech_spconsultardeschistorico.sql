CREATE PROCEDURE "informix".spconsultardeschistorico (p_sNumEmpleado CHAR(8), p_sNumSucursal CHAR(4), p_dFechaDescuento DATE)
...
DEFINE v_mDescAplicado		MONEY(10,2);
 ...
 --SET DEBUG FILE TO "/dbexportb/Fabiola/spconsultardeschistorico.out"; 
 --TRACE ON;
...
BEGIN
	...
	FOREACH
		SELECT numempleado, numsucursal, sueldoquincena, desccalculado, descaplicado INTO v_sEmpleado, v_sSucursal, v_mSueldoQuincenal, v_mDescCalculado, 
		v_mDescAplicado
