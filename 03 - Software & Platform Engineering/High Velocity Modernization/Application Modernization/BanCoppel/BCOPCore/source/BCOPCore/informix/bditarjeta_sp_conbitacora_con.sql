CREATE PROCEDURE "informix".sp_conbitacora_con(cTipo char(1),iElemento integer,dfecha_ini date,dfecha_fin date)
...
--************************************************************
   ...
   IF (cTipo == 1) THEN --Consulta por Todos los Elementos
		...
		FOREACH
			...
			SELECT elemento,fecha_hora,actividad,cve_usuario 
