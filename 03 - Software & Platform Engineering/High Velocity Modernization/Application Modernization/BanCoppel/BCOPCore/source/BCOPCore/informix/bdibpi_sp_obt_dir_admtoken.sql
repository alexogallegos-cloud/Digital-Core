CREATE PROCEDURE "informix".sp_obt_dir_admtoken(pCliente char(9), pSecuencia integer )
...
-- Actividad: Obtiene la dirección del cliente del AdmToken
-- Solicitó: Mauricio León
-- Fecha de Solicitud: 09/11/2009
--11/03/2011 se modifica para obtener departamento y forzar a consultar domicilio más actual  IHM
...
--                      el tamaño del telefono a 22.   Saul Ivanhoe Valdespino Hernandez.       
-- Se modifica para que consulte los datos teléfono y correo de las nuevas tablas si_telefonos_actual y si_correos. Viridiana Rosas.    
-- DIC 2012 
...
-- Modificación..: Se modifica para que cuando un cliente no cuente con domicilio, deje continuar el proceso del jar -- para la generacion masiva de guias.
-- Solicita......: Gabriela Aguilar Mendoza
-- BD............: Bdibpi       

-- Fecha.........: 05/01/2016 
-- Modificación..: Se modifica la consulta del correo.
-- Autor.........: 94362416 - AVF
---------------------------------------------------------------------------------------------
...
--SET DEBUG FILE TO "/informix/gaby/ArchivosOut/sp_obt_dir_admtoken.out";
--TRACE ON;
