CREATE PROCEDURE "informix".spconsultarconfaltante2 (p_sNumEmpleado CHAR(8), p_sNumSucursal CHAR(4), p_sNumZona CHAR(3), 
										p_sNumRegional CHAR(3), p_iIdAsignado SMALLINT, p_dFechaIni DATE, 
										p_dFechaFin DATE, p_iIdEstatus SMALLINT, pRegistros INTEGER, pRecuperacion Integer)
	...
	BEGIN
		...
		--area en especifico, o todas las areas sin restriciÃÂ³n)
			FOREACH
                ...
                numempleado, numsucursal, idfaltante, auxiliar, numzona, numregional, idconcepto, idrecupera, idasignado, 
		...
		ELIF p_iIdEstatus in (4,7) THEN --Consulta para cuando el area sea especifica o todas las areas (no asignados,  o area en especifico, o todas las areas sin restriciÃÂ³n)
					...
					if (p_iIdAsignado > 0 OR p_iIdAsignado IS NULL) THEN
							FOREACH
								SELECT SKIP pRegistros FIRST pRecuperacion 
                                    RC.numempleado, RC.numsucursal, RC.idfaltante, RC.auxiliar, RC.numzona, RC.numregional, RC.idconcepto, RC.idrecupera, RC.idasignado, 
