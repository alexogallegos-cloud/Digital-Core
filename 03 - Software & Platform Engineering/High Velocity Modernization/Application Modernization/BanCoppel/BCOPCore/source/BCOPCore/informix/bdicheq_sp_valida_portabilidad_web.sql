CREATE PROCEDURE "informix".sp_valida_portabilidad_web(pEmpresa CHAR(3),pNumCte CHAR(20),pNumCtaOrd CHAR(20))
--DATOS A REGRESAR---
...
CREATE PROCEDURE "informix".sp_verificatarjetaotrosbancos_web(pClaveBanco CHAR(3),pNumtarjeta CHAR(16))
--DATOS A REGRESAR---
RETURNING	CHAR(5) AS cCodRet;
