CREATE PROCEDURE "informix".sp_cred_consultarinfocrediticia(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumCte CHAR(20), pTpDirec INTEGER)
    ...
    -- Domicilio de Casa y TelÃ©fonos
    CHAR(30)       AS estado,
    CHAR(30)       AS ciudad,
    CHAR(30)       AS colonia,
    CHAR(30)       AS calle,
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			...
			RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   ...
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
                   iAntiguedadMeses, dtFechaApertura, dMontoOtorgado, mIngresoMensual, dtFechaHoy, dSalarioMin;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_cred_consultarinfocrediticia.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR NVL(pNumCte,"") = "" OR pTpDirec IS NULL THEN
			LET cCodRet = '00003';
			RETURN cCodRet,cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
		...
		EXECUTE PROCEDURE bdicred:"informix".sp_consultarinfocrediticia(cEmpresa , pNumCte, pTpDirec)
		INTO cCodRetSp, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
                   iAntiguedadMeses, dtFechaApertura, dMontoOtorgado, mIngresoMensual, dtFechaHoy, dSalarioMin;
		...
		IF iCodRetSp < 0 THEN
			RAISE EXCEPTION iCodRetSp, 0, "ERROR EN LA EJECUCION DEL SP sp_consultarinfocrediticia";
		ELIF iCodRetSp = 00002 THEN
              LET cCodRet = '00050';
              RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
		...
		ELIF iCodRetSp = 00003 THEN
              ...
              RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   ...
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
                   iAntiguedadMeses, dtFechaApertura, dMontoOtorgado, mIngresoMensual, dtFechaHoy, dSalarioMin;
		ELIF iCodRetSp = 00004 THEN
              LET cCodRet = '00846';
              RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
                   iAntiguedadMeses, dtFechaApertura, dMontoOtorgado, mIngresoMensual, dtFechaHoy, dSalarioMin;
		ELIF iCodRetSp = 00005 THEN
			LET cCodRet = '00847';
              RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
                   iAntiguedadMeses, dtFechaApertura, dMontoOtorgado, mIngresoMensual, dtFechaHoy, dSalarioMin;
		ELIF iCodRetSp = 00006 THEN
              LET cCodRet = '00848';
              RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
                   iAntiguedadMeses, dtFechaApertura, dMontoOtorgado, mIngresoMensual, dtFechaHoy, dSalarioMin;
		ELIF iCodRetSp = 00007 THEN
              LET cCodRet = '00849';
              RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
                   iAntiguedadMeses, dtFechaApertura, dMontoOtorgado, mIngresoMensual, dtFechaHoy, dSalarioMin;
		ELIF iCodRetSp = 00008 THEN
              LET cCodRet = '00850';
              RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
                   iAntiguedadMeses, dtFechaApertura, dMontoOtorgado, mIngresoMensual, dtFechaHoy, dSalarioMin;
		ELIF iCodRetSp = 00009 THEN
              LET cCodRet = '00851';
              RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
                   iAntiguedadMeses, dtFechaApertura, dMontoOtorgado, mIngresoMensual, dtFechaHoy, dSalarioMin;
		ELIF iCodRetSp = 00010 THEN
              LET cCodRet = '00852';
              RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
                   iAntiguedadMeses, dtFechaApertura, dMontoOtorgado, mIngresoMensual, dtFechaHoy, dSalarioMin;
		ELIF iCodRetSp = 00011 THEN
              LET cCodRet = '00853';
              RETURN cCodRet, cNumCte, cApellPat, cApellMat, cNom1, cNom2, cRFC, cNumCteCoppel, dtFechaNac,
                   cNomEdo, cNomCiudad, cNomColonia, cNomCalle, cNomMunicipio, cCod_postal, cTelefono1, 
                   cTelefono2, cTelefono3, cNumeroextcalle, cNumerointcalle, cCorreoElect, 
...
'FECHA: 27/09/2016',
'MODULO: CrÃ©dito',
'FUNCIONALIDAD: Aumento LÃ­nea de CrÃ©dito Central',
'DESCRIPCION: Consulta InformaciÃ³n Crediticia',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_cred_consultasaldosgeneral(pUsuario CHAR(8), pIdFuncion CHAR(10),pNumCredito CHAR(20))
		RETURNING CHAR(5) AS codret,
          ...
          DECIMAL(9,2)  AS tasa_interes,
          DECIMAL(9,2)  AS tasa_moratorios,
	...
	DEFINE dTasaInteres      DECIMAL(9,2);
	DEFINE dTasaMoratorios   DECIMAL(9,2);
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cMensajeRet, cNumCredito, cCodTipCred, dtFechaOrigen, dtFechaProxPago,
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_cred_consultasaldosgeneral.out';
		--TRACE ON;
		...
		INTO cCodRetSp, cMensajeRet, cNumCredito, cCodTipCred, dtFechaOrigen, dtFechaProxPago,
			dPagoMinimo, dtFechaUltPago, iPlazo, iPagosRealizados, dLineaOtorgada,
			dTasaInteres, dTasaMoratorios, dMontoSBC, dCapVig, dCapTrans, dCapVdoExig,
			dCapVdoNoExig, dSdoActCap, dIntVig, dIntVdo, dIntMoratorio, dIntMes,
			dSdoActInt, dIvaIntVig, dIvaIntVdo, dIvaIntMoratorio, dIvaIntMes, dSdoActIvaInt,
...
'FECHA: 07/10/2016',
'MODULO: CrÃ©dito',
'FUNCIONALIDAD: DisminuciÃ³n de LÃ­nea de CrÃ©dito Manual',
'DESCRIPCION: Realiza la consulta general de los saldos del cliente',
'BD: bdicnweb';
...
'FECHA: 20/10/2016',
'MODULO: CrÃ©dito ',
'FUNCIONALIDAD: Solicitud Incremento de LÃ­nea de CrÃ©dito Central ',
'DESCRIPCION: Se realiza procedimiento para el registro de la solicitud de incremento de clientes desde sucursal ',
'BD: bdicnweb';
...
'FECHA: 12/10/2016',
'MODULO: CrÃ©dito',
'FUNCIONALIDAD: Solicitud de Incrementos de LÃ­neas de CrÃ©dito Central',
'DESCRIPCION: Consulta las solicitudes dependiendo del numero de crÃ©dtio o cliente para poder realizar el incremento a la LÃ­nea de CrÃ©dito',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_catproductoscredito(pUsuario CHAR(8), pIdFuncion CHAR(10))
		RETURNING CHAR(5) AS codret,
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cNumProducto, cNombreProducto;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_catproductoscredito.out';
		--TRACE ON;
		...
		FOREACH
			...
			INTO cCodRetSp, cDesCodRetSp, cNombreProducto, cNumProducto		
			...
			RETURN cCodRet, cNumProducto, UPPER(cNombreProducto) WITH RESUME;
		END FOREACH;
...
'FECHA: 27/04/2016',
'MODULO: CRÉDITO',
'FUNCIONALIDAD: Monitor de Solicitudes en Supervisión', 
'DESCRIPCION: SPL que se encarga de consultar el número y nombre del catálogo de productos de crédito.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_catstatusupervision(pUsuario CHAR(8), pIdFuncion CHAR(10))
		RETURNING CHAR(5) AS codret,
			CHAR(2) AS status,
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_catstatusupervision.out';
		--TRACE ON;
		...
		FOREACH
			EXECUTE PROCEDURE bdisolic:"informix".sp_obtienestatus_superv('001')
			INTO cCodRetSp, cDesCodRetSp, cStatus, cDescStatus		
			
			IF cCodRetSp::INTEGER < 0 THEN 
				RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bdisolic:sp_obtienestatus_superv';
			ELIF cCodRetSp::INTEGER = 1 THEN 
				LET cCodRet = '00017';
				RETURN cCodRet, cStatus, cDescStatus;
			END IF;
			...
			LET iRecuperacion = iRecuperacion + 1;
			RETURN cCodRet, cStatus, UPPER(cDescStatus) WITH RESUME;
		END FOREACH;
...
'MODULO: CRÉDITO',
'FUNCIONALIDAD: Monitor de Solicitudes en Supervisión', 
'DESCRIPCION: SPL que se encarga de consultar el status y la descripcion del status del catálogo supervisión.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consdetallesolsupervision(pUsuario CHAR(8), pIdFuncion CHAR(10), pIdConsulta CHAR(1), pNumCliente CHAR(20), pNumSolicitud CHAR(20), 
pFechaInicio DATE, pFechaFin DATE, pStatus CHAR(2), pProducto CHAR(4), pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,
			CHAR(20) AS num_solicitud,
			CHAR(20) AS num_cliente,
			CHAR(130) AS nombre_cliente,
			DATE AS fecha_solicitud,
			DATE AS fecha_cambio_status,
			CHAR(2) AS status,
			CHAR(8) AS respuesta_os;		
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cNumSolicitud, cNumCliente, cNombreCliente, dFechaSolicitud, dFechaCambioStatus, cStatus, cRespuestaOs;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_consdetallesolsupervision.out';
		--TRACE ON;
		...
		IF pIdConsulta = '1' THEN
			...
			FOREACH
				EXECUTE PROCEDURE bdisolic:"informix".sp_busca_sol_supervision('001', pUsuario, pNumSolicitud, pNumCliente, pFechaInicio, pFechaFin, pStatus, pProducto)
				...
				IF cCodRetSp::INTEGER < 0 THEN 
					RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bdisolic:sp_busca_sol_supervision';
				ELIF cCodRetSp::INTEGER = 1 THEN
					LET cCodRet = '00003';
					RETURN cCodRet, cNumSolicitud, cNumCliente, cNombreCliente, dFechaSolicitud, dFechaCambioStatus, cStatus, cRespuestaOs;
				...
				LET iRecuperacion = iRecuperacion + 1;
				RETURN cCodRet, cNumSolicitud, cNumCliente, UPPER(cNombreCliente), dFechaSolicitud, dFechaCambioStatus, UPPER(cStatus), cRespuestaOs WITH RESUME;
			END FOREACH;
		...
		ELIF pIdConsulta = '2' THEN
			...
			FOREACH
				EXECUTE PROCEDURE bdicred:"informix".sp_consulta_supervision_mc('001', pNumSolicitud, pNumCliente, pFechaInicio, pFechaFin, 
				pStatus, pProducto, pRegistros, pRecuperacion)
				INTO cCodRetSp, cNumSolicitud, cNumCliente, cNombreCliente, dFechaSolicitud, dFechaCambioStatus, cStatus, cRespuestaOs
				
				IF cCodRetSp::INTEGER < 0 THEN 
					RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bdicred:sp_consulta_supervision_mc';
				ELIF cCodRetSp::INTEGER = 1 THEN
					LET cCodRet = '00003';
					RETURN cCodRet, cNumSolicitud, cNumCliente, cNombreCliente, dFechaSolicitud, dFechaCambioStatus, cStatus, cRespuestaOs;
				ELIF cCodRetSp::INTEGER = 2 THEN
...
'MODULO: CRÉDITO',
'FUNCIONALIDAD: Monitor de Solicitudes en Supervisión', 
'DESCRIPCION: SPL que se encarga de consultar el detalle de la solicitud supervisión.',
'Donde con pIdConsulta = 1, se obtienen las solicitudes por asignar al analista',
'y con pIdConsulta = 2, se obtiene la información principal del Monitor de Supervisión.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consinfodetallesolsupervision(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumSolicitud CHAR(20))
		RETURNING CHAR(5) AS codret,
			CHAR(20)  AS folio_os,
			DATE      AS fecha_generacion_os,
			CHAR(20)  AS num_solicitud,
			CHAR(20)  AS num_cte,
			CHAR(110) AS nombre_cte,
			CHAR(2)   AS status,
			...
			CHAR(27)  AS municipio,
			CHAR(6)   AS codigo_postal,
			CHAR(30)  AS estado,
			CHAR(20)  AS folio_os_coppel,
			DATE      AS fecha_generacion_os_coppel,
			CHAR(20)  AS num_solicitud_coppel,
			CHAR(20)  AS num_cte_coppel,
			INTEGER   AS num_ciudad_coppel,
			INTEGER   AS num_zona_coppel, 
			CHAR(32)  AS nombre_zona_coppel,
			CHAR(60)  AS nombre_ciudad_coppel,
			CHAR(27)  AS municipio_coppel,
			CHAR(6)   AS codigo_postal_coppel,
			CHAR(30)  AS estado_coppel,
			CHAR(11)  AS tienda_matriz_coppel,
	...
	DEFINE iSqlErr INTEGER;
	DEFINE cEmpresa CHAR(3);	
	DEFINE cFolioOs CHAR(20);
	DEFINE dFechaGeneracionOs DATE;
	DEFINE cNumSolicitud CHAR(20);
	DEFINE cNumCliente CHAR(20);
	DEFINE cNombreCliente CHAR(110);
	DEFINE cStatus CHAR(2);
	...
	DEFINE cCodPostal CHAR(6);
	DEFINE cEstado CHAR(30);
	DEFINE cFolioOsCoppel CHAR(20);
	DEFINE dFechaGeneracionOsCoppel DATE;
	DEFINE cNumSolicitudCoppel CHAR(20);
	DEFINE cNumCteCoppel CHAR(20);
	DEFINE iNumCiudadCoppel INTEGER;
	DEFINE iNumZonaCoppel INTEGER;
	DEFINE cNombreZonaCoppel CHAR(32);
	DEFINE cNombreCiudadCoppel CHAR(60);
	DEFINE cMunicipioCoppel CHAR(27);
	DEFINE cCodPostalCoppel CHAR(6);
	DEFINE cEstadoCoppel CHAR(30);
	DEFINE cTiendaMatrizCoppel CHAR(11);
	DEFINE iNumCobranzaCoppel INTEGER;	
	DEFINE iRecuperacion INTEGER;
	...
	LET cEstado = '';
	LET cFolioOsCoppel = '';
	LET dFechaGeneracionOsCoppel = '';
	LET cNumSolicitudCoppel = '';
	LET cNumCteCoppel = '';
	LET iNumCiudadCoppel = 0;
	LET iNumZonaCoppel = 0;
	LET cNombreZonaCoppel = '';
	LET cNombreCiudadCoppel = '';
	LET cMunicipioCoppel = '';
	LET cCodPostalCoppel = '';
	LET cEstadoCoppel = '';
	LET cTiendaMatrizCoppel = '';
	LET iNumCobranzaCoppel = 0;
	LET iRecuperacion = 0;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cFolioOs, dFechaGeneracionOs, cNumSolicitud, cNumCliente, cNombreCliente, cStatus, iNumCiudad, 
			iNumZona, cNombreZona, cNombreCiudad, cMunicipio, cCodPostal, cEstado, cFolioOsCoppel, dFechaGeneracionOsCoppel,
			cNumSolicitudCoppel, cNumCteCoppel, iNumCiudadCoppel, iNumZonaCoppel, cNombreZonaCoppel, cNombreCiudadCoppel,
			cMunicipioCoppel, cCodPostalCoppel, cEstadoCoppel, cTiendaMatrizCoppel, iNumCobranzaCoppel;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_consinfodetallesolsupervision.out';
		--TRACE ON;
		...
		FOREACH
			EXECUTE PROCEDURE bdisolic:"informix".sp_catinfogrid_sol_superv('001', pNumSolicitud)
			INTO cCodRetSp, cFolioOs, dFechaGeneracionOs, cNumSolicitud, cNumCliente, cNombreCliente, cStatus, iNumCiudad, 
			iNumZona, cNombreZona, cNombreCiudad, cMunicipio, cCodPostal, cEstado, cFolioOsCoppel, dFechaGeneracionOsCoppel,
			cNumSolicitudCoppel, cNumCteCoppel, iNumCiudadCoppel, iNumZonaCoppel, cNombreZonaCoppel, cNombreCiudadCoppel,
			cMunicipioCoppel, cCodPostalCoppel, cEstadoCoppel, cTiendaMatrizCoppel, iNumCobranzaCoppel
			
			IF cCodRetSp::INTEGER < 0 THEN 
				RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bdisolic:sp_catinfogrid_sol_superv';
			ELIF cCodRetSp::INTEGER = 1 OR cCodRetSp::INTEGER = 2 THEN
				LET cCodRet = '00003';
				RETURN cCodRet, cFolioOs, dFechaGeneracionOs, cNumSolicitud, cNumCliente, cNombreCliente, cStatus, iNumCiudad, 
				iNumZona, cNombreZona, cNombreCiudad, cMunicipio, cCodPostal, cEstado, cFolioOsCoppel, dFechaGeneracionOsCoppel,
				cNumSolicitudCoppel, cNumCteCoppel, iNumCiudadCoppel, iNumZonaCoppel, cNombreZonaCoppel, cNombreCiudadCoppel,
			...
			LET iRecuperacion = iRecuperacion + 1;
			RETURN cCodRet, cFolioOs, dFechaGeneracionOs, cNumSolicitud, cNumCliente, UPPER(cNombreCliente), cStatus, iNumCiudad, 
			iNumZona, UPPER(cNombreZona), UPPER(cNombreCiudad), UPPER(cMunicipio), cCodPostal, UPPER(cEstado), cFolioOsCoppel, 
			dFechaGeneracionOsCoppel, cNumSolicitudCoppel, cNumCteCoppel, iNumCiudadCoppel, iNumZonaCoppel, UPPER(cNombreZonaCoppel), 
			UPPER(cNombreCiudadCoppel), UPPER(cMunicipioCoppel), cCodPostalCoppel, UPPER(cEstadoCoppel), cTiendaMatrizCoppel, 
			iNumCobranzaCoppel WITH RESUME;
		END FOREACH;
...
'MODULO: CRÉDITO',
'FUNCIONALIDAD: Monitor de Solicitudes en Supervisión', 
'DESCRIPCION: SPL que obtiene el detalle de la solicitud supervisión bancoppel/coppel consultada.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consinfosolsupervision(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumSolicitud CHAR(20))
		RETURNING CHAR(5) AS codret,
			CHAR(20)  AS num_cte,         
			CHAR(20)  AS num_solicitud,   
			CHAR(80)  AS desc_producto,   
			CHAR(80)  AS desc_status,     
			CHAR(4)   AS sucursal,        
			CHAR(150) AS nombre_cte,      
			CHAR(13)  AS rfc,             
			CHAR(30)  AS calle,           
			CHAR(30)  AS estado,          
	...
	DEFINE cNumCliente CHAR(20); 
	DEFINE cNumSolicitud CHAR(20); 
	DEFINE cDescProducto CHAR(80); 
	DEFINE cDescStatus CHAR(80);
	DEFINE cSucursal CHAR(4);
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cNumCliente, cNumSolicitud, cDescProducto, cDescStatus, cSucursal, cNombreCliente, 
			cRfc, cCalle, cEstado, cDepartamento, cComplemento, cCiudad, cMunicipio, sEdificio, cNumInt, cNumExt,
			cCodPostal, cZonaCol, cTelCasa, cTelCelular, cTelTrabajo, cExtTrabajo;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_consinfosolsupervision.out';
		--TRACE ON;
		...
		EXECUTE PROCEDURE bdisolic:"informix".sp_cargainfo_sol_superv('001', pNumSolicitud)
		INTO cCodRetSp, cNumCliente, cNumSolicitud, cDescProducto, cDescStatus, cSucursal, cNombreCliente, 
		cRfc, cCalle, cEstado, cDepartamento, cComplemento, cCiudad, cMunicipio, sEdificio, cNumInt, cNumExt,
		cCodPostal, cZonaCol, cTelCasa, cTelCelular, cTelTrabajo, cExtTrabajo;
		
		IF cCodRetSp::INTEGER < 0 THEN 
			RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bdisolic:sp_cargainfo_sol_superv';
		ELIF cCodRetSp::INTEGER = 1 OR cCodRetSp::INTEGER = 2 THEN
			LET cCodRet = '00003';
			RETURN cCodRet, cNumCliente, cNumSolicitud, cDescProducto, cDescStatus, cSucursal, cNombreCliente, 
			cRfc, cCalle, cEstado, cDepartamento, cComplemento, cCiudad, cMunicipio, sEdificio, cNumInt, cNumExt,
		...
		RETURN cCodRet, cNumCliente, cNumSolicitud, UPPER(cDescProducto), UPPER(cDescStatus), cSucursal, UPPER(cNombreCliente), 
		UPPER(cRfc), UPPER(cCalle), UPPER(cEstado), UPPER(cDepartamento), UPPER(cComplemento), UPPER(cCiudad), UPPER(cMunicipio), 
		sEdificio, cNumInt, cNumExt, cCodPostal, UPPER(cZonaCol), cTelCasa, cTelCelular, cTelTrabajo, cExtTrabajo;
...
'MODULO: CRÉDITO',
'FUNCIONALIDAD: Monitor de Solicitudes en Supervisión', 
'DESCRIPCION: SPL que obtiene el detalle de la solicitud supervisión consultada.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_eliminasolsupervision(pUsuario CHAR(8), pIdFuncion CHAR(10), pIdOperacion CHAR(1))
		RETURNING CHAR(5) AS codret;		
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_eliminasolsupervision.out';
		--TRACE ON;
		...
		IF pIdOperacion = '1' THEN
			...
			EXECUTE PROCEDURE bdisolic:"informix".sp_depuratabla_sol_supervision(cEmpresa)
			INTO cCodRetSp, cDesCodRetSp;
			
			IF cCodRetSp::INTEGER < 0 THEN 
				RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bdisolic:sp_depuratabla_sol_supervision';
			ELIF cCodRetSp::INTEGER = 1 THEN 
				LET cCodRet = '00003';
				RETURN cCodRet;	
			END IF;
		...
		ELIF pIdOperacion = '2' THEN
			...
			EXECUTE PROCEDURE bdisolic:"informix".sp_elimina_sol_supervision(cEmpresa, pUsuario)
			INTO cCodRetSp, cDesCodRetSp;
			
			IF cCodRetSp::INTEGER < 0 THEN 
				RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bdisolic:sp_elimina_sol_supervision';
			ELIF cCodRetSp::INTEGER = 1 THEN 
				LET cCodRet = '00003';
				RETURN cCodRet;	
			END IF;
...
'MODULO: CRÉDITO',
'FUNCIONALIDAD: Monitor de Solicitudes en Supervisión', 
'DESCRIPCION: SPL que se encarga de hacer la eliminación de la tabla de paso para los analistas de MC.',
'Donde, pIdOperacion = 1 se refiere a la eliminación en general y pIdOperacion = 2 a la eliminación por analista.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_reenviosolsupervision(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumSolicitud CHAR(20))
		RETURNING CHAR(5) AS codret;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/informix/jesus/sp_reenviosolsupervision.out';
		--TRACE ON;
		...
		EXECUTE PROCEDURE bdisolic:"informix".sp_os_solicita('001', pNumSolicitud, pUsuario)
		INTO cCodRetSp;
		
		IF cCodRetSp::INTEGER < 0 THEN 
			RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bdisolic:sp_os_solicita';
		ELIF cCodRetSp::INTEGER = 1 THEN 
			LET cCodRet = '00799';
		ELIF cCodRetSp::INTEGER = 2 THEN 
			LET cCodRet = '00800';
...
'MODULO: CRÉDITO',
'FUNCIONALIDAD: Monitor de Solicitudes en Supervisión', 
'DESCRIPCION: SPL encargado de hacer el reenvío de las solicitudes de cualquiera de los productos de crédito en estatus OA a estatus EE.',
'BD: bdicnweb';
...
'FECHA: 23/05/2017',
'MODULO: OPERACIONES',
'FUNCIONALIDAD: BLOQUEO CUENTA CLABE',
'DESCRIPCION: SP que actualiza el estado de la cuenta a CANCELADA',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_reportectaclave(pUsuario CHAR(8), pIdFuncion CHAR(10),pFechaInicio CHAR(10),pFechaFin CHAR(10),pOperacion CHAR(1),pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,
		CHAR(10) AS fecha,
		CHAR(18) AS cuenta_ord,      
		CHAR(3) AS banco,		
		CHAR(40) AS descripcion_banco,		
		CHAR(18) AS cuenta_benef,
		CHAR(20) AS num_cte,
		CHAR(26) AS nombre1,
		CHAR(26) AS nombre2,
	...
	DEFINE cCuentaOrd CHAR(18);
	DEFINE cBanco CHAR(3);
	DEFINE cDescripcionBanco CHAR(40);
	DEFINE cCuentaBenef CHAR(18);
	DEFINE cNumCte CHAR(20);
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cFecha,cCuentaOrd,cBanco,cDescripcionBanco,cCuentaBenef,cNumCte,cNombre1,cNombre2,cApePaterno,cApeMaterno,cRazonSocial,cCuenta;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_reportectaclave.out';
	    --TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pFechaInicio='' OR pFechaFin=''  OR pOperacion='' OR pRegistros IS NULL OR pRecuperacion IS NULL THEN
			LET cCodRet = '00003';
			RETURN cCodRet,cFecha,cCuentaOrd,cBanco,cDescripcionBanco,cCuentaBenef,cNumCte,cNombre1,cNombre2,cApePaterno,cApeMaterno,cRazonSocial,cCuenta;
		END IF;
		...
		IF pOperacion=="1" THEN
			FOREACH SELECT SKIP pRegistros FIRST pRecuperacion  
					DATE(a.dtfech_hor),a.vchrcuentaord,b.banco,b.descripcion, a.vchrcuentabenef,c.num_cte, d.nombre1,d.nombre2,d.apell_paterno, d.apell_materno,d.razon_social,c.cuenta
					INTO  cFecha,cCuentaOrd,cBanco,cDescripcionBanco,cCuentaBenef,cNumCte,cNombre1,cNombre2,cApePaterno,cApeMaterno,cRazonSocial,cCuenta
					FROM bdispei:tblintfallo a
					INNER JOIN bdinteg:si_bancos  b ON SUBSTR(a.vchrcuentaord,0,3)=b.banco
					INNER JOIN bdicheq:sc_maechq  c ON c.cuenta_clabe=a.vchrcuentabenef
					INNER JOIN bdinteg:si_cliente d ON d.numcte=c.num_cte
					WHERE DATE(a.dtfech_hor) BETWEEN pFechaInicio AND pFechaFin
					
				LET iNoRegistros = iNoRegistros +1;
				RETURN cCodRet,cFecha,cCuentaOrd,cBanco,cDescripcionBanco,cCuentaBenef,cNumCte,cNombre1,cNombre2,cApePaterno,cApeMaterno,cRazonSocial,cCuenta  WITH RESUME;
				
			END FOREACH;
		
		ELSE
	
			FOREACH	SELECT SKIP pRegistros FIRST pRecuperacion dtfecha_ins,vchrcuentaord
					INTO cFecha,cCuentaOrd
					FROM bdispei:tblclabebloqueo
					WHERE chrstatus='A'
					AND fecha_mod BETWEEN pFechaInicio AND pFechaFin
...
'FECHA: 29/05/2017',
'MODULO: OPERACIONES',
'FUNCIONALIDAD: Bloqueo Cuentas Clave',
'DESCRIPCION: SP que consulta los registros por fecha y  estatus para generar los reportes',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_tf_transfermsettlement(pUsuario CHAR(8), pIdFuncion CHAR(10), pTipoEjecucion CHAR(1), pFechaInicio DATE, pFechaFin DATE, 
pBancOrigen CHAR(3), pBancDestino CHAR(3), pRutaDescarga CHAR(150), pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,
	...
	DEFINE iSqlErr INTEGER;
	DEFINE cCodRetSp CHAR(5);
	DEFINE cMensajeCodRetSp CHAR(150);
	DEFINE cEmpresa CHAR(3);	
	DEFINE cNombreArchivo CHAR(50);	
	DEFINE cBancoOrigen CHAR(3); 
	...
	LET cCmd1 = '';	
	LET cArchDescarga = '';
	LET cArchivoTxt = TRIM(pRutaDescarga) || 'INTER_TRANSFER.txt';
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			...
			IF bInTransaction = 't' THEN
				BEGIN WORK;
			END IF;
			RETURN cCodRet, cNombreArchivo, cBancoOrigen, cBancoDestino, mMonto, cArchDescarga;
		END EXCEPTION;
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_tf_transfermsettlement.out';
		--TRACE ON;
		...
		IF pTipoEjecucion = 1 THEN
			...
			FOREACH
				EXECUTE PROCEDURE bditransfer:"informix".sp_transfer_msettlement2(pFechaInicio, pFechaFin, pBancOrigen, pBancDestino, pRegistros, pRecuperacion)
				INTO cCodRetSp,cMensajeCodRetSp,cNombreArchivo,cBancoOrigen,cBancoDestino,mMonto
				
				IF cCodRetSp::INTEGER < 0 THEN 
					RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÃN DEL SP bditransfer:sp_transfer_msettlement2';
				ELIF cCodRetSp::INTEGER = 1 THEN
				...
				LET iRecuperacion = iRecuperacion + 1;
				RETURN cCodRet, UPPER(cNombreArchivo), cBancoOrigen, cBancoDestino, mMonto, cArchDescarga WITH RESUME;
			END FOREACH;
		...
		ELIF pTipoEjecucion = 2 THEN
			...
			DROP TABLE IF EXISTS tmp_settlement;
			
			CREATE TABLE tmp_settlement(
										nombrearchivo CHAR(50), 
										bancoorigen CHAR(3), 
										bancodestino CHAR(3), 
										monto MONEY(16,2)
										);
			...
			FOREACH
				...
				INSERT INTO tmp_settlement VALUES(cNombreArchivo, cBancoOrigen, cBancoDestino, mMonto);
				
			END FOREACH;			
			
			LET cCmd1 = "";
			LET cCmd1 = "SELECT 'NOMBRE DEL ARCHIVO','BANCO ORIGEN','BANCO DESTINO','IMPORTE' FROM systables WHERE tabid = 1 UNION ALL "||" SELECT nombrearchivo, bancoorigen, bancodestino, monto::CHAR(18) FROM tmp_settlement;";
			LET cSql = 'echo "UNLOAD TO '||TRIM(cArchivoTxt)||' '||TRIM(cCmd1)||' " > '||TRIM(pRutaDescarga)||'query07.sql';
			SYSTEM TRIM(cSql);
		
			LET  cDelFile = 'chmod 777 '||TRIM(pRutaDescarga)||'query07.sql';
			SYSTEM TRIM(cDelFile);
			
			LET cSql = '';
			--LET cSql = '/informix/bin/dbaccess bdicnweb '||TRIM(pRutaDescarga)||'query07.sql'; --desarrollo
			LET cSql = '/ifxsif01/bin/dbaccess bdicnweb '||TRIM(pRutaDescarga)||'query07.sql'; --produccion
			SYSTEM TRIM(cSql);  
			
			LET cSql = '';
			LET cSql = 'rm -rf '||TRIM(pRutaDescarga)||'query07.sql';
			SYSTEM TRIM(cSql);
			
			LET cArchDescarga = cArchivoTxt;
			
			IF bInTransaction = 't' THEN
				COMMIT WORK;
			END IF;
			
			RETURN cCodRet, UPPER(cNombreArchivo), cBancoOrigen, cBancoDestino, mMonto, cArchDescarga;
...
'DESCRIPCION: SPL encargado de consultar el detalle de las transacciones Interbancarias Transfer.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_tf_conciliacionadmin(pUsuario CHAR(8), pIdFuncion CHAR(10), pFechaInicio DATE, pFechaFin DATE, 
pTransaccion CHAR(5), pNaturaleza CHAR(1), pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,
			CHAR(5) AS transacc_file,
			CHAR(20) AS fecha_alt_file,
			CHAR(15) AS folio_suc_file,
			MONEY(16,2) AS monto_file, 
			CHAR(1) AS conciliado,
			CHAR(20) AS cuenta_cargo_chq , 
			CHAR(5) AS transacc_cargo_chq ,
			CHAR(15) AS folio_suc_cargo_chq ,
			MONEY(16,2) AS monto_cargo_chq,
	...
	DEFINE cEmpresa CHAR(3);
	DEFINE cTransacc_file CHAR(5); 
	DEFINE cFecha_alt_file CHAR(20); 
	DEFINE cFolio_suc_file CHAR(15); 
	DEFINE mMonto_file MONEY(16,2); 
	DEFINE cConciliado CHAR(1);
	DEFINE cCuenta_cargo_chq CHAR(20); 
	DEFINE cCTransacc_cargo_chq CHAR(5); 
	DEFINE cCFolio_suc_cargo_chq CHAR(15); 
	DEFINE mMonto_cargo_chq	MONEY(16,2); 
	DEFINE dFecha_alt_cargo DATE; 
	DEFINE cReferencia_cargo CHAR(50); 
	DEFINE cRccontable_cargo CHAR(20); 
	DEFINE cRacontable_cargo CHAR(20); 
	DEFINE cCuenta_abono_chq CHAR(20); 
	DEFINE cTransacc_abono_chq CHAR(5); 
	DEFINE cFolio_suc_abono_chq	CHAR(15); 
	DEFINE dFecha_alt_abono DATE; 
	DEFINE mMonto_abono_chq MONEY(16,2); 
	DEFINE cReferencia_abono CHAR(50); 
	DEFINE cRccontable_abono CHAR(20); 
	DEFINE cRacontable_abono CHAR(20);
	DEFINE cReferencia_mps CHAR(20);
	DEFINE iRecuperacion INTEGER;	
	...
	LET cFecha_alt_file = ''; 
	LET cFolio_suc_file = ''; 
	LET mMonto_file = 0.00; 
	LET cConciliado = '';
	LET cCuenta_cargo_chq = '';
	LET cCTransacc_cargo_chq = '';
	LET cCFolio_suc_cargo_chq = '';
	LET mMonto_cargo_chq = 0.00; 
	LET dFecha_alt_cargo = '';
	LET cReferencia_cargo = '';
	LET cRccontable_cargo = '';
	LET cRacontable_cargo = '';
	LET cCuenta_abono_chq = '';
	LET cTransacc_abono_chq = '';
	LET cFolio_suc_abono_chq = '';
	LET dFecha_alt_abono = '';
	LET mMonto_abono_chq = 0.00;
	LET cReferencia_abono = ''; 
	LET cRccontable_abono = ''; 
	LET cRacontable_abono = '';
	LET cReferencia_mps = '';	
	LET iRecuperacion = 0;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cTransacc_file,cFecha_alt_file,cFolio_suc_file,mMonto_file,cConciliado,
			cCuenta_cargo_chq,cCTransacc_cargo_chq,cCFolio_suc_cargo_chq,mMonto_cargo_chq,dFecha_alt_cargo,cReferencia_cargo,cRccontable_cargo,cRacontable_cargo,
			cCuenta_abono_chq,cTransacc_abono_chq,cFolio_suc_abono_chq,dFecha_alt_abono,mMonto_abono_chq,cReferencia_abono,cRccontable_abono,cRacontable_abono,cReferencia_mps;
		END EXCEPTION;
	
		--SET DEBUG FILE TO '/tmp/mfinis/sp_tf_conciliacionadmin.out';
		--TRACE ON;
		...
		FOREACH
			EXECUTE PROCEDURE bditransfer:"informix".sp_transfer_mconadmin_success2(pFechaInicio, pFechaFin, pTransaccion, pNaturaleza, pRegistros, pRecuperacion)
			INTO cCodRetSp,cDescCodRetSp,cTransacc_file,cFecha_alt_file,cFolio_suc_file,mMonto_file,cConciliado,cReferencia_mps,
			cCuenta_cargo_chq,cCTransacc_cargo_chq,cCFolio_suc_cargo_chq,mMonto_cargo_chq,dFecha_alt_cargo,cReferencia_cargo,cRccontable_cargo,cRacontable_cargo,
			cCuenta_abono_chq,cTransacc_abono_chq,cFolio_suc_abono_chq,dFecha_alt_abono,mMonto_abono_chq,cReferencia_abono,cRccontable_abono,cRacontable_abono
			
			IF cCodRetSp::INTEGER < 0 THEN 
				RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bditransfer:sp_transfer_mconadmin_success2';
			ELIF cCodRetSp::INTEGER = 1 THEN
			...
			LET iRecuperacion = iRecuperacion + 1;
			RETURN cCodRet,cTransacc_file,cFecha_alt_file,cFolio_suc_file,mMonto_file,cConciliado,
			cCuenta_cargo_chq,cCTransacc_cargo_chq,cCFolio_suc_cargo_chq,mMonto_cargo_chq,dFecha_alt_cargo,UPPER(cReferencia_cargo),cRccontable_cargo,cRacontable_cargo,
			cCuenta_abono_chq,cTransacc_abono_chq,cFolio_suc_abono_chq,dFecha_alt_abono,mMonto_abono_chq,UPPER(cReferencia_abono),cRccontable_abono,cRacontable_abono,cReferencia_mps WITH RESUME;
		END FOREACH;
...
'DESCRIPCION: SPL encargado de consultar el detalle de las conciliaciones administrativas transfer.',
'AUTOR: L. Montserrat León Amador',
'FECHA: 22/06/2017',
'DESCRIPCION: Se modifica spl para recuperar nuevo campo referencia_mps.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consultadetallesaldosctascap(pUsuario CHAR(8), pIdFuncion CHAR(10), pCuenta CHAR(20))
	RETURNING CHAR(5) AS codret,
		MONEY(14,2) AS imp_chq_sbc,
		MONEY(14,2) AS imp_chq_sbg, 
		MONEY(14,2) AS sdo_retenido,
		MONEY(14,2) AS sdo_cong,
		MONEY(14,2) AS com_pendiente,
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, mImp_chq_sbc, mImp_chq_sbg, mSdo_retenido, mSdo_cong, mCom_pendiente, dFecha_proceso;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_consultadetallesaldosctascap.out';
		--TRACE ON;
		...
		SELECT imp_chq_sbc, imp_chq_sbg, sdo_retenido, sdo_cong, com_pendiente, fecha_proceso
		INTO mImp_chq_sbc, mImp_chq_sbg, mSdo_retenido, mSdo_cong, mCom_pendiente, dFecha_proceso
...
'DESCRIPCION: SPL encargado de consultar el detalle de las cuentas a las cuales se les va a aplicar el mantenimiento de los saldos.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_validamodificacionsaldosctascap(pUsuario CHAR(8), pIdFuncion CHAR(10), pIdConsulta CHAR(1), pCuenta CHAR(20))
	RETURNING CHAR(5) AS codret,
		CHAR(1) AS muestra_msj;		
		
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;
	DEFINE cEmpresa CHAR(3);
	DEFINE cMuestraMsj CHAR(1);
	DEFINE iRecuperacion INTEGER;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cMuestraMsj;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_validamodificacionsaldosctascap.out';
		--TRACE ON;

		IF pUsuario = '' OR pIdFuncion = '' OR pIdConsulta = '' OR pCuenta = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet, cMuestraMsj;
		END IF;
		...
		--Valida Salvo Buen Cobro(SBC)
		IF pIdConsulta = '1' THEN
		
			IF (SELECT COUNT(cuenta) FROM bdicheq:"informix".sc_docret_sbc WHERE cuenta = pCuenta AND cancelado = 'T') > 0 THEN
				LET cMuestraMsj = 't'; --La cuenta tiene cheques pendientes de cobrar, ¿desea continuar con la edición?
			ELSE
				LET cMuestraMsj = 'f';
			END IF;
		
		--Valida Saldo Retenido
		ELIF pIdConsulta = '2' THEN
		
			IF (SELECT COUNT(cuenta) FROM bdicheq:"informix".sc_docret WHERE cuenta = pCuenta) > 0 THEN
				LET cMuestraMsj = 't'; --La cuenta tiene saldos retenidos pendientes, ¿desea continuar con la edición?
			ELSE
				LET cMuestraMsj = 'f';
			END IF;
...
'MODULO: DEBITO',
'FUNCIONALIDAD: MANTENIMIENTO SALDOS CUENTAS CAPTACIÓN', 
'DESCRIPCION: SPL encargado de validar los datos para la modificación de los saldos.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_catalogosucursalcaja(pUsuario CHAR(8), pIdFuncion CHAR(10), pTipoSucursal CHAR(2), pCodProvCaja CHAR(4), pIdPlaza CHAR(3), pIndicador CHAR(1), pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,
			CHAR(4) AS cIdSucursal,
			CHAR(40) AS cDescSucursal;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_catalogosucursalcaja.out';
		--TRACE ON;
				
		IF pUsuario = '' OR pIdFuncion = '' OR pIndicador = '' OR pRegistros IS NULL OR pRecuperacion IS NULL THEN
			LET cCodRet = '00003';
			RETURN cCodRet, cIdSucursal, cDescSucursal;
		END IF;
		...
		IF pIndicador = '1' THEN
			...
			IF pTipoSucursal = '' OR pCodProvCaja = '' THEN
				LET cCodRet = '00003';
				RETURN cCodRet, cIdSucursal, cDescSucursal;
			END IF;
			...
			FOREACH
				...
				INTO cIdSucursal, cDescSucursal FROM bdinteg:"informix".si_sucursales AS s, bdisuc:"informix".ss_proveedores AS p 
				WHERE s.plaza_cajagen = p.plaza AND p.cod_proveedor = pCodProvCaja AND s.tpo_sucursal = pTipoSucursal ORDER BY s.sucursal ASC
				RETURN cCodret, cIdSucursal, UPPER(cDescSucursal) WITH RESUME;
				LET iNoRegistros = iNoRegistros + 1;
			END FOREACH;
		
		ELIF pIndicador = '2' THEN
		
			IF pTipoSucursal = '' OR pIdPlaza = '' THEN
				LET cCodRet = '00003';
				RETURN cCodRet, cIdSucursal, cDescSucursal;
			END IF;
			...
			IF pIdPlaza = '000' THEN
				...
				IF pTipoSucursal = 'S' OR pTipoSucursal = 'C' THEN  
					...
					FOREACH
						SELECT  SKIP pRegistros FIRST pRecuperacion DISTINCT suc.sucursal, suc.nombre  
						INTO cIdSucursal, cDescSucursal
						FROM bdinteg:"informix".si_sucursales suc LEFT JOIN bdinteg:"informix".si_plazas_cajagen pla ON (suc.plaza_cajagen = pla.codigo_plaza)
						WHERE tpo_sucursal = pTipoSucursal
				...
				ELIF pTipoSucursal = 'A' THEN 
					FOREACH
						...
						INTO cIdSucursal, cDescSucursal
						FROM bdinteg:"informix".si_sucursales suc LEFT JOIN bdinteg:"informix".si_plazas_cajagen pla ON (suc.plaza_cajagen = pla.codigo_plaza)
						WHERE tpo_sucursal = 'S' OR tpo_sucursal = 'C'
						RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal) WITH RESUME;
						LET iNoRegistros = iNoRegistros + 1;
					END FOREACH;
			...
			ELSE
				...
				IF pTipoSucursal = 'S' OR pTipoSucursal = 'C' THEN 
					FOREACH
						SELECT SKIP pRegistros FIRST pRecuperacion DISTINCT sucursal, nombre  
						INTO cIdSucursal, cDescSucursal 
						FROM bdinteg:"informix".si_sucursales 
						WHERE plaza_cajagen = pIdPlaza AND tpo_sucursal = pTipoSucursal
						RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal) WITH RESUME;
						LET iNoRegistros = iNoRegistros + 1;
					END FOREACH;
					
					IF iNoRegistros = 0 THEN
						LET cCodRet = '00424'; -- Esta plaza no tiene sucursales asignadas
						RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal);
					END IF;
				...
				ELIF pTipoSucursal = 'A' THEN 
					FOREACH
						...
						INTO cIdSucursal, cDescSucursal 
						FROM bdinteg:"informix".si_sucursales 
						WHERE plaza_cajagen = pIdPlaza AND (tpo_sucursal = 'S' OR tpo_sucursal = 'C')
						RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal) WITH RESUME;
						LET iNoRegistros = iNoRegistros + 1;
					END FOREACH;
		...
		ELIF pIndicador = '4' THEN 

			IF pCodProvCaja = '' THEN
				LET cCodRet = '00003';
				RETURN cCodRet, cIdSucursal, cDescSucursal;
			END IF;

			IF pCodProvCaja = '0000' THEN
				FOREACH
					SELECT SKIP pRegistros FIRST pRecuperacion DISTINCT suc.sucursal, suc.nombre
					INTO cIdSucursal, cDescSucursal
					FROM bdinteg:"informix".si_sucursales suc LEFT JOIN bdinteg:"informix".si_plazas_cajagen pla ON (suc.plaza_cajagen = pla.codigo_plaza)
			...
			ELSE
				...
				SELECT plaza INTO cIdPlaza
				FROM bdisuc:"informix".ss_proveedores WHERE cod_proveedor = pCodProvCaja;

				FOREACH
					SELECT SKIP pRegistros FIRST pRecuperacion DISTINCT sucursal, nombre  
					INTO cIdSucursal, cDescSucursal 
					FROM bdinteg:"informix".si_sucursales 
					WHERE plaza_cajagen = cIdPlaza
					RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal) WITH RESUME;
					LET iNoRegistros = iNoRegistros + 1;
				END FOREACH;
			END IF;		
...
DOCUMENT 'AUTOR: L. Montserrat León Amador',
'FECHA: 07/01/2015',
'DESCRIPCION: SPL, que hace la consulta para el llenado del combobox sucursal, Monitor de Operaciones Caja General',
'con pIndicador = 1 nos referimos a Monitor Operaciones, con pIndicador = 2 Consultas Entrada Salida', 
'referente a esto se hacen las validaciones correspondientes',
'FECHA: 23/02/2015',
'DESCRIPCION: Se agregó una consulta más correspondiente a la Funcionalidad Arqueo de sucursales Caja General', 
'la cual se identifica con pIndicador = 3',
'FECHA: 27/03/2015',
'DESCRIPCION: Se agregó una consulta más correspondiente a la Funcionalidad Monitor de Efectivo Caja General', 
'la cual se identifica con pIndicador = 4',
'AUTOR:Martha Salgado Mendoza',
'FECHA:31/07/2017',
'DESCRIPCION: Se agregan parametros de paginacion',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sw_catcoordinador(pUsuario CHAR(8), pIdFuncion CHAR(10))
    RETURNING CHAR(5) AS codRet,
		CHAR(10) AS id_coordinador,
		CHAR(45) AS nombre_coordinador;
	...
	DEFINE cEmpresa CHAR(3);
	DEFINE cIdCoordinador CHAR(10);
	DEFINE cNombreCoordinador CHAR(45);
	DEFINE iRecuperacion INTEGER;
	...
	BEGIN
		ON EXCEPTION SET iSqlErr
			IF iSqlErr <> 0 THEN
				LET cCodRet = iSqlErr;
				RETURN cCodRet, cIdCoordinador, cNombreCoordinador;
			END IF;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sw_catcoordinador.out';
		--TRACE ON;
		...
		FOREACH
			...
			INTO cIdCoordinador,cNombreCoordinador
			FROM bdicnweb:"informix".sw_seg_valida_usuarios
			
			RETURN cCodRet, TRIM(cIdCoordinador), TRIM(UPPER(cNombreCoordinador)) WITH RESUME;	
		END FOREACH;
	
		IF NVL(cIdCoordinador,'') = '' THEN
			LET cCodRet = '00017';
			RETURN cCodRet, cIdCoordinador, cNombreCoordinador;
		END IF;
...
'MODULO: ',
'FUNCIONALIDAD: ',
'DESCRIPCION: Spl encargado de consultar el catalogo de Coordinadores de CC.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sw_validacoordinador(pUsuario CHAR(8), pIdFuncion CHAR(10), pIdEjecucion CHAR(1), pIdCoordinador CHAR(10), pPassword CHAR(20))
    RETURNING CHAR(5) AS codRet;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sw_validacoordinador.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pIdEjecucion = '' OR pIdCoordinador = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		IF pIdEjecucion = '1' THEN
			...
			IF (SELECT COUNT(id_usuario) FROM bdicnweb:"informix".sw_seg_valida_usuarios WHERE id_usuario = pIdCoordinador) = 0 THEN 
		...
		ELIF pIdEjecucion = '2' THEN
			...
			IF (SELECT COUNT(id_usuario) FROM bdicnweb:"informix".sw_seg_valida_usuarios WHERE id_usuario = pIdCoordinador) = 1 THEN 	
				SELECT NVL(COUNT(id_usuario),0) INTO iExiste 
				FROM bdinteg:"informix".si_seg_usuarios WHERE id_usuario = pIdCoordinador AND password = pPassword;
				IF iExiste = 0 OR iExiste IS NULL THEN
					LET cCodRet = '00920'; --EL PASSWORD INGRESADO ES INCORRECTO. VERIFIQUE.
				END IF;	
			END IF;
...
'MODULO: ',
'FUNCIONALIDAD: ',
'DESCRIPCION: Spl encargado de hacer la validación para consultar que el coordinador esté dado de alta y que el password corresponda al Coordinador de CC consultado.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_grabarpagosmanualescre(pIdUsuario CHAR(8), pIdFuncion CHAR(10), 
                pFolioSuc CHAR(16), pNumCte CHAR(20), pNumCredito CHAR(20), pImportePago MONEY(18,2), pTransaccion CHAR(4), pConcepto CHAR(20), 
                pObservaciones CHAR(50), pCapitalVigente MONEY(18,2), pCapitalTransitorio MONEY(18,2), pCapitalVencido MONEY(18,2),
                pCapitalVencidoNoExigible MONEY(18,2), pCapitalTotal MONEY(18,2), pInteresVigente MONEY(18,2), pIvaInteresVigente MONEY(18,2),
                pInteresVencido MONEY(18,2), pIvaInteresVencido MONEY(18,2), pInteresMoratorio MONEY(18,2), pIvaInteresMoratorio MONEY(18,2))
    RETURNING
        CHAR(5) AS CODRET,
	...
	DEFINE mCapitalTransitorio MONEY(18,2);
	DEFINE mCapitalVencido MONEY(18,2);
	DEFINE mCapitalVdoNoExigible MONEY(18,2);
	DEFINE mCapitalTotal MONEY(18,2);
	DEFINE mInteresVigente MONEY(18,2);
	DEFINE mIvaInteresVigente MONEY(18,2);
	...
	LET mCapitalTransitorio = 0.0;
	LET mCapitalVencido = 0.0;
	LET mCapitalVdoNoExigible = 0.0;
	LET mCapitalTotal = 0.0;
	LET mInteresVigente = 0.0;
	LET mIvaInteresVigente = 0.0;
	LET mInteresVencido = 0.0;
	LET mIvaInteresVencido = 0.0;
	LET mInteresMoratorio = 0.0;
	LET mIvaInteresMoratorio = 0.0;
	LET cEmpresa = '001';
	LET mInteresMoratorioBase = 0.0;
	LET mInteresMoratorioCopete = 0.0;
	LET mIvaInteresMoratorioBase = 0.0;
	LET mIvaInteresMoratorioCopete = 0.0;
	
	BEGIN
	
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, mCapitalVigente, mCapitalTransitorio, mCapitalVencido, mCapitalVdoNoExigible, mCapitalTotal, mInteresVigente,
			mIvaInteresVigente, mInteresVencido, mIvaInteresVencido, mInteresMoratorioBase, mInteresMoratorioCopete, mIvaInteresMoratorioBase, mIvaInteresMoratorioCopete;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_grabarpagosmanualescre.out';
		--TRACE ON;
		
		IF pIdUsuario = '' OR pIdFuncion = '' OR 
			pFolioSuc = '' OR pNumCte = '' OR pNumCredito = '' OR pImportePago = '' OR pTransaccion = '' OR pConcepto = '' OR 
			pObservaciones = '' OR pCapitalVigente = '' OR pCapitalTransitorio = '' OR pCapitalVencido = '' OR
			pCapitalVencidoNoExigible = '' OR pCapitalTotal = '' OR pInteresVigente = '' OR pIvaInteresVigente = '' OR
			pInteresVencido = '' OR pIvaInteresVencido = '' OR pInteresMoratorio = '' OR pIvaInteresMoratorio = '' THEN
		...
		EXECUTE PROCEDURE bdinteg:"informix".sp_cnsif_permisosejecutivo(pIdUsuario, pIdFuncion, pNumCte, '06', '2') into cCodRet;
		IF cCodRet <> '00000' THEN
			RETURN cCodRet, mCapitalVigente, mCapitalTransitorio, mCapitalVencido, mCapitalVdoNoExigible, mCapitalTotal, mInteresVigente,
			mIvaInteresVigente, mInteresVencido, mIvaInteresVencido, mInteresMoratorioBase, mInteresMoratorioCopete, mIvaInteresMoratorioBase, mIvaInteresMoratorioCopete;
		END IF;
		
		EXECUTE PROCEDURE bdicred:"informix".sp_grabarpagosmanuales(cEmpresa, pIdUsuario, pFolioSuc, pNumCte, pNumCredito, pImportePago, pTransaccion, pConcepto,
			pObservaciones, pCapitalVigente, pCapitalTransitorio, pCapitalVencido, pCapitalVencidoNoExigible, pCapitalTotal,
			pInteresVigente, pIvaInteresVigente, pInteresVencido, pIvaInteresVencido, pInteresMoratorio, pIvaInteresMoratorio)
		INTO cCodRet, mCapitalVigente, mCapitalTransitorio, mCapitalVencido, mCapitalVdoNoExigible, mCapitalTotal, mInteresVigente, mIvaInteresVigente, mInteresVencido, mIvaInteresVencido, 
		...
		ELIF cCodRet = '00006' THEN
			LET cCodRet = '00921';
		ELIF cCodRet = '00014' THEN
			LET cCodRet = '00364';		
		ELIF cCodRet = '00007' THEN 
			LET cCodRet = '00033';
		ELIF cCodRet = '00008' THEN
			LET cCodRet = '00374'; 
		ELIF cCodRet = '00009' THEN
			LET cCodRet = '00375';
		ELIF cCodRet = '00010' THEN
			LET cCodRet = '00376';
		ELIF cCodRet = '00012' THEN
			LET cCodRet = '00377';
		ELIF cCodRet = '00013' THEN
			LET cCodRet = '00378';
		END IF;
...
"FECHA: 09/07/2013",
"DESCRIPCION: Procedimiento que realiza el pago a una cuenta de credito",
"FECHA: 30/07/2014",
"DESCRIPCION: Se agregan los campos de interes moratorio base y copete asÃ­ como sus correspondientes ivas",
"AUTOR: L. Montserrat León Amador",
"FECHA: 10/01/2017",
"DESCRIPCION: Se cambia mapeo de errores para el codigo 00006.",
"BD: bdicnweb";

CREATE PROCEDURE "informix".sp_ope_obtieneparam(pUsuario CHAR(8), pIdFuncion CHAR(10))
		RETURNING CHAR(5) AS codret, 
		CHAR(2) AS longitud_cliente,
		CHAR(2) AS codMonNac,
		CHAR(100) AS pathReporte,
		CHAR(45) AS nombreUsuario,
		CHAR(30) AS nombreEmpresa,
		DATE AS fechaHoy,
		CHAR(2) AS sistema,
		CHAR(5) AS longitudNoControl,
		CHAR(5) AS longitudCuenta;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_obtieneparam.out';
		--TRACE ON;
		...
		EXECUTE PROCEDURE bdisac:"informix".sp_dinya_obtieneparam(cEmpresa, pUsuario)
		INTO cCodRetSp, cLongitudCliente,cCodMonNac,cPathRep,cNombreUsuario,cNombreEmpresa,dFecha_Hoy,cSistema,cLongitudNoControl,cLongitudCuenta;
		
		LET iCodRetSp = cCodRetSp::INTEGER;
		IF iCodRetSp < 0 THEN
			RAISE EXCEPTION iCodRetSp, 0, "ERROR EN LA EJECUCION DEL SP: bdisac:sp_dinya_obtieneparam";
		END IF;
	...
	END;
END PROCEDURE
DOCUMENT 'AUTOR: José Manuel Zúñiga Flores',
'FECHA: 28/03/2017',
'MODULO: Operaciones',
'FUNCIONALIDAD: Reactivación de Envíos de Órdenes de Pago',
'DESCRIPCION: Este proceso consume el sp_dinya_obtieneparam que obtiene los parametros para el tamaño del campo No. Control',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_ope_consultaenviosbloqueados(pUsuario CHAR(8), pIdFuncion CHAR(10), pNoControl CHAR(12))
		...
		CHAR(2) AS statusCobro,
		CHAR(4) AS codSucursalOrigen,
		CHAR(40) AS sucursalOrigen;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, dFechaEnvio, cNombre1Rem, cNombre2Rem, cApellido1Rem, cApellido2Rem, mImporteEnviado, cStatus, cSuc_origen, cDes_SucOrigen;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultaenviosbloqueados.out';
		--TRACE ON;
		...
		EXECUTE PROCEDURE bdisac:"informix".sp_dinya_consultaenviosbloqueados(pNoControl)
		INTO cCodRetSp, dFechaEnvio, cNombre1Rem, cNombre2Rem, cApellido1Rem, cApellido2Rem, mImporteEnviado, cStatus, cSuc_origen;
		
		LET iCodRetSp = cCodRetSp::INTEGER;
		IF iCodRetSp < 0 THEN
			RAISE EXCEPTION iCodRetSp, 0, "ERROR EN LA EJECUCION DEL SP: bdisac:sp_dinya_consultaenviosbloqueados";
		...
		INTO cDes_SucOrigen
		FROM bdinteg:"informix".si_sucursales 
		WHERE sucursal = cSuc_origen 
		AND empresa = cEmpresa;
	
		RETURN cCodRet, dFechaEnvio, UPPER(cNombre1Rem), UPPER(cNombre2Rem), UPPER(cApellido1Rem), UPPER(cApellido2Rem), NVL(mImporteEnviado, 0), cStatus, NVL(cSuc_origen, ''), UPPER(NVL(cDes_SucOrigen, ''));
...
'DESCRIPCION: Este procedimiento consume el sp_dinya_consultaenviosbloqueados que obtiene los datos de las ordenes de pago',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_catalogosuctrancaja(pUsuario CHAR(8), pIdFuncion CHAR(10), pTipoConsulta CHAR(1), pTipoSucursal CHAR(1), pIdProveedor CHAR(4), pRegistros INTEGER, pRecuperacion INTEGER)
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal), cIdTransaccion, UPPER(cDescTransaccion), cCodTransaccion;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_catalogosuctrancaja.out';
		--TRACE ON;
		...
		IF pTipoConsulta = '1' THEN
			...
			IF pTipoSucursal = '' OR pIdProveedor = '' THEN
				LET cCodRet = '00003';
				RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal), cIdTransaccion, UPPER(cDescTransaccion), cCodTransaccion;
			END IF;
	
			-- OBTIENE PLAZA
			SELECT plaza INTO cPlaza 
			FROM bdisuc:"informix".ss_proveedores WHERE cod_proveedor = pIdProveedor;
		
			FOREACH
				SELECT SKIP pRegistros FIRST pRecuperacion sucursal, nombre INTO cIdSucursal, cDescSucursal
				FROM bdinteg:"informix".si_sucursales WHERE plaza_cajagen = cPlaza AND tpo_sucursal = pTipoSucursal ORDER BY sucursal
				RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal), cIdTransaccion, UPPER(cDescTransaccion), cCodTransaccion WITH RESUME;
				LET iNoRegistros = iNoRegistros + 1;
			END FOREACH;
			
		ELIF pTipoConsulta = '2' THEN
		
			IF pTipoSucursal = '' THEN
				LET cCodRet = '00003';
				RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal), cIdTransaccion, UPPER(cDescTransaccion), cCodTransaccion;
			END IF;
			...
			IF  pTipoSucursal = 'S' THEN
				...
				FOREACH
					SELECT SKIP pRegistros FIRST pRecuperacion DISTINCT valor, descripcion, codigo INTO cIdTransaccion, cDescTransaccion, cCodTransaccion
					FROM bdisuc:"informix".ss_param_cajagen WHERE codigo IN ('0001','0002','0003','0004','0005','0006','0007','0008','0009','0010','0011','0012','0013','0014') ORDER BY valor
					
					IF SUBSTRING(cIdTransaccion FROM 1 FOR 2) = '00' THEN 
						RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal), cIdTransaccion, UPPER(cDescTransaccion), cCodTransaccion WITH RESUME;
						LET iNoRegistros = iNoRegistros + 1;
					END IF;
				END FOREACH;	
			...
			ELIF  pTipoSucursal = 'C' THEN
				...
				FOREACH
					SELECT SKIP pRegistros FIRST pRecuperacion DISTINCT valor, descripcion, codigo INTO cIdTransaccion, cDescTransaccion, cCodTransaccion
					FROM bdisuc:"informix".ss_param_cajagen WHERE codigo IN ('0036','0041') ORDER BY valor
		...
		ELIF pTipoConsulta = '3' THEN
			...
			IF NOT EXISTS(SELECT * FROM bdisuc:"informix".ss_cajageneral WHERE cod_proveedor = pIdProveedor) THEN
				LET cCodRet = '90000'; -- La caja general número ' ' no existe. Por favor verifique 
				RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal), cIdTransaccion, UPPER(cDescTransaccion), cCodTransaccion;
			END IF;
				
			FOREACH
				SELECT SKIP pRegistros FIRST pRecuperacion valor, descripcion, codigo INTO cIdTransaccion, cDescTransaccion, cCodTransaccion
				FROM bdisuc:"informix".ss_param_cajagen WHERE codigo = '0003' OR codigo ='0004' ORDER BY valor
				RETURN cCodRet, cIdSucursal, UPPER(cDescSucursal), cIdTransaccion, UPPER(cDescTransaccion), cCodTransaccion WITH RESUME;
				LET iNoRegistros = iNoRegistros + 1;
			END FOREACH;	
...
DOCUMENT 'AUTOR: L. Montserrat León Amador',
'FECHA: 10/02/2015',
'DESCRIPCION: SPL, que hace la consulta para obtener el id y la descripción de tres catálogos, dependiendo del tipo de consulta que desea ejecutar', 
'con indicador pTipoConsulta = 1 nos referimos al catálogo Sucursal/Atm, con pTipoConsulta = 2 a Transacción, Consulta Operaciones Caja General',
'con pTipoConsulta = 3 la consulta se refiere al catálogo Operacion de la funcionalidad Compras y DeÃ³sitos Caja General',
'AUTOR: Martha Salgado Mendoza',
'FECHA: 02/08/2017',
'DESCRIPCION: Se agregan parametros de paginación', 
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_consultasaldoscredito(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumCuenta CHAR(20))
	...
	LET dSusComisiones = 0.0;
	LET dIva = 0.0;
	LET dSusPagos = 0.0;
	LET dIntMoratorio1 = 0.0;
	LET dIvaIntMoratorio1 = 0.0;
	
	-- VARIABLES DEL SPL sp_conssdogen
	LET dSaldoRetenido1 = 0.0;
	LET dIntMoratorio2 = 0.0;
	LET dIvaIntMoratorio2 = 0.0;
	LET dPagoMinimoHoy = 0.0;
	LET dSaldoDisponible = 0.0;
	...
	LET dSdoActCap = 0.0;
	LET dFechaLimitePago = NULL;
	LET dPagoNoIntereses = 0.0;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, dSaldoUltimoCorte, dSusCompras, dSdoRetenido, dDisposiciones, dSusComisiones, dIva, dIntMoratorio, dIvaIntMoratorio, 
                        dSusPagos,  dSdoActCap, dPagoMinimoHoy, dSaldoDisponible, dFechaLimitePago, dPagoNoIntereses, dSaldoDiferido, dSaldoVencido;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_consultasaldoscredito2.out';
		--TRACE ON;
		...
		SET ISOLATION TO DIRTY READ;
    SET LOCK MODE TO WAIT 3;
		SELECT codret::INTEGER, saldo_ultimo_corte, sus_compras, sus_disposiciones, sus_comisiones, iva, sus_pagos, int_moratorios1, iva_int_moratorios1
		INTO iCodRetSp, dSaldoUltimoCorte, dSusCompras, dDisposiciones, dSusComisiones, dIva, dSusPagos, dIntMoratorio1, dIvaIntMoratorio1		
		FROM TABLE (PROCEDURE bdicred:"informix".sp_conssdoticket(cEmpresa, pNumCuenta, DATE(CURRENT)))
		AS conssdoticket(codret, sus_compras, sus_disposiciones, sus_comisiones, iva, sus_pagos, int_moratorios1, iva_int_moratorios1, saldo_ultimo_corte);
		
		IF iCodRetSp < 0 THEN
			RAISE EXCEPTION iCodRetSp, 0, "ERROR EN LA EJECUCION DEL SP bdicred:sp_conssdoticket";
		END IF;
		
		SELECT codigo_retorno::INTEGER AS codret, sdo_retenido, int_moratorios, iva_int_moratorios, pago_minimo, linea_disponible AS saldo_disponible, 
					(cap_vdo_exig + int_vdo + int_moratorios + iva_int_vdo + iva_int_moratorios) AS saldo_vencido, fecha_prox_pago as fecha_limite_pago, sdo_act_total_cap
		INTO iCodRetSp, dSaldoRetenido1, dIntMoratorio2, dIvaIntMoratorio2, dPagoMinimoHoy, dSaldoDisponible, 
			dSaldoVencido, dFechaLimitePago, dSdoActCap
		--FROM TABLE (PROCEDURE bdicred:"informix".sp_conssdogen(cEmpresa, pNumCuenta))
			FROM TABLE (PROCEDURE bdicred:"informix".sp_consulta_saldos_general(cEmpresa, pNumCuenta))
			AS sp_consulta_saldos_general(codigo_retorno, mensaje_retorno, numero_credito, codigo_tipcred, fecha_origen, 
					fecha_prox_pago, pago_minimo, fecha_ult_pago, plazo, pagos_realizados, linea_otorgada, 
					tasa_interes, tasa_moratorios, monto_sbc, cap_vig, cap_trans, cap_vdo_exig, 
					cap_vdo_no_exig, sdo_act_total_cap, int_vig, int_vdo, int_moratorios, 
					int_mes, sdo_act_total_int, iva_int_vig, iva_int_vdo, iva_int_moratorios, 
					iva_int_mes, sdo_act_total_iva, com_pend, iva_com, sdo_retenido, total_liquidacion, 
					int_devengado, iva_int_devengado, linea_disponible, pagos_vdos, desc_status_cred, id_bloqueo_cred, 
					bloqueo_cta, id_causa_bloqueo_cred, causa_bloqueo_cta, id_sit_esp_cte, 
		...
		-- CONSULTA DEL SALDO DIFERIDO
		SELECT cod_ret::INTEGER AS codret, saldo_diferido
		INTO iCodRetSp, dSaldoDiferido
		FROM TABLE (PROCEDURE bdicred:"informix".sp_consdos_dif_promo(2, '', '', pNumCuenta, '', '', '', '', ''))
		AS consdos_dif_promo(cod_ret, descripcion, num_plaz, interes_iva, saldo_diferido, fecha, desc_mov, monto, conceptos, folio_promo);
		IF iCodRetSp < 0 THEN
			RAISE EXCEPTION iCodRetSp, 0, "bdicred:sp_consdos_dif_promo";
		END IF;
		
		-- ASIGNACIÃN DE VARIABLES
		LET dSdoRetenido = dSaldoRetenido1 - dSaldoDiferido;
		LET dIntMoratorio = dIntMoratorio1 + dIntMoratorio2;
		LET dIvaIntMoratorio = dIvaIntMoratorio1 + dIvaIntMoratorio2;
		
		-- CONSULTA DEL PAGO PARA NO GENERAR INTERESES
		SELECT codret::integer, pago_no_generar_intereses
		INTO iCodRetSp, dPagoNoIntereses
		FROM TABLE (PROCEDURE bdicred:"informix".sp_consultasaldocortemin(cEmpresa, pNumCuenta, 0))
		AS consltasaldocortemin(codret, pago_no_generar_intereses);
		
		IF iCodRetSp < 0 THEN
			RAISE EXCEPTION iCodRetSp, 0, "ERROR EN LA EJECUCION DEL SP bdicred:sp_consultasaldocortemin";
		ELIF iCodRetSp = 1 THEN
			LET cCodRet = '00009';
			RETURN cCodRet, dSaldoUltimoCorte, dSusCompras, dSdoRetenido, dDisposiciones, dSusComisiones, dIva, dIntMoratorio, dIvaIntMoratorio, 
					dSusPagos,  dSdoActCap, dPagoMinimoHoy, dSaldoDisponible, dFechaLimitePago, dPagoNoIntereses, dSaldoDiferido, dSaldoVencido;
...
DOCUMENT 'AUTOR: Oscar Flores Conde',
'FECHA: 18/07/2014',
'DESCRIPCION: Consulta los saldos de una cuenta de credito',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_catcolonia(pUsuario CHAR(8), pIdFuncion CHAR(10), pCp CHAR(5), 
pRegistros INTEGER, pRecuperacion INTEGER)
	RETURNING CHAR(5) AS codret,
		CHAR(8) AS cve_col,
		CHAR(100) AS desc_colonia;	
		
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;
	DEFINE cEmpresa CHAR(3);
	DEFINE cCve_col CHAR(8);
	DEFINE cDesc_colonia CHAR(100);
	DEFINE iRecuperacion INTEGER;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cCve_col, cDesc_colonia;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_catcolonia.out';
		--TRACE ON;

		IF pUsuario = '' OR pIdFuncion = '' OR pCp = '' OR pRegistros IS NULL OR pRecuperacion IS NULL THEN
			LET cCodRet = '00003';
			RETURN cCodRet, cCve_col, cDesc_colonia;
		END IF;
		...
		IF (SELECT COUNT(d_codigo) FROM bdinteg:"informix".si_catsepomex WHERE d_codigo = pCp) > 0 THEN
		
			FOREACH
			
				SELECT SKIP pRegistros FIRST pRecuperacion DISTINCT a.cve_col, a.desc_colonia
				INTO cCve_col, cDesc_colonia
				FROM bdinteg:"informix".si_localidades AS a
				INNER JOIN bdinteg:"informix".si_catsepomex AS b ON a.cp = b.d_codigo
				INNER JOIN bdinteg:"informix".si_estados AS c ON b.c_estado = c.estado
				WHERE a.cp = pCp
				
				LET iRecuperacion = iRecuperacion + 1;
				RETURN cCodRet, cCve_col, UPPER(TRIM(cDesc_colonia)) WITH RESUME;
			END FOREACH;
		...
		ELSE
			...
			LET cCodRet = '00982'; --EL CÓDIGO POSTAL CAPTURADO NO EXISTE, VERIFIQUE
			RETURN cCodRet, cCve_col, cDesc_colonia;
...
'FECHA: 19/05/2017',
'MODULO: OPERACIONES',
'FUNCIONALIDAD: CATÁLOGO DE ESTABLECIMIENTOS', 
'DESCRIPCION: SPL encargado de consultar el detalle del catálogo colonia.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_catestmunicipio(pUsuario CHAR(8), pIdFuncion CHAR(10), pCp CHAR(5),
pRegistros INTEGER, pRecuperacion INTEGER)
	RETURNING CHAR(5) AS codret,
		CHAR(2) AS cCve_estado,
		CHAR(30) AS cNombre_estado,
		CHAR(3) AS cCve_mun,
		CHAR(60) AS cDesc_mun;	
	...
	DEFINE cNombre_estado CHAR(30);
	DEFINE cDesc_mun CHAR(60);
	DEFINE iRecuperacion INTEGER;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cCve_estado, cNombre_estado, cCve_mun, cDesc_mun;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_catestmunicipio.out';
		--TRACE ON;
		...
		IF (SELECT COUNT(d_codigo) FROM bdinteg:"informix".si_catsepomex WHERE d_codigo = pCp) > 0 THEN
			...
			SELECT DISTINCT a.c_estado, b.nombre 
			INTO cCve_estado, cNombre_estado
			FROM bdinteg:"informix".si_catsepomex AS a,	bdinteg:"informix".si_estados AS b
			WHERE a.c_estado = b.estado	AND a.d_codigo = pCp;
			
			FOREACH 
				SELECT SKIP pRegistros FIRST pRecuperacion municipio, nombre 
				INTO cCve_mun, cDesc_mun
				FROM bdinteg:"informix".si_municipios WHERE estado = cCve_estado
				
				LET iRecuperacion = iRecuperacion + 1;
				RETURN cCodRet, cCve_estado, UPPER(TRIM(cNombre_estado)), cCve_mun, UPPER(TRIM(cDesc_mun)) WITH RESUME;
			END FOREACH;
...
'FECHA: 22/05/2017',
'MODULO: OPERACIONES',
'FUNCIONALIDAD: CATÁLOGO DE LOCALIDADES', 
'DESCRIPCION: SPL encargado de consultar el nombre del estado, y cargar el catálogo municipio correspondiente al cp consultado.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_detallecolonias(pUsuario CHAR(8), pIdFuncion CHAR(10), pCp CHAR(5),
pRegistros INTEGER, pRecuperacion INTEGER)
	RETURNING CHAR(5) AS codret,
		CHAR(5) AS cCp,
		CHAR(2) AS cCve_estado,
		...
		CHAR(3) AS cCve_mun,
		CHAR(60) AS cDesc_mun,
		CHAR(14) AS cCve_localidad,
		CHAR(60) AS cDesc_localidad,
		CHAR(8) AS cCve_col,
		CHAR(100) AS cDesc_colonia;	
	...
	DEFINE cNombre_estado CHAR(30);
	DEFINE cDesc_mun CHAR(60);
	DEFINE cDesc_localidad CHAR(60);
	DEFINE cCve_col CHAR(8);
	DEFINE cDesc_colonia CHAR(100);
	DEFINE iRecuperacion INTEGER;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cCp, cCve_estado, cNombre_estado, cCve_mun, cDesc_mun, 
			cCve_localidad, cDesc_localidad, cCve_col, cDesc_colonia;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_detallecolonias.out';
		--TRACE ON;
		...
		IF (SELECT COUNT(d_codigo) FROM bdinteg:"informix".si_catsepomex WHERE d_codigo = pCp) > 0 THEN
			...
			FOREACH
				SELECT SKIP pRegistros FIRST pRecuperacion DISTINCT a.cp, a.cve_estado, c.nombre, a.cve_mun, a.desc_municipio, 
				a.cve_localidad_cnbv, a.desc_localidad, a.cve_col, a.desc_colonia
				INTO cCp, cCve_estado, cNombre_estado, cCve_mun, cDesc_mun, 
				cCve_localidad, cDesc_localidad, cCve_col, cDesc_colonia
				FROM bdinteg:"informix".si_localidades AS a
				INNER JOIN bdinteg:"informix".si_catsepomex AS b ON a.cp = b.d_codigo
				INNER JOIN bdinteg:"informix".si_estados AS c ON b.c_estado = c.estado
				...
				LET iRecuperacion = iRecuperacion + 1;
				RETURN cCodRet, cCp, cCve_estado, UPPER(TRIM(cNombre_estado)), cCve_mun, UPPER(TRIM(cDesc_mun)), 
				cCve_localidad, UPPER(TRIM(cDesc_localidad)), cCve_col, UPPER(TRIM(cDesc_colonia)) WITH RESUME;
			END FOREACH;
...
'MODULO: OPERACIONES',
'FUNCIONALIDAD: CATÁLOGO DE LOCALIDADES', 
'DESCRIPCION: SPL encargado de consultar el estado, municipio, localidad y colonia correspondiente al cp consultado.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_detallecp(pUsuario CHAR(8), pIdFuncion CHAR(10), pCp CHAR(5))
	RETURNING CHAR(5) AS codret,
		CHAR(2) AS cCve_estado,
		CHAR(30) AS cNombre_estado,
		CHAR(3) AS cCve_mun,
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cCve_estado, cNombre_estado, cCve_mun, cDesc_mun, cCve_localidad, cDesc_localidad;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_detallecp.out';
		--TRACE ON;

		IF pUsuario = '' OR pIdFuncion = '' OR pCp = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet, cCve_estado, cNombre_estado, cCve_mun, cDesc_mun, cCve_localidad, cDesc_localidad;
		END IF;
		...
		SELECT DISTINCT a.cve_estado, c.nombre, a.cve_mun, a.desc_municipio, a.cve_localidad_cnbv, a.desc_localidad
		INTO cCve_estado, cNombre_estado, cCve_mun, cDesc_mun, cCve_localidad, cDesc_localidad
		FROM bdinteg:"informix".si_localidades AS a
		INNER JOIN bdinteg:"informix".si_catsepomex AS b ON a.cp = b.d_codigo
		INNER JOIN bdinteg:"informix".si_estados AS c ON b.c_estado = c.estado
		WHERE a.cp = pCp;
		
		RETURN cCodRet, cCve_estado, UPPER(TRIM(cNombre_estado)), cCve_mun, UPPER(TRIM(cDesc_mun)), cCve_localidad, UPPER(TRIM(cDesc_localidad));
...
'MODULO: OPERACIONES',
'FUNCIONALIDAD: CATÁLOGO DE ESTABLECIMIENTOS', 
'DESCRIPCION: SPL encargado de consultar el estado, municipio y localidad correspondiente al cp consultado.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_validaprocesosreg(pUsuario CHAR(8), pIdFuncion CHAR(10), pIdConsulta CHAR(1), pLatitud CHAR(10), pLongitud CHAR(11))
	RETURNING CHAR(5) AS codret;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_validaprocesosreg.out';
		--TRACE ON;

		IF pUsuario = '' OR pIdFuncion = '' OR pIdConsulta = '' OR pLatitud = '' OR pLongitud = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		--Ubicación
		IF pIdConsulta = '1' THEN
			IF (SELECT COUNT(id_ptf) FROM bdinteg:"informix".si_ptf WHERE latitud = pLatitud AND longitud = pLongitud) > 0 THEN
				LET cCodRet = '00983'; --LA LATITUD Y LONGITUD CAPTURADAS YA FUERON ASIGNADAS A OTRO ESTABLECIMIENTO, VERIFIQUE
			END IF;
		END IF;
...
'MODULO: OPERACIONES',
'FUNCIONALIDAD: CATÁLOGO DE ESTABLECIMIENTOS', 
'DESCRIPCION: SPL encargado de validar la ubicación del establecimiento.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_conciliatotbancos(pUsuario CHAR(8), pIdFuncion CHAR(10), pFecha DATE)
    RETURNING CHAR(5) AS codret,
		CHAR(15) AS banamex,
		CHAR(15) AS bancomer,
		CHAR(15) AS prosa,
		INTEGER AS total_banamex,
		INTEGER AS total_bancomer,
		INTEGER AS total_prosa,
		INTEGER AS total_general,
		MONEY(14,2) AS importe_banamex,
		MONEY(14,2) AS importe_bancomer,
		MONEY(14,2) AS importe_prosa,
		MONEY(16,2) AS importe_general;
	...
	DEFINE cBanamex CHAR(15);
	DEFINE cBancomer CHAR(15);
	DEFINE cProsa CHAR(15);
	DEFINE iTotalBanamex INTEGER;
	DEFINE iTotalBancomer INTEGER;
	DEFINE iTotalProsa INTEGER;
	DEFINE iTotalGeneral INTEGER;
	DEFINE mImporteBanamex MONEY(14,2);
	DEFINE mImporteBancomer MONEY(14,2);
	DEFINE mImporteProsa MONEY(14,2);
	DEFINE mImporteGeneral MONEY(16,2);
	...
	LET cProsa = '';
	LET iTotalBanamex = 0;
	LET iTotalBancomer = 0;
	LET iTotalProsa = 0;
	LET iTotalGeneral = 0;
	LET mImporteBanamex = 0.00;
	LET mImporteBancomer = 0.00;
	LET mImporteProsa = 0.00;
	LET mImporteGeneral = 0.00;
	
    BEGIN
        
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cBanamex, cBancomer, cProsa, iTotalBanamex, iTotalBancomer, iTotalProsa, iTotalGeneral, mImporteBanamex, mImporteBancomer, mImporteProsa, mImporteGeneral;
		END EXCEPTION;
  
		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_conciliatotbancos.out';
		--TRACE ON;
		...
		EXECUTE PROCEDURE bdisac:"informix".sp_sac_conciliatotbancos(pFecha)
		INTO cCodRetSp, cDescCodRetSp, cBanamex, cBancomer, cProsa, iTotalBanamex, iTotalBancomer, iTotalProsa, mImporteBanamex, mImporteBancomer, mImporteProsa;
		
		IF cCodRetSp::INTEGER < 0 THEN 
			RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bdisac:sp_sac_conciliatotbancos';
		ELIF cCodRetSp::INTEGER = 7000 THEN
			LET cCodRet = '00939'; --NO EXISTEN ARCHIVOS QUE CORRESPONDAN CON LA FECHA PROPORCIONADA
		ELIF cCodRetSp::INTEGER = 7001 THEN
			LET cCodRet = '00003';
		ELIF cCodRetSp::INTEGER = 7002 THEN
			LET cCodRet = '00948'; --ARCHIVO NO TRANSMITIDO O ACUMULADO A OTRO POSTERIOR
		END IF;
		
		LET iTotalGeneral = NVL(iTotalBanamex,0) + NVL(iTotalBancomer,0) + NVL(iTotalProsa,0);
		LET mImporteGeneral = NVL((mImporteBanamex/100),0) + NVL((mImporteBancomer/100),0) + NVL((mImporteProsa/100),0);
		RETURN cCodRet, UPPER(cBanamex), UPPER(cBancomer), UPPER(cProsa), iTotalBanamex, iTotalBancomer, iTotalProsa, iTotalGeneral, NVL((mImporteBanamex/100),0), NVL((mImporteBancomer/100),0), NVL((mImporteProsa/100),0), mImporteGeneral; 
...
'FECHA: 04/04/2017',
'MODULO: OPERACIONES',
'FUNCIONALIDAD: REPORTE DE PAGOS TDC INTERBANCARIOS',
'DESCRIPCION: SPL encargado de generar la información para mostrar en el reporte totalizado de los registros conciliados de Banamex, Bancomer y PROSA (todos los demás).',
'AUTOR: ISC. José Manuel Zúñiga Flores',
'FECHA: 09/06/2017',
'DESCRIPCION: Se modifica SP para dividir los importes entre 100.',
'AUTOR: L. Montserrat León Amador',
'FECHA: 07/07/2017',
'DESCRIPCION: Se homologa división entre 100 a todos los importes de los bancos.',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_ope_conciliadeta(pUsuario CHAR(8), pIdFuncion CHAR(10), pFecha DATE, pIdEjecucion CHAR(1), pRegistros INTEGER, pRecuperacion INTEGER)
	...
	LET iTotalMovCon = 0;
	LET mImporteMovCon = 0.00; 
	LET iTotalMovNoCon = 0;
	LET mImporteMovNoCon = 0.00;
	LET iTotalMovNoConTab = 0;
	LET mImporteMovNoConTab = 0.00;
	LET iTotalGeneral = 0;
    ...
    BEGIN
		...
		ON EXCEPTION SET iSqlErr
			...
			UPDATE bdicnweb:"informix".sw_tdc_verificaproceso SET status = 'E', error_proceso = 'S', error = TRIM(cCodRet) WHERE usuario = TRIM(pUsuario);
			
			RETURN cCodRet, cTipo, cCodTxn, cCodRegistro, cNumTarjeta, cNumReferencia, cFechaTxn, iImporteTxn, cCodActualDes, 
			cNombreNegocio, cCodRazon, cIndDeposito, cSucursal, cCuentaCargo, cTransaccSuc, mImporte, cNumRefemov,
			iTotalMovCon, mImporteMovCon, iTotalMovNoCon, mImporteMovNoCon, iTotalMovNoConTab, mImporteMovNoConTab, iTotalGeneral;
		END EXCEPTION;

		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_conciliadeta.out';
		--TRACE ON;
		
		-- SE LIMPIA TABLA POR USUARIO
		DELETE FROM bdicnweb:"informix".sw_tdc_verificaproceso WHERE usuario = TRIM(pUsuario);
		
		-- SE INSERTA A TABLA PARA EL MONITOREO DEL STATUS
		INSERT INTO bdicnweb:"informix".sw_tdc_verificaproceso(usuario,status,error_proceso,error) VALUES(pUsuario,'I','',TRIM(cCodRet));  
		...
		IF pIdEjecucion = '1' THEN
			...
			EXECUTE PROCEDURE bdisac:"informix".sp_sac_conciliadeta(pFecha)
			INTO cCodRetSp, cDescCodRetSp;
			
			IF cCodRetSp::INTEGER < 0 THEN 
				RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCIÓN DEL SP bdisac:sp_sac_conciliadeta';
			ELIF cCodRetSp::INTEGER = 6000 THEN
				LET cCodRet = '00939'; --NO EXISTEN ARCHIVOS QUE CORRESPONDAN CON LA FECHA PROPORCIONADA
				...
				cNombreNegocio, cCodRazon, cIndDeposito, cSucursal, cCuentaCargo, cTransaccSuc, mImporte, cNumRefemov,
				iTotalMovCon, mImporteMovCon, iTotalMovNoCon, mImporteMovNoCon, iTotalMovNoConTab, mImporteMovNoConTab, iTotalGeneral;
			ELIF cCodRetSp::INTEGER = 6001 THEN
				LET cCodRet = '00003';
				...
				cNombreNegocio, cCodRazon, cIndDeposito, cSucursal, cCuentaCargo, cTransaccSuc, mImporte, cNumRefemov,
				iTotalMovCon, mImporteMovCon, iTotalMovNoCon, mImporteMovNoCon, iTotalMovNoConTab, mImporteMovNoConTab, iTotalGeneral;
			ELIF cCodRetSp::INTEGER = 6002 THEN
				LET cCodRet = '00948'; --ARCHIVO NO TRANSMITIDO O ACUMULADO A OTRO POSTERIOR
			...
			IF cCodRetSp::INTEGER = 0 THEN
				...
				UPDATE bdicnweb:"informix".sw_tdc_verificaproceso SET status = 'T', error_proceso = '', error = TRIM(cCodRet) WHERE usuario = TRIM(pUsuario);
		...
		ELIF pIdEjecucion = '2' THEN
			...
			SELECT COUNT(tipo), SUM(importe_txn) 
			INTO iTotalMovCon, mImporteMovCon
			FROM bdisac:"informix".sac_reporte WHERE tipo = '1';
			
			--MOVIMIENTOS NO CONCILIADOS EN ARCHIVOS E-GLOBAL
			SELECT COUNT(tipo), SUM(importe_txn) 
			INTO iTotalMovNoCon, mImporteMovNoCon
			FROM bdisac:"informix".sac_reporte WHERE tipo = '2';
			
			--MOVIMIENTOS NO CONCILIADOS EN TABLAS DE MOVIMIENTOS HISTORICOS
			SELECT COUNT(tipo), SUM(importe_txn) 
			INTO iTotalMovNoConTab, mImporteMovNoConTab
			FROM bdisac:"informix".sac_reporte WHERE tipo = '3';
			
			LET iTotalGeneral = NVL(iTotalMovCon,0) + NVL(iTotalMovNoCon,0) + NVL(iTotalMovNoConTab,0);
			...
			FOREACH
				...
				tipo, cod_txn, cod_registro, num_tarjeta, num_referencia, fecha_txn, importe_txn, cod_actual_des, 
				nombre_negocio, cod_razon, ind_deposito, sucursal, cuenta_cargo, transacc_suc, importe, num_refemov
				INTO cTipo, cCodTxn, cCodRegistro, cNumTarjeta, cNumReferencia, cFechaTxn, iImporteTxn, cCodActualDes, 
				cNombreNegocio, cCodRazon, cIndDeposito, cSucursal, cCuentaCargo, cTransaccSuc, mImporte, cNumRefemov
				FROM bdisac:"informix".sac_reporte ORDER BY cod_registro, num_tarjeta ASC   

				LET iRecuperacion = iRecuperacion + 1;
				RETURN cCodRet, cTipo, cCodTxn, UPPER(TRIM(cCodRegistro)), cNumTarjeta, cNumReferencia, cFechaTxn, iImporteTxn, cCodActualDes, 
				UPPER(TRIM(cNombreNegocio)), UPPER(TRIM(cCodRazon)), cIndDeposito, cSucursal, cCuentaCargo, cTransaccSuc, mImporte, cNumRefemov,
				iTotalMovCon, mImporteMovCon, iTotalMovNoCon, mImporteMovNoCon, iTotalMovNoConTab, mImporteMovNoConTab, iTotalGeneral WITH RESUME;
			END FOREACH;
...
'MODULO: OPERACIONES',
'FUNCIONALIDAD: REPORTE DE PAGOS TDC INTERBANCARIOS',
'DESCRIPCION: SPL encargado de generar la información para mostrar en el reporte detalle de los registros conciliados de Banamex, Bancomer y PROSA (todos los demás).',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_ope_conciliaarchivoptc(pUsuario CHAR(8), pIdFuncion CHAR(10), pFecha DATE)
    ...
    BEGIN
		...
		ELIF cCodRetSp::INTEGER = 506 THEN
			LET cCodRet = '00941'; --NO EXISTE EL REGISTRO DEL PARÁMETRO DE LA TRANSACCIÓN 
		ELIF cCodRetSp::INTEGER = 507 THEN
			LET cCodRet = '00003';
		ELIF cCodRetSp::INTEGER = 508 THEN
			LET cCodRet = '00942'; --NO EXISTE EL PARÁMETRO DE PAGO EN EFECTIVO
		ELIF cCodRetSp::INTEGER = 509 THEN
			LET cCodRet = '00943'; --NO EXISTE EL PARÁMETRO DE PAGO CHEQUE MISMO BANCO
		ELIF cCodRetSp::INTEGER = 510 THEN
			LET cCodRet = '00944'; --NO EXISTE EL PARÁMETRO DE PAGO CHEQUE OTRO BANCO
		ELIF cCodRetSp::INTEGER = 511 THEN
			LET cCodRet = '00945'; --NO EXISTE EL PARÁMETRO DE PAGO EN INTERNET
		ELIF cCodRetSp::INTEGER = 512 THEN
			LET cCodRet = '00946'; --LA CONCILIACION NO PUEDE REALIZARSE, AUN NO TERMINA EL PASE DE MOVIMIENTOS DE CHEQUES
		ELIF cCodRetSp::INTEGER = 599 THEN
			LET cCodRet = '00947'; --ERROR DE INFORMIX NO CONTROLADO
		ELSE
			IF cCodRetSp::INTEGER = 0 OR cCodRetSp::INTEGER = 504 THEN
				LET cCodRet = '00000';
			END IF;
		END IF;
...
'MODULO: OPERACIONES',
'FUNCIONALIDAD: REPORTE DE PAGOS TDC INTERBANCARIOS',
'DESCRIPCION: SPL encargado de ejecutar el proceso de conciliación del Archivo E-Global, para posteriormente ejecutar la generación de los Reportes (Banco/Detalle) de Conciliación.',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_ope_consultaconcmovtotal(pUsuario CHAR(8), pIdFuncion CHAR(10), pFechaProceso DATE)
	...
	BEGIN
		...
		LET iCodRetSp = cCodRetSp::INTEGER;
		IF iCodRetSp < 0 THEN
			RAISE EXCEPTION iCodRetSp, 0, "ERROR EN LA EJECUCION DEL SP: bdisac:sp_sac_concimovtotal";
		ELIF iCodRetSp = 6000 THEN
			LET cCodRet = '00950';
		ELIF iCodRetSp = 6002 THEN
			LET cCodRet = '00948';
		ELIF iCodRetSp = 6003 THEN
			LET cCodRet = '00949';
		ELIF iCodRetSp = 7001 THEN
			LET cCodRet = '00003';
		END IF;
		
		RETURN cCodRet, UPPER(NVL(vNombre, '')), pFechaProceso, NVL(iTotalEnvi, 0), NVL(iConciliado, 0), NVL(iAplicados, 0), NVL(iErrores, 0), NVL(ifaltantes, 0);
...
'FECHA: 04/04/2017',
'MODULO: Operaciones',
'FUNCIONALIDAD: Consulta Conciliación de Movimientos de TDC de Otros Bancos',
'DESCRIPCION: Este procedimiento consume el sp_sac_concimovtotal que obtiene la información para la generacion de conciliacion.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_pagoprogtiporep(pUsuario CHAR(8), pIdFuncion CHAR(10))
    RETURNING CHAR(5) AS codret,
		CHAR(2) AS id_reporte,
		CHAR(45) AS descripcion_reporte;
    ...
    BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_pagoprogtiporep.out';
		--TRACE ON;
		...
		FOREACH
			SELECT id_reporte, UPPER(descripcion_reporte) 
			INTO cIdReporte, cDescReporte
			FROM bdicnweb:"informix".sw_ope_tiporeportepagoprog ORDER BY id_reporte ASC
...
'DESCRIPCION: SPL encargado de consultar la información del catálogo Tipo de Reporte.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_pagoprogtipopagos(pUsuario CHAR(8), pIdFuncion CHAR(10))
    RETURNING CHAR(5) AS codret,
		CHAR(2) AS id_pago,
		CHAR(70) AS descripcion_pago;
    
    DEFINE cCodRet CHAR(5);
    DEFINE iSqlErr INTEGER;
    DEFINE cCodRetSp CHAR(5);
    DEFINE iCodRetSp INTEGER;
    DEFINE cIdPago CHAR(2);
	DEFINE cDescPago CHAR(70);
	DEFINE iRecuperacion INTEGER;
    ...
    BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cIdPago, cDescPago;
		END EXCEPTION;

		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_pagoprogtipopagos.out';
		--TRACE ON;
		...
		FOREACH
			SELECT cve_pago, UPPER(descripcion) 
			INTO cIdPago, cDescPago
			FROM bdiprog:"informix".pp_tppago ORDER BY cve_pago ASC
			
			LET iRecuperacion = iRecuperacion + 1;
			RETURN cCodRet, cIdPago, cDescPago WITH RESUME;
		END FOREACH;
...
'MODULO: OPERACIONES',
'FUNCIONALIDAD: REPORTE DE PAGOS PROGRAMADOS',
'DESCRIPCION: SPL encargado de consultar la información del catálogo Tipos de Pago.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultatiporep(pUsuario CHAR(8), pIdFuncion CHAR(10))
    RETURNING CHAR(5) AS codret,
		CHAR(2) AS id_reporte,
		CHAR(45) AS descripcion_reporte;
    ...
    BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultatiporep.out';
		--TRACE ON;
		...
		FOREACH
			SELECT id_reporte, descripcion_reporte 
			INTO cIdReporte, cDescReporte
			FROM bdicnweb:"informix".sw_tdc_tiporeporte ORDER BY id_reporte ASC
...
'MODULO: OPERACIONES',
'FUNCIONALIDAD: REPORTE DE PAGOS TDC INTERBANCARIOS',
'DESCRIPCION: SPL encargado de consultar el detalle del catálogo Tipo de Reporte.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_verificastatus(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,
			  CHAR(1) AS status,
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_verificastatus.out';
		--TRACE ON;
		...
		FROM bdicnweb:"informix".sw_tdc_verificaproceso WHERE usuario = TRIM(pUsuario);
...
'MODULO: OPERACIONES',
'FUNCIONALIDAD: REPORTE DE PAGOS TDC INTERBANCARIOS',
'DESCRIPCION: SPL verifica el status de la ejecucion del spl encargado de generar la información para mostrar en el reporte detalle de los registros conciliados de Banamex, Bancomer y PROSA (todos los demás).',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_ope_reporteprogramacion(pUsuario CHAR(8), pIdFuncion CHAR(10),pTipoReporte CHAR(2),pNumcte CHAR(20),pCvePago CHAR(2),pFechaInicio DATE,pFechaFin DATE,pOperacion CHAR(1),pRegistros INTEGER, pRecuperacion INTEGER)
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
			cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_reporteprogramacion.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pTipoReporte = '' OR pOperacion ='' OR pRegistros IS NULL OR pRecuperacion IS NULL THEN
			LET cCodRet = '00003';
		...
		IF pOperacion = '1' THEN 
			...
			SET ISOLATION TO DIRTY READ;
			FOREACH 
				EXECUTE PROCEDURE bdiprog:"informix".sp_reporteprogramacion2(pTipoReporte,pNumcte,pCvePago,pFechaInicio,pFechaFin,pRegistros, pRecuperacion)
				INTO  cCodRetSp,cMensajeRet,dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
				cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela
				
				IF cCodRetSp::INTEGER < 0 THEN 
					RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCION DEL SP bdiprog:sp_reporteprogramacion2';
				ELIF cCodRetSp::INTEGER = 10000 THEN --DATOS INVALIDOS
					LET cCodRet = '00003';
					RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
				    cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;

				ELIF cCodRetSp::INTEGER = 10004  THEN --NO EXISTEN REGISTROS CON EL CRITERIO PROPORCIONADO
					LET cCodRet = '00030';
					RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
					cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;
				ELIF cCodRetSp::INTEGER = 10005  THEN --TIPO DE REPORTE INVALID0        
					LET cCodRet = '00297';
					RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
					cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;
				ELIF cCodRetSp::INTEGER = 10008  THEN --CLIENTE NO TIENE PAGOS PROGRAMADOS      
					LET cCodRet = '00956';
					RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
					cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;
				ELIF cCodRetSp::INTEGER = 10013  THEN --NO EXISTE PROGRAMACION BAJO LOS CRITERIOS       
					LET cCodRet = '00957';
					RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
					cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;
				ELIF cCodRetSp::INTEGER = 10037  THEN --TIPO DE REPORTE  ES NULO O ESPACIO EN BLANCO            
					LET cCodRet = '00958';
					RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
					cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;
				ELIF cCodRetSp::INTEGER = 26000  THEN --CLAVE DE PAGO NO EXISTE         
					LET cCodRet = '00959';
					RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
					cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;             
				ELIF cCodRetSp::INTEGER = 40000  THEN --CLIENTE NO EXISTE       
					LET cCodRet = '00025';
					RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
					cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;
				ELIF cCodRetSp::INTEGER = 68000  THEN --FECHA INICIO ES MAYOR A LA FECHA DE FINAL       
					LET cCodRet = '00154';
					RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
					cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;                     
				END IF;
				...
				RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
				cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela WITH RESUME;
			END FOREACH;
		...
		ELSE
			...
			SET ISOLATION TO DIRTY READ;
			FOREACH 
				EXECUTE PROCEDURE bdiprog:"informix".sp_reporteprogramacionsegundo2(pTipoReporte,pNumcte,pCvePago,pFechaInicio,pFechaFin,pRegistros, pRecuperacion)
				INTO  cCodRetSp,cMensajeRet,dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
				cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela
				
				IF cCodRetSp::INTEGER < 0 THEN 
					RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCION DEL SP bdiprog:sp_reporteprogramacionsegundo2';
				ELIF cCodRetSp::INTEGER = 10000 THEN --DATOS INVALIDOS
					LET cCodRet = '00003';
					RETURN cCodRet, dFechaSolicitud,dFechaAplicacion,cSucursal,cPeriodoPago,cMedioSolicitud,cCuentaOrigen,cCuentaDestino,mMonto,cTipoPagoDesc,
					cAviso,cEstatus,cNumeroPago,cCausaRechazo,dFechaCancela;
...
'MODULO: OPERACIONES ',
'FUNCIONALIDAD: REPORTE DE PAGOS PROGRAMADOS',
'DESCRIPCION: Sp que consulta la informacion de los pagos programados.',
'AUTOR: José Manuel Zúñiga Flores',
'FECHA: 08/06/2017',
'DESCRIPCION: Se modifica SPL para quitar validación de dato requerido para los parametros fecha_inicial y fecha_fin.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_gc_consultabines_totales(pUsuario CHAR(8), pIdFuncion CHAR(10), pPeriodoDel DATE, pPeriodoAl DATE, pBin CHAR(6), pCreditoDebito CHAR(1), pClaveBanco CHAR(3), pIdentificador CHAR (1))
		RETURNING CHAR(5) AS codret,
			INTEGER AS total_registros;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_gc_consultabines_totales.out';
		--TRACE ON;
		...
		IF pIdentificador = '0' THEN 
			...
			INTO iNoRegistros
			FROM (         
				(SELECT c.bin, c.id_bco, UPPER(c.creditodebito) AS creditodebito, UPPER(c.banco_prosa) AS nombre_banco
					, c.cve_bAnco
					,'ALTA' AS estatus, DATE(c.fecha_insert) AS fecha
					, c.user_insert, b.nombre AS ejecutivo
				FROM bdicheq:"informix".sc_bines c LEFT JOIN bdinteg:"informix".si_ejecut b ON b.ejecutivo = c.user_insert
				WHERE c.bin = CASE WHEN pBin = '' THEN c.bin ELSE pBin END 
					AND LOWER(c.creditodebito) = CASE WHEN pCreditoDebito = '' THEN LOWER(c.creditodebito) ELSE LOWER(pCreditoDebito) END
					AND c.id_bco = CASE WHEN pClaveBanco = '' THEN c.id_bco ELSE pClaveBanco END)
			UNION
				(SELECT a.bin_banco, a.id_bco, UPPER(a.creditodebito) AS creditodebito, UPPER(a.banco_prosa) AS nombre_banco
					, a.cve_banco, DECODE(a.status_operacion, '1', 'ALTA', '0', 'BAJA', '2', 'MODIFICACION') AS estatus
					, DATE(a.fecha_operacion) AS fecha
					,a.usuario, b.nombre AS ejecutivo
				FROM bdicnweb:"informix".sc_bines_hist a LEFT JOIN bdinteg:"informix".si_ejecut b ON b.ejecutivo = a.usuario
				WHERE a.bin_banco = CASE WHEN pBin = '' THEN a.bin_banco ELSE pBin END 
				AND LOWER(a.creditodebito) = CASE WHEN pCreditoDebito = '' THEN LOWER(a.creditodebito) ELSE LOWER(pCreditoDebito) END
				AND a.id_bco = CASE WHEN pClaveBanco = '' THEN a.id_bco ELSE pClaveBanco END));
		
		ELIF pIdentificador = '1' THEN
			SELECT COUNT(*)
			INTO iNoRegistros
			FROM (
				(SELECT c.bin, c.id_bco, UPPER(c.creditodebito) AS creditodebito, UPPER(c.banco_prosa) AS nombre_banco
							...
							, c.user_insert, b.nombre AS ejecutivo
						FROM bdicheq:"informix".sc_bines c LEFT JOIN bdinteg:"informix".si_ejecut b ON b.ejecutivo = c.user_insert
						WHERE DATE(c.fecha_insert) BETWEEN pPeriodoDel AND pPeriodoAl
						AND c.bin = CASE WHEN pBin = '' THEN c.bin ELSE pBin END 
						AND LOWER(c.creditodebito) = CASE WHEN pCreditoDebito = '' THEN LOWER(c.creditodebito) ELSE LOWER(pCreditoDebito) END
						AND c.id_bco = CASE WHEN pClaveBanco = '' THEN c.id_bco ELSE pClaveBanco END)
					UNION
						(SELECT a.bin_banco, a.id_bco, UPPER(a.creditodebito) AS creditodebito, UPPER(a.banco_prosa) AS nombre_banco
							...
							,a.usuario, b.nombre AS ejecutivo
						FROM bdicnweb:"informix".sc_bines_hist a LEFT JOIN bdinteg:"informix".si_ejecut b ON b.ejecutivo = a.usuario
						WHERE DATE(a.fecha_operacion) BETWEEN pPeriodoDel AND pPeriodoAl
						AND a.bin_banco = CASE WHEN pBin = '' THEN a.bin_banco ELSE pBin END 
						AND LOWER(a.creditodebito) = CASE WHEN pCreditoDebito = '' THEN LOWER(a.creditodebito) ELSE LOWER(pCreditoDebito) END
						AND a.id_bco = CASE WHEN pClaveBanco = '' THEN a.id_bco ELSE pClaveBanco END));
...
'FECHA: 26/02/2016',
'MODULO: OPERACIONES',
'FUNCIONALIDAD: Catalogo de bines',
'DESCRIPCION: Consulta el total de registros de datos de bines',
'BD: bdicnweb',
'AUTOR: Guadalupe Angélica Hernández Pérez',
'FECHA: 18/04/2016',
'DESCRIPCION: Se realizo una modificacion a la consulta de totales  por medio del periodo de fechas permitidas y otra consulta sin el periodo de fechas permitidas de datos de bines.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_cargo_ref_masivo(pIdUsuario CHAR(8), pIdFuncion CHAR(10), pLote INT, pIdPlantilla CHAR(25), pTituloPlantilla char(255))
	RETURNING CHAR(5) AS codret,
	...
	BEGIN
		...
		-- Busqueda del lote
		SELECT {+INDEX(bdicnweb:"informix".sw_tr_cargamasiva_retiro idx_sw_tr_cargamasiva_retiro_reg)} count(lote)
		INTO iExiste
		...
		SELECT {+INDEX(bdicnweb:"informix".sw_tr_cargamasiva_retiro idx_sw_tr_cargamasiva_retiro_reg)} FIRST 1 CURRENT 
		INTO dFechaProceso
		FROM bdicnweb:"informix".sw_tr_cargamasiva_retiro;
		...
		FOREACH WITH HOLD SELECT {+INDEX(bdicnweb:"informix".sw_tr_cargamasiva_retiro idx_sw_tr_cargamasiva_retiro_reg)} id_registro, transaccion, cuenta, doc_cheque AS docto, monto_importe, TRIM(descripcion2) AS referencia
				INTO iRegistro, cTransaccion, cCuenta, iDoctoCheque, mImporte, cReferencia
				FROM bdicnweb:"informix".sw_tr_cargamasiva_retiro
				WHERE lote = pLote AND status = 'C'
				
				EXECUTE PROCEDURE bdicnweb:"informix".sp_cargo_ref(pIdUsuario, pIdFuncion, cTransaccion, cCuenta, iDoctoCheque, mImporte, cReferencia) INTO cCodRetSp, cFolio;
					BEGIN WORK;
					...
					UPDATE {+INDEX(bdicnweb:"informix".sw_tr_cargamasiva_retiro idx_sw_tr_cargamasiva_retiro_reg)} bdicnweb:"informix".sw_tr_cargamasiva_retiro
					...
					IF cCodRetSp = '00000' THEN
							INSERT INTO bdicnweb:"informix".sw_tr_cargamasiva_retiro_hist
							SELECT {+INDEX(bdicnweb:"informix".sw_tr_cargamasiva_retiro idx_sw_tr_cargamasiva_retiro_reg)} * FROM bdicnweb:"informix".sw_tr_cargamasiva_retiro WHERE id_registro = iRegistro;
					END IF;
		...
		EXECUTE PROCEDURE "informix".sp_totalesretirocap(pIdUsuario, pIdFuncion, pLote)
		INTO cCodRetSp, cFechaCargaLote, iTotalRegsLote, mMontoLote, iRegsAceptadosLote, iRegsRechazoLote, cArchivo, cStatusLote;
		
		SELECT {+INDEX(bdicnweb:"informix".sw_tr_cargamasiva_retiro idx_sw_tr_cargamasiva_retiro_reg)} COUNT(id_registro)
		INTO iRegsRechazoLote
		FROM bdicnweb:sw_tr_cargamasiva_retiro 
		...
		BEGIN;
			UPDATE {+INDEX(bdicnweb:"informix".sw_tr_cargamasiva_retiro idx_sw_tr_cargamasiva_retiro_reg)} bdicnweb:sw_tr_cargamasiva_retiro
			SET status = 'C'
		...
		SET LOCK MODE TO WAIT 3;
		BEGIN WORK;
			DELETE {+INDEX(bdicnweb:"informix".sw_tr_cargamasiva_retiro idx_sw_tr_cargamasiva_retiro_reg)} FROM bdicnweb:"informix".sw_tr_cargamasiva_retiro WHERE status = 'S' and lote = pLote and codret_proceso = '00000';
		COMMIT;
...
DOCUMENT "AUTOR: Oscar Flores Conde",
"FECHA: 09/08/2013",
"DESCRIPCION: Realiza el retiro masivo de cuentas de captación de la aplicación CNWEB";
...
'FECHA: 03/09/2014',
'DESCRIPCION: Opciones de origen para los reportes de incrementos de lineas de crÃ©dito',
'BD: bdicnweb';
...
pNumCliente CHAR(20), pStatus CHAR(1), pStatusAnt CHAR(1), pMotivo CHAR(250))
    RETURNING CHAR(5) AS codRet,
		CHAR(1) AS status_cte,
		CHAR(25) AS fecha_status;
	...
	DEFINE dFechaUltAct DATETIME YEAR TO FRACTION(3);
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			IF iSqlErr <> 0 THEN
				LET cCodRet = iSqlErr;
				RETURN cCodRet, cStatusCte, dFechaStatus;
			END IF;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_rem_cambioestatusctes.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pIdConsulta = '' OR pNumCliente = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet, cStatusCte, dFechaStatus;
		END IF;
		...
		IF pIdConsulta = '1' THEN
			...
			IF EXISTS (SELECT numcte FROM bdisac:"informix".sac_cte_remesas WHERE numcte = TRIM(pNumCliente)) THEN
			
				--SELECT (CASE WHEN UPPER(status_cte) = 'A' THEN 'ACTIVO' WHEN UPPER(status_cte) = 'B' THEN 'BLOQUEADO' END), fecha_actualizacion
				SELECT status_cte, fecha_actualizacion INTO cStatusCte, dFechaStatus
				FROM bdisac:"informix".sac_cte_remesas WHERE numcte = TRIM(pNumCliente);
				
			ELSE
				LET cCodRet = '00990'; --EL CLIENTE NO CUENTA CON REMESAS
			END IF;
		
			RETURN cCodRet, TRIM(UPPER(cStatusCte)), dFechaStatus;
			
		--Bloquear/Desbloquear
		ELIF pIdConsulta = '2' THEN
			
			IF pStatus = '' OR pMotivo = '' THEN
				LET cCodRet = '00003';
				RETURN cCodRet, cStatusCte, dFechaStatus;
			END IF;
		
			UPDATE bdisac:"informix".sac_cte_remesas SET status_cte = UPPER(pStatus), fecha_actualizacion = CURRENT 
			WHERE numcte = TRIM(pNumCliente);
			
			IF DBINFO('sqlca.sqlerrd2') = 0 THEN
				LET cCodRet = '00283';
			ELSE
				SELECT MAX(fecha_actualizacion) INTO dFechaUltAct
				FROM bdisac:"informix".sac_log_cte_his_mov WHERE numcte = TRIM(pNumCliente);
				
				INSERT INTO bdisac:"informix".sac_log_cte_his_mov(numcte,estatus_anterior,fecha_ult_actualizacion,
				usuario_insert,estatus_actual,fecha_actualizacion,motivo)
				VALUES(TRIM(pNumCliente),pStatusAnt,NVL(dFechaUltAct,''),pUsuario,pStatus,CURRENT,pMotivo);
...
'FECHA 15/06/2017',
'MODULO: REMESAS',
'FUNCIONALIDAD: CAMBIO DE ESTATUS DE LOS CLIENTES DE PAGO REMESAS',
'DESCRIPCION: SPL encargado de consultar/actualizar el estatus del cliente.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_rem_consdetalleremesascte(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumCliente CHAR(20), 
pFechaIni DATE, pFechaFin DATE, pRegistros INTEGER, pRecuperacion INTEGER)
    RETURNING CHAR(5) AS codRet,
		CHAR(40) AS nom_convenio,
		CHAR(25) AS fecha_pago,
		CHAR(16) AS clave_envio,
		CHAR(20) AS monto_pago,
		CHAR(15) AS tipo_pago,
		CHAR(4) AS sucursal,
		CHAR(8) AS empleado;		
	...
	DEFINE cNum_convenio CHAR(3);
	DEFINE cNom_convenio CHAR(40);
	DEFINE cFecha_pago CHAR(25);
	DEFINE cClave_envio CHAR(16);
	DEFINE cMonto_pago CHAR(20);
	DEFINE cTipo_pago CHAR(15);
	DEFINE cSucursal CHAR(4);
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			IF iSqlErr <> 0 THEN
				LET cCodRet = iSqlErr;
				RETURN cCodRet,cNom_convenio,cFecha_pago,cClave_envio,cMonto_pago,cTipo_pago,cSucursal,cEmpleado;
			END IF;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_rem_consdetalleremesascte.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pNumCliente = '' OR pFechaIni IS NULL OR pFechaFin IS NULL OR
		...
		FOREACH
			...
			SELECT SKIP pRegistros FIRST pRecuperacion numconvenio,nomconvenio,fecha_pago,clave_envio,monto_pago,tipo_pago,sucursal,empleado
			INTO cNum_convenio,cNom_convenio,cFecha_pago,cClave_envio,cMonto_pago,cTipo_pago,cSucursal,cEmpleado
			FROM bdicnweb:"informix".sac_detalle_rem
			WHERE numcte = TRIM(pNumCliente) AND usuario_insert = pUsuario ORDER BY numconvenio, fecha_pago ASC
			
			IF NVL(cNum_convenio,'') = '004' THEN                 
				LET cFecha_pago = SUBSTR(cFecha_pago, 7, 2) || '/' || SUBSTR(cFecha_pago, 5, 2) || '/' || SUBSTR(cFecha_pago, 1, 4);
			ELIF NVL(cNum_convenio,'') IN ('006','007','008') THEN                 
				LET cFecha_pago = SUBSTR(cFecha_pago, 9, 2) || '/' || SUBSTR(cFecha_pago, 6, 2) || '/' || SUBSTR(cFecha_pago, 1, 4);
			ELIF NVL(cNum_convenio,'') = '009' THEN                 
				LET cFecha_pago = SUBSTR(cFecha_pago, 7, 2) || '/' || SUBSTR(cFecha_pago, 5, 2) || '/' || SUBSTR(cFecha_pago, 1, 4);
			END IF;
			
			LET iRecuperacion = iRecuperacion + 1;
			RETURN cCodRet,cNom_convenio,cFecha_pago,cClave_envio,cMonto_pago,NVL(cTipo_pago,''),cSucursal,cEmpleado WITH RESUME;			
		END FOREACH;
...
'DESCRIPCION: SPL encargado de consultar el detalle de las remesas por cliente.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_rem_consdetalleremesascte_totales(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumCliente CHAR(20), 
pFechaIni DATE, pFechaFin DATE)
	...
	DEFINE dFechaPagBts CHAR(25);
	DEFINE dFechaPagWu CHAR(25);
	DEFINE dFechaPagOv CHAR(25);
	DEFINE dFechaPagVg CHAR(25);
	DEFINE dFechaPagApp CHAR(25);
	DEFINE cCveEnvioBts CHAR(16);
	DEFINE cCveEnvioWu CHAR(16);
	DEFINE cCveEnvioOv CHAR(16);
	DEFINE cCveEnvioVg CHAR(16);
	DEFINE cCveEnvioApp CHAR(16);
	...
	DEFINE cTipoPagoBts CHAR(15);
	DEFINE cTipoPagoWu CHAR(15);
	DEFINE cTipoPagoOv CHAR(15);
	DEFINE cTipoPagoVg CHAR(15);
	DEFINE cTipoPagoApp CHAR(15);
	DEFINE cSucursalBts CHAR(4);
	DEFINE cSucursalWu CHAR(4);
	DEFINE cSucursalOv CHAR(4);
	DEFINE cSucursalVg CHAR(4);
	DEFINE cSucursalApp CHAR(4);
	DEFINE cEmpleadoBts CHAR(8);
	DEFINE cEmpleadoWu CHAR(8);
	DEFINE cEmpleadoOv CHAR(8);
	DEFINE cEmpleadoVg CHAR(8);
	DEFINE cEmpleadoApp CHAR(8);
	
	DEFINE cClaveEnvBts CHAR(16);
	DEFINE cClaveEnvWu CHAR(16);
	DEFINE cClaveEnvOv CHAR(16);
	DEFINE cClaveEnvVg CHAR(16);
	DEFINE cClaveEnvApp CHAR(16);
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_rem_consdetalleremesascte_totales.out';
		--TRACE ON;
		...
		-- LIMPIA TABLAS
		DELETE FROM bdicnweb:"informix".sac_detalle_rem WHERE usuario_insert = pUsuario;
		
		--REMESAS BTS
		INSERT INTO bdicnweb:"informix".sac_detalle_rem (numconvenio,nomconvenio,fecha_pago,
		clave_envio,monto_pago,tipo_pago,sucursal,empleado,numcte,usuario_insert)
		SELECT '004','REMESAS DE BTS',process_dt,confirmation_nm,'','',branch_sd,user_insert,pNumCliente,pUsuario 
		...
		ORDER BY process_dt ASC;
		
		--REMESAS WU
		INSERT INTO bdicnweb:"informix".sac_detalle_rem (numconvenio,nomconvenio,fecha_pago,
		clave_envio,monto_pago,tipo_pago,sucursal,empleado,numcte,usuario_insert)
		SELECT '006','REMESAS WESTERN UNION',wu.fecha_hora_rp,wu.mtcn,'','',ej.sucursal,wu.user_insert,pNumCliente,pUsuario 
		FROM bdisac:"informix".sac_wu_pay AS wu, bdinteg:"informix".si_ejecut AS ej
		WHERE wu.numcte = TRIM(pNumCliente) AND wu.txn_status = 'A' AND wu.conf_pago = 'P' AND wu.retcode = '00000' 
		AND SUBSTR(wu.mtcn,1,3) NOT IN ('708','972','973') AND DATE(wu.fecha_insert) BETWEEN pFechaIni AND pFechaFin
		AND wu.user_insert = ej.ejecutivo
		ORDER BY wu.fecha_hora_rp ASC;
		
		--REMESAS OV
		INSERT INTO bdicnweb:"informix".sac_detalle_rem (numconvenio,nomconvenio,fecha_pago,
		clave_envio,monto_pago,tipo_pago,sucursal,empleado,numcte,usuario_insert)
		SELECT '007','REMESAS ORLANDI VALUTA',wu.fecha_hora_rp,wu.mtcn,'','',ej.sucursal,wu.user_insert,pNumCliente,pUsuario  
		FROM bdisac:"informix".sac_wu_pay AS wu, bdinteg:"informix".si_ejecut AS ej 
		WHERE wu.numcte = TRIM(pNumCliente) AND wu.txn_status = 'A' AND wu.conf_pago = 'P' AND wu.retcode = '00000' 
		AND SUBSTR(wu.mtcn,1,3) IN ('708') AND DATE(wu.fecha_insert) BETWEEN pFechaIni AND pFechaFin
		AND wu.user_insert = ej.ejecutivo
		ORDER BY wu.fecha_hora_rp ASC;
		...
		INSERT INTO bdicnweb:"informix".sac_detalle_rem (numconvenio,nomconvenio,fecha_pago,
		clave_envio,monto_pago,tipo_pago,sucursal,empleado,numcte,usuario_insert)
		SELECT '008','REMESAS VIGO',wu.fecha_hora_rp,wu.mtcn,'','',ej.sucursal,wu.user_insert,pNumCliente,pUsuario  
		FROM bdisac:"informix".sac_wu_pay AS wu, bdinteg:"informix".si_ejecut AS ej 
		WHERE wu.numcte = TRIM(pNumCliente) AND wu.txn_status = 'A' AND wu.conf_pago = 'P' AND wu.retcode = '00000' 
		AND SUBSTR(wu.mtcn,1,3) IN ('972','973') AND DATE(wu.fecha_insert) BETWEEN pFechaIni AND pFechaFin
		AND wu.user_insert = ej.ejecutivo
		ORDER BY wu.fecha_hora_rp ASC;
		...
		INSERT INTO bdicnweb:"informix".sac_detalle_rem (numconvenio,nomconvenio,fecha_pago,
		clave_envio,monto_pago,tipo_pago,sucursal,empleado,numcte,usuario_insert)
		SELECT '009','REMESAS APPRIZA',r_processdate,unirefnum,'','',nnumber,user_insert,pNumCliente,pUsuario  
		...
		FOREACH
			SELECT qr.destination_am::MONEY(18,2) AS monto_pag, pa.confirmation_nm 
			INTO mMontoPagBts, cClaveEnvBts
			...
			SELECT (CASE WHEN forma_pago = '1' THEN 'EFECTIVO' WHEN forma_pago = '4' THEN 'ABONO EN CUENTA' END) 
			INTO cTipoPagoBts
			FROM bdisac:"informix".sac_movimientos
			WHERE numcategoria = '07'
			AND numconvenio = '004'
			AND referencia1 = cClaveEnvBts
			...
			UPDATE bdicnweb:"informix".sac_detalle_rem
			SET monto_pago = mMontoPagBts, tipo_pago = cTipoPagoBts
			WHERE numconvenio = '004' AND clave_envio = cClaveEnvBts
			AND numcte = pNumCliente AND usuario_insert = pUsuario;
		END FOREACH;
		...
		FOREACH
			SELECT monto_destino::MONEY(18,2) AS monto_pag, mtcn 
			INTO mMontoPagWu, cClaveEnvWu 
			FROM bdisac:"informix".sac_wu_pay 
			WHERE numcte = TRIM(pNumCliente) AND txn_status = 'A' AND conf_pago = 'P' AND retcode = '00000' 
			AND SUBSTR(mtcn,1,3) NOT IN ('708','972','973')	AND DATE(fecha_insert) BETWEEN pFechaIni AND pFechaFin
			...
			UPDATE bdicnweb:"informix".sac_detalle_rem 
			SET monto_pago = mMontoPagWu, tipo_pago = cTipoPagoWu
			WHERE numconvenio = '006' AND clave_envio = cClaveEnvWu
			AND numcte = pNumCliente AND usuario_insert = pUsuario;
		END FOREACH;
		...
		FOREACH		
			SELECT monto_destino::MONEY(18,2) AS monto_pag, mtcn 
			INTO mMontoPagOv, cClaveEnvOv 
			FROM bdisac:"informix".sac_wu_pay 
			WHERE numcte = TRIM(pNumCliente) AND txn_status = 'A' AND conf_pago = 'P' AND retcode = '00000' 
			AND SUBSTR(mtcn,1,3) IN ('708') AND DATE(fecha_insert) BETWEEN pFechaIni AND pFechaFin
			...
			UPDATE bdicnweb:"informix".sac_detalle_rem
			SET monto_pago = mMontoPagOv, tipo_pago = cTipoPagoOv
			WHERE numconvenio = '007' AND clave_envio = cClaveEnvOv
			AND numcte = pNumCliente AND usuario_insert = pUsuario;
		END FOREACH;
		...
		FOREACH
			SELECT monto_destino::MONEY(18,2) AS monto_pag, mtcn 
			INTO mMontoPagVg, cClaveEnvVg 
			FROM bdisac:"informix".sac_wu_pay 
			WHERE numcte = TRIM(pNumCliente) AND txn_status = 'A' AND conf_pago = 'P' AND retcode = '00000' 
			AND SUBSTR(mtcn,1,3) IN ('972','973') AND DATE(fecha_insert) BETWEEN pFechaIni AND pFechaFin
			...
			UPDATE bdicnweb:"informix".sac_detalle_rem
			SET monto_pago = mMontoPagVg, tipo_pago = cTipoPagoVg
			WHERE numconvenio = '008' AND clave_envio = cClaveEnvVg
			AND numcte = pNumCliente AND usuario_insert = pUsuario;
		END FOREACH;
		...
		FOREACH
			SELECT r_destinamount::MONEY(18,2) AS monto_pag, unirefnum  
			INTO mMontoPagApp, cClaveEnvApp 
			FROM bdisac:"informix".sac_app_payi 
			WHERE numcte = TRIM(pNumCliente) AND txn_status = 'A' AND r_code = '0000' AND r_code_d = 'P000'
			AND DATE(fecha) BETWEEN pFechaIni AND pFechaFin
			...
			UPDATE bdicnweb:"informix".sac_detalle_rem
			SET monto_pago = mMontoPagApp, tipo_pago = cTipoPagoApp
			WHERE numconvenio = '009' AND clave_envio = cClaveEnvApp
			AND numcte = pNumCliente AND usuario_insert = pUsuario;
		END FOREACH;
...
'MODULO: REMESAS',
'FUNCIONALIDAD: CONSULTA GENERAL DE REMESAS POR CLIENTE',
'DESCRIPCION: SPL encargado de consultar el número total de registros del detalle de las remesas por cliente.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_rem_consdethistoricomovimientos_totales(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumCliente CHAR(20))
    RETURNING CHAR(5) AS codRet,
		INTEGER AS num_registros;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_rem_consdethistoricomovimientos_totales.out';
		--TRACE ON;
		...
		SELECT COUNT(*)
		INTO iNumRegistros
		FROM bdisac:"informix".sac_log_cte_his_mov
		WHERE numcte = TRIM(pNumCliente);
...
'FECHA 15/06/2017',
'MODULO: REMESAS',
'FUNCIONALIDAD: CONSULTA HISTÓRICO DE MOVIMIENTOS BLOQUEO/DESBLOQUEO',
'DESCRIPCION: SPL encargado de consultar el número total de registros del histórico de movimientos bloqueo/desbloqueo del cliente consultado.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_rem_consdethistoricomovimientos(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumCliente CHAR(20), pRegistros INTEGER, pRecuperacion INTEGER)
    RETURNING CHAR(5) AS codRet,
		CHAR(25) AS fecha_mod,
		CHAR(1) AS tipo_mod,
		CHAR(250) AS motivo,
		CHAR(8) AS empleado;
	...
	DEFINE cDescCodRet CHAR(80);
	DEFINE cEmpresa CHAR(3);
	DEFINE dFechaMod CHAR(25);
	DEFINE cTipoMod CHAR(1);
	DEFINE cMotivo CHAR(250);
	DEFINE cEmpleado CHAR(8);
	DEFINE iRecuperacion INTEGER;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			IF iSqlErr <> 0 THEN
				LET cCodRet = iSqlErr;
				RETURN cCodRet,dFechaMod,cTipoMod,cMotivo,cEmpleado;
			END IF;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_rem_consdethistoricomovimientos.out';
		--TRACE ON;
		...
		FOREACH
			SELECT SKIP pRegistros FIRST pRecuperacion fecha_actualizacion,estatus_actual,motivo,usuario_insert
			INTO dFechaMod,cTipoMod,cMotivo,cEmpleado
			FROM bdisac:"informix".sac_log_cte_his_mov
			WHERE numcte = TRIM(pNumCliente) ORDER BY fecha_actualizacion ASC
			
			LET iRecuperacion = iRecuperacion + 1;
			RETURN cCodRet,SUBSTR(dFechaMod,1,19),cTipoMod,UPPER(cMotivo),cEmpleado WITH RESUME;
		END FOREACH;
...
'MODULO: REMESAS',
'FUNCIONALIDAD: CONSULTA HISTÓRICO DE MOVIMIENTOS BLOQUEO/DESBLOQUEO',
'DESCRIPCION: SPL encargado de consultar el histórico de movimientos bloqueo/desbloqueo del cliente consultado.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_rem_consgralremesascte(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumCliente CHAR(20), 
pFechaIni DATE, pFechaFin DATE, pRegistros INTEGER, pRecuperacion INTEGER)
    RETURNING CHAR(5) AS codRet,
		CHAR(40) AS nom_convenio,
		INTEGER AS total_pagadas,
		CHAR(20) AS monto_pagado,
		CHAR(25) AS fecha_ult;		
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			IF iSqlErr <> 0 THEN
				LET cCodRet = iSqlErr;
				RETURN cCodRet,cNom_convenio,iTotal_pagadas,cMonto_pagado,cFecha_ult;
			END IF;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_rem_consgralremesascte.out';
		--TRACE ON;
		...
		FOREACH
			SELECT SKIP pRegistros FIRST pRecuperacion numconvenio,nomconvenio,total_pagadas,monto_pagado,fecha_ult
			INTO cNum_convenio,cNom_convenio,iTotal_pagadas,cMonto_pagado,cFecha_ult
			FROM bdicnweb:"informix".sac_general_rem
			WHERE numcte = TRIM(pNumCliente) AND usuario_insert = pUsuario ORDER BY numconvenio ASC
			
			IF NVL(cNum_convenio,'') = '004' THEN                 
				LET cFecha_ult = SUBSTR(cFecha_ult, 7, 2) || '/' || SUBSTR(cFecha_ult, 5, 2) || '/' || SUBSTR(cFecha_ult, 1, 4);
			ELIF NVL(cNum_convenio,'') IN ('006','007','008') THEN                 
				LET cFecha_ult = SUBSTR(cFecha_ult, 9, 2) || '/' || SUBSTR(cFecha_ult, 6, 2) || '/' || SUBSTR(cFecha_ult, 1, 4);
			ELIF NVL(cNum_convenio,'') = '009' THEN                 
				LET cFecha_ult = SUBSTR(cFecha_ult, 7, 2) || '/' || SUBSTR(cFecha_ult, 5, 2) || '/' || SUBSTR(cFecha_ult, 1, 4);
			END IF;
			
			LET iRecuperacion = iRecuperacion + 1;
			RETURN cCodRet,cNom_convenio,iTotal_pagadas,cMonto_pagado,cFecha_ult WITH RESUME;
		END FOREACH;
...
'MODULO: REMESAS',
'FUNCIONALIDAD: CONSULTA GENERAL DE REMESAS POR CLIENTE',
'DESCRIPCION: SPL encargado de realizar la consulta general de remesas por cliente.',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_cargasucursalesvalidacion(pUsuario CHAR(8), pIdFuncion CHAR(10), pRegistrosMas CHAR(500), pBandera CHAR(1), pIteracion CHAR(1))
		RETURNING CHAR(5) AS codret;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_cargasucursalesvalidacion.out';
		-- TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pRegistrosMas = '' OR pBandera = '' OR pIteracion = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		IF pBandera = '1' THEN
			LET cFuncionalidad = 'Tipo Sucursal';
		ELIF pBandera = '2' THEN
			LET cFuncionalidad = 'Solicitud TDC';
		END IF;
		
		IF pIteracion = '0' THEN
			DELETE FROM "informix".sw_ope_validacionsucursalmeta 
		...
		FOREACH
			...
			IF (SELECT COUNT(*) FROM bdmis:"informix".mi_sucursalesinfo WHERE num_sucursal = cSucursal) > 0 THEN
				INSERT INTO "informix".sw_ope_validacionsucursalmeta(numsucursal, funcionalidad, usuario) 
				VALUES(cSucursal, cFuncionalidad, pUsuario);
			END IF;
...
'DESCRIPCION: Procedimiento que realiza la inserción masiva de sucursales para validar si existen',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultabitacoraerroresmetas(pUsuario CHAR(8), pIdFuncion CHAR(10), pFunc CHAR(20), pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cNumSuc, cNomSuc, cDesc;
		END EXCEPTION;
		
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultabitacoraerroresmetas.out';
		-- TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pFunc = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet, cNumSuc, cNomSuc, cDesc;
		END IF;
		...
		FOREACH		
			SELECT SKIP pRegistros FIRST pRecuperacion numSucursal, nomSucursal, descMensaje
			INTO cNumSuc, cNomSuc, cDesc
			FROM "informix".sw_ope_bitacoraerrorescargarchivo
			WHERE noEjecutivo = pUsuario AND funcionalidad = pFunc
			
			LET iNoRegistros = iNoRegistros + 1;
			RETURN cCodRet, cNumSuc, cNomSuc, cDesc WITH RESUME;
		END FOREACH;
...
'MODULO: Operaciones',
'FUNCIONALIDAD: Mantenimiento Tipo Sucursal',
'DESCRIPCION: Procedimiento que recupera los registros de la bitacora de errores',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultabitacoraerroresmetas_totales(pUsuario CHAR(8), pIdFuncion CHAR(10), pFunc CHAR(20))
		RETURNING CHAR(5) AS codret,
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultabitacoraerroresmetas_totales.out';
		-- TRACE ON;
...
'MODULO: Operaciones',
'FUNCIONALIDAD: Mantenimiento Tipo Sucursal',
'DESCRIPCION: Procedimiento que recupera el total de los registros de la bitacora de errores',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultafechaultimasolicitudestdc(pUsuario CHAR(8), pIdFuncion CHAR(10))
		RETURNING CHAR(5) AS codret,
				DATE AS fechaUltima;
	...
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;
	DEFINE dFechaUltima DATE;
	
	LET cCodRet = '00000';
	LET iSqlErr = 0;
	LET dFechaUltima = NULL;
	
	BEGIN
	
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, dFechaUltima;
		END EXCEPTION;
		
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultafechaultimasolicitudestdc.out';
		-- TRACE ON;
		...
		SELECT MAX(fecha)
		INTO dFechaUltima
		FROM bdmis:"informix".mi_metascoppel;
		
		IF dFechaUltima IS NULL THEN
		 LET cCodRet = '00017';
		END IF;
...
'FECHA: 17/05/2017',
'MODULO: Operaciones',
'FUNCIONALIDAD: Mantenimiento Metas Solicitudes TDC',
'DESCRIPCION: Procedimiento que realiza la consulta de la fecha maxima de carga de archivo en la tabla mi_metascoppel',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultamantenimientosucursal(pUsuario CHAR(8), pIdFuncion CHAR(10), pBandera CHAR(1), pSucursal CHAR(4), pTipoSucursal CHAR(2), pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,
				CHAR(4) AS numSucursal,
				CHAR(40) AS nomSucursal,
				CHAR(2) AS tipoSucursal;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cSucursal, cNombreSucursal, cTipoSucursal;
		END EXCEPTION;
		
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultamantenimientosucursal.out';
		-- TRACE ON;
		...
		IF pBandera = '1' THEN
			FOREACH		
				SELECT SKIP pRegistros FIRST pRecuperacion num_sucursal, nombre, tipo_suc
				INTO cSucursal, cNombreSucursal, cTipoSucursal
				FROM bdmis:"informix".mi_sucursalesinfo
				WHERE tipo_suc = pTipoSucursal
				ORDER BY 1 ASC
			
				LET iNoRegistros = iNoRegistros + 1;
				RETURN cCodRet, cSucursal, cNombreSucursal, cTipoSucursal WITH RESUME;
			END FOREACH;
		END IF;
		IF pBandera = '2' THEN
			FOREACH		
		...
		IF pBandera = '3' THEN
			FOREACH		
				SELECT SKIP pRegistros FIRST pRecuperacion numsucursal, nomsucursal, tiposucursal
				INTO cSucursal, cNombreSucursal, cTipoSucursal
...
'MODULO: Operaciones',
'FUNCIONALIDAD: Mantenimiento Tipo Sucursal',
'DESCRIPCION: Procedimiento que realiza la consulta por sucursal, tipo sucursal y carga archivo',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultamantenimientosucursal_totales(pUsuario CHAR(8), pIdFuncion CHAR(10), pBandera CHAR(1), pSucursal CHAR(4), pTipoSucursal CHAR(2))
		RETURNING CHAR(5) AS codret,
				INTEGER AS total;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultamantenimientosucursal_totales.out';
		-- TRACE ON;
...
'MODULO: Operaciones',
'FUNCIONALIDAD: Mantenimiento Tipo Sucursal',
'DESCRIPCION: Procedimiento que realiza la consulta de los totales por sucursal, tipo sucursal y carga archivo',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultamanttosolicitudtdc(pUsuario CHAR(8), pIdFuncion CHAR(10), pFechaUltima DATE, pBandera CHAR(1), pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,
				CHAR(4) AS sucursal,
				CHAR(40) AS nombre,
				DECIMAL(3,2) AS metadiaria;
	...
	DEFINE dMetaDiaria DECIMAL(3,2);
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cSucursal, cNombre, dMetaDiaria;
		END EXCEPTION;
		
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultamanttosolicitudtdc.out';
		-- TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pFechaUltima IS NULL OR pBandera = '' OR pRegistros IS NULL OR pRecuperacion IS NULL THEN
			LET cCodRet = '00003';
			RETURN cCodRet, cSucursal, cNombre, dMetaDiaria;
		END IF;
		...
		IF pBandera = '1' THEN
			FOREACH		
				SELECT SKIP pRegistros FIRST pRecuperacion a.sucursal, b.nombre ,a.meta_diaria
				INTO cSucursal, cNombre, dMetaDiaria
				FROM bdmis:"informix".mi_metascoppel AS a
				INNER JOIN bdmis:"informix".mi_sucursalesinfo AS b ON b.num_sucursal= a.sucursal
				WHERE a.fecha= pFechaUltima
		
				LET iNoRegistros = iNoRegistros + 1;
				RETURN cCodRet, cSucursal, cNombre, dMetaDiaria WITH RESUME;
			END FOREACH;
		END IF;
		IF pBandera = '2' THEN
			FOREACH		
				SELECT SKIP pRegistros FIRST pRecuperacion numsucursal, nomsucursal, meta
				INTO cSucursal, cNombre, dMetaDiaria
...
'MODULO: Operaciones',
'FUNCIONALIDAD: Mantenimiento Metas Solicitudes TDC',
'DESCRIPCION: Procedimiento que realiza la consulta de los datos para el llenado del grid',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultamanttosolicitudtdc_totales(pUsuario CHAR(8), pIdFuncion CHAR(10), pFechaUltima DATE, pBandera CHAR(1))
		RETURNING CHAR(5) AS codret,
				INTEGER AS totalRegistros;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultamanttosolicitudtdc_totales.out';
		-- TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pFechaUltima IS NULL OR pBandera = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet, iNoRegistros;
		END IF;
...
'MODULO: Operaciones',
'FUNCIONALIDAD: Mantenimiento Metas Solicitudes TDC',
'DESCRIPCION: Procedimiento que realiza la consulta del total de los datos',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultametasproductos_totales(pUsuario CHAR(8), pIdFuncion CHAR(10), pAnioMes CHAR(10), pTipoSucursal INTEGER)
		RETURNING CHAR(5) AS codret,
				INTEGER AS total;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultametasproductos_totales.out';
		-- TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pAnioMes = '' OR pTipoSucursal IS NULL THEN
			LET cCodRet = '00003';
			RETURN cCodRet, iNoRegistros;
		END IF;
		...
		SELECT COUNT(a.producto)
		INTO iNoRegistros
		FROM bdmis:"informix".mi_metasprod AS a
		INNER JOIN bdmis:"informix".mi_producto AS b ON b.num_producto = a.producto
		WHERE a.aniomes = pAnioMes 
		AND a.id_tiposuc= pTipoSucursal;
...
'DESCRIPCION: Procedimiento que obtiene la informacion del totales para las metas producto',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultamovimientosmetas(pUsuario CHAR(8), pIdFuncion CHAR(10), pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,
				INTEGER AS id,
				DATE AS fecha,
				CHAR(40) AS nombre,
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, iId, dFecha, cNombre, cCambio;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultamovimientosmetas.out';
		--TRACE ON;
		...
		FOREACH		
				SELECT SKIP pRegistros FIRST pRecuperacion id, fecha, nombre, cambio 
				INTO iId, dFecha, cNombre, cCambio
				FROM bdmis:"informix".mi_movimientosmetas
				
				LET iNoRegistros = iNoRegistros + 1;
				RETURN cCodRet, iId, dFecha, cNombre, cCambio WITH RESUME;
...
'DESCRIPCION: Procedimiento que obtiene la informacion para el llenado del grid Consulta Movimientos',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultamovimientosmetas_totales(pUsuario CHAR(8), pIdFuncion CHAR(10))
		RETURNING CHAR(5) AS codret,
				INTEGER AS totalRegistros;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultamovimientosmetas_totales.out';
		-- TRACE ON;
...
'MODULO: Operaciones',
'FUNCIONALIDAD: Consulta Movimientos',
'DESCRIPCION: Procedimiento que obtiene la informacion para el total de registros de la Consulta Movimientos',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_ope_consultanombrearchivometastdc(pUsuario CHAR(8), pIdFuncion CHAR(10), pNombre CHAR(100))
		RETURNING CHAR(5) AS codret;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_ope_consultanombrearchivometastdc.out';
		-- TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pNombre = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		SELECT COUNT(*) 
		INTO iNoRegistros
		FROM "informix".sw_ope_nombrearchivosmetasolicitudtdc
		WHERE nombreArchivo = pNombre 
		AND fechaCarga = TODAY;
...
'FECHA: 18/05/2017',
'MODULO: Operaciones',
'FUNCIONALIDAD: Metas Solicitudes TDC',
'DESCRIPCION: Procedimiento que realiza la consulta del nombre del archivo a cargar',
'BD: bdicnweb';
