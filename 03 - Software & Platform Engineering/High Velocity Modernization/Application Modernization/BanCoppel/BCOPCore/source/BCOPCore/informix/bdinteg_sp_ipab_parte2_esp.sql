CREATE PROCEDURE "informix".sp_ipab_parte2_esp( pFechaIni DATE, pFechaFin DATE ) 
RETURNING CHAR(5), CHAR(5), CHAR(50);
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, cDesErr
        SET DEBUG FILE TO '/resplogifx/conciliachq/ipab/sp_ipab_parte2_esp.err';
        TRACE ON;
        LET cCodRet  = iSqlErr;
    ...
    --- SET DEBUG FILE TO '/resplogifx/conciliachq/ipab/sp_ipab_parte2_esp.out';
    --- TRACE ON;
    ...
    */ 
    ...
    FOREACH WITH HOLD
        ...
        IF iContador2 >= 10000 THEN
            LET iContador2 = 0;
            LET cSql = 'echo "REGISTROS PROCESADOS PARTE 2: '||iContador1||'" > /resplogifx/conciliachq/ipab/regsprocpte2.txt';
            SYSTEM cSql;
        END IF;
