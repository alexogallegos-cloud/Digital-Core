CREATE PROCEDURE "informix".sp_obt_boleto_cte_mib(pPerido char(2), pDato char(16),pRegistros INTEGER)
...
--SET DEBUG FILE TO "/RESPALDOSNEW/sp_obt_boleto_cteTRACE.out";
--TRACE ON;
...
set lock mode to wait 5;
	...
	END IF;
		   ...
		   FOREACH			   
				...
				FROM bdinteg@stag_ids1170:si_sorteo_efectivo_hist a
				INNER JOIN  bdinteg:si_cliente b  on cast(a.num_cliente as CHAR(10))  = b.numcte  
				INNER JOIN bdicheq:sc_maechq c on cast(a.num_cuenta as CHAR(10))   = c.cuenta
