CREATE PROCEDURE "informix".spei_aplicaordenpago_dos( pRegistros INTEGER, pOrigen CHAR(1) ) 
RETURNING CHAR(5), INTEGER, INTEGER; 
    ...
    IF cStatusProc = '0' THEN
        ...
        FOREACH WITH HOLD
            ...
            /*EXECUTE FUNCTION "informix".syn_verify2(TRIM(wcadena_val), TRIM(wvchrfirma), 21)
            INTO codretfirma;*/
