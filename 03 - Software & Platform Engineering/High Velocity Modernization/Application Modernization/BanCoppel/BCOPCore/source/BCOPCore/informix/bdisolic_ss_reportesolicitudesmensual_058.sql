CREATE PROCEDURE "informix".ss_reportesolicitudesmensual_058(pfecha_ini DATE, pfecha_fin DATE)
returning   char(06),
            char(70);
...
--defino las variables para la fecha
...
--    alter table ss_riesgos_os type (RAW);
	...
	foreach with hold
        ...
        where sol.empresa='001' and cli.tpo_persona='01' and sol.fecha_insert >= pfecha_ini and sol.fecha_insert <= pfecha_fin
