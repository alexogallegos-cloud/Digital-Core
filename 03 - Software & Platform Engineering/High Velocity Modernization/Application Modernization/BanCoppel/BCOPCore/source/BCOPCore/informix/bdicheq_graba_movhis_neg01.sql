CREATE PROCEDURE "informix".graba_movhis_neg01(pempresa CHAR(3))
    ...
    BEGIN
       ...
       AND cancelad <> "S"
       ORDER BY num_serial
       INTO TEMP tmp_neg01 WITH NO LOG;
       CREATE INDEX idx_tmp_neg ON tmp_neg01(empresa,cuenta) USING BTREE;
       UPDATE STATISTICS MEDIUM FOR TABLE tmp_neg01;
