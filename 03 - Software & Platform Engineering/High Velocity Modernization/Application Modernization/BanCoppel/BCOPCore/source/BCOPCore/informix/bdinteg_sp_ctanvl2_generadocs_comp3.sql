CREATE PROCEDURE "informix".sp_ctanvl2_generadocs_comp3( pEmpresa CHAR(3) )
RETURNING CHAR(5), CHAR(5), CHAR(50), INTEGER, INTEGER;
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, iDesErr
        SET DEBUG FILE TO "/RESPALDOSNEW/DoctosCtaNvl2/sp_ctanvl2_generadocs_comp3.err";
        TRACE ON;
        IF iSqlErr <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/RESPALDOSNEW/DoctosCtaNvl2/sp_ctanvl2_generadocs_comp3.out";
    --- TRACE ON;
