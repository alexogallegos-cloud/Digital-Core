CREATE PROCEDURE "informix".sp_grabarreversopagosman (pFolio CHAR(16), pEjecutivo CHAR(8),  pObservacionRev CHAR(50))
...
BEGIN
    ...
    AND cod_param = '28';
        ...
        IF cCredito <> '' AND cCredito IS NOT NULL AND cSucursal <> '' AND cSucursal IS NOT NULL THEN
            ...
            CALL bdicred:reversion ('001', cSucursal, pEjecutivo,pFolio, "M") Returning cCodRet;	
            ...
            UPDATE sd_bitacorapagos SET status='R', descripcion_rev = pObservacionRev WHERE folio = pFolio; --Actualiza a reversado el estatus del pago manual.
...
END PROCEDURE
DOCUMENT
'DESCRIPCION: MANDA LLAMAR LA REVERSION Y ACTUALIZA A REVERSADO EL ESTATUS EN LOS PAGOS MANUALES', 
