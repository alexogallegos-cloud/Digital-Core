CREATE PROCEDURE "informix".sp_generaarchivoadicionalesr2(p_Empresa CHAR(3), pFechaAct DATE)
RETURNING
     CHAR(6);
...
LET vtiporeposicion = 2; --DEFAULT 2
...
BEGIN
	ON EXCEPTION
		SET iSqlErr
		Set debug file to '/RESPALDOS/sp_GeneraArchivoAdicionalesR2.out';
		trace on;
...
--*************************************************************************
--| Modificado por  : Victor Hugo
--| Ultima Modif.   : Octubre 2012
--| Descripción     : Se modifican defaults.
--*************************************************************************
END PROCEDURE;