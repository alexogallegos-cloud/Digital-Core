CREATE PROCEDURE "informix".sp_formararchivodedeclaracion_pba(p_cFechaXML CHAR(6), p_cDeclaracion CHAR(1),p_cTipoDeclaracion CHAR(1))
    RETURNING CHAR(6),CHAR(20);

--Declaracion de variables generales
DEFINE v_cRetorno        CHAR(6);
DEFINE iSqlError         INTEGER;
DEFINE v_cFiller         CHAR(32);
DEFINE v_cNumReg         CHAR(1);
DEFINE v_iNumComplementaria INTEGER;
DEFINE v_cDomicilio      CHAR(90);
DEFINE v_cArchivo        CHAR(20);
DEFINE v_dFechaPres      DATE;
DEFINE v_cNumFolioAnt    CHAR(20);
DEFINE v_cDiaUltimo      CHAR(2);
DEFINE v_cVarPrueba1     CHAR(128);
DEFINE v_cVarPrueba2     CHAR(128);
DEFINE v_cVarPrueba3     CHAR(128);
DEFINE v_cVarPrueba4     CHAR(128);
DEFINE v_cMes            CHAR(2);
DEFINE v_cAnio           CHAR(4);
DEFINE v_dFechOper       DATE;
DEFINE v_mMontoOper      MONEY(16,2);
DEFINE v_cTipoOper       CHAR(2);
DEFINE v_iContador		 INT ;
--Declaracion de variables stattmp_anualxmlfisica, stattmp_anualxmlmoral
DEFINE v_cCliente        CHAR(20);
DEFINE v_cTipoPersona    CHAR(2);
DEFINE v_cRfc            CHAR(13);
DEFINE v_cCurp           CHAR(20);
DEFINE v_cRazonSocial    CHAR(60);
DEFINE v_cApPaterno      CHAR(26);
DEFINE v_cApMaterno      CHAR(26);
DEFINE v_cNombre1        CHAR(26);
DEFINE v_cNombre2        CHAR(26);
DEFINE v_cCalle          CHAR(30);
DEFINE v_cNumInterior    CHAR(10);
DEFINE v_cNumExterior    CHAR(10);
DEFINE v_cColonia        CHAR(30);
DEFINE v_cCP             CHAR(5);
...
DEFINE v_cEsquemaXSD     CHAR(20);
DEFINE v_cRfcDeclarante  CHAR(13);
DEFINE v_cInstitucion    CHAR(50);
DEFINE v_cRfcLegal       CHAR(13);
DEFINE v_cCurpLegal      CHAR(20);
DEFINE v_cNomLegal       CHAR(60);
DEFINE v_cVersionXSD     CHAR(5);
DEFINE v_cNomInstitucion CHAR(60);
DEFINE v_cRfcInstitucion CHAR(13);
...
--DSB 25/03/2013
DEFINE v_cCorreoElec 		CHAR(100);
DEFINE v_cTelefono1 		CHAR(15);
DEFINE v_cTelefono2 		CHAR(15);
DEFINE v_msaldopenrec   	MONEY(16,2);
DEFINE v_cTipoCuenta		CHAR(50);
...
--SET DEBUG FILE TO '/tmp/sp_FormarArchivodeDeclaracion.out';
--TRACE ON;
...
BEGIN
	...
	IF p_cDeclaracion = 'M' THEN
		...
		IF v_cRetorno = '000000' THEN
			DELETE FROM bdilide:"informix".sl_archivoxml WHERE nomarchivo = v_cArchivo;
				...
				--FOREACH
					...
					AND tpo_persona IS NOT NULL)THEN
						...
						FOREACH
							...
							/*VALUES (v_cArchivo,LPAD(v_cFiller, 16, ' ')||'<DepositoEnEfectivo impuestoDeterminado="' || NVL(ROUND(v_mImpDeterminado::INT8),0) || ---Se modifica para la generación de la Declaracion informativa.20/05/2014 MLFS
			...
			Se comenta esta sección para la generación de las DIM informativa 20/05/2014*/
			INSERT INTO bdilide:"informix".sl_archivoxml(nomarchivo, registro)
	...
	ELSE
		...
		IF v_cRetorno = '000000' THEN
			IF v_cNumReg = '1' THEN
				...
				SELECT {+ INDEX (bdilide:"informix".sl_anualxml idx_anualxml2)} num_cte, tpo_persona, rfc, curp, razon_soc, apell_pat, apell_mat, nombre1,
				...
				SELECT b.num_cte, b.num_cta, b.cotitulares, b.porcion, b.imprecaudado, b.fechaxml
				...
				SELECT  b.keyx, b.num_cte, b.num_cta, b.tipo_oper, b.monto_oper, b.fecha_oper, b.fechaxml
		...
		INSERT INTO bdilide:"informix".sl_archivoxml(nomarchivo, registro)
			...
			TRUNCATE TABLE bdilide:"informix".stattmp_anualxmlfisic;
			TRUNCATE TABLE bdilide:"informix".stattmp_anualxmlmoral;
			TRUNCATE TABLE bdilide:"informix".stattmp_ctasfisicas;
			TRUNCATE TABLE bdilide:"informix".stattmp_ctasmorales;
			TRUNCATE TABLE bdilide:"informix".stattmp_movctasfisicas;
