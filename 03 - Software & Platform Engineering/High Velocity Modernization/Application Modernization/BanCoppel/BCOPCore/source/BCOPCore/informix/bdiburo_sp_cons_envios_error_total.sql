CREATE PROCEDURE "informix".sp_cons_envios_error_total(pInstitucion CHAR(2), pFechaInicio CHAR(10), pFechaFin CHAR(10))
RETURNING CHAR(5) AS codret,
	...
	BEGIN
		...
		SELECT count(*)
			...
			WHERE fecha_insert >=  pFechaInicio AND fecha_insert <= pFechaFin and status = 3 AND institucion = pInstitucion;
