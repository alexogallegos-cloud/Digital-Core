CREATE PROCEDURE "informix".sp_cifra_archivo_chq( pCodigo CHAR(20) ) 
RETURNING CHAR(5);
    ...
    SELECT TO_CHAR(fecha_hoy,'%Y%m%d')
      INTO vfech_arch
    ...
    FOREACH
        ...
        IF pCodigo = 'ALTASTARJETASNOMINA' THEN
            LET vNomarch = 'N001'||vfech_arch||'01'||'.dat';
        END IF;
