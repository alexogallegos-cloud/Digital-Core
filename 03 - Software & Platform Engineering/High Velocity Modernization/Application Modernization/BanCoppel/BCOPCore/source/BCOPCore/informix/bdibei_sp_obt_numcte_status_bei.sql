CREATE PROCEDURE "informix".sp_obt_numcte_status_bei(
    pNumCte CHAR(20),
    pIdUsuario CHAR(30)
...
RETURNING CHAR(5), CHAR(20), SMALLINT, INTEGER, INTEGER,DATETIME YEAR to SECOND;
   ...
   LET iFecBloqueo='1900-01-01 00:00:00';
	...
	-- BD: bdibei
	-- SOLICITO :BanCoppel
	-- MODIFICACION: AHORA RECIBE pIdUsuario EN LUGAR DEL NUMERO DE IDENTIFICACIÓN Y LO UTILIZA PARA LA 
	--		 CONSULTA EN LA TABLA SERVICIO.
