CREATE PROCEDURE "informix".sp_compras_monto_prom_mes(p_anio INTEGER, p_mes INTEGER, p_num_credito CHAR(20), p_origen INTEGER)
...
IF fch_periodo >= fch_limite THEN
    ...
    FOREACH
            ...
            SELECT  a.num_credito, nvl(sdo_debe,0) + nvl(interes_pago_total_tc,0) saldo_al_corte,
                ...
                --(d.saldo_promedio /b.monto_otorgado)  *100 Porcentaje_consumo
            ...
            FROM bdimonitorcob:mc_masterestad a,
                ...
                bdicred:sd_encabezado2_edocta c,
                bdicred:sd_pie_edocta d
