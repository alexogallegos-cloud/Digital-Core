CREATE PROCEDURE "informix".sp_obtiene_productos_cub_mx(pEmpresa CHAR(3), pSucursal CHAR(4), pEjecutivo CHAR(8), pPuesto_local CHAR(2), pNumcte CHAR(20), 	
...
--jom-26/11/2018
	...
	--SET DEBUG FILE TO "/controlcambios/P-BD-21042021-01/sp_obtiene_productos.sql";
	--TRACE ON;
...
-- EM 2017/05/25
		...
		-- Valida que NO oferte productos de crÃÂºÃÂ¨dito a empleados GC RQM 09 539
		IF pEmp = '1' THEN
