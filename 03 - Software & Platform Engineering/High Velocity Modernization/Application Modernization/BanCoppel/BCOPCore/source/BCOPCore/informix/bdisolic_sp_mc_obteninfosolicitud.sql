CREATE PROCEDURE "informix".sp_mc_obteninfosolicitud(pEmpresa CHAR(3),pNumSol CHAR(20))
RETURNING 
...
ON EXCEPTION SET iSqlErr, iIsamErr, cErrorInfo   
     ...
     RETURN cCodRet, cErrorInfo,cNumcte,cNombreCte,cRfc,cSucursal,
		...
		iPar_prestamos,cEnvioCop,cNum_solicitud_ref,cStatusSol2, cCausaStatus2 ,dtFechaCambioStatus2,cPermCambio,dMontoAut,dLimitecreditopesos,cComportamientoSicCop,cCausaSol,cCausaSol2; 		
END EXCEPTION;
...
SET LOCK MODE TO WAIT 3;
	...
	IF NVL(cNumSolicitud,"") = "" THEN
	    ...
	    dCMA_cop,dTAB_cop,dCRA_cop,dMontoSol_cop,dLineaTeorica_cop,iPuntos_parcn,iPar_altoriesgo,iPar_celulares,iPar_prestamos,cEnvioCop,cNum_solicitud_ref,cStatusSol2, cCausaStatus2 ,dtFechaCambioStatus2,cPermCambio,dMontoAut,dLimitecreditopesos,cComportamientoSicCop,cCausaSol,cCausaSol2; 		
	END IF
...
RETURN cCodRet, cMensajeRet,cNumcte,cNombreCte,cRfc,cSucursal,
		...
		dIngresoMensual,dIngresoLC,dCompromisosBanco,dCompromisosSIC,dCompromisosCoppel,dCMA,dTAB,	dLineaTeorica,dMontoSol,
		dMontoMaxSol,cNumProd,cDescNumProd,cNumProd2,cDescNumProd2,	
	    dCMA_cop,dTAB_cop,dCRA_cop,dMontoSol_cop,dLineaTeorica_cop,iPuntos_parcn,iPar_altoriesgo,iPar_celulares,iPar_prestamos,cEnvioCop,cNumSol2,cStatusSol2, cCausaStatus2,dtFechaCambioStatus2,cPermCambio,dMontoAut,dLimitecreditopesos,cComportamientoSicCop,cCausaSol,cCausaSol2; 
