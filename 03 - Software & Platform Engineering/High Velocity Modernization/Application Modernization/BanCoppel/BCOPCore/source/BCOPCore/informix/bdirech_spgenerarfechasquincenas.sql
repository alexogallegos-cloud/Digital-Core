CREATE PROCEDURE "informix".spgenerarfechasquincenas()
...
BEGIN
	...
	FOREACH
		SELECT DISTINCT(fechadesc) INTO v_dFechaQuincena FROM bdirech:"informix".rec_deschistorico ORDER BY fechadesc DESC				
		RETURN v_sCodRet, v_dFechaQuincena WITH RESUME;
	END FOREACH;
