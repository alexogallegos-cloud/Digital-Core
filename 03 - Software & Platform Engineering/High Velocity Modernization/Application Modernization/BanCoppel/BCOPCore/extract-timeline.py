...
open(BASE + "timeline-code-bcop.md", "w", encoding="utf-8").write("\n".join(L))
print(f"timeline-code-bcop.md escrito · {n_with_date:,}/{n_sp:,} SPs con fecha ({100*n_with_date//n_sp if n_sp else 0}%)")
