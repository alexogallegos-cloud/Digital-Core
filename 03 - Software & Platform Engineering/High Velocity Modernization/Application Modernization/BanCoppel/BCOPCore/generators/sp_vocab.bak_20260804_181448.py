...
CAT = {
 ...
 "cnsif":("PREFIJO","consulta SIF (bus de integración)","inf"),"cac":("PREFIJO","familia crédito (CAC)","conf"),
 "mon":("PREFIJO","monitor / módulo","conf"),"dicta":("PREFIJO","dictamen (aclaraciones/crédito)","conf"),
 ...
 "ro":          ("ENTIDAD","ro — Rol Operativo (subsistema sp_sw_ro_* — bdicnweb)","conf"),
 "fc":          ("ENTIDAD","fc — Fuentes Combinadas (subsistema sp_fc_*; biométricos — bdicnweb)","conf"),
 "cc":          ("ENTIDAD","cc — cuenta corriente (sp_*_cc_* — bdicnweb)","conf"),
 ...
 "dicta":       ("ENTIDAD","dicta — dictamen / subsistema de dictaminación (sp_dicta_* — bdinteg fan_in=268+)","conf"),
 ...
 # ── ACCIONES (verbos) ──
 "consulta":("ACCION","consulta / lee","conf"),"cons":("ACCION","consulta","conf"),"con":("ACCION","consulta","conf"),"consreportes":("ACCION","consulta reportes","conf"),"consreporte":("ACCION","consulta reporte","conf"),
 ...
 "gen":("ACCION","genera / general","conf"),"confirma":("ACCION","confirma","conf"),
 ...
 "cp":("ENTIDAD","código postal","conf"),"dictamen":("ENTIDAD","dictamen","conf"),
 ...
 "solic":("ENTIDAD","solicitud","conf"),"sol":("ENTIDAD","solicitud","conf"),"solin":("ENTIDAD","solicitud de crédito","inf"),
 "lincred":("ENTIDAD","línea de crédito","conf"),"credito":("ENTIDAD","crédito","conf"),"cred":("ENTIDAD","crédito","conf"),"cre":("ENTIDAD","crédito","conf"),
 ...
 "archivo":("ENTIDAD","archivo","conf"),"arch":("ENTIDAD","archivo","conf"),
 ...
 "movil":("MODIF","canal móvil","conf"),"suc":("MODIF","sucursal","conf"),"aumento":("MODIF","aumento","inf"),# ambiguos — requieren SME/DBA
 ...
 "indicadores":("ENTIDAD","indicadores","conf"),"aut":("ACCION","autorización","conf"),
