...
CAT = {
 ...
 # ── ACCIONES (verbos) ──
 "consulta":("ACCION","consulta / lee","conf"),"cons":("ACCION","consulta","conf"),"con":("ACCION","consulta","inf"),"consreportes":("ACCION","consulta reportes","conf"),"consreporte":("ACCION","consulta reporte","conf"),
 ...
 "aplica":("ACCION","aplica / ejecuta","conf"),"rec":("ACCION","recepción / recibe","conf"),"valida":("ACCION","valida","conf"),
 "validacion":("ACCION","validación","conf"),"carga":("ACCION","carga / ingresa","conf"),"inserta":("ACCION","inserta / registra","conf"),
 ...
 "estatus":("ENTIDAD","estatus","conf"),"solicitud":("ENTIDAD","solicitud","conf"),
 "solic":("ENTIDAD","solicitud","conf"),"sol":("ENTIDAD","solicitud","inf"),"solin":("ENTIDAD","solicitud de crédito","inf"),
 "lincred":("ENTIDAD","línea de crédito","conf"),"credito":("ENTIDAD","crédito","conf"),"cred":("ENTIDAD","crédito","conf"),"cre":("ENTIDAD","crédito","inf"),
 ...
 "periodicidad":("MODIF","periodicidad","conf"),"remanente":("MODIF","remanente","inf"),"autoriza":("ACCION","autoriza","conf"),
 ...
 "decodifica":("ACCION","decodifica","conf"),"opcion":("ENTIDAD","opción","conf"),"canal":("ENTIDAD","canal","conf"),"descripcion":("ENTIDAD","descripción","conf"),
 ...
 "movil":("MODIF","canal móvil","conf"),"suc":("MODIF","sucursal","inf"),"aumento":("MODIF","aumento","inf"),# ambiguos — requieren SME/DBA
 ...
 "motivo":("ENTIDAD","motivo / causa","conf"),"apellido":("ENTIDAD","apellido","conf"),"error":("ENTIDAD","error","conf"),"ciudad":("ENTIDAD","ciudad","conf"),"atm":("ENTIDAD","cajero automático (ATM)","conf"),
 ...
 "receptor":("ENTIDAD","receptor","conf"),
