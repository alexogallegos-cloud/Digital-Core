...
function render(){{
  ...
  if(showSP)drawPanel("#chartSP",CSP,cvSP,ymax,U.spei,zSP);else d3.select("#chartSP svg").remove();
  if(showEG)drawPanel("#chartEG",CEG,cvEG,ymax,U.eglobal,zEG);else d3.select("#chartEG svg").remove();
