...
json.dump(DATA, open(BASE + "lexical-souls-data.json", "w", encoding="utf-8"), ensure_ascii=False, separators=(",", ":"))
...
open(BASE + "lexical-evolution-bcop.html", "w", encoding="utf-8").write(HTML)
