...
| `abono_ref` | `bancoppel.bdicheq.abono_ref.latency` | `bancoppel.bdicheq.abono_ref.errors` | [SME-PENDING] ms |
...
| `bancoppel.bdicheq.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["bancoppel/bdicheq", "latency.p50"], ["bancoppel/bdicheq", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["bancoppel/bdicheq", "errors.total"], ["bancoppel/bdicheq", "errors.l4"]]},
...
```
DETECTAR: Alarma bancoppel.bdicheq.errors.l4 > 0
ACCIÓN INMEDIATA:
