...
|---------------------|--------------------|--------------------|-----|
| `sp_fal_cancelacion_cuenta_credito` | `bancoppel.bdiaclaracion.fal_cancelacion_cuenta_credito.latency` | `bancoppel.bdiaclaracion.fal_cancelacion_cuenta_credito.errors` | [SME-PENDING] ms |
...
| `sp_fal_liquidacion_asignar_analista` | `bancoppel.bdiaclaracion.fal_liquidacion_asignar_analista.latency` | `bancoppel.bdiaclaracion.fal_liquidacion_asignar_analista.errors` | [SME-PENDING] ms |
...
| `bancoppel.bdiaclaracion.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["bancoppel/bdiaclaracion", "latency.p50"], ["bancoppel/bdiaclaracion", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["bancoppel/bdiaclaracion", "errors.total"], ["bancoppel/bdiaclaracion", "errors.l4"]]},
...
```
DETECTAR: Alarma bancoppel.bdiaclaracion.errors.l4 > 0
ACCIÓN INMEDIATA:
