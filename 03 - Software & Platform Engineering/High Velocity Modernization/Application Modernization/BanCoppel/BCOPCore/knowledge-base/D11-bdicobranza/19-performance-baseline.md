# D11 · Cobranza — Baseline de Performance

> **Componente:** BCOPCore · SPE-AM-001 · TEST Phase
> **Base de datos:** `bdicobranza` · IBM Informix IDS 14.10 POWER-AIX → Aurora PostgreSQL
...
-- Instrumentar el SP que llama a bdicobranza:sp_nombre() para registrar:
...
|----|-----------------|---------|---------|---------|---------|
| `sp_inserta_bitacora_cob` | 406 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_cat_graba_telefono_adicional` | 15 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_cat_gen_info_admin` | 7 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_consultacuentascliente_bis` | 4 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_consultacuentascliente_crd` | 4 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
...
| Patrón | Impacto en `bdicobranza` | Preparación |
|--------|-------------------|------------|
...
export default function() {
  ...
  let res = http.post('https://api.target/bdicobranza/v1/endpoint', payload);
...
**Total llamadas dominio:** 54,756 · **Total errores:** 49,701 · **Error rate global:** 90.77%
