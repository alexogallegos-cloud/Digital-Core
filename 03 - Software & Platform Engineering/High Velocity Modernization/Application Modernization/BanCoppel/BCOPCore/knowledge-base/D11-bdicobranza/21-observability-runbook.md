...
|---------------------|--------------------|--------------------|-----|
| `sp_inserta_bitacora_cob` | `bancoppel.bdicobranza.inserta_bitacora_cob.latency` | `bancoppel.bdicobranza.inserta_bitacora_cob.errors` | [SME-PENDING] ms |
| `sp_cat_graba_telefono_adicional` | `bancoppel.bdicobranza.cat_graba_telefono_adicional.latency` | `bancoppel.bdicobranza.cat_graba_telefono_adicional.errors` | [SME-PENDING] ms |
| `sp_cat_gen_info_admin` | `bancoppel.bdicobranza.cat_gen_info_admin.latency` | `bancoppel.bdicobranza.cat_gen_info_admin.errors` | [SME-PENDING] ms |
...
| `bancoppel.bdicobranza.requests.total` | Custom | Total de requests al microservicio |
...
| `bancoppel.bdicobranza.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["bancoppel/bdicobranza", "latency.p50"], ["bancoppel/bdicobranza", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["bancoppel/bdicobranza", "errors.total"], ["bancoppel/bdicobranza", "errors.l4"]]},
...
```
DETECTAR: Alarma bancoppel.bdicobranza.errors.l4 > 0
ACCIÓN INMEDIATA:
