...
|---------------------|--------------------|--------------------|-----|
| `sp_validafecha` | `bancoppel.bdispei.validafecha.latency` | `bancoppel.bdispei.validafecha.errors` | [SME-PENDING] ms |
...
| `sp_regordenctecte_pp` | `bancoppel.bdispei.regordenctecte_pp.latency` | `bancoppel.bdispei.regordenctecte_pp.errors` | [SME-PENDING] ms |
...
| `bancoppel.bdispei.requests.total` | Custom | Total de requests al microservicio |
...
| `bancoppel.bdispei.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["bancoppel/bdispei", "latency.p50"], ["bancoppel/bdispei", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["bancoppel/bdispei", "errors.total"], ["bancoppel/bdispei", "errors.l4"]]},
...
```
DETECTAR: Alarma bancoppel.bdispei.errors.l4 > 0
ACCIÓN INMEDIATA:
