...
|---------------------|--------------------|--------------------|-----|
| `sp_sac_guardamensajeerror` | `bancoppel.bdisac.sac_guardamensajeerror.latency` | `bancoppel.bdisac.sac_guardamensajeerror.errors` | [SME-PENDING] ms |
| `sp_validanombenefbts` | `bancoppel.bdisac.validanombenefbts.latency` | `bancoppel.bdisac.validanombenefbts.errors` | [SME-PENDING] ms |
| `sp_sac_consucursales` | `bancoppel.bdisac.sac_consucursales.latency` | `bancoppel.bdisac.sac_consucursales.errors` | [SME-PENDING] ms |
...
| `bancoppel.bdisac.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["bancoppel/bdisac", "latency.p50"], ["bancoppel/bdisac", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["bancoppel/bdisac", "errors.total"], ["bancoppel/bdisac", "errors.l4"]]},
...
```
DETECTAR: Alarma bancoppel.bdisac.errors.l4 > 0
ACCIÓN INMEDIATA:
