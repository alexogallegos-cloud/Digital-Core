...
|---------------------|--------------------|--------------------|-----|
| `sp_consultadatospiezas_bym3` | `bancoppel.bdisuc.consultadatospiezas_bym3.latency` | `bancoppel.bdisuc.consultadatospiezas_bym3.errors` | [SME-PENDING] ms |
| `sp_consutacat_dictamen_bym` | `bancoppel.bdisuc.consutacat_dictamen_bym.latency` | `bancoppel.bdisuc.consutacat_dictamen_bym.errors` | [SME-PENDING] ms |
| `sp_consultadatospiezas_bym3_totales` | `bancoppel.bdisuc.consultadatospiezas_bym3_totales.latency` | `bancoppel.bdisuc.consultadatospiezas_bym3_totales.errors` | [SME-PENDING] ms |
...
| `bancoppel.bdisuc.requests.total` | Custom | Total de requests al microservicio |
...
| `bancoppel.bdisuc.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["bancoppel/bdisuc", "latency.p50"], ["bancoppel/bdisuc", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["bancoppel/bdisuc", "errors.total"], ["bancoppel/bdisuc", "errors.l4"]]},
...
```
DETECTAR: Alarma bancoppel.bdisuc.errors.l4 > 0
ACCIÓN INMEDIATA:
