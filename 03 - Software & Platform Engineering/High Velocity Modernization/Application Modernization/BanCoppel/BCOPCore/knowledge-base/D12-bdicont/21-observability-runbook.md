...
|---------------------|--------------------|--------------------|-----|
| `sp_consultaparametrosgenerales2` | `bancoppel.bdicont.consultaparametrosgenerales2.latency` | `bancoppel.bdicont.consultaparametrosgenerales2.errors` | [SME-PENDING] ms |
| `sp_datosdiahoy_cod47_2` | `bancoppel.bdicont.datosdiahoy_cod47_2.latency` | `bancoppel.bdicont.datosdiahoy_cod47_2.errors` | [SME-PENDING] ms |
| `sp_ope_catalogomotivos2` | `bancoppel.bdicont.ope_catalogomotivos2.latency` | `bancoppel.bdicont.ope_catalogomotivos2.errors` | [SME-PENDING] ms |
...
| `bancoppel.bdicont.requests.total` | Custom | Total de requests al microservicio |
...
| `bancoppel.bdicont.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["bancoppel/bdicont", "latency.p50"], ["bancoppel/bdicont", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["bancoppel/bdicont", "errors.total"], ["bancoppel/bdicont", "errors.l4"]]},
...
```
DETECTAR: Alarma bancoppel.bdicont.errors.l4 > 0
ACCIÓN INMEDIATA:
