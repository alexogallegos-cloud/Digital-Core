...
|---------------------|--------------------|--------------------|-----|
| `sp_asigna_solicitud_soc` | `bancoppel.bdisolic.asigna_solicitud_soc.latency` | `bancoppel.bdisolic.asigna_solicitud_soc.errors` | [SME-PENDING] ms |
...
| `sp_obtienegrupo` | `bancoppel.bdisolic.obtienegrupo.latency` | `bancoppel.bdisolic.obtienegrupo.errors` | [SME-PENDING] ms |
...
| `bancoppel.bdisolic.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["bancoppel/bdisolic", "latency.p50"], ["bancoppel/bdisolic", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["bancoppel/bdisolic", "errors.total"], ["bancoppel/bdisolic", "errors.l4"]]},
...
```
DETECTAR: Alarma bancoppel.bdisolic.errors.l4 > 0
ACCIÓN INMEDIATA:
