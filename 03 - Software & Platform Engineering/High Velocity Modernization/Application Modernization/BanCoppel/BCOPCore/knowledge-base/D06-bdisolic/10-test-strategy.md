...
| `sp_actualiza_respuestacoppel_cteprosp` | `bdiprospectos` | Simular respuesta API de `bdiprospectos` con mock — verificar contrato |
| `sp_actualiza_respuestacoppel_cteprosp` | `bdisolic` | Simular respuesta API de `bdisolic` con mock — verificar contrato |
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/BCOPCore/informix/bdisolic_*.sql (análisis estático de 70 archivos SQL) · Specialist — Informix SPL Analysis + QA Lead Equivalencia*
