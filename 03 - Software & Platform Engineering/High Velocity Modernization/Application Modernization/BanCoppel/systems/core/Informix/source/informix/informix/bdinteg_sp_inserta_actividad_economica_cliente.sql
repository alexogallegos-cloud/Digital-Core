CREATE PROCEDURE "informix".sp_inserta_actividad_economica_cliente(p_NumCte VARCHAR(20), p_Actividad VARCHAR(100))
        RETURNING CHAR(6);
		...
		BEGIN
				...
				IF v_Existe <=0 THEN
					LET v_CodRet = '00001';
				ELSE
					UPDATE bdinteg:si_cliente SET actividad_economica = p_Actividad WHERE numcte = p_NumCte;
				END IF;
