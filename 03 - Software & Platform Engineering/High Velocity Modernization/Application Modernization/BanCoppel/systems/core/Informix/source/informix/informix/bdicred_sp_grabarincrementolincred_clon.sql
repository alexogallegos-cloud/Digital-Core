CREATE PROCEDURE "informix".sp_grabarincrementolincred_clon(pEmpresa  CHAR(3), 
													   pSolicitud CHAR(20))
...
END EXCEPTION;
 ...
 --SET DEBUG FILE TO '/informix/sp_grabarincrementolincred_clon.out';
 --TRACE ON ;
...
SELECT lincred_sugerida, num_producto, lincred_sugerida - lincred_actual,sucursal
  ...
  FROM bdicred:sd_bitacora_aumlincred_clon
 WHERE empresa = pEmpresa 
...
'el incremto de la lÃ­nea de crÃ©dito',
