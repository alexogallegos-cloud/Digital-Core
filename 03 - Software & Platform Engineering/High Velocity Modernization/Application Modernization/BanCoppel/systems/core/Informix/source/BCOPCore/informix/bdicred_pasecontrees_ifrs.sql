CREATE PROCEDURE "informix".pasecontrees_ifrs(pempresa     CHAR(3),
                                        wfecha_captura   DATE,
                                       wfecha_valida   DATE,
                                       wifrs     CHAR(1),
                                        pusuario     CHAR(8),
   ...
   DEFINE wdescripcion_det              CHAR(60);
 ...
 ***************************************************************************}
   ...
   ON EXCEPTION SET sql_err, isam_err, error_info
      ...
      SET DEBUG FILE TO "pasecontrees.err";
  ...
  --SET DEBUG FILE TO "/ifxsif01/aldo/etapas/movdia_ifrs/pasecontrees.out";
  --TRACE ON;
   ...
   BEGIN WORK;
      LET wcod_ret = "000";
      LET wproceso = pproceso;  -- "PaseContRees";
...
--         END IF;
      ...
      LET wsecuenciadl = 1;
      LET wnro_auxiliar = " ";
      LET wdescripcion_det = "MOVTOS DE REESTRUC DEL DIA ";
