create procedure "informix".sp_validavencidos(pEmpresa char(3), pNumCredito char(20), pFechaConsulta Date)
...
--INICIALIZACION DE VARIABLES--
        ...
        IF pEmpresa IS NOT NULL AND TRIM(pEmpresa) <> '' AND pNumCredito IS NOT NULL AND TRIM(pNumCredito) <> '' AND pFechaConsulta IS NOT NULL THEN
            ...
            Execute procedure bdicred:sp_dias_vencido(pEmpresa, pNumCredito) into vCod_Ret, vStatus;
