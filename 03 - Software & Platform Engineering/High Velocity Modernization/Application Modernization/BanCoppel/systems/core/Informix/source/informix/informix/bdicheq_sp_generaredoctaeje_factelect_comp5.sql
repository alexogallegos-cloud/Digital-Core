CREATE PROCEDURE "informix".sp_generaredoctaeje_factelect_comp5( pEmpresa char(3) )
RETURNING CHAR(5);
    ...
    ON EXCEPTION SET vsqlerr, iIsamErr, cErrorInfo
        IF vsqlerr != 0 THEN
            SET DEBUG FILE TO "/resplogifx/conciliachq/edoctacfd/sp_generaredoctaeje_factelect_comp5.err";
            TRACE ON;
            LET vcodret = vsqlerr;
    ...
    END EXCEPTION;
     ...
     --SET DEBUG FILE TO '/RESPALDOSNEW/rsv/cfdi_4.0/produccion/sp_generaredoctaeje_factelect_comp5.txt';
	 --TRACE ON;
    ...
    -- // obtener la fecha en que se ejecutltima vez.
