CREATE PROCEDURE "informix".sp_insertactesitesp_pba(pEmpresa char(3), pSucursal char(4), pOrigen smallint, pNumCliente char(20), pSituacion char(1), pCausa smallint, pusuarioalta char(8),
