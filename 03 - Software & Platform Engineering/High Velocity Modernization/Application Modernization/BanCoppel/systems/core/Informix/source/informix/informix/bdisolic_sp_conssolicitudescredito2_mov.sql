CREATE PROCEDURE "informix".sp_conssolicitudescredito2_mov(pTipo INTEGER, pEmpresa CHAR(3), pSucursal CHAR(20),
            ...
            ELIF pTipo = 4 THEN
				...
				IF iConsSPMovil_6500 = 0 OR iConsSPMovil_6001 = 0 THEN
					...
					IF 0 = 2 THEN 					
						...
						FOREACH
							EXECUTE PROCEDURE "informix".envia_monitorsol_pp_ss_mov(pEmpresa,pSucursal,sinicio,pNumCte,	   pNum_producto,'OA',11,pFechaIni,pFechaFin)
								INTO  cValRetorno,s_Mensaje_Retorno,s_numsol,s_numcte,s_nombre,s_rfc,s_fechasol,
