CREATE PROCEDURE "informix".sp_validarpassword_bpi(pEmpresa char(3), pUsuario char(50), pPass char(50))
   returning char(5);

--Creador: Javier Calderón Zazueta
--Fecha: 08/12/09
  ...
  BEGIN
   ...
   END EXCEPTION ;
        ...
        ELSE
                ...
                LET cod_ret = '001';  -- Usuario y/o Contraseña incorrecta
