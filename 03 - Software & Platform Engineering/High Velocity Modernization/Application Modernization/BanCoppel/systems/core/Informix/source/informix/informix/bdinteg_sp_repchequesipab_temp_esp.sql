CREATE PROCEDURE "informix".sp_repchequesipab_temp_esp( pNumCliente  CHAR(20), 
                                                    pFechaIni    DATE, 
                                                    pFechaFin    DATE, 
...
RETURNING CHAR(5);
    ...
    DEFINE cRegFiscal, cOperArit, cTasaVar, cRangoFecha, cStatusCta, cStatusOrigen, cStatusActual CHAR(1);
    ...
    LET cRegFiscal = 'N'; LET cOperArit = NULL; LET cTasaVar  = ''; LET cRangoFecha  = ''; LET cStatusCta = ''; LET cStatusOrigen = ''; LET cStatusActual = '';
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, cDesErr
        SET DEBUG FILE TO '/resplogifx/conciliachq/ipab/sp_repchequesipab_temp_esp.err';
        TRACE ON;
        LET cCodRet  = iSqlErr;
    ...
    --- SET DEBUG FILE TO '/resplogifx/conciliachq/ipab/sp_repchequesipab_temp_esp.out';
    --- TRACE ON;
    ...
    FOREACH
        SELECT mae.cuenta, mae.producto, mae.sucursal, noc.fecha_alta, pro.nombre nombre_prod, pro.divisa moneda, pro.tasa, pro.paga_dividendo, mae.status_cta
          INTO cNumCuenta, cNumProducto, cSucursal, dtFecAlta, cproducto, cMoneda, ctasa, cTasaVar, cStatusActual
        ...
        UNION ALL
        SELECT mae.cuenta, mae.producto, mae.sucursal, mae.fecultdep, pro.nombre nombre_prod, pro.divisa moneda, pro.tasa, pro.paga_dividendo, mae.status_cta
          FROM bdicheq:sc_maechq mae,
               bdicheq:sc_maenoc noc,
               bdicheq:sc_producto pro
         WHERE mae.num_cte = pNumCliente
        ...
        IF dtFecAlta < pFechaIni THEN
            ...
            IF iAnioMes = 0 THEN
                ...
                EXECUTE PROCEDURE bdinteg:sp_capintafecha_status(cNumCuenta, pFechaIni) 
                INTO cCodRetSdos, mSdo_Ini, mInt_al_Inicio, cStatusOrigen;
        ...
        IF cStatusOrigen == cStatusActual THEN
        ...
        ELSE
            IF cStatusOrigen <> cStatusActual THEN
                IF cStatusOrigen == 6 THEN 
                    LET cNumProducto = 5000;
                    ...
                    mSdo_Prom_Ini, mInt_al_Inicio, dImp_Isr_Ini, iDiasProyec, mSdo_Fin, mSdo_Prom_Fin, mInt_Proyec, dImp_Isr_Fin, cStatusCta, cMotivoBloq );
               ELSE 
                    IF(substr(cNumCuenta,0,2) == 10) THEN
                    LET cNumproducto = 2000;
                    END IF;
