CREATE PROCEDURE "informix".sp_refclientes_cjunk_pros( sEmpresa CHAR(3),
                                                       cFuncion CHAR(1),
...
RETURNING CHAR(5), INTEGER;
    ...
    --- SET DEBUG FILE TO "/respaldosbd/Martha/sp_refclientes_cjunk_pros.out";
    --- TRACE ON;
    ...
    IF cFuncion = "A" THEN
        ...
        INSERT INTO pr_refclientes
        ( empresa, num_solicitud, numcte_pros, sucursal, secuencia, apell_paterno, apell_materno, nombre1, nombre2,
    ...
    ELIF cFuncion = "C" THEN
        ...
        UPDATE pr_refclientes 
           SET ( empresa,num_solicitud, numcte_pros, sucursal, apell_paterno, apell_materno, nombre1, nombre2,
                 rfc, fecha_nac, curp, sexo, estado_civil, nacionalidad, no_fm3, codidentifi, numidentifi, pers_domicilio,
                 email, parentesco, apellido_cas, numcte_ref, numcte_banco, user_insert, fecha_insert) =	
               ( sEmpresa, sNoSolicitud, sNumCte, sSucursal, sApellPaterno, sApellMaterno, sNombre1, sNombre2,
                 sRfc, dFechaNac, sCurp, sSexo, sEstadoCivil, sNacionalidad, sNoFm, sCodigoIden, sNumIdentif, sPersDomicilio,
                 sEmail, sParentesco, sApellCasada, sNumcteRef, sNumCteBanco, sUsuario, dFecha)
         WHERE numcte_pros = sNumCte 
           AND secuencia = pSecuenciaRef; 
