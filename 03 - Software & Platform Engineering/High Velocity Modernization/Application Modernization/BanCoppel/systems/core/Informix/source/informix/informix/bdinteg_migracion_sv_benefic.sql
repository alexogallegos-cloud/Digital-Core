CREATE PROCEDURE "informix".migracion_sv_benefic()
	RETURNING CHAR(6);
...
--SET DEBUG FILE TO '/respaldosbd/migracion_sv_benefic.out';
--TRACE ON;
	...
	BEGIN
        ...
        foreach with hold
            ...
            begin work;
                 UPDATE bdinvers:sv_benefic SET parentesco = vparentesco WHERE rowid = vrowid;
            commit work;
        end foreach;
