...
CREATE PROCEDURE "informix".sp_regordenctecte_pp(pEmpresa  CHAR(3),
                                                 pchrSucursal CHAR(4),
                                                 pchrUsuario CHAR(8),
                                                 pintBancoDest INTEGER,
                                                 pmnyImporte MONEY(14,2),
...
RETURNING CHAR(5), CHAR(100), CHAR(30);
	...
	--- SET DEBUG FILE TO '/resplogifx/conciliachq/spei/sp_regordenctecte_pp.out';
    --- TRACE ON;
	...
	IF CURRENT HOUR TO fraction > '17:58:00' AND CURRENT HOUR TO fraction < '18:30:00' THEN
		SELECT vchrvalor
		  INTO vchrparametro
		  FROM tblparametros
		  WHERE vchrcveparametro = 'BLOQUEO_A_USUARIOS';
