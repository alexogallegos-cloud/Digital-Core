CREATE PROCEDURE "informix".cambio_perfil(psucursal CHAR(4),pcod_usuario CHAR(8),ppass_ant CHAR(1),
...
BEGIN
	...
	INSERT INTO "informix".si_cambio_perf (sucursal,cod_usuario,password_ant,password_nuevo,perfil_ant,perfil_nuevo,user_autoriza,fecha_cambio,hora_cambio )
