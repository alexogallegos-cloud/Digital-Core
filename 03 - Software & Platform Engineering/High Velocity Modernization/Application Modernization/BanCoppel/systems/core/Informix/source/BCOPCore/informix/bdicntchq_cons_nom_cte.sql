...
RETURNING char(5),char(2), char(52),char(26), char(26),char(13),char(20), date, char(3), date, char(60);
...
begin
  ...
  -- TRACE ON;   
   ...
   SELECT cliente.tpo_persona, nvl(apell_paterno," "), nvl(apell_materno," "),
	...
	FOREACH
		EXECUTE PROCEDURE bdinteg:sp_consulta_correos('001',pnumcte,1,'1')
		INTO
   ...
   RETURN vcodret, vtpo_persona, vnomcte, vpaterno, vmaterno, vrfc, vcurp, vfecha_nacimiento,vnacionalidad,vfec_alta,vemail;
END
END procedure
;