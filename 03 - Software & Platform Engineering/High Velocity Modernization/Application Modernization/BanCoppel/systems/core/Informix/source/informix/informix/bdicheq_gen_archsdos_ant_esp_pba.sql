CREATE PROCEDURE "informix".gen_archsdos_ant_esp_pba( pFechaHoy DATE, pFechaAnt DATE )
RETURNING CHAR(5), CHAR(5), CHAR(50), INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err, desc_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/gen_archsdos_ant_esp_pba.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    SET DEBUG FILE TO "/resplogifx/conciliachq/gen_archsdos_ant_esp_pba.out";
    TRACE ON;
    ...
    IF vfecha_hoy = vpri_hab_mes THEN
        ...
        FOREACH WITH HOLD
            SELECT {+INDEX(sc_maechq_resp)}
                   FIRST 10 chq.cuenta, chq.sucursal, chq.sdo_dia_ant, chq.imp_chq_sbg, noc.int_acum, noc.acum_sdo_int,
