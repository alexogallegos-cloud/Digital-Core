CREATE PROCEDURE "informix".sp_notifica_resultados (
...
--  CONTROL DE CAMBIOS
	...
	--Fecha de creaci?n: 27/12/2021
	--Peticion: RQM 04 127 - IFRS
	--Modificado por: 
...
-- ****************************************************************************
    BEGIN
        ...
        --*						Debug del Procedure                     --*        
        --*****************************************************************
	    --SET DEBUG FILE TO '/tmp/sp_notifica_resultados.out';
		--TRACE ON;                                                     --*
...
-- ****************************************************************************	
		...
		FOREACH WITH HOLD
			...
			FROM bdimnsj:"informix".mnsj_notifica_resultados
			...
			INTO v_id_registro
			FROM bdimnsj:"informix".mnsj_notifica_resultados_hist
			WHERE id_registro > 0 
				AND fecha_envio IS NOT NULL;
			
			INSERT INTO bdimnsj:"informix".mnsj_notifica_resultados_hist VALUES (
