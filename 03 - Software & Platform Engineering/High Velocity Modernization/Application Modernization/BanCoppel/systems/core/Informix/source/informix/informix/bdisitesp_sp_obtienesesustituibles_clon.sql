CREATE PROCEDURE "informix".sp_obtienesesustituibles_clon(pEmpresa CHAR(3), pSE CHAR(1), pCausa SMALLINT, pAlcance SMALLINT, pRegistros INTEGER, pRecuperacion INTEGER)
        ...
        --checar valores nulos en los parametros
            ...
            ELSE
                ...
                ELSE
                    ...
                    FOREACH
                        SELECT {+ INDEX(se_catsitesp idx_catsitesp2)} SKIP pRegistros FIRST pRecuperacion a.sitsiguente, a.causasiguiente, b.descripcion
