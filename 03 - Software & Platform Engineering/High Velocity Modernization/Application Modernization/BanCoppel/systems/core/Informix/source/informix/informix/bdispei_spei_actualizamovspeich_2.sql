CREATE PROCEDURE "informix".spei_actualizamovspeich_2(pfechaejecuta_var varchar(15))
...
*/  --se comenta para prueba controlada
	...
	LET vestadoctrl = '0'; --se ejecuta para prueba controlada
  ...
  */
  ...
  LET vsql = 'echo "file /RESPALDOSNEW/SYSSPEI/DetSPEICH'||vfechaarch||'.txt delimiter ''|'' 19; INSERT INTO tblhistpagoactuali_temp;" > /RESPALDOSNEW/SYSSPEI/query.sql';
        SYSTEM vsql;
        
		LET vsql = ''; 
        LET vsql = 'dbload -d bdispei -c /RESPALDOSNEW/SYSSPEI/query.sql -l /RESPALDOSNEW/SYSSPEI/err_DetSPEICH'||vfechaarch||'.log -e 2500 -n 1000';
        SYSTEM vsql;
        LET vsql = ''; 
