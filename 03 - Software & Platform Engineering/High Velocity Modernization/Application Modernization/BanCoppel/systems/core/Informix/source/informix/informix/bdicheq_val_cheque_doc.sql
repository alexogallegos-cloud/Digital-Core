create procedure "informix".val_cheque_doc( pempresa   char(3), -- Empresa
...
begin
   ...
   --//Verifica que el cheque se encuentre activo ó presentado en ventanilla
