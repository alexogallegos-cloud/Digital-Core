create procedure "informix".sp_mf_consultamontotransacciones(p_dtfecha_ini DATETIME YEAR TO FRACTION, p_dtfecha_final DATETIME YEAR TO FRACTION, p_iMonto_ini INTEGER, p_iMonto_fin INTEGER, p_ValorInicial INT8)
RETURNING 
...
BEGIN
	...
	AND Monto BETWEEN p_iMonto_ini AND p_iMonto_fin;
	...
	FOREACH
		...
		FROM
			...
			WHERE fechahorainauth BETWEEN p_dtfecha_ini AND p_dtfecha_final AND b.Monto BETWEEN p_iMonto_ini AND p_iMonto_fin)
			)
...
END;
--##############################################################################
--## Procedimiento   : sp_mf_ConsultaMontoTransacciones
--## Base de datos   : intercard
--## Version         : 2.0
--## Creado por      : Mohamed Carreón 
--## Fecha creacion  : 25 de Agosto del 2009
