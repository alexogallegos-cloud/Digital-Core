CREATE PROCEDURE "informix".sp_synmotor_getlentotaltrama(sOperacion CHAR(5), sTipo CHAR(2))

RETURNING CHAR(5) As CodRet, INTEGER As LenTrama;

/**************************************************************************/
/* Fecha: 02/Abril/2018                                                   */
/* SPL: "informix".sp_synmotor_getlentotaltrama                           */
/* Actividad:                                                             */
