CREATE PROCEDURE "informix".sp_rep_pagosydisposiciones()
--   EXECUTE PROCEDURE "informix".sp_rep_pagosydisposiciones();
...
--    alter table sd_pagosydisposiciones type(RAW);
 ...
 Pago SBC                       6246         336        
 IdentificaciÃ³n canal internet  7100         337        
 DevoluciÃ³n INTERCARD           6813         904    
 */
        ...
        IF cSucursalTar IS NULL OR cNumCte IS NULL THEN
            LET cCodRet = '000001';
            LET cMensaje = 'No se encontrÃ³ crÃ©dito en Maestro de Clientes';
            RETURN cCodRet,cMensaje;
        ELSE
        ...
        IF fSdoActual IS NULL THEN
            LET cCodRet = '000002';
            LET cMensaje = 'No se encontrÃ³ crÃ©dito en Maestro de Saldos';
            RETURN cCodRet,cMensaje;
        ELSE
