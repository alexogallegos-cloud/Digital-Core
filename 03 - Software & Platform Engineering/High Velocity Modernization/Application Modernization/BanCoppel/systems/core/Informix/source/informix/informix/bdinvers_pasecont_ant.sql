create procedure "informix".pasecont_ant(pempresa char(3), pfecha_hoy date)
returning char(5);
    ...
    --- set debug file to "/pisa/pisabanco/pasecont_antinv.out";
    --- trace on;
    ...
    Foreach
        ...
        if vtotcar > 0 then
            ...
            values(vusuario,vfecha_hoy,vsecuencia,v_empresa,vccmayor,vccsub,vccsubsub,vccssubsub,vccsssubsub,vsector,vciudad,vsuccta,vauxiliar,"D",vtotcar,w_descripcion,vfecha_hoy,vmoneda,vsucursal);
        end if
        ...
        if vtotabo > 0 then
            ...
            insert into bdicont:co_poldet
            values(vusuario,vfecha_hoy,vsecuencia,v_empresa,vccmayor,vccsub,vccsubsub,vccssubsub,vccsssubsub,vsector,vciudad,vsuccta,vauxiliar,"C",vtotabo,w_descripcion,vfecha_hoy,vmoneda,vsucursal);
        end if
    ...
    if vmca_aplic = "1" then
        execute procedure bdicont:auditapase_ant(vfecha_hoy,v_empresa,vusuario)
        into cod_ret;
    end if
