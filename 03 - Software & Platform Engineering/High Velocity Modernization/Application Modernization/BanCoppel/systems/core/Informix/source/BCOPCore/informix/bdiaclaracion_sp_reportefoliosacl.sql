CREATE PROCEDURE "informix".sp_reportefoliosacl(pfolios varchar(250))
							...
							DATETIME YEAR TO FRACTION(5) as Fecha_afectacion_abono,
		...
		DEFINE vnumero_tarjeta		varchar(17);
		...
		DEFINE vfecha_afectacion	DATETIME YEAR TO FRACTION(5) ;
		...
		DEFINE vreferencia23		varchar(24);
				...
				NVL((
					Case when producto='TDC' and Naturaleza='POS' and tipo_fraude='CLONACION' then '1402 90 01 05 01 00' 
						 ...
						 ' ' as Evento_fraude, ' ' as Solicitud_a_fraudes, ' ' as Dias_vencidos, ' ' as Analista, ' ' as Fecha_respuesta_PF
								 ...
								 vmes_trx, vmes_afectacion, vcodgironeg,  vidretailer, vciudad_comercio,
								vmetodocaptura, vdescstatustarjeta, vfecha_afectacion, vnaturaleza, vtipo_fraude, vnombre_cliente, vnombreciudad, vinicialestado,  
								   vanio_trx, vreferencia23, vcuenta_contable	, vevento_fraude, vsolicitud_fraude,
						 ...
						 and w.numerociudad=v.numerociudad and a.folio_csuac is not null and a.fky_estatus_aclaracion =2 						 
