CREATE PROCEDURE "informix".consdetcred_web(f_empresa      CHAR(3),
...
-- ############################################################################
   ...
   ELSE
	...
	ELSE
                RETURN 
v_codret, r_nompromo, r_nomdiv, r_stcred, r_intvig,r_intven, r_intmor, r_capvig, r_capven , r_adetotal,r_fcuota;
	END IF
   END IF
