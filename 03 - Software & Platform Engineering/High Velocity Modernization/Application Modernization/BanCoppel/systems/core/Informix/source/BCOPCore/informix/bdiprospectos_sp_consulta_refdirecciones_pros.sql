CREATE PROCEDURE "informix".sp_consulta_refdirecciones_pros(
                                                            sNumCte       CHAR(20),
                                                            sSecuencia    INTEGER
                                                            )
...
--        SET DEBUG FILE TO "/tmp/sp_consulta_refdirecciones_pros.out";
--        TRACE ON;
...
BEGIN
    ...
    IF (sNumCte <> ' ' AND sNumCte IS NOT NULL) THEN
            ...
            SELECT numcte_pros, secuencia, tipo_dir, calle, colonia, entre_calles, pais, estado, ciudad, municipio, cod_postal, apart_postal, tipo_telef1, 
