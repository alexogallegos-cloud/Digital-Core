CREATE PROCEDURE "informix".sp_geninfsociodemotmp(pempresa CHAR(3))
...
RETURNING CHAR(5), CHAR(5), CHAR(50), INTEGER, INTEGER;
    ...
    ON EXCEPTION SET vsqlerr, visamerr
        SET debug file to "/resplogifx/conciliachq/sp_geninfsociodemotmp.err";
        TRACE ON;
        IF vsqlerr <> 0 THEN
    ...
    --- SET debug file to "/resplogifx/conciliachq/sp_geninfsociodemotmp.out";
    --- TRACE ON;
    ...
    CREATE TEMP TABLE sc_infsociodemocap_tmp
        (
    ...
    WITH NO LOG;
    CREATE INDEX idx_socdemcaptmp ON sc_infsociodemocap_tmp(numcte) USING BTREE;
    UPDATE STATISTICS MEDIUM FOR TABLE sc_infsociodemocap_tmp;
    ...
    FOREACH WITH HOLD
        ...
        FOREACH 
            ...
            -- // Inserta datos en tabla sc_infsociodemocap_tmp
            INSERT INTO sc_infsociodemocap_tmp 
