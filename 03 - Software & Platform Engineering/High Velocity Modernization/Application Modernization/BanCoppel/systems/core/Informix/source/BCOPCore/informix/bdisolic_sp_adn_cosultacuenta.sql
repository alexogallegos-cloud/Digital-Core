CREATE PROCEDURE "informix".sp_adn_cosultacuenta(pEmpresa CHAR(3), pNumCte CHAR(20), pCuenta CHAR (20))
		...
		IF NVL(cNumSol,'') <> '' THEN
       	/*	
			IF nvl(cstatus_cred,'')<>'FF' THEN
                LET cCodRet ='000005';		--indica que tiene un anticipo en tramite o vigente
			ELSE
