CREATE PROCEDURE "informix".sp_bcplr_integracion (vnombrearchivo		CHAR (35))
   ...
   */
   let vpaso = 1;
      FOREACH cursor1 WITH HOLD for
	   SELECT 	{+INDEX(mi_rcda_infocoppel_paso idx_infocoppel_paso_clave)}
				clave, num_solicitud,numcte ,suc_tienda, promotor, cliente_cand_club, compraClub, fechageneracion,fecha_apertura,	fecha_primercompra, nombre_cliente, ap_paterno, ap_materno, fecha_nacimiento, fecha_inser
