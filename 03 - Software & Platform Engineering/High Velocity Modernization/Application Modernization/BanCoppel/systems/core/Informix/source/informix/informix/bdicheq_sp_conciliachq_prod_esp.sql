CREATE PROCEDURE "informix".sp_conciliachq_prod_esp(pempresa CHAR(3), pfecha DATE, pproducto CHAR(4))
...
RETURNING CHAR(5), CHAR(5), INTEGER, INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/sp_conciliachq_prod_esp.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/sp_conciliachq_prod_esp.out";
    --- TRACE ON;
