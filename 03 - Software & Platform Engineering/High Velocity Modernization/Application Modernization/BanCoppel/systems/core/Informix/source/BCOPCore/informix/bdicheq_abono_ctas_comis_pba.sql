CREATE PROCEDURE "informix".abono_ctas_comis_pba(pempresa CHAR(3))
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/abono_ctas_comis.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/abono_ctas_comis.out";
    --- TRACE ON;
    ...
    LET vsql = 'echo "LOAD FROM /resplogifx/conciliachq/comisionesxabonar.unl DELIMITER ''","'' INSERT INTO ctasxabonar" > /resplogifx/conciliachq/ctasxabon.sql';
    SYSTEM vsql;
    LET vsql = '';
    ...
    FOREACH WITH HOLD
        SELECT tarjeta, monto, transacc, descripcion
