CREATE PROCEDURE "informix".sp_idetraspasomovtoshistoricocomp1_mod()
RETURNING CHAR(6)  AS codigo_retorno,
    ...
    ON EXCEPTION SET iSqlErr, iIsamErr, cErrorInfo
        SET DEBUG FILE TO '/resplogifx/conciliachq/sp_idetraspasomovtoshistoricocomp1.err';
        TRACE ON;
        LET cCodRet  = iSqlErr;
    ...
    --- SET DEBUG FILE TO '/home/sysifx/jesusm/costos/sp_idetraspasomovtoshistoricocomp1.out';
    --- TRACE ON;
