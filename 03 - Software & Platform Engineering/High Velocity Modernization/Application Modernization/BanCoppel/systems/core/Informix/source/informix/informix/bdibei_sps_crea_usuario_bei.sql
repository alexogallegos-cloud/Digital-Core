CREATE PROCEDURE "informix".sps_crea_usuario_bei(pNumCliente CHAR(9),pIdStatus SMALLINT,
pUsuario CHAR(50),pTipoUsuario SMALLINT ,pNombrePerfil CHAR(50),
  ...
  BEGIN
   ...
   END EXCEPTION ;
	...
	END IF;
				...
				(id_usuario,num_cliente,id_status,usuario_bei,f_status,f_registro,id_tipo_usuario) VALUES
				(0,pNumCliente,pIdStatus,pUsuario,CURRENT YEAR TO DAY,CURRENT YEAR TO DAY,pTipoUsuario );
