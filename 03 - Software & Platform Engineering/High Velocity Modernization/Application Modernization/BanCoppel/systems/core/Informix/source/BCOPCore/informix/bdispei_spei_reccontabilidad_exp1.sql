CREATE PROCEDURE "informix".spei_reccontabilidad_exp1(pctacontable CHAR(14),
                                                 pccorigen    CHAR(4),
                                                 pccdestino   CHAR(4),
...
RETURNING CHAR(5);
    ...
    ELSE
        ...
        -- // VALIDA QUE NO EXISTAN ORDENES EN STATUS N y T 
        SELECT COUNT(*) 
          INTO wpendientes 
          FROM bdispei:"informix".tblpago
         WHERE dtfechavalor= wfecha_hoy 
           AND chrestatusenvio IN('N','T');
        ...
        UPDATE STATISTICS MEDIUM FOR TABLE bdispei:"informix".tblpago;
        
        -- // DEPURA MOVIMIENTOS DE LA TABLA tbldetranpago A LA TABLA tblhistdetranpago
        CALL spei_depuratbldetranpago(wfecha_hoy)
        RETURNING vcodret5;
        
        UPDATE STATISTICS MEDIUM FOR TABLE bdispei:"informix".tbldetranpago;

		-- // ACTUALIZA PARAMETROS
        UPDATE bdispei:"informix".tblparametros
           SET vchrvalor = 0
         WHERE vchrcveparametro IN('FOLIO_OPCAJERO','FOLIO_BITACORA','FOLIO_PAGO','FOLIO_DEVOLUCION');
        ...
        -- // GENERA REPORTES DE MOVIMIENTOS DIARIOS
        EXECUTE PROCEDURE bdicheq:"informix".sp_rptmovsdiariospei(wchrempresa)
        INTO vcodretrpt1, vcodretrpt2, vcodretrpt3;
		
        EXECUTE PROCEDURE bdicheq:"informix".sp_rptmovsdiariospei_acuenta(wchrempresa)
        INTO vcodretrpt4, vcodretrpt5, vcodretrpt6;
