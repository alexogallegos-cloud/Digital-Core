CREATE PROCEDURE "informix".sp_ipab_comp1( pFechaIni DATE, pFechaFin DATE ) 
RETURNING CHAR(5), CHAR(5), CHAR(50);
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, cDesErr
        SET DEBUG FILE TO '/resplogifx/conciliachq/ipab/sp_ipab_comp1.err';
        TRACE ON;
        LET cCodRet  = iSqlErr;
    ...
    --- SET DEBUG FILE TO '/resplogifx/conciliachq/ipab/sp_ipab_comp1.out';
    --- TRACE ON;
    
    SET ISOLATION TO DIRTY READ;
    SET LOCK MODE TO WAIT 5;
    
    -- // DESACTIVA BANDERAS DE PROCESAMIENTO
    ...
    EXECUTE PROCEDURE sp_ipab_borratablas( '999999999' )
    INTO cCodRet4;
    
    IF cCodRet4 <> '000' THEN
        LET cCodRet  = '999';
        LET cCodRet2  = '999';
        LET cCodRet3  = 'ERROR EN LA CREACION DE LAS TABLAS DE TRABAJO';
        RETURN cCodRet, cCodRet2, cCodRet3;
    END IF;
    
    -- // OBTENCION DE CLIENTES A PROCESAR
    EXECUTE PROCEDURE sp_ipab_obtienectes( pFechaIni, '999999999' )
    INTO cCodRet5;
    
    IF cCodRet5 <> '000' THEN
        LET cCodRet  = '999';
        LET cCodRet2  = '999';
        LET cCodRet3  = 'ERROR EN EL PROCESO DE OBTENCION DE CLIENTES';
        RETURN cCodRet, cCodRet2, cCodRet3;
    END IF;
    
    -- // OBTENCION DE RANGOS DE CLIENTES
    EXECUTE PROCEDURE sp_ipab_rangoctes()
    INTO cCodRet5;
    
    IF cCodRet5 <> '000' THEN
        LET cCodRet  = '999';
        LET cCodRet2  = '999';
        LET cCodRet3  = 'ERROR EN EL PROCESO DE RANGOS DE CLIENTES';
        RETURN cCodRet, cCodRet2, cCodRet3;
    END IF;
    
    -- // ACTIVA BANDERA DE PROCESAMIENTO
    UPDATE si_contproc_ipab
       SET proceso = 1
     WHERE empresa = '001'
       AND cod_proceso = 0;
...
################################################## */
    ...
    WHILE ( iComp2 = 0  OR iComp3 = 0  OR iComp4 = 0  OR iComp5 = 0  OR iComp6 = 0  OR iComp7 = 0  OR iComp8 = 0  OR iComp9 = 0  OR iComp10 = 0 OR
            iComp11 = 0 OR iComp12 = 0 OR iComp13 = 0 OR iComp14 = 0 OR iComp15 = 0 OR iComp16 = 0 OR iComp17 = 0 OR iComp18 = 0 OR iComp19 = 0 OR iComp20 = 0 )
        SET ISOLATION TO DIRTY READ;
        
        SELECT proceso INTO iComp2  FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 2;
        SELECT proceso INTO iComp3  FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 3;
        SELECT proceso INTO iComp4  FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 4;
        SELECT proceso INTO iComp5  FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 5;
        SELECT proceso INTO iComp6  FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 6;
        SELECT proceso INTO iComp7  FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 7;
        SELECT proceso INTO iComp8  FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 8;
        SELECT proceso INTO iComp9  FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 9;
        SELECT proceso INTO iComp10 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 10;
        SELECT proceso INTO iComp11 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 11;
        SELECT proceso INTO iComp12 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 12;
        SELECT proceso INTO iComp13 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 13;
        SELECT proceso INTO iComp14 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 14;
        SELECT proceso INTO iComp15 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 15;
        SELECT proceso INTO iComp16 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 16;
        SELECT proceso INTO iComp17 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 17;
        SELECT proceso INTO iComp18 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 18;
        SELECT proceso INTO iComp19 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 19;
        SELECT proceso INTO iComp20 FROM si_contproc_ipab WHERE empresa = '001' AND cod_proceso = 20;
    END WHILE;
    
    UPDATE STATISTICS MEDIUM FOR TABLE si_infpertit_comp;
    UPDATE STATISTICS MEDIUM FOR TABLE si_infpattit_comp;
    UPDATE STATISTICS MEDIUM FOR TABLE si_ctaasotit_comp;
    UPDATE STATISTICS MEDIUM FOR TABLE si_infcrdtit_comp;
    UPDATE STATISTICS MEDIUM FOR TABLE si_crdasotit_comp;
    ...
    LET cArchivo1 = '01'||canio||cmes||cdia||'.137';
    LET cArchivo2 = '02'||canio||cmes||cdia||'.137';
    LET cArchivo3 = '03'||canio||cmes||cdia||'.137';
    LET cArchivo4 = '04'||canio||cmes||cdia||'.137';
    LET cArchivo5 = '05'||canio||cmes||cdia||'.137';
    LET cArchivo6 = '06'||canio||cmes||cdia||'.137';
    ...
    LET cSql = 'echo "UNLOAD TO ' || ("/resplogifx/conciliachq/ipab/"||TRIM(cArchivo1)) ||
               ...
               ' FROM si_infpertit_comp;" > /resplogifx/conciliachq/ipab/desc_ipab1.sql';
    SYSTEM cSql;
    ...
    LET cSql = 'echo "UNLOAD TO ' || ("/resplogifx/conciliachq/ipab/"||TRIM(cArchivo2)) ||
               ...
               ' FROM si_infpattit_comp;" > /resplogifx/conciliachq/ipab/desc_ipab2.sql';
    SYSTEM cSql;
    ...
    LET cSql = 'echo "UNLOAD TO ' || ("/resplogifx/conciliachq/ipab/"||TRIM(cArchivo3)) ||
               ...
               ' FROM si_ctaasotit_comp;" > /resplogifx/conciliachq/ipab/desc_ipab3.sql';
    SYSTEM cSql;
    ...
    LET cSql = 'echo "UNLOAD TO ' || ("/resplogifx/conciliachq/ipab/"||TRIM(cArchivo4)) ||
               ...
               ' FROM si_infcrdtit_comp;" > /resplogifx/conciliachq/ipab/desc_ipab4.sql';
    SYSTEM cSql;
    ...
    LET cSql = 'echo "UNLOAD TO ' || ("/resplogifx/conciliachq/ipab/"||TRIM(cArchivo5)) ||
               ...
               ' FROM si_crdasotit_comp;" > /resplogifx/conciliachq/ipab/desc_ipab5.sql';
    SYSTEM cSql;
    ...
    -- // MARCA BANDERA DE FIN DE PROCESO
    UPDATE si_contproc_ipab
       SET proceso = 1
     WHERE empresa = '001'
       AND cod_proceso = 1;
