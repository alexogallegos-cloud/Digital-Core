CREATE PROCEDURE "informix".sp_reporteprogramacion2(p_tiporeporte CHAR(2),p_numcte CHAR(20),p_cve_pago CHAR(2),p_fecha_inicio DATE,p_fecha_fin DATE,pRegistros INTEGER, pRecuperacion INTEGER)
	...
	--SET DEBUG FILE TO '/tmp/mfinis/sp_reporteprogramacion2.out';
    --TRACE ON;
					...
					--Se valida que existan pagos para ese rango de fechas para ese cliente y para esa clave de pago
						IF EXISTS(SELECT  descripcion  FROM bdiprog:pp_pagoprog  WHERE num_cte = p_numcte  AND cve_pago = p_cve_pago) THEN
							...
							IF v_sBandera = '2110' THEN
								FOREACH
									SELECT SKIP pRegistros FIRST pRecuperacion b.fecha_insert,b.fecha_aplic,a.cuenta_origen,a.cuenta_destino,a.importe,a.cve_pago,b.consecutivo
