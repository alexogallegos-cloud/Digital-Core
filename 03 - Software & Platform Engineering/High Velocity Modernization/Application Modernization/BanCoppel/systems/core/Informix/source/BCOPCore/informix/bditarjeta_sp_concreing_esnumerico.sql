CREATE PROCEDURE "informix".sp_concreing_esnumerico ( psCadena CHAR (20))

RETURNING CHAR (1) AS Numerico ;

--****************************************************************************************************
-- DESCRIPCION:  SP CLONADO QUE VERIFICA QUE LA CADENA DE ENTRADA SOLAMENTE CONTENGA NUMEROS
-- AUTOR : Casanova Edeza Hector Juan // CLONADOR ALFONSO CRUZ
-- FECHA : 20/06/2011
-- BD: bditarjeta
...
END PROCEDURE
DOCUMENT
'AUTOR: Casanova Edeza Hector Juan // CLONADOR ING ALFONSO CRUZ',
...
CREATE PROCEDURE "informix".sp_concreing_guardabitacora(
	psElemento INTEGER,
	...
	*/
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/home/sysifx/concreing/TraceGUARDABITACORA.sql';
		--SET DEBUG FILE TO '/tmp/conciliacion/TraceGUARDABITACORA.txt';
		--TRACE ON;
		...
		INSERT INTO bditarjeta:"informix".td_bitacora_conciliacion (elemento, fecha_hora, actividad, cve_usuario)
		VALUES (psElemento,(SELECT DBINFO('utc_to_datetime', Sh_Curtime)::DATETIME YEAR TO FRACTION(5) FROM SysMaster:"informix".Sysshmvals),psActividad,psCve_usuario);
