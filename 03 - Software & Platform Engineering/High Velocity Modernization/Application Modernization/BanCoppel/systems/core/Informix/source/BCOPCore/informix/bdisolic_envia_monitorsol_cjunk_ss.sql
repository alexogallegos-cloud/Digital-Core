...
-- COMENTARIOS: Se modifica para que muestre las solicitud de Credito 
--              BanCoppel y las de Credito Coppel
-------------------------------------------------------------------------------
-- FECHA: 2010/02/09
...
-- COMENTARIOS: Se modifica para realizar la homologacion del procedimiento con la version envia_monitorsol.
...
END EXCEPTION;
  ...
  --SET DEBUG FILE TO "/informix/envia_monitorsol_cjunk_ss.out";
  --TRACE ON;
