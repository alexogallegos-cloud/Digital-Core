create procedure "informix".reoaux(
             detauxiliar char(12),
             detsucursal char(4),
             detciudad   char(3),
             detmayor    char(10),
...
--inicializa variables
   ...
   let polinro_auxiliar = detauxiliar;
   let pol1nro_auxiliar = de1auxiliar;
   ...
   let polidescripcion = "reubicacion de auxiliar ";
   let pol1descripcion = "reubicacion de auxiliar ";
