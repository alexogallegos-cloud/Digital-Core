CREATE PROCEDURE "informix".sp_entrada_salida2(eEmpresa    CHAR(3),
                                              eTipo       CHAR(1), 
                                              eSucursal   CHAR(4),
                                              ePlaza      CHAR(3),
                                              eFecInicio  DATE,
...
SET ISOLATION TO DIRTY READ;
  ...
  IF ePlaza <> '000' AND eSucursal = '0000' AND eStatus = '00'  THEN
                FOREACH
                          SELECT {+ INDEX(bdisuc:ss_operaciones idx01ss_operaciones)} SKIP eRegistros FIRST eRecuperacion b.folio_oper,b.sucursal,b.folio_sucursal,b.fecha_solicitud,b.usuario_solicitud,
