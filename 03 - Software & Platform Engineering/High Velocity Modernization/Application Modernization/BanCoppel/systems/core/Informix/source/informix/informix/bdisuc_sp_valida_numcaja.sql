CREATE PROCEDURE "informix".sp_valida_numcaja(pEmpresa CHAR(3),
											  pSucursal CHAR(4),
											  pNumeroCaja CHAR(10)) 
--DATOS A REGRESAR---												 
	RETURNING
...
'cCodRet = 001308 Parametros de entrada invalidos.',
'cCodRet = 001309 No se encontro informacion para la consultas realizada.',
'cCodRet = 001310 No se puede crear caja, ya existe una.',
'Folio: 1759',
'Autor: 95975071 Jairo Valdez Gonzalez',
'Fecha: 23/10/2015',
'Modificación: Se crea procedimiento almacenado para validar si la caja anterior se encuentra activa y vacia.',
