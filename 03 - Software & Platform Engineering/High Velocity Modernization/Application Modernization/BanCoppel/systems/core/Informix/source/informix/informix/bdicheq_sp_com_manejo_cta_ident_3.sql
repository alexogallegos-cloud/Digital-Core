CREATE PROCEDURE "informix".sp_com_manejo_cta_ident_3()
...
-- *****************************************************************************
    ...
    ON EXCEPTION SET vSQLErr, vIsamErr, vErrorInfo
        IF  vSQLErr != 0 THEN
            SET DEBUG FILE TO '/resplogifx/conciliachq/sp_com_manejo_cta_ident_3.err';
            TRACE ON;
            LET vCodRet     = vSQLErr;
    ...
    --SET DEBUG FILE TO '/resplogifx/conciliachq/sp_com_manejo_cta_ident_3.out';
    --TRACE ON;
