CREATE PROCEDURE "informix".sp_conciladm_carga_archivoseglo(pempresa char(3),psFechaconciliacion DATE)
...
BEGIN
    ...
    DELETE FROM intercard:conciladm_archegloposacum WHERE fecha_mov < vfecha_depura OR fecha_mov = psFechaconciliacion;
    DELETE FROM intercard:conciladm_sifegloposacum WHERE fecha_mov < vfecha_depura OR fecha_mov = psFechaconciliacion;
