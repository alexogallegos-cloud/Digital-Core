CREATE PROCEDURE "informix".sp_refclientes_cjunk_cps(
												sEmpresa CHAR(3),
												cFuncion CHAR(1),
...
--DOCUMENTACION:
--RealizÃ³: Martha Aguirre
--Fecha: 31/01/2009
--Funcionalidad: Inserta en la tabla si_refclientes
-- las referencias de los clientes solicitantes de CrÃ©dito

--Modifico: Daniela Ramirez
--Fecha: 13/06/2011
--ModificaciÃ³n: se agrega parametro de secuencia.
