CREATE PROCEDURE "informix".sp_com_manejo_cta_cobro_5()
...
BEGIN
    ON EXCEPTION SET vSQLErr, vIsamErr, vErrorInfo
        IF  vSQLErr != 0 THEN
            SET DEBUG FILE TO '/resplogifx/conciliachq/sp_com_manejo_cta_cobro_5.err';
            TRACE ON;
            LET vCodRet     = vSQLErr;
    ...
    --SET DEBUG FILE TO "/resplogifx/conciliachq/sp_com_manejo_cta_cobro_5.out";
    --TRACE ON;
    ...
    CREATE INDEX idx_tmp_ctas_pendientes_5 ON tmp_ctas_pendientes ( cuenta )
        USING BTREE;
