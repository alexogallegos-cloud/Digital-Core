CREATE PROCEDURE "informix".sp_bancosdom_web(iRegOmitidos SMALLINT)
RETURNING
...
DOCUMENT
'Autor		: Armida Pazos',
'DescripciÃ³n: Obtiene los bancos para pago domiciliado.',
'Fecha		: 2010/02/03',
'VersÃ³n		: 20100203.1230',
'BD         : bdidomi';

CREATE PROCEDURE "informix".sp_tarjetascreditodomi_web(cEmpresa CHAR(3), cNumcte CHAR(9), iRegistrosOmitidos SMALLINT)
	RETURNING	CHAR  (5) AS Retorno,--Codigo de Retorno
				CHAR (20) AS NumTarjeta, --NÃºmero de tarjeta
...
--Inicializar Variables
	...
	BEGIN
			...
			IF iContador = 0 THEN
				LET cCodret = '00002'; --No hay tarjetas del cliente
				RETURN cCodret, cNumTarjeta, cNumCredito;
			END IF;
...
DOCUMENT
'Autor		: Armida Pazos',
'DescripciÃ³n: Carga las tarjetas de crÃ©dito que pertenezcan al cliente.',
'Fecha		: 2010/02/02',
'VersÃ³n		: 20100219.1656',
'BD         : bdidomi';

CREATE PROCEDURE "informix".sp_tiposcuentasdomi_web(iRegOmitidos SMALLINT)
RETURNING
	CHAR (5) AS Retorno,	--Codigo de retorno
...
DOCUMENT
'Autor		: Armida Pazos',
'DescripciÃ³n: Carga el tipo de cuentas para el pago domiciliado.',
'Fecha		: 2010/02/02',
'VersÃ³n		: 20100202.1850',
'BD         : bdidomi';
