CREATE PROCEDURE "informix".sp_grabaremail_bei (pEmpresa CHAR(3), pNumCte CHAR(20), pEMail CHAR(60))
    RETURNING CHAR(6), CHAR(80);
 
    --Autor: Manuel Ramos Figueroa
    --Fecha: 22-07-2011
    --Descripción: Guarda el email en la tabla si_ctepf.
   ...
   --TRACE ON;
    ...
    BEGIN
		...
		--UPDATE bdinteg:"informix".si_ctepm SET emailpm = pEMail WHERE numcte = pNumCte and empresa = pEmpresa;
		IF (pEMail <> '') THEN
