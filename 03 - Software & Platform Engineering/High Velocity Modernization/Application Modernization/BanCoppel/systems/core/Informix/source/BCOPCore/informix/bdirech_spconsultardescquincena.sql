CREATE PROCEDURE "informix".spconsultardescquincena (p_sNumEmpleado CHAR(8), p_sNumSucursal CHAR(4), p_dFechaDescuento DATE)
...
DEFINE v_mDescAplicado		MONEY(10,2);
 ...
 --****************************************************************
	...
	BEGIN
		...
		FOREACH
		    SELECT numempleado, numsucursal, sueldoquincena, desccalculado, descaplicado INTO v_sEmpleado, v_sSucursal, 
