CREATE PROCEDURE "informix".sp_actualiza_usuario_bei_historico(pNumCliente CHAR(9),
                                                            pIdUsuario INTEGER,
                                                            pPass CHAR(250),
                                                            pNombre CHAR(150),
                                                            pTelCel CHAR(15),
...
RETURNING CHAR(5);
    ...
    -- NOTA: Se clona sp sp_actualiza_usuario_bei para el requerimiento de bitacora de administradores
    -- AUTOR: Solser
    -- FECHA: 05/06/2018
