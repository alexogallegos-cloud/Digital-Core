...
'MODIFICO: Daniel Reyes Guillen 18/08/2021 se cambia el retorno 1001 por 00017',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_dic_eliminabitadicta(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumEmp CHAR(8),pNumcte CHAR(20))
	RETURNING CHAR(5) AS codret;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_dic_eliminabitadicta.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pNumEmp = '' OR pNumcte = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;		
		...
		SELECT MAX(fecha_insert) INTO dFecha FROM bdinteg:"informix".si_bitacora_dictamenes WHERE numcte = TRIM(pNumCte);
		
		DELETE 
		FROM bdinteg:"informix".si_bitacora_dictamenes
		WHERE NVL(TRIM(numcte_coinc),'0') = '0' and fecha_insert <> dFecha and numemp <> pNumEmp and numcte = TRIM(pNumCte);
...
'FECHA: 07/09/2021',
'MODULO: CLIENTES ',
'FUNCIONALIDAD: MONITOR ALERTAS', 
'DESCRIPCION: SPL encargado de eliminar los registros basura de la tabla si_bitacora_dictamenes',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_actualizacatczb_rh(pUsuario CHAR(8), pIdFuncion CHAR(10), pCzb_clave_a CHAR(4), 
	pCzb_nombre_a CHAR(40), pNoempleado_czb_a CHAR(20),pNombre_czb_a CHAR(80),pNocelular_czb_a CHAR(13),pEmail_czb_a CHAR(80),pCentrocosto_czb_a CHAR(8),pCzb_clave CHAR(4), 
	pCzb_nombre CHAR(40), pNoempleado_czb CHAR(20),pNombre_czb CHAR(80),pNocelular_czb CHAR(13),pEmail_czb CHAR(80),pCentrocosto_czb CHAR(8))
	RETURNING CHAR(5) AS codret;
	
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;	
	DEFINE cCzb_clave CHAR(4);
	DEFINE cCzb_nombre CHAR(40);
	DEFINE cNo_empleado_czb CHAR(20);
	DEFINE cNombre_czb CHAR(80);
	DEFINE cNo_celular_czb CHAR(13);
	DEFINE cE_mail_czb CHAR(80);
	DEFINE cCentro_costo_czb CHAR(8);
	...
	LET cCzb_clave ='';
	LET cCzb_nombre ='';
	LET cNo_empleado_czb ='';
	LET cNombre_czb ='';
	LET cNo_celular_czb ='';
	LET cE_mail_czb ='';
	LET cCentro_costo_czb ='';
	LET iTotal = 0;
	...
	BEGIN
		...
		IF pUsuario = '' OR pIdFuncion = '' OR pCzb_clave ='' OR pCzb_nombre ='' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_actualizacatgcb_rh.out';
		 --TRACE ON;
		...
		SELECT COUNT(*)
		INTO iTotal
		FROM bdinteg:"informix".si_catgcbczb_rh
		WHERE TRIM(czb_clave)=TRIM(pCzb_clave_a);
		
		IF (iTotal > 0) THEN 
		IF (pCzb_clave_a <> pCzb_clave)THEN
			SELECT czb_clave, czb_nombre, no_empleado_czb, nombre_czb, no_celular_czb, e_mail_czb, centro_costo_czb
			INTO cCzb_clave,cCzb_nombre,cNo_empleado_czb,cNombre_czb,cNo_celular_czb,cE_mail_czb,cCentro_costo_czb
			FROM bdinteg:"informix".si_catgcbczb_rh
			WHERE TRIM(czb_clave)=TRIM(pCzb_clave);

			IF (cCzb_clave = pCzb_clave) THEN
				LET cCodRet = '01264';
			ELSE
				UPDATE bdinteg:"informix".si_catgcbczb_rh SET  
				czb_clave = pCzb_clave, 
				czb_nombre = pCzb_nombre,
				no_empleado_czb=pNoempleado_czb,
				nombre_czb=pNombre_czb,
				no_celular_czb=pNocelular_czb,
				e_mail_czb=pEmail_czb,
				centro_costo_czb=pCentrocosto_czb
                WHERE TRIM(czb_clave)=TRIM(pCzb_clave_a)
                AND TRIM(czb_nombre) = TRIM(pCzb_nombre_a)
                AND TRIM(no_empleado_czb) = TRIM(pNoempleado_czb_a)
                AND TRIM(nombre_czb)=TRIM(pNombre_czb_a)
                AND TRIM(no_celular_czb)= TRIM(pNocelular_czb_a)
                AND TRIM(e_mail_czb)=TRIM(pEmail_czb_a)
                AND TRIM(centro_costo_czb) = TRIM(pCentrocosto_czb_a);
			END IF;
            ELSE
          UPDATE bdinteg:"informix".si_catgcbczb_rh SET  
				czb_nombre = pCzb_nombre,
		...
		ELSE
            ...
            LET pCzb_clave_a = pCzb_clave_a;
            LET pCzb_clave = pCzb_clave;
        	SELECT czb_clave, czb_nombre, no_empleado_czb, nombre_czb, no_celular_czb, e_mail_czb, centro_costo_czb
			INTO cCzb_clave,cCzb_nombre,cNo_empleado_czb,cNombre_czb,cNo_celular_czb,cE_mail_czb,cCentro_costo_czb
			FROM bdinteg:"informix".si_catgcbczb_rh
			WHERE TRIM(czb_clave)=TRIM(pCzb_clave);
			...
			IF (cCzb_clave = pCzb_clave) THEN
				LET cCodRet = '01264';
			ELSE
			INSERT INTO bdinteg:"informix".si_catgcbczb_rh (czb_clave, czb_nombre, no_empleado_czb, nombre_czb, no_celular_czb, e_mail_czb, centro_costo_czb)
			VALUES (pCzb_clave,pCzb_nombre,pNoempleado_czb,pNombre_czb,pNocelular_czb,pEmail_czb,pCentrocosto_czb);
            END IF;
		END IF;
...
'MODULO: ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: INSERTA O ACTUALIZA LOS VALORES DE LA TABLA si_catgcbczb_rh',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_actualizacatgcb_rh(pUsuario CHAR(8), pIdFuncion CHAR(10),pCvegerencia_a CHAR(4), 
	pNombregerencia_a CHAR(40), pNoempleado_a CHAR(20),pNombreemp_a CHAR(80),pNocelular_a CHAR(13),pEmail_a CHAR(80),pCentro_costo_a CHAR(8), pCvegerencia CHAR(4), 
	pNombregerencia CHAR(40), pNoempleado CHAR(20),pNombreemp CHAR(80),pNocelular CHAR(13),pEmail CHAR(80),pCentro_costo CHAR(8))
	RETURNING CHAR(5) AS codret;
	
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;	
	DEFINE cCve_gerencia CHAR(4);
	DEFINE cNombre_gerencia CHAR(40);
	DEFINE cNo_empleado CHAR(20);
	DEFINE cNombre_emp CHAR(80);
	DEFINE cNo_celular CHAR(13);
	DEFINE cEmail CHAR(80);
	DEFINE cCentro_costo CHAR(8);
	DEFINE iTotal INTEGER;
	
	LET cCodRet = '00000';
	LET iSqlErr = 0;	
	LET cCve_gerencia ='';
	LET cNombre_gerencia ='';
	LET cNo_empleado ='';
	LET cNombre_emp ='';
	LET cNo_celular ='';
	LET cEmail ='';
	...
	BEGIN
		...
		SELECT COUNT(*)
		INTO iTotal
		FROM bdinteg:"informix".si_catgcb_rh
		WHERE TRIM(gc_cve_gerencia)=TRIM(pCvegerencia_a);
		
		IF (iTotal > 0) THEN 
		   IF (pCvegerencia_a <> pCvegerencia)THEN
			SELECT gc_cve_gerencia, gc_nombre_gerencia, no_empleado_gcb, nombre_emp_gcb, no_celular_gcb, e_mail_gcb, centro_costo
			INTO cCve_gerencia,cNombre_gerencia,cNo_empleado,cNombre_emp,cNo_celular,cEmail,cCentro_costo
			FROM bdinteg:"informix".si_catgcb_rh
			WHERE TRIM(gc_cve_gerencia)=TRIM(pCvegerencia);
           
			IF (cCve_gerencia = pCvegerencia) THEN
				LET cCodRet = '01264';
			ELSE
				UPDATE bdinteg:"informix".si_catgcb_rh SET  
				gc_cve_gerencia = pCvegerencia, 
				gc_nombre_gerencia = pNombregerencia,
				no_empleado_gcb=pNoempleado,
				nombre_emp_gcb=pNombreemp,
				no_celular_gcb=pNocelular,
				e_mail_gcb=pEmail,
				centro_costo=pCentro_costo
               WHERE TRIM(gc_cve_gerencia)=TRIM(pCvegerencia_a)
               AND TRIM (gc_nombre_gerencia)= TRIM(pNombregerencia_a)
              AND TRIM (no_empleado_gcb)= TRIM(pNoempleado_a)
                 AND TRIM (nombre_emp_gcb)= TRIM(pNombreemp_a)
                     AND TRIM (no_celular_gcb)= TRIM(pNocelular_a)
                 AND TRIM (e_mail_gcb)= TRIM(pEmail_a)
                AND TRIM (centro_costo)= TRIM(pCentro_costo_a);
        ...
        LEt pCvegerencia_a = pCvegerencia_a;
        LEt pCvegerencia = pCvegerencia;
        ...
        SELECT gc_cve_gerencia, gc_nombre_gerencia, no_empleado_gcb, nombre_emp_gcb, no_celular_gcb, e_mail_gcb, centro_costo
			...
			IF (cCve_gerencia = pCvegerencia) THEN
				LET cCodRet = '01264';
			ELSE
			INSERT INTO bdinteg:"informix".si_catgcb_rh (gc_cve_gerencia, gc_nombre_gerencia, no_empleado_gcb, nombre_emp_gcb, no_celular_gcb, e_mail_gcb, centro_costo)
			VALUES (pCvegerencia,pNombregerencia,pNoempleado,pNombreemp,pNocelular,pEmail,pCentro_costo);
            END IF;
		END IF;
...
'MODULO: ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: INSERTA O ACTUALIZA LOS VALORES DE LA TABLA si_catgcb_rh',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_actualizaclasificacion_gcb(pUsuario CHAR(8), pIdFuncion CHAR(10),pCve_clasificacion_a CHAR(3), pClasificacion_a CHAR(40) ,pCve_clasificacion CHAR(3), pClasificacion CHAR(40))
	RETURNING CHAR(5) AS codret;
	
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;	
	DEFINE cCve_clasificacion CHAR(3);
	DEFINE cClasificacion CHAR(40);
	DEFINE iTotal INTEGER;
	
	LET cCodRet = '00000';
	LET iSqlErr = 0;	
	LET cCve_clasificacion='';
	LET cClasificacion ='';
	LET iTotal = 0;
	...
	BEGIN
		...
		IF pUsuario = '' OR pIdFuncion = '' OR pCve_clasificacion ='' OR pClasificacion ='' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_actualizaclasificacion_gcb.out';
		 --TRACE ON;
		...
		SELECT COUNT(*)
		INTO iTotal
		FROM bdinteg:"informix".si_clasificacion_gcb
	    WHERE TRIM(cve_clasificacion)=TRIM(pCve_clasificacion_a);
		IF (iTotal > 0) THEN 
			IF (pCve_clasificacion_a <> pCve_clasificacion)THEN
			SELECT cve_clasificacion,clasificacion
			INTO cCve_clasificacion,cClasificacion
			FROM bdinteg:"informix".si_clasificacion_gcb
			WHERE TRIM(cve_clasificacion)=TRIM(pCve_clasificacion);
			
			IF (cCve_clasificacion = pCve_clasificacion) THEN
				LET cCodRet = '01264';
			ELSE
				UPDATE bdinteg:"informix".si_clasificacion_gcb SET  
				cve_clasificacion = pCve_clasificacion, 
				clasificacion = pClasificacion
                WHERE TRIM(cve_clasificacion)=TRIM(pCve_clasificacion_a) AND TRIM(clasificacion)=TRIM(pClasificacion_a);
			END IF;
             ELSE
            	UPDATE bdinteg:"informix".si_clasificacion_gcb SET  
				clasificacion = pClasificacion
            ...
            END IF;
		ELSE
            LET pCve_clasificacion = pCve_clasificacion;
            LEt pClasificacion_a = pClasificacion_a;
             SELECT cve_clasificacion,clasificacion
			INTO cCve_clasificacion,cClasificacion
			FROM bdinteg:"informix".si_clasificacion_gcb
			WHERE TRIM(cve_clasificacion)=TRIM(pCve_clasificacion);
			...
			IF (cCve_clasificacion = pCve_clasificacion) THEN
				LET cCodRet = '01264';
			ELSE
			INSERT INTO bdinteg:"informix".si_clasificacion_gcb (cve_clasificacion,clasificacion)
			VALUES (pCve_clasificacion,pClasificacion);
            END IF;
		END IF;
...
'MODULO: ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: INSERTA O ACTUALIZA LOS VALORES DE LA TABLA si_clasificacion_gcb',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_actualizaformato_gcb(pUsuario CHAR(8), pIdFuncion CHAR(10),pCve_formato_a CHAR(3), pFormato_a CHAR(40), pCve_formato CHAR(3), pFormato CHAR(40))
	RETURNING CHAR(5) AS codret;
	
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;	
	DEFINE cCve_formato CHAR(3);
	DEFINE cFormato CHAR(40);
	DEFINE iTotal INTEGER;
	...
	BEGIN
		...
		IF pUsuario = '' OR pIdFuncion = '' OR pCve_formato ='' OR pFormato ='' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_actualizaformato_gcb.out';
		 --TRACE ON;
		...
		SELECT COUNT(*)
		INTO iTotal
		FROM bdinteg:"informix".si_formato_gcb
		WHERE TRIM(cve_formato)=TRIM(pCve_formato_a);
		
		IF (iTotal > 0) THEN 
		IF (pCve_formato_a <> pCve_formato)THEN
			SELECT cve_formato,formato
			INTO cCve_formato,cFormato
			FROM bdinteg:"informix".si_formato_gcb
			WHERE TRIM(cve_formato)=TRIM(pCve_formato);
			
			IF (cCve_formato = pCve_formato) THEN
				LET cCodRet = '01264';
			ELSE
				UPDATE bdinteg:"informix".si_formato_gcb SET  
				cve_formato = pCve_formato, 
				formato = pFormato
                WHERE TRIM(cve_formato)=TRIM(pCve_formato_a) AND TRIM(formato)=TRIM(pFormato_a);
			END IF;
            ELSE
            UPDATE bdinteg:"informix".si_formato_gcb SET  
				formato = pFormato
            ...
            END IF;
		ELSE
            LET pCve_formato_a = pCve_formato_a;
            LET pCve_formato = pCve_formato;
            SELECT cve_formato,formato
			INTO cCve_formato,cFormato
			FROM bdinteg:"informix".si_formato_gcb
			WHERE TRIM(cve_formato)=TRIM(pCve_formato);
			...
			IF (cCve_formato = pCve_formato) THEN
				LET cCodRet = '01264';
			ELSE
			INSERT INTO bdinteg:"informix".si_formato_gcb (cve_formato,formato)
			VALUES (pCve_formato,pFormato);
            END IF;
		END IF;
...
'MODULO: ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: INSERTA O ACTUALIZA LOS VALORES DE LA TABLA si_formato_gcb',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_actualizasucursal(pUsuario CHAR(8), pIdFuncion CHAR(10), pIdSucursal_a CHAR(4), pIdSucursal CHAR(4),
	pNomSucur CHAR(40),	pFormato CHAR(40), pTipo CHAR(3), pTipologia CHAR(40),pFechaAp DATE,pCalle CHAR(100), pNumExt CHAR(6),pNumInt CHAR(5),pEntreCalle CHAR(100), 
	pColonia CHAR(100), pCveMun CHAR(3), pMun CHAR(60), pCveEst CHAR(2), pEst CHAR(30),pCP CHAR(5), pEstDom CHAR(1), pTelSuc CHAR(14),pLatitud CHAR(10),pLongitud CHAR(11),
	pZonaHoraria CHAR(20), pSerLun CHAR(1), pSerMar CHAR(1), pSerMie CHAR(1), pSerJue CHAR(1), pSerVie CHAR(1), pSerSab CHAR(1), pSerDom CHAR(1),
	pLunAp DATETIME YEAR to SECOND, pLunCi DATETIME YEAR to SECOND, pMarAp DATETIME YEAR to SECOND, pMarCi DATETIME YEAR to SECOND, pMieAp DATETIME YEAR to SECOND, 
	pMieCi DATETIME YEAR to SECOND, pJueAp DATETIME YEAR to SECOND, pJueCi DATETIME YEAR to SECOND, pVieAp DATETIME YEAR to SECOND, pVieCi DATETIME YEAR to SECOND, 
	pSabAp DATETIME YEAR to SECOND, pSabCi DATETIME YEAR to SECOND, pDomAp DATETIME YEAR to SECOND, pDomCi DATETIME YEAR to SECOND, pClasificacion CHAR(40),
	pCveSucEje CHAR(40), pM2 FLOAT, pNumVent INTEGER, pNumEsc INTEGER, pNumATM INTEGER, pZonaEco CHAR(30),pCveGer CHAR(4),pZbcve CHAR(4))
	RETURNING CHAR(5) AS codret;
	...
	DEFINE iTotal INTEGER;
    DEFINE bEstDom BOOLEAN;
    DEFINE bSerLun BOOLEAN;
    DEFINE bSerMar BOOLEAN;
    DEFINE bSerMie BOOLEAN;
    DEFINE bSerJue BOOLEAN;
    DEFINE bSerVie BOOLEAN;
    DEFINE bSerSab BOOLEAN;
	DEFINE bSerDom BOOLEAN;
	...
	BEGIN
		...
		END EXCEPTION;
         ...
         --SET DEBUG FILE TO '/tmp/mfinis/sp_actualizasucursalA.out';
		 --TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pIdSucursal_a='' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
 ...
 LET pSabAp = pSabAp;
  ...
  IF pLunAp = '1900-01-01 00:00:00' THEN
          LET pLunAp = null;
        END IF;
        
         IF pLunCi = '1900-01-01 00:00:00' THEN
          LET pLunCi = null;
        END IF;

         IF pMarAp = '1900-01-01 00:00:00' THEN
          LET pMarAp = null;
        END IF;
        
         IF pMarCi = '1900-01-01 00:00:00' THEN
          LET pMarCi = null;
        END IF;

         IF pMieAp = '1900-01-01 00:00:00' THEN
          LET pMieAp = null;
        END IF;
        
         IF pMieCi = '1900-01-01 00:00:00' THEN
          LET pMieCi = null;
        END IF;
        
         IF pJueAp = '1900-01-01 00:00:00' THEN
          LET pJueAp = null;
        END IF;
        
         IF pJueCi = '1900-01-01 00:00:00' THEN
          LET pJueCi = null;
        END IF;

         IF pVieAp = '1900-01-01 00:00:00' THEN
          LET pVieAp = null;
        END IF;
        
         IF pVieCi = '1900-01-01 00:00:00' THEN
          LET pVieCi = null;
        END IF;
        
         IF pSabAp = '1900-01-01 00:00:00' THEN
          LET pSabAp = null;
        END IF;
        
         IF pSabCi = '1900-01-01 00:00:00' THEN
          LET pSabCi = null;
        END IF;

        IF pDomAp = '1900-01-01 00:00:00' THEN
          LET pDomAp = null;
        END IF;
        
         IF pDomCi = '1900-01-01 00:00:00' THEN
          LET pDomCi = null;
        END IF;
		...
		SELECT COUNT(*)
		INTO iTotal
		FROM bdinteg:"informix".si_info_sucur_gcb
        WHERE TRIM(no_sucursal)=TRIM(pIdSucursal_a);
		...
		IF (iTotal > 0) THEN 
			...
			INTO cIdSucursal
			FROM bdinteg:"informix".si_info_sucur_gcb
            WHERE TRIM(no_sucursal)=TRIM(pIdSucursal);
			...
			ELSE
                ...
                END IF;
				UPDATE bdinteg:"informix".si_info_sucur_gcb SET  
				no_sucursal = pIdSucursal,
				nom_sucur = UPPER(pNomSucur),
				su_formato = UPPER(pFormato),
				su_tipo = pTipo,
				tipologia = UPPER(pTipologia),
				su_fecha_apertura = pFechaAp,
				su_calle= UPPER(pCalle),
				su_numero = pNumExt,
				su_numero_int = pNumInt,
				entre_calles = UPPER(pEntreCalle),
				colonia = UPPER(pColonia),
				su_cve_municipio = pCveMun,
				su_municipio = UPPER(pMun),
				su_cve_estado = pCveEst,
				estado = UPPER(pEst),
				codigo_postal = pCP,
				estatus_domicilio = bEstDom,
				telefono_sucursal = pTelSuc,
				latitud = pLatitud, 
				longitud = pLongitud,
				zona_horaria = UPPER(pZonaHoraria),
				servicio_lunes = bSerLun,
				servicio_martes = bSerMar,
				servicio_miercoles = bSerMie,
				servicio_jueves = bSerJue,
				servicio_viernes = bSerVie,
				servicio_sabado = bSerSab,
				servicio_domingo =bSerDom,
				lunes_apertura = pLunAp,
				lunes_cierre = pLunCi,
				martes_apertura = pMarAp,
				martes_cierre = pMarCi,
				miercoles_apertura = pMieAp,
				miercoles_cierre = pMieCi,
				jueves_apertura = pJueAp,
				jueves_cierre = pJueCi,
				viernes_apertura = pVieAp,
				viernes_cierre = pVieCi,
				sabado_apertura = pSabAp,
				sabado_cierre = pSabCi,
				domingo_apertura = pDomAp,
				domingo_cierre = pDomCi,
				su_clasificacion = pClasificacion,
				su_cve_suc_eje = pCveSucEje,
				m2 = pM2,
				su_num_ventanilla = pNumVent,
				su_num_escritorios = pNumEsc,
				su_num_atm = pNumATM,
				su_zonaeco = pZonaEco,
                su_cve_gerencia=pCveGer,
                su_czb_clave=pZbcve
		...
		ELSE
			...
			IF (cIdSucursal = pIdSucursal) THEN
					LET cCodRet = '01264';
			ELSE
			INSERT INTO bdinteg:"informix".si_info_sucur_gcb(no_sucursal, nom_sucur, su_formato, su_tipo, tipologia, su_fecha_apertura, su_calle, su_numero, su_numero_int, entre_calles, colonia, su_cve_municipio, su_municipio, su_cve_estado, estado, codigo_postal, estatus_domicilio, telefono_sucursal, latitud, longitud, zona_horaria, servicio_lunes, servicio_martes, servicio_miercoles, servicio_jueves, servicio_viernes, servicio_sabado, servicio_domingo, lunes_apertura, lunes_cierre, martes_apertura, martes_cierre, miercoles_apertura, miercoles_cierre, jueves_apertura, jueves_cierre, viernes_apertura, viernes_cierre, sabado_apertura, sabado_cierre, domingo_apertura, domingo_cierre, su_clasificacion, su_cve_suc_eje, m2, su_num_ventanilla, su_num_escritorios, su_num_atm, region_coppel, division_tienda,su_zonaeco,su_cve_gerencia,su_czb_clave) 
			VALUES(pIdSucursal, UPPER(pNomSucur),UPPER (pFormato), pTipo, UPPER(pTipologia), pFechaAp,UPPER(pCalle), pNumExt, pNumInt, UPPER(pEntreCalle), UPPER(pColonia), pCveMun, UPPER(pMun), pCveEst, UPPER(pEst), pCP, bEstDom, pTelSuc, pLatitud, pLongitud, UPPER(pZonaHoraria), bSerLun, bSerMar, bSerMie, bSerJue, bSerVie, bSerSab, bSerDom, pLunAp, pLunCi, pMarAp, pMarCi, pMieAp, pMieCi, pJueAp, pJueCi, pVieAp, pVieCi, pSabAp, pSabCi, pDomAp, pDomCi, pClasificacion, pCveSucEje, pM2, pNumVent, pNumEsc, pNumATM, '', '',pZonaEco,pCveGer,pZbcve);
			END IF;
		END IF;
...
'MODULO: ',
'FUNCIONALIDAD: ',
'DESCRIPCION: INSERTA O ACTUALIZA LOS VALORES DE LA TABLA si_info_sucur_gcb',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_actualizatipo_gcb(pUsuario CHAR(8), pIdFuncion CHAR(10), pCve_tipo_a CHAR(3), pCve_tipo CHAR(3))
	RETURNING CHAR(5) AS codret;
	
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;	
	DEFINE cCve_tipo CHAR(3);
	DEFINE cTipo CHAR(40);
	DEFINE iTotal INTEGER;
	...
	BEGIN
		...
		IF pUsuario = '' OR pIdFuncion = '' OR pCve_tipo =''  THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_actualizatipo_gcb.out';
		 --TRACE ON;
		...
		SELECT COUNT(*)
		INTO iTotal
		FROM bdinteg:"informix".si_tipo_gcb
		WHERE TRIM(cve_tipo)=TRIM(pCve_tipo_a);
		...
		IF (iTotal > 0) THEN 
			...
			INTO cCve_tipo
			FROM bdinteg:"informix".si_tipo_gcb
			WHERE TRIM(cve_tipo)=TRIM(pCve_tipo);
			
			IF (cCve_tipo = pCve_tipo) THEN
				LET cCodRet = '01264';
			ELSE
				UPDATE bdinteg:"informix".si_tipo_gcb SET  
				cve_tipo = pCve_tipo
	
                WHERE TRIM(cve_tipo)=TRIM(pCve_tipo_a);
			END IF;
		ELSE
            LEt pCve_tipo = pCve_tipo;
        	SELECT cve_tipo
			INTO cCve_tipo
			FROM bdinteg:"informix".si_tipo_gcb
			WHERE TRIM(cve_tipo)=TRIM(pCve_tipo);
			...
			IF (cCve_tipo = pCve_tipo) THEN
				LET cCodRet = '01264';
			ELSE
			INSERT INTO bdinteg:"informix".si_tipo_gcb (cve_tipo)
			VALUES (pCve_tipo);
            END IF;
		END IF;
...
'MODULO: ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: INSERTA O ACTUALIZA LOS VALORES DE LA TABLA si_tipo_gcb',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_actualizazona_gcb(pUsuario CHAR(8), pIdFuncion CHAR(10), pCve_zona_a CHAR(3),pZona_economica_a CHAR(40),pCve_zona CHAR(3), pZona_economica CHAR(40))
	RETURNING CHAR(5) AS codret;
	
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;	
	DEFINE cCve_zona CHAR(3);
	DEFINE cZona_economica CHAR(40);
	DEFINE iTotal INTEGER;
    DEFINE iId_zona INTEGER;
	...
	BEGIN
		...
		IF pUsuario = '' OR pIdFuncion = '' OR pCve_zona ='' OR pZona_economica ='' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_actualizazona_gcb.out';
		 --TRACE ON;
		...
		SELECT COUNT(*)
		INTO iTotal
		FROM bdinteg:"informix".si_zona_gcb
        WHERE TRIM(cve_zona)= TRIM(pCve_zona_a);
		
		IF (iTotal > 0) THEN 
		IF (pCve_zona_a <> pCve_zona)THEN
			SELECT cve_zona,zona_economica
			INTO cCve_zona,cZona_economica
			FROM bdinteg:"informix".si_zona_gcb
            WHERE TRIM(cve_zona)= TRIM(pCve_zona);

			IF (cCve_zona = pCve_zona) THEN
					LET cCodRet = '01264';
			ELSE
				UPDATE bdinteg:"informix".si_zona_gcb SET  
				cve_zona = pCve_zona, 
				zona_economica = pZona_economica
                WHERE TRIM(cve_zona)= TRIM(pCve_zona_a) AND TRIM(zona_economica)= TRIM(pZona_economica_a);
			END IF;
            ELSE
            	UPDATE bdinteg:"informix".si_zona_gcb SET  
				zona_economica = pZona_economica
            ...
            END IF;
		ELSE
            LET pCve_zona_a = pCve_zona_a;
            LET pCve_zona = pCve_zona;
            SELECT cve_zona,zona_economica
			INTO cCve_zona,cZona_economica
			FROM bdinteg:"informix".si_zona_gcb
            WHERE TRIM(cve_zona)= TRIM(pCve_zona);
			...
			IF (cCve_zona = pCve_zona) THEN
					LET cCodRet = '01264';
			ELSE
			INSERT INTO bdinteg:"informix".si_zona_gcb (cve_zona,zona_economica)
			VALUES (pCve_zona,pZona_economica);
            END IF;
		END IF;
...
'MODULO: ',
'FUNCIONALIDAD: ',
'DESCRIPCION: INSERTA O ACTUALIZA LOS VALORES DE LA TABLA si_zona_gcb',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consultacatczb_rh(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,CHAR(4) AS czb_clave,CHAR(40) AS czb_nombre, 
	CHAR(20) AS no_empleado_czb, CHAR(80) AS nombre_czb, CHAR(13) AS no_celular_czb, 
	CHAR(80) AS e_mail_czb, CHAR(8) AS centro_costo_czb;
...
BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cCzb_clave,cCzb_nombre,cNo_empleado_czb,cNombre_czb,cNo_celular_czb,cE_mail_czb,cCentro_costo_czb;
		END EXCEPTION;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_consultacatczb_rh.out';
		 --TRACE ON;
		...
		INTO cCzb_clave,cCzb_nombre,cNo_empleado_czb,cNombre_czb,cNo_celular_czb,cE_mail_czb,cCentro_costo_czb
		FROM bdinteg:"informix".si_catgcbczb_rh
        ORDER by czb_nombre ASC
        LET iFilas = iFilas+1;
		
		RETURN cCodRet,cCzb_clave,cCzb_nombre,cNo_empleado_czb,cNombre_czb,cNo_celular_czb,cE_mail_czb,cCentro_costo_czb WITH RESUME;
		END FOREACH;
...
'MODULO:  ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: CONSULTA LOS VALORES DE LA TABLA si_catgcb_rh',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consultacatgcb_rh(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,CHAR(4) AS cve_gerencia,CHAR(40) AS nombre_gerencia, 
	CHAR(20) AS no_empleado, CHAR(80) AS nombre_emp, CHAR(13) AS no_celular, 
	CHAR(80) AS e_mail, CHAR(8) AS centro_costo;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cCve_gerencia,cNombre_gerencia,cNo_empleado,cNombre_emp,cNo_celular,cEmail,cCentro_costo;
		END EXCEPTION;
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_consultacatgcb_rh.out';
		-- TRACE ON;
		...
		INTO cCve_gerencia,cNombre_gerencia,cNo_empleado,cNombre_emp,cNo_celular,cEmail,cCentro_costo
		FROM bdinteg:"informix".si_catgcb_rh
        WHERE  gc_cve_gerencia is not null
        ORDER BY gc_nombre_gerencia ASC

       LET iFilas = iFilas+1;

		RETURN cCodRet,cCve_gerencia,cNombre_gerencia,cNo_empleado,cNombre_emp,cNo_celular,cEmail,cCentro_costo WITH RESUME;
		END FOREACH;
...
CREATE PROCEDURE "informix".sp_consultaclasificacion_gcb(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,CHAR(3) AS cve_clasificacion,CHAR(40) AS clasificacion;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cCve_clasificacion,cClasificacion;
		END EXCEPTION;
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_consultaclasificacion_gcb.out';
		-- TRACE ON;
		...
		RETURN cCodRet,cCve_clasificacion,cClasificacion WITH RESUME;
		END FOREACH;
...
'MODULO:  ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: CONSULTA LOS VALORES DE LA TABLA si_clasificacion_gcb',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consultaformato_gcb(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,CHAR(3) AS cve_formato,CHAR(40) AS formato;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cCve_formato,cFormato;
		END EXCEPTION;
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_consultaformato_gcb.out';
		-- TRACE ON;
		...
		RETURN cCodRet,cCve_formato,cFormato WITH RESUME;
...
'MODULO:  ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: CONSULTA LOS VALORES DE LA TABLA si_formato_gcb',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consultasucursal_datos1(pUsuario CHAR(8), pIdFuncion CHAR(10),pIdSucursal CHAR(4))
	RETURNING CHAR(5) 		 AS CodRet, 
			  CHAR(40) 	 AS NombreSuc,
			  CHAR(2) 	 AS Cveestado,
			  CHAR(30) 	 AS NombreEst,
			  CHAR(3) 	 AS CveMun,
			  CHAR(60) 	 AS NombreMun,
			  CHAR(100)  AS Colonia,
			  CHAR(5) 	 AS NumInt,
			  CHAR(5) 	 AS CP,
			  CHAR(14)   AS Tel,
	...
	DEFINE cNombreMun CHAR(60);
	DEFINE cColonia CHAR(100);
	DEFINE cNumInt CHAR(5);
	DEFINE cCP CHAR(5);
	DEFINE cTel CHAR(14);
	DEFINE cLatitud CHAR(11);
	DEFINE cLongitud CHAR(10);
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cNombreSuc,cCveestado,cNombreEst, cCveMun, cNombreMun,cColonia,cNumInt,cCP,cTel,cLatitud,cLongitud;
		END EXCEPTION;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_consultasucursal_datos1.out';
		 --TRACE ON;
		
		SET ISOLATION TO DIRTY READ;
		SET LOCK MODE TO WAIT 3;
		
		SELECT a.nombre,b.cve_estado, c.nombre,d.cve_mun,d.desc_municipio, d.desc_colonia,nvl(b.num_int,'N/A') as num_int,b.cp,nvl(b.tel1,'N/A') as tel1,b.latitud,b.longitud      
        INTO  cNombreSuc,cCveestado,cNombreEst,cCveMun,cNombreMun,cColonia,cNumInt,cCP,cTel,cLatitud,cLongitud            
		FROM bdinteg:"informix".si_sucursales a
		inner join bdinteg:si_ptf b on a.sucursal= b.id_ptf 
		inner join bdinteg:si_estados c  on b.cve_estado=c.estado
		inner join bdinteg:si_localidades d on d.cve_col = b.cve_col
        left join bdinteg:si_info_sucur_gcb e on a.sucursal=e.no_sucursal
		where a.sucursal= pIdSucursal and b.tipo = 'S' and a.tipo = 'S';
...
'MODULO:  ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: CONSULTA LOS VALORES DE LA TABLA si_sucursales',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consultasucursal_datos2(pUsuario CHAR(8), pIdFuncion CHAR(10),pIdSucursal CHAR(4))
	RETURNING CHAR(5) 		 AS CodRet, 
			  INTEGER 	 AS  NumATM,
			  CHAR(18) 	 AS  M2,
			  INTEGER 	 AS  NumVentanilla,
			  INTEGER 	 AS  NumEscri,
			  CHAR(40) 	 AS  Tipologia,
			  CHAR(3) 	 AS  Tipo,
			  CHAR(30) 	 AS  ZonaEco,
			  CHAR(40) 	 AS  Formato;
	...
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;	
    DEFINE iNumATM INTEGER;
    DEFINE fM2 FLOAT;
    DEFINE iNumVentanilla INTEGER;
    DEFINE iNumEscri INTEGER;
    DEFINE cTipologia CHAR(40);
    DEFINE cTipo CHAR(3);
    DEFINE cZonaEco CHAR(30);
    DEFINE cFormato CHAR(40);
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,iNumATM,fM2,iNumVentanilla, iNumEscri, cTipologia,cTipo,cZonaEco,cFormato;
		END EXCEPTION;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_consultasucursal_datos2.out';
		 --TRACE ON;
		
		SET ISOLATION TO DIRTY READ;
		SET LOCK MODE TO WAIT 3;
		
		SELECT e.su_num_atm,e.m2,e.su_num_ventanilla,e.su_num_escritorios,e.tipologia,e.su_tipo,e.su_zonaeco,e.su_formato
        INTO  iNumATM,fM2,iNumVentanilla,iNumEscri,cTipologia,cTipo,cZonaEco,cFormato
		FROM bdinteg:"informix".si_sucursales a
		inner join bdinteg:si_ptf b on a.sucursal= b.id_ptf 
		inner join bdinteg:si_estados c  on b.cve_estado=c.estado
		inner join bdinteg:si_localidades d on d.cve_col = b.cve_col
...
CREATE PROCEDURE "informix".sp_consultasucursal_datosgen(pUsuario CHAR(8), pIdFuncion CHAR(10),pIdSucursal CHAR(4))
	RETURNING CHAR(5) 		 AS CodRet, 
			  DATE 		     AS fecha_apertura,
			  CHAR(20)       AS ZonaHoraria,
			  CHAR(40)       AS Clasificacion,
			  CHAR(40) 	     AS cSucEje,
              CHAR(4)        AS CveGer,
              CHAR(4)        AS Zbcve;
    ...
    DEFINE cZonaHoraria CHAR(20);
    DEFINE cClasificacion CHAR(40);
    DEFINE cSucEje CHAR(40);
    DEFINE cCveGer CHAR(4);
    DEFINE cZbcve CHAR(4);
  
	
	LET cCodRet = '00000';
	LET iSqlErr = 0;	
	LET dFechaAp = current;
	LET cZonaHoraria = '';
    LET cClasificacion ='';
    LET cSucEje='';
    LET cCveGer ='';
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,dFechaAp,cZonaHoraria,cClasificacion, cSucEje,cCveGer,cZbcve;
		END EXCEPTION;
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_consultasucursal_datosgen.out';
		--TRACE ON;
		...
		SELECT 
		e.su_fecha_apertura,e.zona_horaria,e.su_clasificacion,e.su_cve_suc_eje,e.su_cve_gerencia,e.su_czb_clave
        INTO 
        dFechaAp,cZonaHoraria,cClasificacion,cSucEje,cCveGer,cZbcve
        FROM bdinteg:"informix".si_sucursales a
		inner join bdinteg:si_ptf b on a.sucursal= b.id_ptf 
		inner join bdinteg:si_estados c  on b.cve_estado=c.estado
		inner join bdinteg:si_localidades d on d.cve_col = b.cve_col
...
CREATE PROCEDURE "informix".sp_consultasucursal_diasap(pUsuario CHAR(8), pIdFuncion CHAR(10),pIdSucursal CHAR(4))
	RETURNING CHAR(5) 		 AS CodRet, 
			  DATETIME YEAR to SECOND	 AS dLunAp,
			  DATETIME YEAR to SECOND	 AS dMarAp,
			  DATETIME YEAR to SECOND	 AS dMieAp,
			  DATETIME YEAR to SECOND	 AS dJueAp,
			  DATETIME YEAR to SECOND	 AS dVieAp,
			  DATETIME YEAR to SECOND	 AS dSabAp,
			  DATETIME YEAR to SECOND	 AS dDomAp;
	
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;	
    DEFINE dLunAp DATETIME YEAR to SECOND;
    DEFINE dMarAp DATETIME YEAR to SECOND;
    DEFINE dMieAp DATETIME YEAR to SECOND;
    DEFINE dJueAp DATETIME YEAR to SECOND;
    DEFINE dVieAp DATETIME YEAR to SECOND;
    DEFINE dSabAp DATETIME YEAR to SECOND;
    DEFINE dDomAp DATETIME YEAR to SECOND;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,dLunAp,dMarAp,dMieAp, dJueAp, dVieAp,dSabAp,dDomAp;
		END EXCEPTION;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_consultasucursal_diasap.out';
		 --TRACE ON;
		...
		SELECT 
        e.lunes_apertura,e.martes_apertura,e.miercoles_apertura,e.jueves_apertura,e.viernes_apertura,e.sabado_apertura,e.domingo_apertura        
        INTO  
        dLunAp,dMarAp,dMieAp,dJueAp,dVieAp,dSabAp,dDomAp          
		FROM bdinteg:"informix".si_sucursales a
		inner join bdinteg:si_ptf b on a.sucursal= b.id_ptf 
		inner join bdinteg:si_estados c  on b.cve_estado=c.estado
		inner join bdinteg:si_localidades d on d.cve_col = b.cve_col
...
CREATE PROCEDURE "informix".sp_consultasucursal_diasserv(pUsuario CHAR(8), pIdFuncion CHAR(10),pIdSucursal CHAR(4))
        RETURNING CHAR(5) AS CodRet, 
			  CHAR(5) AS ServLun,
			  CHAR(5) AS ServMar,
			  CHAR(5) AS ServMie,
	...
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;	
    DEFINE bServLun BOOLEAN;
    DEFINE bServMar BOOLEAN;
    DEFINE bServMie BOOLEAN;
    DEFINE bServJue BOOLEAN;
    DEFINE bServVie BOOLEAN;
    DEFINE bServSab BOOLEAN;
    DEFINE bServDom BOOLEAN;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,bServLun,bServMar,bServMie, bServJue, bServVie,bServSab,bServDom;
		END EXCEPTION;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_consultasucursal.out';
		 --TRACE ON;
		...
		SELECT 
        e.servicio_lunes,e.servicio_martes,e.servicio_miercoles,e.servicio_jueves,e.servicio_viernes,e.servicio_sabado,e.servicio_domingo     
        INTO 
        bServLun,bServMar,bServMie,bServJue,bServVie,bServSab,bServDom
		FROM bdinteg:"informix".si_sucursales a
		inner join bdinteg:si_ptf b on a.sucursal= b.id_ptf 
		inner join bdinteg:si_estados c  on b.cve_estado=c.estado
		inner join bdinteg:si_localidades d on d.cve_col = b.cve_col
...
CREATE PROCEDURE "informix".sp_consultasucursal_ub(pUsuario CHAR(8), pIdFuncion CHAR(10),pIdSucursal CHAR(4))
	RETURNING CHAR(5) 		 AS CodRet, 
			  CHAR(100) 	 AS cECalles,
			   CHAR(5)	 	 AS EstDom,
                CHAR(100)    AS Calle,
                CHAR(6)      AS NumExt;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cECalles,bEstDom,cCalle,cNumExt;
		END EXCEPTION;
		...
		END IF;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_consultasucursal_ub.out';
		 --TRACE ON;
		...
		SELECT 
        e.entre_calles,e.estatus_domicilio,b.num_ext,b.calle
        INTO
        cECalles,bEstDom,cNumExt,cCalle
		FROM bdinteg:"informix".si_sucursales a
		inner join bdinteg:si_ptf b on a.sucursal= b.id_ptf 
		inner join bdinteg:si_estados c  on b.cve_estado=c.estado
		inner join bdinteg:si_localidades d on d.cve_col = b.cve_col
...
CREATE PROCEDURE "informix".sp_consultatipo_gcb(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,CHAR(3) AS cve_tipo;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_consultatipo_gcb.out';
		-- TRACE ON;
		...
		INTO cCve_tipo
		FROM bdinteg:"informix".si_tipo_gcb
        ORDER BY cve_tipo ASC
		
		RETURN cCodRet,cCve_tipo WITH RESUME;
		END FOREACH;
...
'MODULO:  ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: CONSULTA LOS VALORES DE LA TABLA si_tipo_gcb',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consultazona_gcb(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,CHAR(3) AS cve_zona,CHAR(40) AS zona_economica;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cCve_zona,cZona_economica;
		END EXCEPTION;
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_consultazona_gcb.out';
		-- TRACE ON;
		...
		INTO cCve_zona,cZona_economica
		FROM bdinteg:"informix".si_zona_gcb
        ORDER BY zona_economica ASC
		RETURN cCodRet,cCve_zona,cZona_economica WITH RESUME;
...
'MODULO:  ',
'FUNCIONALIDAD:  ',
'DESCRIPCION: CONSULTA LOS VALORES DE LA TABLA si_zona_gcb',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_dr_abono_ref(pUsuario CHAR(8), pIdFuncion CHAR(10),
									   pEmpresa     CHAR(3),
                                       pSucursal    CHAR(4),
                                       pTransacc    CHAR(4),
                                       pTransuc     CHAR(4),
	...
	BEGIN
		...
		END EXCEPTION;
		 ...
		 --SET DEBUG FILE TO '/tmp/mfinis/sp_dr_abono_ref.out';
		 --TRACE ON;
...
DOCUMENT 'AUTOR: Daniel Reyes Guillen',
'FECHA: 09/08/2021',
'FUNCIONALIDAD: DEPOSITOS REFERENCIADOS',
'DESCRIPCION: Ejecuta el procedimiento almacenado abono_ref',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_dr_consultafecha(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,			
		      DATE AS feha;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_dr_consultafecha.out';
		-- TRACE ON;
		...
		UNION
		SELECT (fecha_hoy  - 1 UNITS MONTH)::DATE from bdicheq:"informix".sc_fechas where empresa ='001'
        LET iTotal = iTotal+1;
		RETURN cCodRet,dFecha WITH RESUME;	
		END FOREACH;
...
'FECHA: 09/08/2021',
'FUNCIONALIDAD: DEPOSITOS REFERENCIADOS',
'DESCRIPCION: RECUPERA LAS FECHAS DE LA TABLA bdicheq:sc_fechas',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_dr_consultaparamlong(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,			
		      CHAR(100) AS valor;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_dr_consultaparamlong.out';
		-- TRACE ON;
		...
		SELECT valor
		INTO cValor
		FROM bdinteg:"informix".si_param WHERE empresa = '001' AND descripcion ='longitud cliente';		 
...
'FECHA: 09/08/2021',
'FUNCIONALIDAD: DEPOSITOS REFERENCIADOS',
'DESCRIPCION: RECUPERA LOS PARAMETRTOS DE LA TABLA bdinteg:si_param',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_dr_consultaparammoneda(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,			
		      CHAR(100) AS valor;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_dr_consultaparammoneda.out';
		-- TRACE ON;
		...
		SELECT valor
		INTO cValor
		FROM bdinteg:"informix".si_param WHERE empresa = '001' AND descripcion ='codigo mn';		 
...
CREATE PROCEDURE "informix".sp_dr_consultaparsistema(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,			
		      CHAR(2) AS sistema;
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_dr_consultaparsistema.out';
		-- TRACE ON;
		...
		SELECT sistema
		INTO cValor
		FROM bdinteg:"informix".si_sistema WHERE siglas ='SI';		 
...
'FECHA: 09/08/2021',
'FUNCIONALIDAD: DEPOSITOS REFERENCIADOS',
'DESCRIPCION: RECUPERA LOS PARAMETRTOS DE LA TABLA bdinteg:si_sistema',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_dr_consultartdacoppel(pUsuario CHAR(8), pIdFuncion CHAR(10),pNumTienda CHAR(10))
	RETURNING CHAR(5) AS codret,
			  CHAR(10) AS tienda,
			  CHAR(40) AS descrip;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;			
			RETURN cCodRet,cTienda,cDescrip;	
		END EXCEPTION;
		
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_dr_consultartdacoppel.out';
		-- TRACE ON;
		...
		EXECUTE PROCEDURE bdinteg:"informix".sp_consultartdacoppel(pNumTienda) INTO cCodRet,cTienda,cDescrip;
...
'FECHA: 09/08/2021',
'FUNCIONALIDAD: DEPOSITOS REFERENCIADOS',
'DESCRIPCION: Ejecuta el procedimiento almacenado sp_consultartdacoppel',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_dr_desc_ret(pUsuario CHAR(8), pIdFuncion CHAR(10),pSistema CHAR(2),pCodigoE CHAR(4))
	RETURNING CHAR(5) AS codret,
			  CHAR(3) AS cod,
		      CHAR(50) AS descrip;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;			
			RETURN cCodRet,cCod,cDescrip;	
		END EXCEPTION;
		
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_dr_desc_ret.out';
		-- TRACE ON;
		...
		EXECUTE PROCEDURE bdinteg:"informix".sp_desc_ret(pSistema,pCodigoE) INTO cCod,cDescrip;
...
'FECHA: 09/08/2021',
'FUNCIONALIDAD: DEPOSITOS REFERENCIADOS',
'DESCRIPCION: Ejecuta el procedimiento almacenado sp_desc_ret',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_dr_generafolionominapagos(pUsuario CHAR(8), pIdFuncion CHAR(10),pNomUsuario CHAR(8))
	RETURNING CHAR(5) AS codret,		
			  CHAR(16) AS descrip;
	...
	BEGIN
		...
		EXECUTE PROCEDURE bdicheq:"informix".sp_generafolionominapagos(pNomUsuario) INTO cCodRet,cDescrip;
...
'FECHA: 09/08/2021',
'FUNCIONALIDAD: DEPOSITOS REFERENCIADOS',
'DESCRIPCION: Ejecuta el procedimiento almacenado sp_generafolionominapagos',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_dr_obtenercuentascoppel(pUsuario CHAR(8), pIdFuncion CHAR(10),pStatus CHAR(1))
	RETURNING CHAR(5) AS codret,			
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_dr_obtenercuentascoppel.out';
		-- TRACE ON;
		...
		FOREACH
		EXECUTE PROCEDURE bdicheq:"informix".sp_obtenercuentascoppel(pStatus) INTO cCodRet,cCuenta
        END FOREACH;
...
'FECHA: 09/08/2021',
'FUNCIONALIDAD: DEPOSITOS REFERENCIADOS',
'DESCRIPCION: Ejecuta el procedimiento almacenado sp_obtenercuentascoppel',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sac_actualizaabonoparam(pUsuario CHAR(8), pIdFuncion CHAR(10), pValor VARCHAR(40),pCodigo CHAR(4))
		RETURNING CHAR(5) AS codret;								
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sac_actualizaabonoparam.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pValor ='' OR pCodigo='' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		UPDATE bdicheq:sc_param_abono_coppel_atm SET valor =pValor  WHERE codigo=pCodigo;
...
'MODULO: Operaciones',
'FUNCIONALIDAD: ',
'DESCRIPCION: SPL encargado de actualizar los valores de la tabla sc_param_abono_coppel_atm',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sac_consultaabonoatm(pUsuario CHAR(8), pIdFuncion CHAR(10))
		RETURNING CHAR(5) AS codret,					
				  INTEGER AS total_pagos,
				  CHAR(40) AS convenio,	
				  MONEY(16,2) AS importe_suc,
				  MONEY(16,2) AS com_conv,
				  MONEY(16,2) AS iva_conv
			;	
    ...
    DEFINE mimporte_suc   MONEY(16,2);
	DEFINE mcom_conv  MONEY(16,2);
    DEFINE miva_conv   MONEY(16,2);
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, itotal_pagos,cconvenio,mimporte_suc,mcom_conv,miva_conv;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sac_consultaabonoatm.out';
		--TRACE ON;
		...
		FOREACH		
		SELECT {+INDEX (bdicnweb:sw_sac_reporteabonoatmtmp idx_sw_sac_reporteabonoatmtmp)}  total_pagos,convenio,importe_suc,com_conv,iva_conv 
		INTO  itotal_pagos,cconvenio, mimporte_suc, mcom_conv, miva_conv
		FROM informix.sw_sac_reporteabonoatmtmp WHERE usuario =pUsuario
      		       
		RETURN cCodRet, itotal_pagos,cconvenio,mimporte_suc,mcom_conv,miva_conv WITH RESUME;
		END FOREACH;
...
'FECHA: 01/07/2021',
'MODULO: Operaciones',
'FUNCIONALIDAD: Reportes sac',
'DESCRIPCION: SPL encargado de recuperar datos dela tabla sw_sac_reporteabonoatmtmp',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sac_consultaabonoatm_totales(pUsuario CHAR(8), pIdFuncion CHAR(10), pFechaIni DATE, pFechaFin DATE)
		RETURNING CHAR(5) AS codret,					
				  INTEGER AS Total
			;	
	...
	DEFINE iSqlErr INTEGER;
	DEFINE iTotal INTEGER;
	DEFINE dIva DECIMAL(10,3);
	DEFINE dCom DECIMAL(10,3);
	DEFINE itotal_pagos  INTEGER;
    DEFINE cconvenio  VARCHAR(40);
    DEFINE mimporte_suc   MONEY(16,2);
	DEFINE mcom_conv  MONEY(16,2);
    DEFINE miva_conv   MONEY(16,2);
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sac_abonoatm_totales.out';
		--TRACE ON;
        ...
        DELETE {+INDEX (bdicnweb:sw_sac_reporteabonoatmtmp idx_sw_sac_reporteabonoatmtmp)} FROM  sw_sac_reporteabonoatmtmp WHERE usuario=pUsuario;
		...
		SELECT valor/100 INTO dIva FROM bdicheq:sc_param_abono_coppel_atm WHERE codigo='0001';
		
		SELECT valor INTO dCom FROM bdicheq:sc_param_abono_coppel_atm WHERE codigo='0002';
	
		
		select nvl(COUNT(*),0),nvl(SUM(monto_tot),0),nvl(COUNT(*)*dCom,0),nvl(COUNT(*)*dCom*dIva,0)
		INTO itotal_pagos,mimporte_suc,mcom_conv,miva_conv
		FROM bdicheq:sc_movhis   
		WHERE transacc in('0533') and fech_alt BETWEEN  pFechaIni AND pFechaFin and cancelad <>'S' ;
		
		SELECT descripcion INTO cconvenio FROM bdinteg:si_transacc WHERE numero ='0533';
		
		INSERT INTO informix.sw_sac_reporteabonoatmtmp(usuario, total_pagos, convenio, importe_suc,com_conv,iva_conv) 
		VALUES(pUsuario, itotal_pagos, cconvenio, mimporte_suc, mcom_conv, miva_conv);
		

        select nvl(COUNT(*),0),nvl(SUM(monto_tot),0),nvl(COUNT(*)*dCom,0),nvl(COUNT(*)*dCom*dIva,0)
		INTO itotal_pagos,mimporte_suc,mcom_conv,miva_conv
		FROM bdicheq:sc_movhis   
		WHERE transacc in('0534') and fech_alt BETWEEN  pFechaIni AND pFechaFin and cancelad <>'S';
		
		SELECT descripcion INTO cconvenio FROM bdinteg:si_transacc WHERE numero ='0534';
		...
		INTO itotal_pagos,mimporte_suc,mcom_conv,miva_conv
		FROM bdicheq:sc_movhis   
		WHERE transacc in('0533','0534') and fech_alt BETWEEN  pFechaIni AND pFechaFin and cancelad <>'S';

        INSERT INTO informix.sw_sac_reporteabonoatmtmp(usuario, total_pagos, convenio, importe_suc,com_conv,iva_conv) 
		VALUES(pUsuario, itotal_pagos, 'ABONOS COPPEL ATM', mimporte_suc, mcom_conv, miva_conv);
...
'MODULO: Operaciones',
'FUNCIONALIDAD: Reportes sac',
'DESCRIPCION: SPL encargado de recuperar datos dela tabla sc_movhis',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sac_consultaabonoparam(pUsuario CHAR(8), pIdFuncion CHAR(10),pCodigo CHAR(4))
		RETURNING CHAR(5) AS codret,
				  CHAR(4) AS codigo,
				  CHAR(40) AS valor;								
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cCodigo,cValor;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sac_consultaabonoparam.out';
		--TRACE ON;
		...
		SELECT codigo,valor INTO cCodigo,cValor FROM bdicheq:sc_param_abono_coppel_atm WHERE codigo=pCodigo;
...
'MODULO: Operaciones',
'FUNCIONALIDAD: ',
'DESCRIPCION: SPL encargado de consultar los valores de la tabla sc_param_abono_coppel_atm',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sac_consultabitacoraiva(pUsuario CHAR(8), pIdFuncion CHAR(10),pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,					
				  INTEGER AS id,
				  INTEGER AS usuario,	
				  CHAR(80) AS nombre,
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, iId,iUsuario,cNombre,cAccion,dFecha;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sac_consultabitacoraiva.out';
		--TRACE ON;
		...
		FOREACH		
		SELECT {+INDEX (bdicheq:sc_bitacora_abono_coppel_atm idx_sc_bitacora_abono_coppel_atm)} SKIP pRegistros FIRST pRecuperacion  
		id,usuario_modifica,nombre_usuario_modifica,accion, fecha_modifica
		INTO  iId,iUsuario, cNombre, cAccion, dFecha
		FROM bdicheq:sc_bitacora_abono_coppel_atm 
		
		LET iRecuperacion = iRecuperacion + 1;
      		       
		 RETURN cCodRet, iId,iUsuario,cNombre,cAccion,dFecha WITH RESUME;
		END FOREACH;
...
'MODULO: Operaciones',
'FUNCIONALIDAD: Reportes sac',
'DESCRIPCION: SPL encargado de recuperar datos dela tabla sc_bitacora_abono_coppel_atm',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sac_insertbitacoraabonoatm(pUsuario CHAR(8), pIdFuncion CHAR(10),pNombreUsu VARCHAR(80),pAccion CHAR(1))
		RETURNING CHAR(5) AS codret;
										
		
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;
	DEFINE cAccion VARCHAR(50);
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sac_insertbitacoraabonoatm.out';
		--TRACE ON;
		...
		IF pAccion = 1 THEN
			LET cAccion = 'MODIFICACIÓN IVA';
		END IF;
		IF pAccion = 2 THEN
			LET cAccion = 'MODIFICACIÓN COMISIÓN';
		END IF;
		...
		INSERT INTO bdicheq:sc_bitacora_abono_coppel_atm(usuario_modifica, nombre_usuario_modifica, accion, fecha_modifica) 
	     VALUES(pUsuario, UPPER(pNombreUsu), cAccion, current);
...
'MODULO: Operaciones',
'FUNCIONALIDAD: ',
'DESCRIPCION: SPL encargado de insertar los valores de la tabla de bitacora',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sac_repabonoatm(pUsuario CHAR(8), pIdFuncion CHAR(10),pFechaInicial DATE,pFechaFinal DATE,pRutaDescarga CHAR(100),pCuentaCheques CHAR(30),pCuentaContable CHAR(30))
    RETURNING CHAR(5) AS codret,
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sac_repabonoatm.out';
		--TRACE ON;
        ...
        LET cFecha1= LPAD(DAY(pFechaInicial),2,0)||'/'||LPAD(MONTH(pFechaInicial),2,0)||'/'||YEAR(pFechaInicial);

        IF NVL(pFechaFinal,'')='' THEN
        LET cFecha3= cFecha1;
        LET cFecha2= cFecha1;
        ELSE
        LET cFecha2= LPAD(DAY(pFechaFinal),2,0)||'/'||LPAD(MONTH(pFechaFinal),2,0)||'/'||YEAR(pFechaFinal);
        LET cFecha3= cFecha1||'-'||cFecha2;
        END IF;		

		LET cCmd1 ="";
        LET cCmd1 ="SELECT ' ',' ',' ','SISTEMA DE ADMINISTRACION DE CONVENIOS',' ',' ',' ',' ',' ' FROM systables  WHERE tabid = 1 ";
        LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
        LET cCmd1 =""||TRIM(cCmd1)||" SELECT ' ',' ',' ','REPORTE TOTAL DE COBRANZA - CONCILIACION DE PAGOS COPPEL EN ATM',' ',' ',' ',' ',' ' FROM systables  WHERE tabid = 1 ";        
        LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT 'CONVENIOS:ABONOS COPPEL',' ','SUCURSAL:TODAS',' ',' ',' ','RANGO DE FECHAS DEL:','"||cFecha1||"','AL:"||cFecha2||"' FROM systables  WHERE tabid = 1 " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT 'PAGOS','CONVENIO','IMPORTE SUCURSAL','COMISION CONVENIO','IVA CONVENIO','COMISION CLIENTE','IVA CLIENTE','STATUS SUCURSAL','STATUS CENTRAL' FROM systables  WHERE tabid = 1 " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT total_pagos::CHAR(20), convenio::CHAR(30), importe_suc::CHAR(20),com_conv::CHAR(20),iva_conv::CHAR(20),((0.00)::MONEY(2,2))::CHAR(10),((0.00)::MONEY(2,2))::CHAR(10),'0','0' FROM sw_sac_reporteabonoatmtmp where convenio IN ('ABONO PAGO CRED COPPEL ATM','ABONO DEP PAGO CRED COPPEL ATM') " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT 'PAGOS:',total_pagos::CHAR(20)||'     '||'TOTAL:', importe_suc::CHAR(20),com_conv::CHAR(20),iva_conv::CHAR(20),((0.00)::MONEY(2,2))::CHAR(10),((0.00)::MONEY(2,2))::CHAR(10),'0','0' FROM sw_sac_reporteabonoatmtmp where convenio IN ('ABONOS COPPEL ATM') " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT ' ','CONVENIO', 'NO. DE PAGOS','IMPORTE TOTAL','COMISION','IVA','COMISION CLIENTE','IVA CLIENTE','IMPORTE A PAGAR' FROM sw_sac_reporteabonoatmtmp where convenio IN ('ABONOS COPPEL ATM') " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT 'ABONOS COPPEL ATM','',total_pagos::CHAR(20), importe_suc::CHAR(20),com_conv::CHAR(20),iva_conv::CHAR(20),((0.00)::MONEY(2,2))::CHAR(10),((0.00)::MONEY(2,2))::CHAR(10),(importe_suc-com_conv-iva_conv)::CHAR(20) FROM sw_sac_reporteabonoatmtmp where convenio IN ('ABONOS COPPEL ATM') " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT ' ','TOTAL DE COBRANZA',total_pagos::CHAR(20), importe_suc::CHAR(20),com_conv::CHAR(20),iva_conv::CHAR(20),((0.00)::MONEY(2,2))::CHAR(10),((0.00)::MONEY(2,2))::CHAR(10),(importe_suc-com_conv-iva_conv)::CHAR(20) FROM sw_sac_reporteabonoatmtmp where convenio IN ('ABONOS COPPEL ATM') " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT ' ',' ',' ','CONCILIACION TOTAL POR CONVENIOS',' ',' ',' ',' ',' ' FROM systables  WHERE tabid = 1 " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT 'CONVENIO','ABONOS COPPEL ATM',' ',' ',' ',' ',' ',' ',' ' FROM systables  WHERE tabid = 1 " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT 'FECHA',' ',' ','ARCHIVO ABONOS COPPEL ATM','CUENTA DE CHEQUES "||pCuentaCheques||"',' ',' ',' ','CUENTA CONTABLE "||pCuentaContable||" ' FROM systables  WHERE tabid = 1 " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT '"||cFecha3||"',' ',' ', (importe_suc-com_conv-iva_conv)::CHAR(20),(importe_suc-com_conv-iva_conv)::CHAR(20),' ',' ',' ',((0.00)::MONEY(2,2))::CHAR(10) FROM sw_sac_reporteabonoatmtmp where convenio IN ('ABONOS COPPEL ATM') " ;
		LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
		LET cCmd1 =""||TRIM(cCmd1)||" SELECT 'TOTALES',' ',' ', (importe_suc-com_conv-iva_conv)::CHAR(20),(importe_suc-com_conv-iva_conv)::CHAR(20),' ',' ',' ',((0.00)::MONEY(2,2))::CHAR(10) FROM sw_sac_reporteabonoatmtmp where convenio IN ('ABONOS COPPEL ATM') " ;
		
		
		LET dFechaHoy = CURRENT;
		LET cFechaHoraArchivo = LPAD(DAY(dFechaHoy),2,0)||LPAD(MONTH(dFechaHoy),2,0)||YEAR(dFechaHoy)||'_'||TO_CHAR(CURRENT, '%H%M%S');
		 
		-- SE DEFINE NOMENCLATURA DEL REPORTE A GENERAR		
		
		LET cNombreArchivo = 'REP_CONCILIACION_PCATM_'||TRIM(cFechaHoraArchivo)||'.txt';
...
'FECHA: 01/07/2021',
'DESCRIPCION: SPL que genera el Reporte Abono ATM',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sac_repbitacoraiva(pUsuario CHAR(8), pIdFuncion CHAR(10),pRutaDescarga CHAR(100))
    RETURNING CHAR(5) AS codret,
    CHAR(100) AS reporte_generado;
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
            LET cCodRet = iSqlErr;
			UPDATE {+INDEX (bdicnweb:sw_verificastatusrepbitacoraiva idx_sw_verificastatusrepbitacoraiva)} "informix".sw_verificastatusrepbitacoraiva
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sac_repbitacoraiva.out';
		--TRACE ON;
		...
		DELETE {+INDEX (bdicnweb:sw_verificastatusrepbitacoraiva idx_sw_verificastatusrepbitacoraiva)} FROM "informix".sw_verificastatusrepbitacoraiva
		WHERE usuario_insert = pUsuario AND tipo_proceso = 'LECTURA'; 
 
		-- SE INSERTA A TABLA PARA EL MONITOREO DEL STATUS
		INSERT INTO "informix".sw_verificastatusrepbitacoraiva(usuario_insert, nombre_archivo, status,  error_proceso, tipo_proceso, error) 
		VALUES(pUsuario,'','I','','LECTURA','');
			

		LET cCmd1 ="";
        LET cCmd1 ="SELECT 'ID','USUARIO MODIFICA','NOMBRE USUARIO MODIFICA','ACCION','FECHA MODIFICA' FROM systables  WHERE tabid = 1 ";
        LET cCmd1 =""||TRIM(cCmd1)||" UNION ALL ";
        LET cCmd1 =""||TRIM(cCmd1)||" SELECT id::CHAR(10), usuario_modifica::CHAR(11),nombre_usuario_modifica::CHAR(80),accion::CHAR(50),LPAD(DAY(fecha_modifica),2,0)||'/'||LPAD(MONTH(fecha_modifica),2,0)||'/'||YEAR(fecha_modifica) FROM bdicheq:sc_bitacora_abono_coppel_atm ";        
		...
		LET cNombreArchivo = 'REP_BITACORA_IVACOM_'||TRIM(cFechaHoraArchivo)||'.txt';
...
'AUTOR: Daniel Reyes Guillen',
'FECHA: 01/07/2021',
'DESCRIPCION: SPL que genera el Reporte de la bitacora',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_sac_verificastatusbitacoraiva(pUsuario CHAR(8), pIdFuncion CHAR(10))
	RETURNING CHAR(5) AS codret,
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_sac_verificastatusbitacoraiva.out';
		--TRACE ON;
		...
		SELECT {+INDEX (bdicnweb:sw_verificastatusrepbitacoraiva idx_sw_verificastatusrepbitacoraiva)} status,nombre_archivo,error_proceso,error,tipo_proceso
		INTO cStatus,cNombre_archivo,cErrorProceso,cError,cProceso
		FROM "informix".sw_verificastatusrepbitacoraiva
...
'MODULO:  ',
'FUNCIONALIDAD: ', 
'DESCRIPCION: SPL encargado de hacer la validacion del reporte bitacora iva',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_cb_consultafechas(pUsuario CHAR(8), pIdFuncion CHAR(10))
		RETURNING CHAR(5) AS codret,									 
				  DATE AS fecha
			;	
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_cb_consultafechas.out';
		--TRACE ON;
		...
		SELECT DISTINCT fecha_trasp_benefic 
		INTO dFecha
		FROM bdicheq:"informix".sc_cuentas_concentradas
        WHERE fecha_trasp_benefic IS NOT NULL
        ORDER BY fecha_trasp_benefic ASC
...
'DESCRIPCION: SPL encargado de recuperar fechas de la tabla sc_cuentas_concentradas',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_cb_consultareportes(pUsuario CHAR(8), pIdFuncion CHAR(10),pTipo CHAR(1))
	RETURNING CHAR(5) AS codret,
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cNombre,dFecha,cHora,cUsuario;
		END EXCEPTION;
	 
		--SET DEBUG FILE TO '/tmp/mfinis/sp_cb_consultareportes.out';
		--TRACE ON;
		...
		FOREACH 
		SELECT nombre_reporte,fecha_reporte,hr_reporte,usuario_insert
		INTO cNombre,dFecha,cHora,cUsuario
		FROM "informix".sw_ctrlgenreportesart
		WHERE tipo = pTipo
		ORDER BY hr_reporte ASC

		LET iTotal = iTotal+1;
		
		RETURN cCodRet,cNombre,dFecha,cHora,cUsuario WITH RESUME;	
		END FOREACH;
