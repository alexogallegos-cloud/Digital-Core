CREATE PROCEDURE "informix".libmaycon(pempresa char(3), pfecha_hoy date, v_mayor char(10),
...
DEFINE unecta             CHAR(60);
   ...
   FOREACH
      ...
      ORDER BY
           ...
           ccsssubsub, sector, ciudad, moneda
      ...
      INSERT INTO co_libMAenca
         VALUES(tempresa,unecta,
                ...
                tccsssubsub,tsector,tciudad,"001",tmoneda,
