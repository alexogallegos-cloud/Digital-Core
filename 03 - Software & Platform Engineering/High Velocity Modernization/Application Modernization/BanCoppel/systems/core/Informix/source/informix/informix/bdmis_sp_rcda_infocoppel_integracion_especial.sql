CREATE PROCEDURE "informix".sp_rcda_infocoppel_integracion_especial (pfecha DATE)
...
BEGIN
   ...
   DELETE FROM "informix".mi_rcda_infocoppel;
   ...
   let vpaso = 1;
      FOREACH cursor1 WITH HOLD for
	   ...
	   FROM mi_rcda_infocoppel_cargaespecial WHERE clave <> ' '
