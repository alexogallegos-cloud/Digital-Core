CREATE PROCEDURE "informix".arregsdodiarioc(pempresa CHAR(3))
...
RETURNING CHAR(5), INTEGER;
    ...
    --- SET DEBUG FILE TO "arregsdodiarioc.out";
    --- TRACE ON;
    ...
    FOREACH WITH HOLD
        ...
        UPDATE sc_sdodiarioc
           SET capvig8 = capvig8 + vmonto_int,
               capvigacum = capvigacum + vmonto_int
