CREATE PROCEDURE "informix".sp_ftc_ptoproxy(v_periodo CHAR(04))
...
ON EXCEPTION SET iSqlErr
    ...
    SET DEBUG FILE TO "/fatca/sp_ftc_ptoproxy.err";
...
--SET DEBUG FILE TO "sp_ftc_ptoproxy.out";
--TRACE ON;

LET cVarDataErr = '';
LET v_vlr_prm = '';

--- VALIDACIÓN: PUERTO PROXY ---
...
IF NOT EXISTS (SELECT a.valor
   ...
   LET cCodret = '00001';
   LET cVarDataErr = 'ERROR NO EXISTE PUERTO PARA PROXY';
ELSE
   SELECT a.valor
     INTO v_vlr_prm
     FROM bdilide:sl_ftc_prm AS a, bdilide:sl_ftc_cat AS b
