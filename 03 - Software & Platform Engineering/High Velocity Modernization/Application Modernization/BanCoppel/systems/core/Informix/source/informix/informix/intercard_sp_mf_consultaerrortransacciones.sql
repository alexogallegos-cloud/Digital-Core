create procedure "informix".sp_mf_consultaerrortransacciones(p_dtfecha_ini DATETIME YEAR TO FRACTION, p_dtfecha_final DATETIME YEAR TO FRACTION, p_ValorInicial INT8)
RETURNING 
...
BEGIN
	...
	WHERE fechahorainauth BETWEEN p_dtfecha_ini AND p_dtfecha_final AND numtarjeta = '';
