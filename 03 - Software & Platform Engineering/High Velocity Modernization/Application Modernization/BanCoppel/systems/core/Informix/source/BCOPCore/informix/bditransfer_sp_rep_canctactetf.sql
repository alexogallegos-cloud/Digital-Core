CREATE PROCEDURE "informix".sp_rep_canctactetf(pEmpresa CHAR(3), pNumCteTf CHAR(20), pNumCtaTf CHAR(20), pSucursal CHAR(4),
	...
	--SET DEBUG FILE TO "/home/sysifx/Pedro/sp_rep_canctactetf.out";
	--TRACE ON;
	...
	BEGIN
		...
		IF EXISTS (SELECT cuenta_tf FROM "informix".tf_maecte WHERE numcte_tf = pNumCteTf AND cuenta_tf = pNumCtaTf AND status_cta="2") THEN
