CREATE PROCEDURE "informix".sp_ctes_captacion()
RETURNING CHAR(5);
   ...
   DEFINE error_info             CHAR(40);
	...
	--SET DEBUG FILE TO "sp_ctes_captac_cut.out";
	--TRACE ON; 
	   
	SET ISOLATION TO DIRTY READ;
		
	--truncate table bdicheq:"informix".extriecap;
	...
	FOREACH WITH HOLD
		...
		--select -- {+INDEX(bdicheq:sc_maechq ix174_1)} productivo
		select 		
	...
	select  {+INDEX(bdinvers:sv_maeinv  idx_maeinv1)}
	num_cte, cuenta, sucursal, plazo, tasa, capital, fecha_alta  
