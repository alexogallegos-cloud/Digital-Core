CREATE PROCEDURE "informix".sp_calcularfc_pba(pEmpresa CHAR(3), 
                                          pApePat VARCHAR(26), 
                                          pApeMat VARCHAR(26), 
                                          pNombre1 VARCHAR(26),  
                                          pNombre2 VARCHAR(26), 
...
CREATE PROCEDURE "informix".ctefisico_pba( pEmpresa CHAR(3),
                                       pFuncion CHAR(1),
                                       pNumcte CHAR(20),
                                       pSucursal CHAR(4),
                                       pEjecutivo CHAR(8),
...
-- Valida referencia Coppel JOM 20/Abr/2014 FIN
    ...
    ELSE
        ...
        IF pSucursal ='0010' OR pSucursal ='0012' OR pSucursal ='0034'
            OR pSucursal ='0131' OR pSucursal ='0164' OR pSucursal ='0623' OR pSucursal ='0638' THEN
            
            IF EXISTS(SELECT * FROM si_solicitud_movil WHERE numcte=cNumcte AND folio_procesado=0) THEN
...
"MODIFICACION: Se agrega validaciÃÂ³n para cuando la sucursal este activa como caja unica",
"marque al cliente en el campo string1 como cliente nacido en caja unica",
"BD    : bdinteg",
"VER   : 1.1",
"MODIFICO : Aguilar Heredia Jesus Manuel",
"FECHA : 26/Abril/2012",
"MODIFICACION: Se agrega validaciÃÂ³n para crear la relacion de clientes Bancoppel con Coppel en una tabla de control",
"BD    : bdinteg",
"VER   : 1.1",
"MODIFICO : Zazueta Acosta Josue Remberto",
"FECHA : 11/JUNIO/2012",
"MODIFICACION:Se modificÃÂ³ para que realice el insert a la tabla de si_relacion_ctebcplcpl por medio de el", "sp_relacion_generarelacion en lugar de aserlo por medio de alta unica",
"BD    : bdinteg",
"VER   : 1.1",
"MODIFICO : Zazueta Acosta Josue Remberto",
...
"BD    : bdinteg",
"VER   : 1.1",
"MOFIDICÃÂ     : MartÃÂ­n Eduardo Miranda",
"FECHA        : 26/Abril/2013",
"MODIFICACIÃÂN : Se modifica Procedimiento Almacenado para comentar la lÃÂ­nea 'LET pCurp = cCurp'",
"               * Se aplican reglas de programaciÃÂ³n.",
"MOFIDICÃÂ     : Claudio Almodovar",
"FECHA        : 29/10/2014",
...
"MODIFICACIÃÂN : Se modifica para agregar la opcion 'S' para pFuncion y se comenta donde pFm3 toma valor si es vacio o null";
