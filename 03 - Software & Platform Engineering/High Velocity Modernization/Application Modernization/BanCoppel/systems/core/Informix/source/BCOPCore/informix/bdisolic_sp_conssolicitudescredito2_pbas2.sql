CREATE PROCEDURE "informix".sp_conssolicitudescredito2_pbas2 (pTipo INTEGER, pEmpresa CHAR(3), pSucursal CHAR(20), 
...
RETURNING
	...
	--SET DEBUG FILE TO "/respaldosbd/IvanM/18077/sp_conssolicitudescredito2.out";
	--TRACE ON;
