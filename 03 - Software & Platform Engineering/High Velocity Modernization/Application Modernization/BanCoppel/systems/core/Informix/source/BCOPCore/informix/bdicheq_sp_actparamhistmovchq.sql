CREATE PROCEDURE "informix".sp_actparamhistmovchq(pempresa CHAR(3))
RETURNING CHAR(5);
    ...
    ON EXCEPTION SET vsqlerr, isam_err, error_info
        SET DEBUG FILE TO "/resplogifx/conciliachq/sp_actparamhistmovchq.err";
        TRACE ON;
        IF vsqlerr <> 0 THEN
            LET vcodret = vsqlerr;
    ...
    ---	SET DEBUG FILE TO "/resplogifx/conciliachq/sp_actparamhistmovchq.out";
    ---	TRACE ON;
