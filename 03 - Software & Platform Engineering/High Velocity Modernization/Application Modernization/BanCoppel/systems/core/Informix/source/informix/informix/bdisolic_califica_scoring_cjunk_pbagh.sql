CREATE PROCEDURE "informix".califica_scoring_cjunk_pbagh( o_empresa       CHAR(3),
													o_numsol   	 	CHAR(20),
	...
	-- ModificaciÃ?ÃÂ³n: Se valida la consulta del Cliente en BurÃ?ÃÂ³ de CrÃ?ÃÂ©dito.
	-- Fecha de ModificaciÃ?ÃÂ³n: 08/01/2009
	-- Proyecto: Caja Ã?Ã?nica
	--------------------------------------------------------------------------------
	-- Fecha de ModificaciÃ?ÃÂ³n: 18-02-2009
	-- ModificÃ?ÃÂ³: Viridiana Osobampo
	-- DescripciÃ?ÃÂ³n: Se valida el puntaje requerido para la secciÃ?ÃÂ³n 2 por tipo de
	--              cliente.
	-- RQM 09113
	--------------------------------------------------------------------------------
	-- Autor: Viridiana Osobampo
	-- ModificaciÃ?ÃÂ³n: Se modifica para recibir y almacenar el importe solicitado
	--               para PrÃ?ÃÂ©stamo Personal.
	--               ademas se actualiza el parametro para tomar los dias de vigencia de la consulta a SICÃ?ÃÂ´s
	-- Fecha de ModificaciÃ?ÃÂ³n: 18/09/2009
	-- PeticiÃ?ÃÂ³n: RQM 10 108 PrÃ?ÃÂ©stamo Personal
	--------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³: Viridiana Osobampo
	--Fecha de modificaciÃ?ÃÂ³n: 25-09-2009
	--DescripciÃ?ÃÂ³n: Se modifica para reemplazar los parÃ?ÃÂ¡metros al obtener la edad minima y maxima
	--                   por el cambio a los asignados para el proyecto de caja unica.
	--Peticion: RQM 10 108 PrÃ?ÃÂ©stamo Personal
	------------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³: Viridiana Osobampo
	--Fecha de modificaciÃ?ÃÂ³n: 15-10-2009
	--DescripciÃ?ÃÂ³n: Se realiza correcciÃ?ÃÂ³n de query  que verifica que la puntuaciÃ?ÃÂ³n
	-- 		   del scoring es vÃ?ÃÂ¡lida, Ã?ÃÂ©sto para que el count de registros se
	--		  realice por el campo secciÃ?ÃÂ³n.
	--Peticion: RQM 10 108 PrÃ?ÃÂ©stamo Personal
	------------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³: Viridiana Osobampo
	--Fecha de modificaciÃ?ÃÂ³n: 05-01-2010
	--DescripciÃ?ÃÂ³n:  Se modifca la variable de cÃ?ÃÂ³digo de retorno para asignar un
	--		error controlado de 5 caracteres y no de 6 como se eontraba,
	--		Ã?ÃÂ©sto al ocurrir un error en la ejecuciÃ?ÃÂ³n del spl
	...
	------------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³: Viridiana Osobampo
	--Fecha de modificaciÃ?ÃÂ³n: 17-01-2010
	--DescripciÃ?ÃÂ³n: Se modifica para cuando el nÃ?ÃÂºm de salarios minimos sobrepase el
	--		  rango mÃ?ÃÂ¡ximo, se tope al valor mÃ?ÃÂ¡ximo.
	--Peticion: PrÃ?ÃÂ©stamo Personal
	------------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³: Viridiana Osobampo
	--Fecha de modificaciÃ?ÃÂ³n: 01-07-2010
	--DescripciÃ?ÃÂ³n: Se agregan parÃ?ÃÂ¡metros para recibir el tipo de ingreso y la periodicidad,
	--		  mismos datos que se actualizan como parte de la informaciÃ?ÃÂ³n de solicitud.
	--Peticion: Alta Ã?Ã?nica paso 4
	------------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³: JesÃ?ÃÂºs Manuel Aguilar Heredia
	--Fecha de modificaciÃ?ÃÂ³n: 09-12-2010
	--DescripciÃ?ÃÂ³n: Se  agrega validacion para identificar si el cliente presenta una ocupacion de riesgo.
	--Peticion: Alta Ã?Ã?nica paso 4.5
	------------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³: Mohamed Carreon
	--Fecha de modificaciÃ?ÃÂ³n: 07-06-2011
	--DescripciÃ?ÃÂ³n: Se  agrega una causa de rechazo la cual valida que cuando una solicitud sea de coppel y
	--                       que si el estado civil es diferente a casado que verifique que al menos tenga una referencia  de familiar directo
	--		    Causa => "RFP"  DescripciÃ?ÃÂ³n Causa => "Fuera de PolÃ?ÃÂ­ticas de CrÃ?ÃÂ©dito Coppel".
	--Peticion: Alta Ã?Ã?nica paso 5
	------------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³:JesÃ?ÃÂºs Manuel Aguilar Heredia
	--Fecha de modificaciÃ?ÃÂ³n: 26-10-2011
	--DescripciÃ?ÃÂ³n: Se registra las referencias para el producto coppel, ya que si tramita banco y coppel al mismo tiempo, la informaciÃ?ÃÂ³n se guarda con el numero de solicitud de banco,
	--Peticion: Ajustes Alta Ã?Ã?nica paso 5 - piloto
	------------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³:JesÃ?ÃÂºs Manuel Aguilar Heredia
	--Fecha de modificaciÃ?ÃÂ³n: 22-12-2011
	--DescripciÃ?ÃÂ³n: Se modifca para verficar si es necesario el envio a buro de credito.
	--Peticion: RQM 18 011 Vigencia de Consulta al BurÃ?ÃÂ³ y CÃ?ÃÂ­rculo de CrÃ?ÃÂ©dito
	------------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³:JosuÃ?ÃÂ© Remberto Zazueta Acosta  
	--Fecha de modificaciÃ?ÃÂ³n: 16-11-2012 
	--DescripciÃ?ÃÂ³n: Se modifica para rechazar solicitudes de crÃ?ÃÂ©dito BanCoppel y Coppel  que hagan match con la huella de algÃ?ÃÂºn  empleado del grupo Coppel 
	--Peticion: RQM+09+299+Rechazo+de+solicitudes+de+CrÃ?ÃÂ©dito+a+empleados+del+grupo_0001_v1.pdf 
	--BD      : bdisolic
	------------------------------------------------------------------------------------ 
	------------------------------------------------------------------------------------ 
	--ModificÃ?ÃÂ³: Clemente Angulo Ballardo 
	--Fecha de modificaciÃ?ÃÂ³n: 22-12-2012 
	--DescripciÃ?ÃÂ³n: Se valida el riesgo correctamente de la actividad del solicitante, segun sea una solicitud Banco o Coppel
	--Peticion: RQM+09+299+Rechazo+de+solicitudes+de+CrÃ?ÃÂ©dito+a+empleados+del+grupo_0001_v1.pdf 
	--BD      : bdisolic 
	------------------------------------------------------------------------------------ 
	------------------------------------------------------------------------------------ 
	--ModificÃ?ÃÂ³: Guadalupe Payan
	--Fecha de modificaciÃ?ÃÂ³n: 25-01-2013
	--DescripciÃ?ÃÂ³n: Se realiza homologaciÃ?ÃÂ³n con fuentes modificados por bancoppel: Se agrega validaciÃ?ÃÂ³n para filtrar clientes "Z"  y actualizar la causa solicitud a "RDO". 
	--             AdemÃ?ÃÂ¡s se actualiza el campo "elemento" de la tabla "bdisolic:ss_detalle_scoring" segÃ?ÃÂºn el valor extraÃ?ÃÂ­do de la tabla "bdinteg:si_ctepf del campo habita_en".
	...
	--DescripciÃ?ÃÂ³n: Se modifica el nombre del sp de califica_scoring_cjunk_02 a califica_scoring_cjunk
	--Peticion: RQM 18 023 - EstatusSolicitudCoppelEC
	------------------------------------------------------------------------------------
	------------------------------------------------------------------------------------
	--ModificÃ?ÃÂ³: Carlos Aguirre Vega
	--Fecha de modificaciÃ?ÃÂ³n: 23-05-2013
	--DescripciÃ?ÃÂ³n: Se actualiza status de solicitud a EC cuando la solicitud termine de consultar buro.
	--Peticion: RQM 18 023 - EstatusSolicitudCoppelEC
	------------------------------------------------------------------------------------
	-- ModificÃ?ÃÂ³: Maria Elena Angulo Aispuro
	-- Fecha de ModificaciÃ?ÃÂ³n: 28-08-2018
	-- DescripciÃ?ÃÂ³n: Se inhabilita el bloque de FICO Extended
	-- RQ: RQI27201
	-- CC Rational: 26072
	------------------------------------------------------------------------------------
	-- *********************************************************************
	...
	--- habita en CorrecciÃ?ÃÂ³n Grupo 6 FMJ INI 
	DEFINE vElementohabita_en 		SMALLINT; 
	---habita en CorrecciÃ?ÃÂ³n Grupo 6 FMJ FIN 
...
--IPCB junio2017//RECHAZO POR CREDITO BLOQUEADO RCB 
	...
	-- ****************************************************************************
    SET DEBUG FILE TO "/tmp/califica_scoring_cjunk_anne.out";
	TRACE ON;
...
--IPCB junio2017//RECHAZO POR CREDITO BLOQUEADO RCB 
   ...
   END EXCEPTION WITH RESUME;*/
		...
		-- ********************************  
       --SET DEBUG file to 'califica_scoring_cjunk_pam.out';   TRACE ON;
		...
		sol.numcte,sol.tipo_solicitud, sol.num_producto,sol.sucursal,mov.status,mov.folio_movil ,sol.status_solicitud,sol.fecha_insert-- Viridiana. Obtiene el producto
		INTO v_cliente,v_tpsol, sNum_producto,v_sucursal,cStatusMov,cFolioMovil,cStatusSol2,vfecha_sol
        ...
        --APR ini
		SELECT rechazo_RGC, monto_min_cred
		INTO v_rechazo,dlinea_min_prod
	...
	--ini jesus RM 09-279-2
		...
		IF (cStatusSol2 = 'PA' and cCanal = 0) THEN
		...
		IF  (cCanal = 4 and cStatusPrev  <> '') THEN		
        ...
        IF ((sNumPregSol != sNumGpos) OR	   -- Cuestionario de solicitud en sucursal no tiene todas las preguntas, segun lo esperado en central 
		   (select count(*) from bdisolic:ss_detalle_scoring det where det.empresa = o_empresa
			 and det.seccion = '2' and det.num_solicitud = o_numsol )  != sNumGpos )  THEN
       ...
       END IF;
		...
		-- Extrae bandera de validacaiÃ?ÃÂ³n de IFE
		SELECT nvl(valor,'')
		  INTO B_valida_ife
	...
	--IF sNum_producto IN ('6001', '6600','6500') THEN--SE VALIDA QUE EL PRODUCTO SEA TDC COPPEL, BCPL BASICA O VISA
		...
		--Se optiene el numero de cliente para validar si esta excepto de validacion RGC 
			...
			ELSE 
				SELECT activo 
				 ...
				 WHERE numcte = v_cliente AND secuencia IN(SELECT {+INDEX("informix".ss_clientes_exentos_rgc)}  MAX(secuencia) FROM bdisolic:"informix".ss_clientes_exentos_rgc WHERE numcte = v_cliente);
			 
				LET cBandera = '1' ;
			 
			END IF;	
		
			IF cActivo =  'S' OR cBandera = '0' THEN 
				...
				IF NVL(cTicket,"") <> "" THEN   -- CON EL TICKET SE VALIDA QUE LA HUELLA NO CORRESPONDA A EMPLEADOS 
					...
					--IF sNum_producto <> '6400' or (sNum_producto = '6400' and cEmpresa <> 0) THEN
                        ...
                        -- OCURRIÃ?Ã? UN ERROR AL EJECUTAR EL PROCEDIMIENTO SP_ACTUALIZA_STATUS_SOL
							IF p_cod_ret <> '000000' THEN
								LET scod_ret= '00004'; 
								RETURN scod_ret;
							END IF;
		...
		IF sNum_producto ='7800' THEN --RQM 10 617
			...
			IF o_ingreso < dMontoMin THEN--dejar parametriado
				...
				AND numcte  =  v_cliente;
					...
					EXECUTE PROCEDURE "informix".sp_actualiza_status_sol(o_empresa, 'SISTEMA',o_numsol, cStatusSol,cCausa_sol, vMensaje ) INTO p_cod_ret;
					--?Tu solicitud del Anticipo de NÃ?ÃÂ³mina no concluyo satisfactoriamente, acude a tu sucursal BanCoppel para que te expliquemos el motivo ?.
		...
		IF v_mod_parame='1' THEN
			...
			-- Edo. de MÃ?ÃÂ©xico ( Edo.15), Guerrero( Edo.12), TorreÃ?ÃÂ³n( Cd 047 Edo. 05), Edo de Sinaloa (Edo. 25)
			...
			IF v_CiudadCoppelCte <> 0 THEN
				...
				-- se realiza el calculo de aÃ?ÃÂ±os cumplidos
			...
			-- Se obtiene el grupo, elemento, secciÃ?ÃÂ³n
		...
		-- Se obtiene el peso o valor de la secciÃ?ÃÂ³n a la cual hace referencia la ciudad.
			SELECT nvl(valor,0)
			INTO v_Valor_Cd
			FROM "informix".ss_scoring_pesos
			WHERE empresa = o_empresa
		...
		IF v_SalarioMinimoCoppel IS NULL THEN
			LET v_SalarioMinimoCoppel= 0;
		END IF;
		-- Se calcula el nÃ?ÃÂºmero de Salarios MÃ?ÃÂ­nimos Coppel que el cliente percibe.
		IF v_SalarioMinimoCoppel >= 0 Then
			LET v_NumSalariosMinimos= ROUND((o_ingreso / v_SalarioMinimoCoppel),2);
		ELSE
			LET v_NumSalariosMinimos= 0;
		END IF;
		-- Actualiza el numero de salarios mÃ?ÃÂ­nimos que corresponden al ingreso mensual del cliente
		UPDATE "informix".ss_resum_scor_fin
	   ...
	   --mahr-cnbv  
		...
		IF v_mod_parame='1' THEN
			...
			-- Se obtiene el peso asigado para el NÃ?ÃÂºmero de Salarios MÃ?ÃÂ­nimos Coppel.
			SELECT valor
			INTO v_Valor_smc
			FROM "informix".ss_scoring_pesos
			WHERE empresa = o_empresa
			...
			IF  v_valor_2s IS NULL THEN
				LET  v_valor_2s= 0; -- No se localizaron puntos a sumar para la secciÃ?ÃÂ³n 2
			END IF;
...
--	Se sustituye causa RDO por subcausas para reflejarse en el arbol de solicitudes RQM 04 469
		IF (v_puntualidad = "Z") THEN 
		   LET cCausa_sol = "PTZ"; 
		   LET vMensaje='Puntualidad Z'; 	
...
-- Se agrega validacion para filtrar clientes "Z" FIN 
		...
		ELIF vValidaSPTienda = 'F' THEN --se quita rechazo para producto coppel
		   LET cCausa_sol = "RSD";
		   LET vMensaje='Revaluacion situacion tienda';   
		END IF;
        ...
        IF sNum_producto ='6500' THEN						
            IF ((v_cuantos IS NULL OR v_cuantos = 0) AND v_mod_parame ='1') OR  v_profesion='6' OR vRiesgo =1 OR cSinFamiliar = "1" 
                  OR v_puntualidad = "Z" OR ( v_meses > 0 and (v_SituacionPagoCoppel < v_EficienciaCoppel) and (v_SituacionPagoCoppel >= 0)) 
                  OR vValidaSPTienda = 'F' THEN
                LET cStatusSol = 'RT';
		...
		--AAME 20150303 RQM 10 550 Se agrega consulta para la obtenciÃ?ÃÂ³n de los productos validos para heredar la informacion de referencias de la solicitud contemplando los nuevos productos de prestamo(7600,7700)
		/*SELECT COUNT(valor)
		INTO iProdMC 
		FROM "informix".ss_param 
		WHERE empresa = o_empresa
	   ...
	   --JMAH Se realiza homologacion con ajustes paso 5
		...
		--obtiene la edad del cliente --para validar si se consulta a las SICÃ?ÃÂ´s
		EXECUTE PROCEDURE bdinteg:"informix".consedadcte(o_empresa, v_cliente)
		INTO cCodRet, cNomcte, iEdadcte;
...
--IPCB 16jun2015 Se incluye para extraer la instutuciÃ?ÃÂ³n a cargar en la tabla ss_solicitudes_Sic, en vez de dejar en balnco la instituciÃ?ÃÂ³n por default cargara 'BC'
...
--IPCB junio2017//RECHAZO POR CREDITO BLOQUEADO RCB --se extrae el nuevo campo causa_rt, para validar los rechazos			
			...
			WHERE ROWID = (SELECT MAX(rowid)
						   FROM "informix".ss_solicitudes_sic
						   WHERE numcte= v_cliente
							AND (fecha_sic >= v_hoy - iDiasVigencia or fecha_sic IS NULL));
...
--JMAH RQM 09 392
			IF iFlag2credito =1 AND NVL(cNumSolSIC,'') <> '' THEN --SE valida que la solicitud vigente , tenga el flag de segundo credito
				...
				IF iFlag2creditoAux = 1 THEN
					LET iFlag2credito = 0; -- con esta validaciÃ?ÃÂ³n hacemos que no se realice nuevamente la consulta a buro 
				END IF;
			ELSE
...
--IPCB Octubre2015 RQM 09 384-3 FICO SCORE--Incluir grupos 1,A,2, Hit. Para determinar si fueron a FICO --Se incluyen en el cgrupo
				IF ptipogrupo in ('1','2','3','5','A','8') AND v_tpsol IN ( 'T','P') AND cNumSolSIC is not null THEN
...
--IPCB junio2017 //RECHAZO POR CREDITO BLOQUEADO RCB		
			...
			END IF;
		END IF;
--IPCB junio2017 //RECHAZO POR CREDITO BLOQUEADO RCB -- Se incluye la validaciÃ?ÃÂ³n flag_rt_rcb <>1, para que las solicitudes Coppel ya rechazadas por RCB no pasen a EC
