CREATE PROCEDURE "informix".sp_conssolicitudescredito_movil_credmoto_exp(pTipo INTEGER, pEmpresa CHAR(3), pSucursal CHAR(20),
...
RETURNING
	...
	SET DEBUG FILE TO "/tmp/sp_conssolicitudescredito2.out";
	TRACE ON;
