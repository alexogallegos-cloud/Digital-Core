CREATE PROCEDURE "informix".pasecontrees(pempresa     CHAR(3),
                                        fecha_pase   DATE,
                                        pusuario     CHAR(8),
                                        pusuariopase CHAR(8),
                                        pproceso     CHAR(12))
 ...
 ***************************************************************************}
 ...
 -- SET DEBUG FILE TO "/pisa/cas/pasecontrees.out";
 -- TRACE ON;
...
--         END IF;
      ...
      ELSE
         SELECT c.regional, a.suc_origen, a.codigo_fun, a.codigo_ref,
           ...
           FROM sd_movdiacrd a, sd_maecredcrd b, bdinteg:si_plazas c
          WHERE a.empresa = pempresa
            AND a.empresa = b.empresa
            AND a.num_credito = b.num_credito
            AND a.plaza = c.plaza
