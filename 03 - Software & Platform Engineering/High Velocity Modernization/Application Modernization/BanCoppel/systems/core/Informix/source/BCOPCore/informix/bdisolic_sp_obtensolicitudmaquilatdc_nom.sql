CREATE PROCEDURE "informix".sp_obtensolicitudmaquilatdc_nom(pempresa CHAR(3),
pnumcte CHAR(20),
...
END EXCEPTION;
 ...
 --SET DEBUG FILE TO '/home/sysifx/jesuslopez/736/sp_obtensolicitudmaquilatdc.out';
 --TRACE ON;
		...
		END IF;
			...
			INTO vcodret, vsecuencia, vtipo_dir, vcalle, vcolonia, ventre_calles, vpais, vestado,
			   ...
			   vNomColonia, vNomCalle, vNomMunicipio, vNomLote, vNomEntrada, vNomEdificio, vNomEtapa, vNomAndador, vNomOtros, vNomManzana;
				...
				IF vcodret <> '000' THEN
					  LET cMensajeRet = 'Error al obtener la informació® ¤el domicilio del Cliente';					 
						--- AAME 20190218 RQM 10682-4 SE GUARDA INFORMACIÓ DE REPORTERÍ
			...
			*/					--	RQM 10 1224						 
			...
			LET capellmatcliente="";
			 For i = 1 To Length(cnombre_embosado) STEP 1
				 --Recorre la cadena leñ del embozado y se divide en 4 campos
