CREATE PROCEDURE "informix".sp_depura_bitacora_bpi()
       RETURNING char(6);
...
DEFINE vcontador INTEGER;
	...
	--SET DEBUG FILE TO "/home/informix/BereniceOut/sp_depura_bitacora_bpi.out";
    --TRACE ON; 
		...
		FOREACH WITH HOLD
			...
			where id_operacion = Vid_oper 
			 AND EXTEND(fecha_oper,YEAR to day) <= dFecha
				...
				DELETE FROM bdibpi:"informix".bpi_bitacora
				WHERE id_operacion = Vid_oper 
	...
	delete temp_bpi_bitacora_depurar;
