CREATE PROCEDURE "informix".sp_rptsemanalconproac( pempresa char(3) )
RETURNING CHAR(5), CHAR(5), CHAR(50);
    ...
    ON EXCEPTION SET sql_err, isam_err, desc_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/sp_rptsemanalconproac.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/sp_rptsemanalconproac.out";
    --- TRACE ON;
    ...
    SELECT fecha
     ...
     WHERE proceso = 'rptsemanalconproac'
