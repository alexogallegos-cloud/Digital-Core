CREATE PROCEDURE "informix".sp_ctepr_actualizastatus_sitesp( 
													  pEjecutivo CHAR(8), 
...
RETURNING CHAR(6) AS CodRet;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/respaldosbd/antoniocebreros/1468/sp_ctepr_actualizastatus.out';
		--TRACE ON;
		...
		IF (NVL(pCausa,'') = '' AND NVL(cSitEsp,'') = '') THEN
		...
		END IF;
			...
			IF  cNumctebcpl <> ''  AND pNuevo_Status_Sol IN ('RT', 'AT', 'CN') THEN 		
