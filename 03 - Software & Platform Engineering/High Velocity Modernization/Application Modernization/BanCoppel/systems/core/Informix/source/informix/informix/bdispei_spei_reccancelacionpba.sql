CREATE PROCEDURE "informix".spei_reccancelacionpba( pvchrclaverastreo CHAR(30),       -- clave de rastreo
...
RETURNING CHAR(30); -- folio
	...
	LET wvchrcodretcodi = '00000';
     ...
     SET DEBUG FILE TO "/resplogifx/conciliachq/spei/spei_reccancelacionpba.out";
     TRACE ON;
