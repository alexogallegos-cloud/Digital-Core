CREATE PROCEDURE "informix".calcula_fechapago( pFechaInicial  DATE,	-->Fecha Calculo Inicial
...
RETURNING CHAR(5), -->Codigo de Retorno
    ...
    -- *******************************************************************
    --
    --      Nombre:                calcula_fechapago
    --      Version:               1.0.0
    --      Objetivo:              calcula la fecha para capitalizar intereses
    --                             para cuentas de captacion
    --      Creado por:
    ...
    --- SET DEBUG FILE TO "/tmp/calcula_fechapago.out";
    --- TRACE ON;
