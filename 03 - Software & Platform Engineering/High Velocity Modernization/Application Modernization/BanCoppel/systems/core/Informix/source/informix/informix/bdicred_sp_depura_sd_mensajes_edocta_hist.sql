CREATE PROCEDURE "informix".sp_depura_sd_mensajes_edocta_hist(pfecha_insert DATE)
       RETURNING char(6);
...
DEFINE Vfechaemision				DATE;
	...
	FROM "informix".sd_mensajes_edocta_hist
	WHERE fecha_emision >= mdy('01','20','2012')

	BEGIN WORK;

		DELETE FROM "informix".sd_mensajes_edocta_hist
