CREATE PROCEDURE "informix".sp_consultalimdepefec( pParametro CHAR(20) )
RETURNING CHAR(5), CHAR(60);
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/altamasempnet/sp_consultalimdepefec.out";
    --- TRACE ON;
...
--SET ISOLATION TO COMMITTED READ LAST COMMITTED;
    ...
    ON EXCEPTION SET viSqlErr, viIsamErr, vcDescErr
        SET DEBUG FILE TO "/resplogifx/conciliachq/altamasempnet/sp_consultalimdepefec.err";
        TRACE ON;
        IF viSqlErr <> 0 THEN
