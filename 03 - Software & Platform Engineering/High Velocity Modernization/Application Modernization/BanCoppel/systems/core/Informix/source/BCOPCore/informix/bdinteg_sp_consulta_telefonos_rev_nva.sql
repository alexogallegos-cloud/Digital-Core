CREATE PROCEDURE "informix".sp_consulta_telefonos_rev_nva( pNumCte CHAR(20) ) -- NO. CLIENTE
RETURNING CHAR(5),   -- CODIGO DE RETORNO
	...
	-- CGP 09/02/2015
	-- Se aÃÂ±ade la maxima secuencia de los correos para evitar los errores -284
    SELECT  correo_elec
      INTO vCorreo
