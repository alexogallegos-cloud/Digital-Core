CREATE PROCEDURE "informix".situacion_pago_banco_cjunk_2_pbajlh(o_empresa CHAR(3),
  ...
  -- Ini caja Unica. Viridiana
   ...
   END IF;
    ...
    IF crechazo <> '1' THEN
       ...
       FOREACH
           SELECT {+AVOID_STMT_CACHE +QUERYSELECT21} num_credito, status_cred, num_producto, fecha_apertura
            ...
            WHERE empresa = o_empresa
              ...
              AND status_cred <> "FF"
           UNION
           SELECT {+AVOID_STMT_CACHE +QUERYSELECT21.1} a.num_credito, 'CV', a.num_producto, a.fecha_apertura
