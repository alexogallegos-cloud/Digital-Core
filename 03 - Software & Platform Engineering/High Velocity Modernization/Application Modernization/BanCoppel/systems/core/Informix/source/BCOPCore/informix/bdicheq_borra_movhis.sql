CREATE PROCEDURE "informix".borra_movhis( pfecha DATE )
RETURNING CHAR(5), INTEGER, INTEGER, INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err, desc_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/borra_movhis.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/borra_movhis.out";
    --- TRACE ON;
