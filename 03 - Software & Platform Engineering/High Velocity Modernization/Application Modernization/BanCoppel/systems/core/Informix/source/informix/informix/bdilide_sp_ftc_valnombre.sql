CREATE PROCEDURE "informix".sp_ftc_valnombre(v_periodo CHAR(04))
...
ON EXCEPTION SET iSqlErr
    ...
    SET DEBUG FILE TO "/fatca/sp_ftc_valnombre.err";
...
--SET DEBUG FILE TO "sp_ftc_valnombre.out";
--TRACE ON;
...
IF NOT EXISTS (SELECT a.valor
   ...
   LET cCodret = '00001';
   LET cVarDataErr = 'ERROR NO EXISTE NOMBRE DE XML';
ELSE
   SELECT a.valor
     INTO v_vlr_prm
     FROM bdilide:sl_ftc_prm AS a, bdilide:sl_ftc_cat AS b
    WHERE a.cve_param = b.cve_param
      ...
      AND a.valor_param = '3';
   LET cCodret = '00000';
   LET cVarDataErr = 'NOMBRE XML: '||v_vlr_prm;
END IF;
