CREATE PROCEDURE "informix".sp_guardabitacora_atm(
    pEmpresa         CHAR(3),
    pTipo_movimiento CHAR(20),
    pObservaciones   CHAR(150),
    pTipo_moneda     CHAR(1),
    pUsuario         CHAR(8),
	pTipo            CHAR(1))
RETURNING CHAR(5);
...
BEGIN
    ...
    IF NVL(pEmpresa,'') = '' OR NVL(pTipo_movimiento,'') = '' OR NVL(pUsuario,'') = ''	THEN
        LET cCodRet = '00001';
    ELSE
        IF(pTipo = '1') THEN
		
			 INSERT INTO bdisuc:"informix".ss_bitacora_cajeros_suc ( empresa, tipo_movimiento, observaciones, tipo_moneda, usuario_inserta, fecha_insert) VALUES(pEmpresa,pTipo_movimiento,pObservaciones,pTipo_moneda,pUsuario,CURRENT);	
...
END PROCEDURE
DOCUMENT
'DESCRIPCION: Se crea procedimiento para guardar en bitacora los movimientos de procesos ATM',
