CREATE PROCEDURE "informix".ctefisico_mib2p(
	pEmpresa			CHAR(3),
	pFuncion			CHAR(1),
	pNumcte				CHAR(20),
	pSucursal			CHAR(4),
...
"FECHA : 26/Abril/2012",
"MODIFICACION: Se agrega validación para crear la relacion de clientes Bancoppel con Coppel en una tabla de control",
"BD    : bdinteg",
"VER   : 1.1",
"MODIFICO : Zazueta Acosta Josue Remberto",
"FECHA : 11/JUNIO/2012",
"MODIFICACION:Se modificó para que realice el insert a la tabla de si_relacion_ctebcplcpl por medio de el", "sp_relacion_generarelacion en lugar de aserlo por medio de alta unica",
"BD    : bdinteg",
"VER   : 1.1",
"MODIFICO : Zazueta Acosta Josue Remberto",
...
"BD    : bdinteg",
"VER   : 1.1",
"MOFIDICÓ     : Martín Eduardo Miranda",
"FECHA        : 26/Abril/2013",
"MODIFICACIÓN : Se modifica Procedimiento Almacenado para comentar la línea 'LET pCurp = cCurp'",
"               * Se aplican reglas de programación.",
"MOFIDICÓ     : Claudio Almodovar",
"FECHA        : 29/10/2014",
...
"MODIFICACIÓN : Se modifica para agregar la opcion 'S' para pFuncion y se comenta donde pFm3 toma valor si es vacio o null",
"--------------",
"Folio:			1693",
...
"Descripción:	Se agrega parámetro para aceptar el nuevo campo id_pais para el insert de la si_cliente y para el update de la si_ctepf",
"BD: 			bdinteg",
"Etiqueta:		DSB230162JERV1694";

CREATE PROCEDURE "informix".ctefisico_mibp2( pEmpresa CHAR(3),
                                       pFuncion CHAR(1),
                                       pNumcte CHAR(20),
                                       pSucursal CHAR(4),
                                       pEjecutivo CHAR(8),
...
CREATE PROCEDURE "informix".ctefisico_mib3p(
	pEmpresa			CHAR(3),
	pFuncion			CHAR(1),
	pNumcte				CHAR(20),
	pSucursal			CHAR(4),
