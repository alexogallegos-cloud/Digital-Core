CREATE PROCEDURE "informix".sp_consflagtdcoro(pempresa CHAR(3),pnumsolcred CHAR(20),pflagconfirma_oro CHAR (1),pnombre_embosado CHAR (21))
...
IF TRIM(NVL(cEmpresa,'')) = '' THEN
  LET cCodRet = '000001'; -- 'El parámetro no es valido';
