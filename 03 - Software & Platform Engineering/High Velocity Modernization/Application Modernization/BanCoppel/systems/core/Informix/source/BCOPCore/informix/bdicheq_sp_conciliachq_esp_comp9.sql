CREATE PROCEDURE "informix".sp_conciliachq_esp_comp9(pempresa CHAR(3), pfecha DATE)
RETURNING CHAR(5), CHAR(5), INTEGER, INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/sp_conciliachq_esp_comp9.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/sp_conciliachq_esp_comp9.out";
    --- TRACE ON;
