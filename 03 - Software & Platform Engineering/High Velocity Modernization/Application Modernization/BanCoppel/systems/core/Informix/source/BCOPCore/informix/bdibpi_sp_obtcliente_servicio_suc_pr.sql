CREATE PROCEDURE "informix".sp_obtcliente_servicio_suc_pr(pNumCel CHAR(10))
   RETURNING CHAR(5),CHAR(20);
	...
	/*
			CodRet					Descripción 
			00001				Si no encontró un cliente. 
			00000				Se realizó todo correctamente.
	*/
	
  --SET DEBUG FILE TO "/tmp/sp_obtcliente_servicio_pr.out";
  --TRACE ON;
BEGIN
   ...
   ON EXCEPTION SET sql_err
      IF sql_err <> 0 THEN
            ...
            RETURN cCod_ret,NVL(cNumCliente,'');
      END IF;
   END EXCEPTION;
	...
	WHERE celular=pNumCel AND estatus_servicio IN('A','I') ;
...
'FECHA.........: 16/12/2015',
'MODIFICACIÓN..: Se crea stored procedure, se obtiene el numero de cliente del servicio rayo por celular',
'SOLICITA......: Jesus Montoya',
'BD............: BDIBPI',
'FOLIO.........: 1785 - MejoraPagoRayo',
'AUTOR.........: Carolina Elizabeth Verdugo Gastélum',
'FECHA.........: 22/01/2016',
'MODIFICACIÓN..: Se modifica filtro de busqueda para que regrese los clientes con estatus_servio = I',
'BD............: BDIBPI';
