CREATE PROCEDURE "informix".sp_actualizarfc_alterno()
...
BEGIN
    ...
    FOREACH WITH HOLD
        select  numcte, rfc_calculado INTO vnumcte,  vrfc_calculado from resultadosrfc_alterno where rfc_duplicado=0
