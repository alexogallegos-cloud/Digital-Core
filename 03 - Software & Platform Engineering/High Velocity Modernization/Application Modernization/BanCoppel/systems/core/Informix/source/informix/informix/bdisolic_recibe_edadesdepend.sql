...
-- *************************************************************************
	...
	-- Inserta Ocurrencia 1
     IF r_col1_1 <> 0 THEN
	INSERT INTO ss_edades_depend
	  (empresa,          num_solicitud, secuencia,        
	   tipo_prestatario, edad)
	 VALUES
