CREATE PROCEDURE "informix".sp_soc_reporte_mov_atm2(vfechadesde DATE, vfechaal DATE, vmovimiento CHAR(15), pRegistros INTEGER, pRecuperacion INTEGER)
...
set isolation to dirty read;
        ...
        IF vmovimiento ='TODOS' THEN
                ...
                foreach
                        select SKIP pregistros FIRST precuperacion ssb.cc_atm, sis.nombre, ssb.accion, ssb.fecha_movimiento,  ssp.cod_proveedor, ssp.descripcion, ssb.usuario, sie.nombre
