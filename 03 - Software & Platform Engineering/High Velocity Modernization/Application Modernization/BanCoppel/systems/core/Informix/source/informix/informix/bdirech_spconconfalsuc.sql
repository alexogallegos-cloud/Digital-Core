CREATE PROCEDURE "informix".spconconfalsuc (p_sNumEmpleado CHAR(8), p_sNumSucursal CHAR(4), p_iIdConcepto SMALLINT, p_iIdEstatus SMALLINT, p_iRegistros SMALLINT)
...
CHAR(8) AS UsuarioAutoriza, CHAR(26) AS Referencia
	...
	BEGIN
		...
		FOREACH
			SELECT SKIP p_iRegistros numempleado, numsucursal, idfaltante, auxiliar, numzona, numregional, idconcepto, idrecupera, idasignado, 
			...
			AND idconcepto = NVL(p_iIdConcepto, idconcepto) AND idestatus = NVL(p_iIdEstatus, idestatus)
