CREATE PROCEDURE "informix".spei_aplicaordenpago_mib( pRegistros INTEGER, pOrigen CHAR(1) ) 
RETURNING CHAR(5), INTEGER, INTEGER; 
    ...
    SET DEBUG FILE TO "/resplogifx/conciliachq/spei/spei_aplicaordenpagMibo.out";
    TRACE ON;
