create procedure "informix".reosuc(
             detsucursal char(4),
             detciudad   char(3),
             detmayor    char(10),
             detsub1     char(10),
...
--inicializa variables
   ...
   let polidescripcion = "reubicacion de sucursales ";
   let pol1descripcion = "reubicacion de sucursales ";
   ...
   let pol1tipo_mov = " ";
   let politipo_mov = " ";
   let polisucursal = detsucursal;
   let pol1sucursal = de1sucursal;
   select regional into policiudad
       from bdinteg:si_plazas
       where plaza = (select plaza from bdinteg:si_sucursales
                      where sucursal = detsucursal);
   select regional into pol1ciudad
       from bdinteg:si_plazas
       where plaza = (select plaza from bdinteg:si_sucursales
                      where sucursal = de1sucursal);
