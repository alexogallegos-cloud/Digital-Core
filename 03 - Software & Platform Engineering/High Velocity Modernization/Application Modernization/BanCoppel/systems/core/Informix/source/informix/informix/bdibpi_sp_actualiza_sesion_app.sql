CREATE PROCEDURE "informix".sp_actualiza_sesion_app(pc_numero_cliente varchar(20), pc_canal varchar(20), pc_id_sesion char(500), key_old varchar(100), key_new varchar(100))
    ...
    SET ISOLATION TO DIRTY READ;
		...
		INTO exist
		FROM bdibpi:"informix".bpi_doblesesion 
...
--GM3 P.Del Razo: 15/11/2018 INI:Modificacion Validacion Doble Sesion para evitar error -284
			...
			IF  (vCountinactivas = 1) THEN
				...
				SET fecha = CURRENT, llave = key_new
				WHERE numcliente = pc_numero_cliente
                AND canal = pc_canal;
...
CREATE PROCEDURE "informix".sp_consulta_sesion_app(pc_numero_cliente varchar(20), pc_canal varchar(50), pc_id_sesion char(500), pc_usuario varchar(20), key_old varchar(100), key_new varchar(100))
    RETURNING CHAR(5),CHAR(3);
	...
	--SET debug FILE TO "/informix/ireb/bdibpi/BPI/sp_consulta_sesion_app.out";
	--Trace ON;
...
CREATE PROCEDURE "informix".sp_ini_session_bexi_pba(pNumCel CHAR(10),pImei CHAR(150), pUdid CHAR(150), pIp CHAR(15))
