CREATE PROCEDURE "informix".borramovscfd_piepagina( pfecha DATE )
RETURNING CHAR(5), INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/borramovscfd_piepagina.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    -- SET DEBUG FILE TO "/resplogifx/conciliachq/borramovscfd_piepagina.out";
    -- TRACE ON;
    ...
    FOREACH cursor_borra WITH HOLD FOR
        SELECT {+INDEX(sc_piepagina_edocta_factelect idx_piepagina_fe2)} fecha_emision, idreg
          INTO vfecha_emision, vidreg
