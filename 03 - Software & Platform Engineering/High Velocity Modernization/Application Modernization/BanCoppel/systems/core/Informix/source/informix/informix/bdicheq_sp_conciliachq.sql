CREATE PROCEDURE "informix".sp_conciliachq( pempresa CHAR(3) )
RETURNING CHAR(5), CHAR(5), CHAR(50), INTEGER, INTEGER;
	...
	--Quitar esta validaciÃ³n
   /*IF pempresa IS NULL OR LENGTH(TRIM(pempresa)) = 0 THEN
      RETURN '001', '001', 'ParÃ¡metro empresa invÃ¡lido', 0, 0;
   END IF;*/

	--- SET DEBUG FILE TO "/home/c98789058/SPL_ACCENTURE/sp_conciliachq.out";
    --- TRACE ON;
   ...
   SELECT valor INTO vcuentafin
    ...
    WHERE codparam = 'CtaIniConcilChqComp1';
