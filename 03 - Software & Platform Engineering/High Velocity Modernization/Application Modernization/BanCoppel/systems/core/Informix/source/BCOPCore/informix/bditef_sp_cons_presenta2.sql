CREATE PROCEDURE "informix".sp_cons_presenta2(pempresa char(3),pfechapre date)
            RETURNING 
            char(5)    AS codret,
            char(100)  AS banco,
            char(11)   AS cuenta,
...
'DESCRIPCION: SPL que se encarga de consultar el detalle de los cheques presentados.',
'BD: bditef';
