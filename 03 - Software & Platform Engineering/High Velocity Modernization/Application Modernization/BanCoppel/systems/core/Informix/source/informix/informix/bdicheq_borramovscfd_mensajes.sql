CREATE PROCEDURE "informix".borramovscfd_mensajes( pfecha DATE )
RETURNING CHAR(5), INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/borramovscfd_mensajes.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    -- SET DEBUG FILE TO "/resplogifx/conciliachq/borramovscfd_mensajes.out";
    -- TRACE ON;
    ...
    FOREACH cursor_borra WITH HOLD FOR
        SELECT {+INDEX(sc_mensajes_edocta_factelect idx_mensajes_fe)} fecha_emision
          INTO vfecha_emision
