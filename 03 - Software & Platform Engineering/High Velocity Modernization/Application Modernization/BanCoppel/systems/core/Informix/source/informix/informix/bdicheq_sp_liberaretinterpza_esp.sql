CREATE PROCEDURE "informix".sp_liberaretinterpza_esp( pEmpresa CHAR(3) ) 
RETURNING CHAR(5); 
    ...
    ON EXCEPTION SET Sql_Err, Isam_Err, Desc_Err
        SET DEBUG FILE TO "/resplogifx/conciliachq/sp_liberaretinterpza_esp.err";
        TRACE ON;
        IF Sql_Err <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/sp_liberaretinterpza_esp.out";
    --- TRACE ON;
