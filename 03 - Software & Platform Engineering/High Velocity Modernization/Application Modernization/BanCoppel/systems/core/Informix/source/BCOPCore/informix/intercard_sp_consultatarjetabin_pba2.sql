CREATE PROCEDURE "informix".sp_consultatarjetabin_pba2(pEmpresa CHAR(3), pLote INTEGER, pTarjetaini CHAR(16), pTarjetafin CHAR(16), pMigracionVisaActiva CHAR(1))
	...
	BEGIN
		...
		ELSE		
			...
			ELSE
				...
				SELECT UNIQUE(numerolote) INTO iNumeroLote2
...
CREATE PROCEDURE "informix".sp_consultatarjetabin_pba(pEmpresa CHAR(3), pLote INTEGER, pTarjetaini CHAR(16), pTarjetafin CHAR(16), pMigracionVisaActiva CHAR(1))
RETURNING CHAR(5) AS codigo_retorno,CHAR(1) AS tipo;
