CREATE PROCEDURE "informix".sp_mueve_movdia_fecha_sec(pEmpresa char(3), pfecha date, secini integer, secfin integer)
...
--set pdqpriority 15;
   ...
   FOREACH cursor_borra WITH HOLD FOR
        ...
        and num_credito matches '600*'
        and fecha_mov = pfecha
        and secuencia >= secini
        and secuencia <  secfin
