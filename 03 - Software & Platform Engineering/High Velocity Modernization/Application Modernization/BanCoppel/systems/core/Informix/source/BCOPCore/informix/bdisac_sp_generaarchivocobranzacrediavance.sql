CREATE PROCEDURE "informix".sp_generaarchivocobranzacrediavance(pCatConv CHAR (5))
...
LET ccalle           = '';
	...
	--SET DEBUG FILE TO '/RESPALDOSNEW/enrique/sp_generaarchivocobranzacrediavance.out';
	--TRACE ON;
	...
	BEGIN
        ...
        LET cCategoria  = SUBSTRING(pCatConv FROM 1 FOR 2); -- Separar  categorÃ­a 
        ...
        LET cNomArchivo = SUBSTR(cNomArchivo, 1, 3)  || -- CR_
                          ...
                          '.txt';						-- Resultado esperado: CR_AAAAMMDDHHMM.txt
        ...
        FOREACH				
            ...
            WHERE    a.fecha_pago > dFechaIni  
            AND	     a.fecha_pago      <= dFecha_Hoy
            ...
            IF bHeader = 't' THEN
                --Imprimir sÃ³lo filas de la consulta (sin encabezados)
                LET cStmt = 'echo "'
