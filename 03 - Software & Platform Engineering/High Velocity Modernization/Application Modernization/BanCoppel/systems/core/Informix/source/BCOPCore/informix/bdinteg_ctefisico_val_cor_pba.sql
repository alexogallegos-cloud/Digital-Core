CREATE PROCEDURE "informix".ctefisico_val_cor_pba
(
	--DSB230162JERV1694 - Se le agrega parámetro pIdPais CHAR(3)
...
BEGIN
	...
	--DSB230162JERV1694 - Se le agrega parámetro id_pais para invocar el SP pIdPais
...
"Descripción:	Se agrega parámetro para aceptar el nuevo campo id_pais y se le agrega como parámetro a la invocación del SP ctefisico",
"BD: 			bdinteg",
