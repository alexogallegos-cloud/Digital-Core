CREATE PROCEDURE  "informix".sp_reiniciapaseatm(pusuario char(4), pfecha_sucursal  date)
RETURNING CHAR(5);
...
BEGIN
   ...
   END EXCEPTION;
    ...
    DELETE FROM bdicont:"informix".co_poliza  WHERE fecha_captura = pfecha_sucursal AND usuario = pusuario;
...
'FECHA: 28/02/2022',
'DESCRIPCIÃN: Se agrega la tabla co_poliza para reiniciar tablas para pase ATM',
'BASE DE DATOS: bdisuc',
'FOLIO:838';
