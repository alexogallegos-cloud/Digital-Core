CREATE PROCEDURE "informix".sp_reporteprogramacionsegundo(p_tiporeporte CHAR(2),p_numcte CHAR(20),p_cve_pago CHAR(2),p_fecha_inicio DATE,p_fecha_fin DATE)

			--RETURNING CHAR(5),CHAR(60),DATE,DATE,CHAR(2),CHAR(2),CHAR(20),CHAR(20),MONEY(16,2),CHAR(2),CHAR(16),CHAR(2),CHAR(10),CHAR(5),DATE;
	...
	LET v_sNumSucursal = '';
	LET v_sDescSucursal = '';
	--SET DEBUG FILE TO "/tmp/SP_ReporteProgramacion.out";
	--TRACE ON;
	BEGIN
