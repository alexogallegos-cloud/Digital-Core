CREATE PROCEDURE "informix".spei_aplicaordenpago_trace( pRegistros INTEGER, pOrigen CHAR(1) ) 
RETURNING CHAR(5), INTEGER, INTEGER; 
    ...
    END EXCEPTION;
    -- rgr
    SET DEBUG FILE TO "/resplogifx/conciliachq/spei/spei_aplicaordenpago_trace.out";
    TRACE ON;
