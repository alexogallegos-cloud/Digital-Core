CREATE PROCEDURE "informix".sp_calculadvdish(pNumRefDish CHAR(13))
...
--SET DEBUG FILE TO '/home/sysifx/adrian/sp_calculadvdish.out';
--TRACE ON;
...
BEGIN
	...
	IF LENGTH(TRIM(pNumRefDish)) = 13 THEN
		
		LET sFijo = SUBSTR(pNumRefDish, 1, 2)::SMALLINT;
		
--		IF sFijo = 21 THEN
		
			LET sDigVerCapturado = SUBSTR(pNumRefDish,13, 1)::SMALLINT;

			FOR sCiclo = 1 TO 12
	
				LET sValorDigito = SUBSTR(pNumRefDish, sCiclo, 1)::SMALLINT;
...
END PROCEDURE
DOCUMENT
'DESCRIPCION: Calcula el digito verificador para DISH',
'AUTOR : Adrian Lara',
