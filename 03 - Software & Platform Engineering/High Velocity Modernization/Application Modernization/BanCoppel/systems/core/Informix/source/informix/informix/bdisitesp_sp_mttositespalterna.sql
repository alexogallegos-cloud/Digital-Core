CREATE PROCEDURE "informix".sp_mttositespalterna(pEmpresa CHAR(3),pNumcte CHAR(20),pSucursal CHAR(4),pOperador CHAR(8))
...
LET iSqlErr		= 0;		
	...
	BEGIN
		...
		IF  NVL(pEmpresa,'') = '' OR NVL(pNumcte,'') = '' OR NVL(pSucursal,'') = '' OR NVL(pOperador,'') = '' THEN
			LET cCodRet = '000001'; -- 'PARAMETROS INCOMPLETOS'
		ELSE
			...
			IF DBINFO("sqlca.sqlerrd2") = 0 THEN
				LET cCodRet = '000002'; -- NO SE PUDO REALIZAR EL INSERT.
			END IF	
		END IF;
	RETURN cCodRet;
	END; 
