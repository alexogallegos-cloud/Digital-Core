CREATE PROCEDURE "informix".sp_consulta_sol_cancelada_pba(pRegistros SMALLINT)
	RETURNING CHAR(5),CHAR(10),CHAR(9),CHAR(9);
	...
	BEGIN
		...
		FOREACH
			SELECT SKIP pRegistros FIRST 10 s.solicitud,s.numcte,s.ns_token INTO vSolicitud,vNumCte,vNsToken
			...
			RETURN vCodRet,vSolicitud,vNumCte,vNsToken WITH RESUME;
		END FOREACH;
