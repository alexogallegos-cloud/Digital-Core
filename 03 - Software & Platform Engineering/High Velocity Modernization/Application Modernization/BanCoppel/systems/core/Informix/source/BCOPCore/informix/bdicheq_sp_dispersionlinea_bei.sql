CREATE PROCEDURE "informix".sp_dispersionlinea_bei(pidempresa CHAR(3),pnumcte CHAR(9),pnombrearchivo CHAR(20),pSucursal CHAR(10),pUsuario CHAR(10),pTransaccionIva CHAR(5),pTransaccionCargo CHAR(5),pFolioSuc CHAR(20),pCuenta CHAR(20),pIvaDisp MONEY(14,2),pCargoDisp MONEY(14,2))
returning char(5);
...
--Fecha: 15/08/2017
--Actividad:Se clona de  sp_dispersionlinea_bei, para el proceso batch en segundo plano de dispersiÃ³n en lÃ­nea.
--BD:bdicheq.
	...
	--SET debug FILE TO "/home/informix/BereniceOut/sp_dispersionlinea_bei.out";
	--Trace ON;
					...
					IF vcodret4="000" THEN
							...
							--	CALL bdicheq:"informix".sp_dispercionnomina_bpi() returning vcodret2;
								--IF vcodret2 = "000" THEN 
									LET cMensaje = 'LA APLICACION SE EJECUTO EXITOSAMENTE CC (se omite el spl de dispersionnomina_bpi';
								--ELSE
