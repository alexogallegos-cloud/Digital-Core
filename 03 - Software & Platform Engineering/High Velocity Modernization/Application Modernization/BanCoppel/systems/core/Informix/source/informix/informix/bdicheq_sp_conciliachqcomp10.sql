CREATE PROCEDURE "informix".sp_conciliachqcomp10( pempresa CHAR(3) )
RETURNING CHAR(5), CHAR(5), CHAR(50), INTEGER, INTEGER;
    ...
    LET vpri_hab_mes  = '';
    LET vfecha_actual = '';
    LET vproceso      = 'conciliachqcomp10';
    LET vsistema      = '01';
    LET vexiste       = 0;
    LET vexistefin    = 0;
    LET vusuario      = user;
    ...
    ON EXCEPTION SET sql_err, isam_err, desc_err
      SET DEBUG FILE TO "/resplogifx/conciliachq/sp_conciliachqcomp10.err";
      TRACE ON;
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/sp_conciliachqcomp10.out";
    --- TRACE ON;
   ...
   END IF;
    ...
    IF vfecha_actual = vpri_hab_mes THEN
        ...
        FOREACH cur_1 WITH HOLD FOR
			...
			--Se quita Directiva, B̼squeda OK , con INDEX PATH
