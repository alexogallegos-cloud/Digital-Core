CREATE PROCEDURE "informix".corrige_prov_31102010(pempresa CHAR(3))
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/corrige_prov_31102010.err";
        TRACE ON;
        IF sql_err <> 0 THEN
            LET vcodret = sql_err;
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/corrige_prov_31102010.out";
    --- TRACE ON;
    ...
    LET vsql = 'echo "LOAD FROM /resplogifx/conciliachq/prov_31102010.unl INSERT INTO ctasxcorregir" > /resplogifx/conciliachq/ctasxcorreg.sql';
    SYSTEM vsql;
    LET vsql = '';
