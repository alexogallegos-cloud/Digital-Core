CREATE PROCEDURE "informix".sp_consultactesfusionados(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumCliente CHAR(20))
		RETURNING CHAR(5) AS codret,
				CHAR(20) AS nocliente1, 
				CHAR(1) AS status_fusion,
				CHAR(30) AS desc_status_fusion, 
				CHAR(26) AS nombre1_1,
				CHAR(26) AS nombre2_1,
				CHAR(26) AS ap_paterno_1,
				CHAR(26) AS ap_materno_1, 
				CHAR(13) AS rfc_1, 
				DATE AS fecha_nacimiento_1,
				CHAR(20) AS nocliente2,
				CHAR(26) AS nombre1_2,
				CHAR(26) AS nombre2_2,
				CHAR(26) AS ap_paterno_2,
				CHAR(26) AS ap_materno_2,
				CHAR(13) AS rfc_2, 
				DATE AS fecha_nacimiento_2;
		
	DEFINE cCodRet CHAR(5);
	DEFINE iSqlErr INTEGER;
	DEFINE cNoCliente1 CHAR(20);
	DEFINE cNoCliente2 CHAR(20);
	DEFINE cStatusFusion CHAR(1);
	DEFINE cDescStatusFusion CHAR(30);
	DEFINE cNombre1_1 CHAR(26);
	DEFINE cNombre2_1 CHAR(26);
	DEFINE cApPaterno_1 CHAR(26);
	DEFINE cApMaterno_1 CHAR(26);
	DEFINE cRfc_1 CHAR(13);
	DEFINE dFechaNacimiento_1 DATE;
	DEFINE cNombre1_2 CHAR(26);
	DEFINE cNombre2_2 CHAR(26);
	DEFINE cApPaterno_2 CHAR(26);
	DEFINE cApMaterno_2 CHAR(26);
	DEFINE cRfc_2 CHAR(13);
	DEFINE dFechaNacimiento_2 DATE;
	DEFINE iNoRegistrosCliente INTEGER;
	...
	LET cNoCliente2 = '';
	LET cStatusFusion = '';
	LET cDescStatusFusion = '';
	LET cNombre1_1 = '';
	LET cNombre2_1 = '';
	LET cApPaterno_1 = '';
	LET cApMaterno_1 = '';
	LET cRfc_1 = '';
	LET dFechaNacimiento_1 = NULL;
	LET cNombre1_2 = '';
	LET cNombre2_2 = '';
	LET cApPaterno_2 = '';
	LET cApMaterno_2 = '';
	LET cRfc_2 = '';
	LET dFechaNacimiento_2 = NULL;
	LET iNoRegistrosCliente= 0;
	
	BEGIN
	
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, cNoCliente1, cStatusFusion, cDescStatusFusion, 
					cNombre1_1, cNombre2_1, cApPaterno_1, cApMaterno_1, cRfc_1, dFechaNacimiento_1,
					cNoCliente2, cNombre1_2, cNombre2_2, cApPaterno_2, cApMaterno_2, cRfc_2, dFechaNacimiento_2;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_consultactesfusionados.out';
		--TRACE ON;
		
		IF NVL(pUsuario,'') = '' OR NVL(pIdFuncion,'') = '' OR NVL(pNumCliente,'') = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet, cNoCliente1, cStatusFusion, cDescStatusFusion, 
					cNombre1_1, cNombre2_1, cApPaterno_1, cApMaterno_1, cRfc_1, dFechaNacimiento_1,
					cNoCliente2, cNombre1_2, cNombre2_2, cApPaterno_2, cApMaterno_2, cRfc_2, dFechaNacimiento_2;
		...
		-- BUSCAMOS AL CLIENTE EN LA TABLA DE LOS FUSIONADOS
		SELECT COUNT(*)
		INTO iNoRegistrosCliente
		--FROM bdicnweb:'informix'.sw_tr_clientesduplicados
		FROM bdicnweb:sw_tr_clientesduplicados
		WHERE numcte_1 = pNumCliente 
			OR numcte_2 = pNumCliente;
		
		IF iNoRegistrosCliente = 0 THEN
			LET cCodRet = '00022';
			RETURN cCodRet, cNoCliente1, cStatusFusion, cDescStatusFusion, 
					cNombre1_1, cNombre2_1, cApPaterno_1, cApMaterno_1, cRfc_1, dFechaNacimiento_1,
					cNoCliente2, cNombre1_2, cNombre2_2, cApPaterno_2, cApMaterno_2, cRfc_2, dFechaNacimiento_2;
		...
		FOREACH SELECT DECODE(cte_correcto, '1', numcte_1, '2', numcte_2, numcte_1) AS cte_correcto
					, DECODE(cte_correcto, '1', numcte_2, '2', numcte_1, numcte_2) AS cte_incorrecto
					, flag_fusion
					, DECODE(flag_fusion, '1', 'CLIENTE FUSIONADO', 'CLIENTE NO FUSIONADO') AS desc_fusion
					INTO cNoCliente1, cNoCliente2, cStatusFusion, cDescStatusFusion
				--FROM bdicnweb:'informix'.sw_tr_clientesduplicados
				FROM bdicnweb:sw_tr_clientesduplicados
				WHERE numcte_1 = pNumCliente OR numcte_2 = pNumCliente
			
			-- CONSULTAMOS LOS DATOS DEL CLIENTE CORRECTO
			SELECT nombre1, nombre2, apell_paterno, apell_materno, rfc, fecha_nac
			INTO cNombre1_1, cNombre2_1, cApPaterno_1, cApMaterno_1, cRfc_1, dFechaNacimiento_1
			FROM bdinteg:si_cliente b LEFT JOIN bdinteg:si_ctepf c ON c.numcte = b.numcte
			WHERE b.numcte = cNoCliente1;
			
			IF DBINFO('sqlca.sqlerrd2') = 0 THEN
				SELECT nombre1, nombre2, apell_paterno, apell_materno, rfc, fecha_nac
				INTO cNombre1_1, cNombre2_1, cApPaterno_1, cApMaterno_1, cRfc_1, dFechaNacimiento_1 
				FROM bdinteg:si_fuscliente b LEFT JOIN bdinteg:si_fusctepf c ON c.numcte = b.numcte
				WHERE b.numcte = cNoCliente1;
			END IF;
			-- CONSULTAMOS LOS DATOS DEL CLIENTE INCORRECTO
			SELECT nombre1, nombre2, apell_paterno, apell_materno, rfc, fecha_nac
			INTO cNombre1_2, cNombre2_2, cApPaterno_2, cApMaterno_2, cRfc_2, dFechaNacimiento_2 
			FROM bdinteg:si_cliente b LEFT JOIN bdinteg:si_ctepf c ON c.numcte = b.numcte
			WHERE b.numcte = cNoCliente2;
			...
			RETURN cCodRet, cNoCliente1, cStatusFusion, cDescStatusFusion, 
					cNombre1_1, cNombre2_1, cApPaterno_1, cApMaterno_1, cRfc_1, dFechaNacimiento_1,
					cNoCliente2, cNombre1_2, cNombre2_2, cApPaterno_2, cApMaterno_2, cRfc_2, dFechaNacimiento_2 WITH RESUME;		
		END FOREACH;
...
'FECHA: 16/07/2014',
'DESCRIPCION: Consulta los clientes que se fusionaron',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_regaccesoautenticacionfusioncte(pUsuario CHAR(8), pIdFuncion CHAR(10), pUsuarioIntentoAcceso CHAR(8))
		RETURNING CHAR(5) AS codret,
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_regaccesoautenticacionfusioncte.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pUsuarioIntentoAcceso = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet, iNoRegistros;
		END IF;
		...
		LET cAbreAplicacion = 'NO';
		LET cStatus = 'Usuario No Autorizado';
		LET cTipoReporte = '1';
		
		INSERT INTO bdinteg:"informix".si_fusbitacora(usuario_sif, abre_aplicacion, fecha_abreaplicacion, hora_abreaplicacion, usuario_no_autorizado, status, tipo_reporte)
		VALUES(pUsuario, cAbreAplicacion, CURRENT, CURRENT, pUsuarioIntentoAcceso, cStatus, cTipoReporte);
...
DOCUMENT 'AUTOR: Oscar Flores Conde',
'FECHA: 10/09/2014',
'DESCRIPCION: Registra el acceso no autorizado a la funcionalidad de FusiÃ³n de Clientes asÃ­ como el intento fallido de fusion de un cliente',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_usuariosfuncionalidad(pUsuario CHAR(8), pIdFuncion CHAR(10), pIdFuncionConsulta CHAR(10))
		RETURNING CHAR(5) AS codret,
				CHAR(8) AS ejecutivo,
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_usuariosfuncionalidad.out';
		--TRACE ON;
		...
		IF pIdFuncionConsulta = '' THEN
			LET pIdFuncionConsulta = pIdFuncion;
		END IF;
		...
		SET ISOLATION TO DIRTY READ;
		FOREACH SELECT id_usuario, nombre
			INTO cEjecutivo, cNombreEjecutivo
			FROM bdinteg:si_seg_usuarios_funciones a LEFT JOIN bdinteg:si_ejecut b ON b.ejecutivo = a.id_usuario
			WHERE id_funcion = pIdFuncionConsulta
			
			RETURN cCodRet, cEjecutivo, cNombreEjecutivo WITH RESUME;
...
DOCUMENT 'AUTOR: Oscar Flores Conde',
'FECHA: 16/07/2014',
'DESCRIPCION: Consulta los ejecutivos que tienen asignada una funcionalidad',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consultahistoricotarjetascte(pUsuario CHAR(10), pIdFuncion CHAR(10), pNumCuenta CHAR(20), pNumTarjeta CHAR(16), pSistemaCuenta CHAR(2), pTipoOperacion CHAR(1), pRegistros INTEGER, pRecuperacion INTEGER)
        RETURNING CHAR(5) AS codret,
                        CHAR(1) AS tipocliente,
                        CHAR(10) AS fechastatusultmod,
                        CHAR(10) AS horastatusultmod,
                        CHAR(8) AS empleadomodifico,
                        CHAR(100) AS nombreempmod,
                        CHAR(10) AS fechastatusaperturacuenta,
                        CHAR(4) AS sucursalaperturacuenta,
                        CHAR(8) AS empleadoaperturo,
                        CHAR(100) AS nombreempaperturo,
                        CHAR(10) AS fechastatusentrega,
                        CHAR(10) AS horastatusentrega,
                        CHAR(4) AS sucursalentrega,
                        CHAR(8) AS empleadoentrega,
                        CHAR(100) AS nombreempentrego,
                        CHAR(25) AS statustarjetacancelada,
                        CHAR(10) AS fechastatuscancelada,
                        CHAR(10) AS horastatuscancelada,
                        SMALLINT AS secuencia,
                        CHAR(8) AS empleadomodificocancelacion,
                        CHAR(100) AS nombreempmodcancelacion,
						CHAR(16) AS num_tarjeta,
						CHAR(4) AS sucursal_modifico,
						CHAR(20) AS cuenta;
        ...
        DEFINE iTipoBusqueda SMALLINT;
        DEFINE cTipoCliente CHAR(1);
        DEFINE cFechaStatusUltMod CHAR(10);
        DEFINE cHoraStatusUltMod CHAR(10);
        DEFINE cEmpleadoModifico CHAR(8);
        DEFINE cNombreEmpMod CHAR(100);
        DEFINE cFechaStatusAperturaCuenta CHAR(10);
        DEFINE cSucursalAperturaCuenta CHAR(4);
        DEFINE cEmpleadoAperturo CHAR(8);
        DEFINE cNombreEmpAperturo CHAR(100);
        DEFINE cFechaStatusEntrega CHAR(10);
        DEFINE cHoraStatusEntrega CHAR(10);
        DEFINE cSucursalEntrega CHAR(4);
        DEFINE cEmpleadoEntrega CHAR(8);
        DEFINE cNombreEmpEntrego CHAR(100);
        DEFINE cStatusTarjetaCancelada CHAR(25);
        DEFINE cFechaStatusCancelada CHAR(10);
        DEFINE cHoraStatusCancelada CHAR(10);
        DEFINE iSecuencia SMALLINT;
        DEFINE cEmpleadoModificoCancelacion CHAR(8);
        DEFINE cNombreEmpModCancelacion CHAR(100);
		DEFINE cNumCliente CHAR(20);
		DEFINE cNumTarjeta CHAR(16);
		DEFINE iNoRegistros INTEGER;
		DEFINE cSucursalModifico CHAR(4);
        ...
        LET iTipoBusqueda = 0;
        LET cTipoCliente = '';
        LET cFechaStatusUltMod = '';
        LET cHoraStatusUltMod = '';
        LET cEmpleadoModifico = '';
        LET cNombreEmpMod = '';
        LET cFechaStatusAperturaCuenta = '';
        LET cSucursalAperturaCuenta = '';
        LET cEmpleadoAperturo = '';
        LET cNombreEmpAperturo = '';
        LET cFechaStatusEntrega = '';
        LET cHoraStatusEntrega = '';
        LET cSucursalEntrega = '';
        LET cEmpleadoEntrega = '';
        LET cNombreEmpEntrego = '';
        LET cStatusTarjetaCancelada = '';
        LET cFechaStatusCancelada = '';
        LET cHoraStatusCancelada = '';
        LET iSecuencia = 0;
        LET cEmpleadoModificoCancelacion = '';
        LET cNombreEmpModCancelacion = '';
		LET cNumCliente = '';
		LET cNumTarjeta = '';
		LET iNoRegistros = 0;
		LET cSucursalModifico = '';
		LET cNumCuenta = '';
        ...
        BEGIN
                ...
                ON EXCEPTION SET iSqlErr
                        LET cCodRet = iSqlErr;
                        RETURN cCodRet, cTipoCliente, cFechaStatusUltMod, cHoraStatusUltMod, cEmpleadoModifico, cNombreEmpMod, cFechaStatusAperturaCuenta, 
                                        cSucursalAperturaCuenta, cEmpleadoAperturo, cNombreEmpAperturo, cFechaStatusEntrega, cHoraStatusEntrega, cSucursalEntrega, 
                                        cEmpleadoEntrega, cNombreEmpEntrego, cStatusTarjetaCancelada, cFechaStatusCancelada, cHoraStatusCancelada, iSecuencia, 
                                        cEmpleadoModificoCancelacion, cNombreEmpModCancelacion, cNumTarjeta, cSucursalModifico, cNumCuenta;
                END EXCEPTION;
                
                --SET DEBUG FILE to '/tmp/mfinis/sp_consultahistoricotarjetascte';
                --TRACE ON;
                
                IF pUsuario = '' OR pIdFuncion = '' OR pNumCuenta = '' OR pSistemaCuenta = '' OR pTipoOperacion = '' THEN
                        LET cCodRet = '00003';
                        RETURN cCodRet, cTipoCliente, cFechaStatusUltMod, cHoraStatusUltMod, cEmpleadoModifico, cNombreEmpMod, cFechaStatusAperturaCuenta, 
                                        cSucursalAperturaCuenta, cEmpleadoAperturo, cNombreEmpAperturo, cFechaStatusEntrega, cHoraStatusEntrega, cSucursalEntrega, 
                                        cEmpleadoEntrega, cNombreEmpEntrego, cStatusTarjetaCancelada, cFechaStatusCancelada, cHoraStatusCancelada, iSecuencia, 
				...
				IF pTipoOperacion = 0 THEN
					-- VALIDAMOS EL SISTEMA CUENTA PARA DETERMINAR QUE TIPO DE CONSULTA SE REALIZARA
					...
					-- VALIDACION DE ACCESO A LA FUNCIONALIDAD
					EXECUTE PROCEDURE bdinteg:'informix'.sp_cnsif_permisosejecutivo(pUsuario, pIdFuncion, pNumCuenta, pSistemaCuenta, '1') INTO cCodRet;
					IF cCodRet <> '00000' THEN
							RETURN cCodRet, cTipoCliente, cFechaStatusUltMod, cHoraStatusUltMod, cEmpleadoModifico, cNombreEmpMod, cFechaStatusAperturaCuenta, 
											cSucursalAperturaCuenta, cEmpleadoAperturo, cNombreEmpAperturo, cFechaStatusEntrega, cHoraStatusEntrega, cSucursalEntrega, 
											cEmpleadoEntrega, cNombreEmpEntrego, cStatusTarjetaCancelada, cFechaStatusCancelada, cHoraStatusCancelada, iSecuencia, 
				...
				IF pTipoOperacion = 0 THEN
					...
					EXECUTE PROCEDURE bdicnweb:'informix'.sp_consultahistoricotarjetas(pNumCuenta, pNumTarjeta, iTipoBusqueda, cEmpresa)
					INTO cCodRetSp, cTipoCliente, cFechaStatusUltMod, cHoraStatusUltMod, cEmpleadoModifico, cNombreEmpMod, cFechaStatusAperturaCuenta, 
											cSucursalAperturaCuenta, cEmpleadoAperturo, cNombreEmpAperturo, cFechaStatusEntrega, cHoraStatusEntrega, cSucursalEntrega, 
											cEmpleadoEntrega, cNombreEmpEntrego, cStatusTarjetaCancelada, cFechaStatusCancelada, cHoraStatusCancelada, iSecuencia, 
											cEmpleadoModificoCancelacion, cNombreEmpModCancelacion;
											
					IF cCodRetSp::INTEGER < 0 THEN
							RAISE EXCEPTION cCodRetSp::INTEGER, 0, 'ERROR EN LA EJECUCION DEL SP bdinteg:sp_consultahistoricotarjetas';
					END IF;
					
					IF cCodRetSp::INTEGER = 1 THEN
							LET cCodRet = '00039'; -- NO SE ENCONTRÃ INFORMACIÃN DE LA CUENTA
					ELIF cCodRetSp::INTEGER = 2 THEN
							LET cCodRet = '00237'; -- NO SE ENCONTRO INFORMACIÃN DE LA APERTURA DE LA CUENTA
					ELIF cCodRetSp::INTEGER = 3 THEN
							LET cCodRet = '00238'; -- NO SE ENCONTRO INFORMACIÃN DE LA ENTREGA DE LA TARJETA
					ELIF cCodRetSp::INTEGER = 4 THEN
							LET cCodRet = '00239'; -- SIN INFORMACIÃN DEL CÃDIGO DEL ESTATUS DE LA TARJETA
					END IF;
					
					-- Momentaneamente, en lo que se indica de donde tomar ese valor
					LET cSucursalModifico = cSucursalEntrega;

					RETURN cCodRet, cTipoCliente, cFechaStatusUltMod, cHoraStatusUltMod, cEmpleadoModifico, cNombreEmpMod, cFechaStatusAperturaCuenta, 
									cSucursalAperturaCuenta, cEmpleadoAperturo, cNombreEmpAperturo, cFechaStatusEntrega, cHoraStatusEntrega, cSucursalEntrega, 
									cEmpleadoEntrega, cNombreEmpEntrego, cStatusTarjetaCancelada, cFechaStatusCancelada, cHoraStatusCancelada, iSecuencia, 
									cEmpleadoModificoCancelacion, cNombreEmpModCancelacion, pNumTarjeta, cSucursalModifico, cNumCuenta;
										
				ELIF pTipoOperacion = 1 THEN
					
					LET cNumCliente = pNumCuenta;
					
					SET ISOLATION TO DIRTY READ;
					FOREACH SELECT SKIP pRegistros FIRST pRecuperacion a.cuenta, b.num_tarjeta
							INTO pNumCuenta, pNumTarjeta
							FROM bdicheq:sc_maechq a, bdicheq:sc_tarjeta b
							WHERE a.num_cte = cNumCliente AND b.numcte = a.num_cte AND b.cuenta = a.cuenta
							UNION
							-- TARJETAS DE CREDITO
							SELECT a.num_credito, b.num_tarjeta
							FROM bdicred:sd_maecred a, bdicred:sd_tarjeta b
							WHERE a.numcte = cNumCliente AND b.numcte = a.numcte AND b.num_credito = a.num_credito
							
							LET cNumCuenta = pNumCuenta;
							LET cNumTarjeta = pNumTarjeta;
							
							LET iTipoBusqueda = 2;
							IF SUBSTR(pNumCuenta, 1, 1) = '6' THEN
								LET iTipoBusqueda = 1;
							END IF;
							...
							RETURN cCodRet, cTipoCliente, cFechaStatusUltMod, cHoraStatusUltMod, cEmpleadoModifico, cNombreEmpMod, cFechaStatusAperturaCuenta, 
											cSucursalAperturaCuenta, cEmpleadoAperturo, cNombreEmpAperturo, cFechaStatusEntrega, cHoraStatusEntrega, cSucursalEntrega, 
											cEmpleadoEntrega, cNombreEmpEntrego, cStatusTarjetaCancelada, cFechaStatusCancelada, cHoraStatusCancelada, iSecuencia, 
											cEmpleadoModificoCancelacion, cNombreEmpModCancelacion, cNumTarjeta, cSucursalModifico, cNumCuenta WITH RESUME;
...
DOCUMENT 'AUTOR: Oscar Flores Conde',
'FECHA: 20/01/2014',
'DESCRIPCION: Consulta los datos historicos de las tarjtas de credito/debito',
'FECHA: 11/11/2014',
'DESCRIPCION: Para el reporte se filtran solo las cuentas que tienen tarjeta',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_actdatosfirmadigitalizacion(pUsuario CHAR(8), pIdFuncion CHAR(10), pCliente CHAR(20), pCuenta CHAR(20),  
		pCodigoDocumento CHAR(4), pSecuencia SMALLINT, pDescripcion2 CHAR(30), pUserModif CHAR(8))
		RETURNING CHAR(5) AS codret;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_actdatosfirmadigitalizacion.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pCliente = '' OR pCuenta = '' OR pCodigoDocumento = '' OR pSecuencia = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		EXECUTE PROCEDURE bdidigital:"informix".act_datos_firma(cEmpresa, pCliente, pCuenta, pCodigoDocumento, pSecuencia, pDescripcion2, pUsuario)
		INTO cCodRetSp;
...
CREATE PROCEDURE "informix".sp_activalidaciontelefono(pUsuario CHAR(8), pIdfuncion CHAR(10),pNumCte CHAR(9), pFlagTelefonoCasa CHAR(1), 
					pFlagTelefonoCelular CHAR(1), pflagTelefonoOficina CHAR(1), pTipoDireccion CHAR(1), pTipo CHAR(1))
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/prospescto/sp_actvalidacioncofetel_prospecto.out';
		-- TRACE ON;
		...
		EXECUTE PROCEDURE bdinteg:"informix".sp_actvalidacioncofetel('001', pNumCte, pFlagTelefonoCasa, pFlagTelefonoCelular, pflagTelefonoOficina, pTipoDireccion,  pTipo)
		INTO cCodRetSp;
...
'Descripcion: Intermedio Funcionalidad Prospecto: Actualiza un registro en la bdinteg:si_direcciones si el telÃ©fono proporcionado por el cliente fue validado por la COFETEL',
'Fecha: 10/06/2014';

CREATE PROCEDURE "informix".sp_actualizaetapaenviodigitalizacion(pUsuario CHAR(8), pIdFuncion CHAR(10),	pIdControl INTEGER, pValorCampo CHAR(50), pTipo SMALLINT)
		RETURNING CHAR(5) AS codret;
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_actualizaetapaenviodigitalizacion.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pValorCampo = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		EXECUTE PROCEDURE bdidigital:"informix".sp_dgactualizaetapaenvioenvio(pIdControl, pValorCampo, pTipo)
		INTO cCodRetSp;
		...
		ELIF iCodRetSp = 000001 THEN	
			LET cCodRet = '00379';		ELIF iCodRetSp = 000002 THEN	
			LET cCodRet = '00380';		ELIF iCodRetSp = 000003 THEN
			LET cCodRet = '00003';
		ELIF iCodRetSp = 000004 THEN
			LET cCodRet = '00381';		END IF;
		RETURN cCodRet;
	END;
...
CREATE PROCEDURE "informix".sp_cancelaperturacteprospecto(pUsuario CHAR(8), pIdfuncion CHAR(10),pNumCte CHAR(20))
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/prospescto/sp_cancelaperturacteprospecto.out';
		-- TRACE ON;
		...
		EXECUTE PROCEDURE bdinteg:"informix".canc_aper('001', pNumCte) INTO cCodRetSp;
		IF cCodRetSp = '100' THEN
			LET cCodRet = '00022'; --El NUMERO DE CLIENTE NO EXISTE
			RETURN cCodRet;
		ELIF cCodRetSp = '365' THEN
			LET cCodRet = '00317'; --EL CLIENTE NO FUE APERTURADO EL DIA DE HOY
			RETURN cCodRet;
...
DOCUMENT
'AUTOR: Esparza Brenis Fernando Martin',
'Descripcion: Cancela prospecto Alta Domicilios',
'Fecha: 2014/06/09';
...
DOCUMENT 'AUTOR: Oscar Flores Conde',
'FECHA: 22/05/2014',
'DESCRIPCION: Consulta catalogo consultaactividadsocial. La variable pTipoOrden indica el ordenamiento de la informaciÃ³n',
'0: Consulta ordenada por el cÃ³digo, 1: Consulta ordenada por las descripciones',
'BD: bdicnweb';
...
'FECHA: 23/05/2014',
'DESCRIPCION: Se realiza procedimiento para Obtener el listado de Estados',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_catalogoinfouhcte(pUsuario CHAR(8), pIdFuncion CHAR(10), pCiudad SMALLINT, pColonia SMALLINT, pCveDom SMALLINT  , pRegistros INTEGER, pRecuperacion INTEGER)
	...
	BEGIN
		...
		LET cTmpTable = "CREATE TEMP TABLE tmpinfouh_"||iPid||" (cve_domicilio SMALLINT, nombre_domicilio CHAR(30)) WITH NO LOG;";
		EXECUTE IMMEDIATE cTmpTable;

		WHILE 1=1
			--clave domicilio= 1 manzana, 2 otros, 3 andador, 4 etapa, 5 edificio, 6 entrada, 7 lote
			FOREACH EXECUTE PROCEDURE bdinteg:"informix".sp_obtieneinfouh(pCiudad, pColonia, pCveDom, iRecuperacion)
				INTO cCodRetSp, sCveDomicilio, cNombreDomicilio
				
				LET iCodRetSp = cCodRetSp::INTEGER;
				IF iCodRetSp < 0 THEN
					RAISE EXCEPTION iCodRetSp, 0, 'ERROR EN LA EJECUCION DEL SP sp_obtieneinfouh';
				ELIF iCodRetSp = 3 THEN
					EXIT WHILE;
				END IF;
				
				LET cTmpTable = "INSERT INTO tmpinfouh_"||iPid||" VALUES('";
				LET cTmpTable = TRIM(cTmpTable)||sCveDomicilio||"', '"||cNombreDomicilio||"');";
				EXECUTE IMMEDIATE cTmpTable;
		...
		IF iNoRegistros = 0 THEN
			LET cTmpTable = "DROP TABLE tmpinfouh_"||iPid;
			EXECUTE IMMEDIATE cTmpTable;
			LET cCodRet = '00017';
			RETURN cCodRet, sCveDomicilio,cNombreDomicilio;
		END IF;
		...
		LET cTmpTable = "SELECT SKIP "||pRegistros||" FIRST "||pRecuperacion||" cve_domicilio, nombre_domicilio FROM tmpinfouh_"||iPid;
		PREPARE stmtId FROM TRIM(cTmpTable);
		DECLARE selectQryCur CURSOR FOR stmtId;
		OPEN selectQryCur;
		
		LET iNoRegistros = 0;
		FETCH selectQryCur INTO sCveDomicilio, cNombreDomicilio;
		WHILE(SQLCODE == 0)
			RETURN cCodRet, sCveDomicilio,cNombreDomicilio WITH RESUME;
			LET iNoRegistros = iNoRegistros + 1;
			FETCH selectQryCur INTO sCveDomicilio, cNombreDomicilio;
		END WHILE;
...
DOCUMENT 'AUTOR: SAUL ORTIZ BAEZA',
'FECHA: 26/05/2014',
'DESCRIPCION: Se modifica para que se obtenga tambien clave y descripcion de manzana, otros, andador, etapa, edificio, entrada y lote de una colonia con una ',
'Unidad Habitacional, ya que anteriormente solo devolvÃ­a la descripciÃ³n.',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_catalogoprocrecursosctamec(pUsuario CHAR(8), pIdFuncion CHAR(10), pClave CHAR(2))
        ...
        BEGIN
                ...
                FOREACH EXECUTE PROCEDURE bdicheq:"informix".sp_ctamec_obtieneprocrecursos(cEmpresa, pClave)
                        ...
                        LET iCodRetSp = cCodRetSp::INTEGER;
                        IF iCodRetSp < 0 THEN
                                RAISE EXCEPTION iCodRetSp, 0, 'ERROR EN LA EJECUCION DEL SP sp_ctamec_obtieneprocrecursos';
                        ELIF iCodRetSp = 200 THEN
                                LET cCodRet = '00300'; -- NO EXISTE EL TIPO DE PROCEDENCIA
                                RETURN cCodRet, cProcedencia, cDescripcion;     
                        ...
                        RETURN cCodRet, cProcedencia, cDescripcion WITH RESUME;
...
DOCUMENT 'AUTOR: Oscar Flores Conde',
'FECHA: 18/06/2014',
'DESCRIPCION: Consulta el tipo de procedencia de los recursos',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_catalogoproductoxtipopersona(pUsuario CHAR(8), pIdFuncion CHAR(10), pFisica CHAR(1), pTipoPersona CHAR(2), pCuenta CHAR(20), pCodProd CHAR(4))
        ...
        BEGIN
                ...
                FOREACH EXECUTE PROCEDURE bdicheq:"informix".sp_ctamec_obtieneproductosxtipper(cEmpresa, pFisica, pTipoPersona, pCuenta, pCodProd)
                        INTO cCodRetSp, cCodProducto, cDescProducto, cEsPersonaFisica, cTipoPersona, cDescTipoPersona
                
                        LET iCodRetSp = cCodRetSp::INTEGER;
                        IF iCodRetSp < 0 THEN
                                RAISE EXCEPTION iCodRetSp, 0, 'ERROR EN LA EJECUCION DEL SP sp_ctamec_obtieneproductosxtipper';
                        ...
                        RETURN cCodRet, cCodProducto, cDescProducto, cEsPersonaFisica, cTipoPersona, cDescTipoPersona WITH RESUME;
...
DOCUMENT 'AUTOR: Oscar Flores Conde',
'FECHA: 17/06/2014',
'DESCRIPCION: Obtener productos por tipo de persona ',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_catalogoscteprospecto(pUsuario CHAR(8), pIdfuncion CHAR(10), pConsulta CHAR(1))
		RETURNING CHAR(5) AS cCodigoRetorno,
		  CHAR(3) AS cNoNacion,
		  CHAR(60) AS cDescripcionNacion;

	DEFINE iSqlErr INTEGER;
	DEFINE cCodRet CHAR(5);
	DEFINE cNacion CHAR(3);
	DEFINE cDescNacion CHAR(60);
	...
	BEGIN
		ON EXCEPTION SET iSqlErr
			IF iSqlErr <> 0 THEN
				LET cCodRet = iSqlErr;
				RETURN  cCodRet, cNacion, cDescNacion;
			END IF;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/prospescto/catalogoNacion.out';
		--TRACE ON;
		...
		IF pConsulta = '1' THEN
			SELECT COUNT(nacion) INTO iNumRows FROM bdinteg:si_nacion;
			IF iNumRows > 1 THEN 
				FOREACH
					SELECT DISTINCT nacion, descripcion 
					INTO cNacion, cDescNacion 
					FROM bdinteg:si_nacion ORDER BY nacion
					RETURN  cCodRet, cNacion, cDescNacion WITH RESUME;
				END FOREACH;
			ELSE
				LET cCodRet = '00017';
				RETURN cCodRet, cNacion, cDescNacion;
		...
		ELIF pConsulta = '2' THEN
			SELECT COUNT(descripcion) INTO iNumRows FROM bdinteg:si_cantpersonas;
			IF iNumRows > 1 THEN 
				FOREACH
					SELECT DISTINCT descripcion 
					INTO cDescNacion 
					FROM bdinteg:si_cantpersonas ORDER BY descripcion
					RETURN  cCodRet, cNacion, cDescNacion WITH RESUME;
				END FOREACH;
			ELSE
				LET cCodRet = '00017';
		...
		ELIF pConsulta = '3' THEN
			SELECT COUNT(habita_en) INTO iNumRows FROM bdinteg:si_habitaen;
			IF iNumRows > 1 THEN 
				FOREACH
					SELECT DISTINCT habita_en, descripcion 
					INTO cNacion, cDescNacion 
					FROM bdinteg:si_habitaen ORDER BY habita_en
					RETURN  cCodRet, cNacion, cDescNacion WITH RESUME;
				END FOREACH;
			ELSE
				LET cCodRet = '00017';
		...
		ELIF pConsulta = '4' THEN
			SELECT COUNT(codidentif) INTO iNumRows FROM bdinteg:si_tipoidentif;
			IF iNumRows > 1 THEN 
				FOREACH
					SELECT DISTINCT codidentif, descripcion 
					INTO cNacion, cDescNacion 
					FROM bdinteg:si_tipoidentif ORDER BY codidentif
					RETURN  cCodRet, cNacion, cDescNacion WITH RESUME;
				END FOREACH;
			ELSE
				LET cCodRet = '00017';
		...
		ELIF pConsulta = '5' THEN
			SELECT COUNT(profesion) INTO iNumRows FROM bdinteg:si_profesion;
			IF iNumRows > 1 THEN 
				FOREACH
					SELECT DISTINCT profesion, descripcion 
					INTO cNacion, cDescNacion 
					FROM bdinteg:si_profesion ORDER BY profesion
					RETURN  cCodRet, cNacion, cDescNacion WITH RESUME;
				END FOREACH;
			ELSE
				LET cCodRet = '00017';
				RETURN cCodRet, cNacion, cDescNacion;
			END IF;
		ELIF pConsulta = '6' THEN
			SELECT COUNT(tipo_cliente) INTO iNumRows FROM bdinteg:si_tipocte;
			IF iNumRows > 1 THEN 
				FOREACH
					SELECT tipo_cliente, descripcion
					INTO cNacion, cDescNacion 
					FROM bdinteg:si_tipocte ORDER BY tipo_cliente
					RETURN  cCodRet, cNacion, cDescNacion WITH RESUME;
				END FOREACH;
			ELSE
				LET cCodRet = '00017';
...
DOCUMENT
'AUTOR: Esparza Brenis Fernando Martin',
'Descripcion: SP que consulta el catalogo para Nacion',
' 1 -> Carga Datos de Nacionalidades', 
' 2 -> NÃºmero de personas que habitan en la casa', 
' 3 -> Carga el tipo de Vivienda', 
' 4 -> Carga Tipo_IdentificaciÃ³n', 
' 5 -> Carga Ocupaciones', 
' 6 -> Carga Tipo de Cliente', 
'Fecha: 10/06/2014';
...
CREATE PROCEDURE "informix".sp_catalogotipmontomovtosctamec(pUsuario CHAR(8), pIdFuncion CHAR(10), pCodigo CHAR(2))
        ...
        BEGIN
                ...
                ON EXCEPTION SET iSqlErr
                        LET cCodRet = iSqlErr;
                        RETURN cCodRet, cCodNumMov, cDescripcion, cDe, cA;
                END EXCEPTION;
                
                --SET DEBUG FILE TO '/tmp/mfinis/sp_catalogotipmontomovtosctamec.out';
                --TRACE ON;
                ...
                FOREACH EXECUTE PROCEDURE bdicheq:"informix".sp_ctamec_obtienetipmontomovtos(cEmpresa, pCodigo)
                        INTO cCodRetSp, cCodNumMov, cDescripcion, cDe, cA
                        
                        LET iCodRetSp = cCodRetSp::INTEGER;
                        IF iCodRetSp < 0 THEN
                                RAISE EXCEPTION iCodRetSp, 0, 'ERROR EN LA EJECUCION DEL SP ';
                        ELIF iCodRetSp = 200 THEN
                                LET cCodRet = '00302'; -- NO EXISTE EL CODIGO DEL MONTO
                                RETURN cCodRet, cCodNumMov, cDescripcion, cDe, cA;
                        ELIF iCodRetSp = 300 THEN
                                LET cCodRet = '00017'; -- NO EXISTE EL CODIGO DEL MONTO
                                RETURN cCodRet, cCodNumMov, cDescripcion, cDe, cA;
                        END IF;
                        
                        RETURN cCodRet, cCodNumMov, cDescripcion, cDe, cA WITH RESUME;
...
CREATE PROCEDURE "informix".sp_catalogotipmontomovtosmensctamec(pUsuario CHAR(8), pIdFuncion CHAR(10), pCodigo CHAR(2))
                RETURNING CHAR(5) AS codret,
                                CHAR(2) AS cod_num_mov_mes,
                                CHAR(60) AS descripcion,
                                CHAR(16) AS de,
                                CHAR(16) AS a;
        ...
        BEGIN
                ...
                ON EXCEPTION SET iSqlErr
                        LET cCodRet = iSqlErr;
                        RETURN cCodRet, cCodNumMovMes, cDescripcion, cDe, cA;
                END EXCEPTION;
                
                --SET DEBUG FILE TO '/tmp/mfinis/sp_catalogotipmontomovtosmensctamec.out';
                --TRACE ON;
                ...
                FOREACH EXECUTE PROCEDURE bdicheq:"informix".sp_ctamec_obtienetipmontomovtosmens(cEmpresa, pCodigo)
                        INTO cCodRetSp, cCodNumMovMes, cDescripcion, cDe, cA
                        ...
                        RETURN cCodRet, cCodNumMovMes, cDescripcion, cDe, cA WITH RESUME;
...
CREATE PROCEDURE "informix".sp_catalogotipnummovtosctamec(pUsuario CHAR(8), pIdFuncion CHAR(10), pCodigo CHAR(2))
                RETURNING CHAR(5) AS codret,
                                CHAR(2) AS cod_num_mov,
                                CHAR(60) AS descripcion,
                                CHAR(16) AS de,
        ...
        DEFINE iCodRetSp INTEGER;
        DEFINE cEmpresa CHAR(3);
        DEFINE cCodNumMovimiento CHAR(2);
        DEFINE cDescripcion CHAR(60);
        DEFINE cDe CHAR(16);
        DEFINE cA CHAR(16);
        ...
        BEGIN
                ...
                ON EXCEPTION SET iSqlErr
                        LET cCodRet = iSqlErr;
                        RETURN cCodRet, cCodNumMovimiento, cDescripcion, cDe, cA;
                END EXCEPTION;

                --SET DEBUG FILE TO '/tmp/mfinis/sp_catalogotipnummovtosctamec.out';
                --TRACE ON;
                ...
                FOREACH EXECUTE PROCEDURE bdicheq:"informix".sp_ctamec_obtienetipnummovtos(cEmpresa, pCodigo)
                        INTO cCodRetSp, cCodNumMovimiento, cDescripcion, cDe, cA

                        LET iCodRetSp = cCodRetSp::INTEGER;
                        IF iCodRetSp < 0 THEN
                                RAISE EXCEPTION iCodRetSp, 0, 'ERROR EN LA EJECUCION DEL SP ';
                        ELIF iCodRetSp = 200 THEN
                                LET cCodRet = '00301'; -- NO EXISTE EL TIPO DE MOVIMIENTO
                                RETURN cCodRet, cCodNumMovimiento, cDescripcion, cDe, cA;
                        ELIF iCodRetSp = 300 THEN
                                LET cCodRet = '00017';
                                RETURN cCodRet, cCodNumMovimiento, cDescripcion, cDe, cA;
                        ...
                        RETURN cCodRet, cCodNumMovimiento, cDescripcion, cDe, cA WITH RESUME;
...
CREATE PROCEDURE "informix".sp_catalogotipoadminpmgobierno(pUsuario CHAR(8), pIdFuncion CHAR(10), pCodigo CHAR(3), pTipoOrden SMALLINT)
		RETURNING CHAR(5) AS codret,
				CHAR(3) AS codigo,
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_catalogotipoadminpmgobierno.out';
		-- TRACE ON;
		...
		FOREACH EXECUTE PROCEDURE bdinteg:"informix".sp_tipo_admin_pm_gobierno(cEmpresa, pCodigo, pTipoOrden)
			INTO cCodRetSp, cEmpresa, cCodigo, cDescripcion
			
			LET iCodRetSp = cCodRetSp::INTEGER;
			IF iCodRetSp < 0 THEN
				RAISE EXCEPTION iCodRetSp, 0, 'ERROR EN LA EJECUCION DEL SP sp_tipo_admin_pm_gobierno';
			ELIF iCodRetSp = 3 THEN
				LET cCodRet = '00017';
				RETURN cCodRet, cCodigo, cDescripcion;
			END IF;
...
DOCUMENT 'AUTOR: Oscar Flores Conde',
'FECHA: 26/05/2014',
'DESCRIPCION: Procedimiento para obtener el tipo de administraciÃ³n de persona moral de gobierno',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_catalogotipopoderpmgobierno(pUsuario CHAR(8), pIdFuncion CHAR(10), pCodigo CHAR(3), pTipoOrden SMALLINT)
		RETURNING CHAR(5) AS codret,
				CHAR(3) AS codigo,
				CHAR(20) AS descripcion;		
	...
	BEGIN
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_catalogotipopoderpmgobierno.out';
		-- TRACE ON;
		...
		FOREACH EXECUTE PROCEDURE bdinteg:"informix".sp_tipo_poder_pm_gobierno(cEmpresa, pCodigo, pTipoOrden)
			INTO cCodRetSp, cEmpresa, cCodigo, cDescripcion
			
			LET iCodRetSp = cCodRetSp::INTEGER;
			IF iCodRetSp < 0 THEN
				RAISE EXCEPTION iCodRetSp, 0, 'ERROR EN LA EJECUCION DEL SP sp_tipo_poder_pm_gobierno';
			ELIF iCodRetSp = 3 THEN
				LET cCodRet = '00017';
				RETURN cCodRet, cCodigo, cDescripcion;
			END IF;
			
			RETURN cCodRet, cCodigo, UPPER(cDescripcion) WITH RESUME;
...
CREATE PROCEDURE "informix".sp_catalogotiporegimenfirmas(pUsuario CHAR(8), pIdFuncion CHAR(10), pClave CHAR(1))
                RETURNING CHAR(5) AS codret,
                                CHAR(2) AS clave_regimen,
                                CHAR(20) AS descripcion,
                                CHAR(20) AS combinacion;
                
        DEFINE cCodRet CHAR(5);
        DEFINE iSqlErr INTEGER;
        DEFINE cCodRetSp CHAR(5);
        DEFINE iCodRetSp INTEGER;
        DEFINE cClaveRegimen CHAR(2);
        DEFINE cDescripcion CHAR(20);
        ...
        BEGIN
                ...
                ON EXCEPTION SET iSqlErr
                        LET cCodRet = iSqlErr;
                        RETURN cCodRet, cClaveRegimen, cDescripcion, cCombinacion;
                END EXCEPTION;
                
                --SET DEBUG FILE TO '/tmp/mfinis/sp_catalogotiporegimenfirmas.out';
                --TRACE ON;
                ...
                FOREACH EXECUTE PROCEDURE bdicntchq:"informix".sp_ctamec_obtienetiporegimenfirmas(pClave)
                        INTO cCodRetSp, cClaveRegimen, cDescripcion, cCombinacion
                
                        LET iCodRetSp = cCodRetSp::INTEGER;
                        IF iCodRetSp < 0 THEN
                                RAISE EXCEPTION iCodRetSp, 0, 'ERROR EN LA EJECUCION DEL SP sp_ctamec_obtienetiporegimenfirmas';
                        ELIF iCodRetSp = 200 THEN
                        ...
                        RETURN cCodRet, cClaveRegimen, cDescripcion, cCombinacion WITH RESUME;
...
DOCUMENT 'AUTOR: Oscar Flores Conde',
'FECHA: 18/06/2014',
'DESCRIPCION: Consulta los tipos de firmas para el alta de cuenta de persona moral',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_consdireccionctemoral(pUsuario CHAR(8), pIdFuncion CHAR(10),  pNumCliente CHAR(20), pTipoDirec INTEGER)
		RETURNING CHAR(5) AS codret,
		INT AS vsecuencia,
		CHAR(1) AS vtipo_dir,
		CHAR(40) AS vcalle,
	...
	BEGIN
		...
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet, vsecuencia, vtipo_dir, vcalle, vcolonia, ventre_calles, vpais, vestado,
                vciudad, vmunicipio, vcod_postal, vapart_postal, vtipo_telef1, vtelefono1, vtipo_telef2, vtelefono2,
                vtipo_telef3, vtelefono3, vextension, vestado_inegi, vmunicipio_inegi, vlocalidad_inegi, vnumerociudad, vnumeroextcalle,
                vnumerointcalle, vdepartamento, vnumerocalle, vnumerocolonia, vpuntocardinal, vunidadhabitac, vmanzana, votros,
                vandador, vetapa, vlote, vedificio, ventrada, vobservaciones, vNomEdo, vNomCiudad,
		...
		-- SET DEBUG FILE TO '/tmp/mfinis/sp_consdireccionctemoral.out';
		-- TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = ''  OR pNumCliente = '' OR pTipoDirec IS NULL THEN
			LET cCodRet = '00003';
			RETURN cCodRet, vsecuencia, vtipo_dir, vcalle, vcolonia, ventre_calles, vpais, vestado,
                vciudad, vmunicipio, vcod_postal, vapart_postal, vtipo_telef1, vtelefono1, vtipo_telef2, vtelefono2,
                vtipo_telef3, vtelefono3, vextension, vestado_inegi, vmunicipio_inegi, vlocalidad_inegi, vnumerociudad, vnumeroextcalle,
		...
		FOREACH EXECUTE PROCEDURE "informix".sp_consul_direc(cEmpresa, pNumCliente, pTipoDirec)
		INTO cCodRetSp,vsecuencia, vtipo_dir, vcalle, vcolonia, ventre_calles, vpais, vestado,
				vciudad, vmunicipio, vcod_postal, vapart_postal, vtipo_telef1, vtelefono1, vtipo_telef2, vtelefono2,
				vtipo_telef3, vtelefono3, vextension, vestado_inegi, vmunicipio_inegi, vlocalidad_inegi, vnumerociudad, vnumeroextcalle,
				vnumerointcalle, vdepartamento, vnumerocalle, vnumerocolonia, vpuntocardinal, vunidadhabitac, vmanzana, votros,
				vandador, vetapa, vlote, vedificio, ventrada, vobservaciones, vNomEdo, vNomCiudad,
				...
				LET iCodRetSp = cCodRetSp::INTEGER;
				IF iCodRetSp < 0 THEN
					RAISE EXCEPTION iCodRetSp, 0, 'ERROR EN LA EJECUCION DEL SP sp_consul_direc';	
				END IF;
...
DOCUMENT 'AUTOR: SAUL ORTIZ BAEZA',
'FECHA: 09/06/2014',
'DESCRIPCION: CONSULTA  DIRECCIONES DE CLIENTE MORAL',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consdireccionescteprospecto(pUsuario CHAR(8), pIdfuncion CHAR(10), pCliente CHAR(20), pTipoDireccion INTEGER)
	RETURNING
		CHAR(5)	AS	cCodret, 
		INT	AS	vsecuencia, 
		CHAR(1)	AS	vtipo_dir, 
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/prospescto/sp_sp_consdirec_Prospecto.out';
		--TRACE ON;
		
		IF NVL(pUsuario, '') = '' OR NVL(pIdFuncion, '') = '' OR NVL(pCliente, '') = '' OR NVL(pTipoDireccion, '') = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet, vsecuencia, vtipo_dir, vcalle, vcolonia, ventre_calles, vpais, vestado,vciudad, vmunicipio, vcod_postal, vapart_postal, 
			vtipo_telef1, vtelefono1, vtipo_telef2, vtelefono2,vtipo_telef3, vtelefono3, vextension, vestado_inegi, vmunicipio_inegi, vlocalidad_inegi, 
			vnumerociudad,	vnumeroextcalle,vnumerointcalle, vdepartamento, vnumerocalle, vnumerocolonia, vpuntocardinal, vunidadhabitac, vmanzana, 
...
DOCUMENT
'AUTOR: Esparza Brenis Fernando Martin',
'Descripcion: Consulta direcciones del cliente prospecto',
'Fecha: 2014/06/09';

CREATE procedure "informix".sp_consul_direc(eEmpresa  CHAR(3),
                                            eNumCte   CHAR(20),
                                            eTpDirec  INTEGER)
...
returning char(5),int,char(1),char(40),char(60),char(40),
    ...
    /*SELECT MAX(secuencia) INTO vSec       FROM si_direcciones
    WHERE  numcte    = eNumCte
    AND  tipo_dir = eTpDirec;*/
    ...
    FOREACH
     ...
     --- ORDER BY secuencia
        ...
        IF vsecuencia is null THEN LET vsecuencia = 0; END IF;
        IF vtipo_dir is null THEN LET vtipo_dir = ' '; END IF;
        IF vcalle is null THEN LET vcalle = ' '; END IF;
        IF vcolonia is null THEN LET vcolonia = ' '; END IF;
        IF ventre_calles is null THEN LET ventre_calles = ' '; END IF;
        IF vpais is null THEN LET vpais = ' '; END IF;
        IF vestado is null THEN LET vestado = ' '; END IF;
        IF vciudad is null THEN LET vciudad = ' '; END IF;
        IF vmunicipio is null THEN LET vmunicipio = ' '; END IF;
        IF vcod_postal is null THEN LET vcod_postal = ' '; END IF;
        IF vapart_postal is null THEN LET vapart_postal = ' '; END IF;
        IF vtipo_telef1 is null THEN LET vtipo_telef1 = ' '; END IF;
        IF vtelefono1 is null THEN LET vtelefono1 = ' '; END IF;
        IF vtipo_telef2 is null THEN LET vtipo_telef2 = ' '; END IF;
        IF vtelefono2 is null THEN LET vtelefono2 = ' '; END IF;
        IF vtipo_telef3 is null THEN LET vtipo_telef3 = ' '; END IF;
        IF vtelefono3 is null THEN LET vtelefono3 = ' '; END IF;
        IF vextension is null THEN LET vextension = ' '; END IF;
        IF vestado_inegi is null THEN LET vestado_inegi = ' '; END IF;
        IF vmunicipio_inegi is null THEN LET vmunicipio_inegi = ' '; END IF;
        IF vlocalidad_inegi is null THEN LET vlocalidad_inegi = ' '; END IF;
        IF vnumerociudad is null THEN LET vnumerociudad = 0; END IF;
        IF vnumeroextcalle is null THEN LET vnumeroextcalle = ' '; END IF;
        IF vnumerointcalle is null THEN LET vnumerointcalle = ' '; END IF;
        IF vdepartamento is null THEN LET vdepartamento = ' '; END IF;
        IF vnumerocalle is null THEN LET vnumerocalle = 0; END IF;
        IF vnumerocolonia is null THEN LET vnumerocolonia = 0; END IF;
        IF vpuntocardinal is null THEN LET vpuntocardinal = ' '; END IF;
        IF vunidadhabitac is null THEN LET vunidadhabitac = ' '; END IF;
        IF vmanzana is null THEN LET vmanzana = 0; END IF;
        IF votros is null THEN LET votros = 0; END IF;
        IF vandador is null THEN LET vandador = 0; END IF;
        IF vetapa is null THEN LET vetapa = 0; END IF;
        IF vlote is null THEN LET vlote = 0; END IF;
        IF vedificio is null THEN LET vedificio = 0; END IF;
        IF ventrada is null THEN LET ventrada = 0; END IF;
        IF vobservaciones is null THEN LET vobservaciones = ' '; END IF;
        IF vNomEdo is null THEN LET vNomEdo = ' '; END IF;
        IF vNomCiudad is null THEN LET vNomCiudad = ' '; END IF;
        IF vNomColonia is null THEN LET vNomColonia = ' '; END IF;
        IF vNomCalle is null THEN LET vNomCalle = ' '; END IF;
        IF vNomLote is null THEN LET vNomLote = ' '; END IF;        
        IF vNomEntrada is null THEN LET vNomEntrada = ' '; END IF;
        IF vNomEdificio is null THEN LET vNomEdificio = ' '; END IF;
        IF vNomEtapa is null THEN LET vNomEtapa = ' '; END IF;
        IF vNomAndador is null THEN LET vNomAndador = ' '; END IF;
        IF vNomOtros is null THEN LET vNomOtros = ' '; END IF;
        IF vNomManzana is null THEN LET vNomManzana = ' '; END IF;
...
"BD    : bdinteg",
"VER   : 1.1",
"MODIFICACION:  SE CAMBIA SI_DIRECCIONES POR SI_DIRECCIONES ACTUAL DE LAS CONSULTAS",
...
DOCUMENT 'AUTOR: Esparza Brenis Fernando Martin',
'FECHA: 25/07/2014',
'DESCRIPCION: ejecuta los documentos que se van a digitalizar',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consultaexpediente(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumCliente CHAR(20), pNumRegs CHAR(6), pRegistros INTEGER, pRecuperacion INTEGER)
		RETURNING CHAR(5) AS codret,
				CHAR(20) AS cuenta,
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/consultagridexpediente.out';
		--TRACE ON;
...
'FECHA: 23/07/2014',
'DESCRIPCION: Consulta los registros Existentes',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consultainfocteprospecto(pUsuario CHAR(8), pIdfuncion CHAR(10),pNumCte CHAR(20))
    RETURNING
		CHAR(5) AS cCodRet,
		CHAR(3) AS empresa,
		CHAR(20) AS numcte,
		...
		CHAR(2) AS sector,
		CHAR(3) AS segmento,
		CHAR(3) AS actividad_princ,
		CHAR(3) AS grupo,
		CHAR(3) AS subgrupo,
		CHAR(1) AS residencia,
		DATE AS fecha_alta,
		...
		CHAR(20) AS string1,
		CHAR(60) AS string2,
		SMALLINT AS numeric1,
		INTEGER AS numeric2,
		MONEY(14,2) AS money1,
		DATE AS date1,
		CHAR(1) AS puesto_ppes,
		CHAR(1) AS familiar_ppes,
		CHAR(11) AS actividad_esp,
		CHAR(8) AS ejecut_autoriza,
		...
		CHAR(20) AS pfnumcte,
		DATE AS pffecha_nac,
		CHAR(2) AS pflugar_nac,
		CHAR(3) AS pfnacionalidad,
		CHAR(18) AS pfno_fm3,
		CHAR(2) AS pfestado_civil,
		CHAR(1) AS pfregim_matrimonio,
		CHAR(3) AS pfprofesion,
		CHAR(1) AS pfsexo,
		CHAR(20) AS pfcurp,
		CHAR(2) AS pfcodidentifi,
		CHAR(30) AS pfnumidentifi,
		CHAR(12) AS pfno_imss,
		SMALLINT AS pfdependientes,
		CHAR(60) AS pftutor,
		CHAR(60) AS pfemail,
		CHAR(60) AS pfpfnom_conyuge,
		CHAR(1) AS pfseguro_defunc,
		CHAR(2) AS pfescolaridad,
		CHAR(2) AS pfhabita_en,
		SMALLINT AS pfanios_habita,
		CHAR(60) AS pfnombre_prop,
		MONEY(16,2) AS pfimp_hipo_renta,
		CHAR(30) AS pfactividadogiro,
		CHAR(20) AS pfnumeroife,
		CHAR(20) AS pfnumerotutor,
		CHAR(20) AS pfnumeroconyuge,
		CHAR(20) AS pfstring1,
		CHAR(20) AS pfstring2,
		INTEGER AS pfnumeric1,
		INTEGER AS pfnumeric2,
		MONEY(14,2) AS pfmoney1,
		DATE AS pfdate1,
		CHAR(8) AS pfuser_insert,
		DATE AS pffecha_insert,
		CHAR(1) AS tipoDireccion;
	...
	BEGIN
		ON EXCEPTION SET iSqlErr
			IF iSqlErr <> 0 THEN
				LET cCodRet = iSqlErr;
				RETURN cCodRet, vempresa, vnumcte, vstatus_cte, vsucursal, vejecutivo, vtpo_persona, vtipo_cliente, vapell_paterno, vapell_materno,
					vnombre1, vnombre2, vrazon_social, vrfc, vsector, vsegmento, vactividad_princ, vgrupo, vsubgrupo, vresidencia, vfecha_alta, 
					vapell_casada, vdistrito, vnumcte_ref, vstring1, vstring2, vnumeric1, vnumeric2, vmoney1, vdate1, vpuesto_ppes, vfamiliar_ppes, 
					vactividad_esp, vejecut_autoriza, vuser_insert, vfecha_insert, vrfc_alterno, vpfempresa, vpfnumcte, vpffecha_nac, vpflugar_nac,
					vpfnacionalidad, vpfno_fm3, vpfestado_civil, vpfregim_matrimonio, vpfprofesion, vpfsexo, vpfcurp, vpfcodidentifi, vpfnumidentifi,
					vpfno_imss, vpfdependientes, vpftutor, vpfemail, vpfpfnom_conyuge, vpfseguro_defunc, vpfescolaridad, vpfhabita_en, vpfanios_habita,
					vpfnombre_prop, vpfimp_hipo_renta, vpfactividadogiro, vpfnumeroife, vpfnumerotutor, vpfnumeroconyuge, vpfstring1, vpfstring2, vpfnumeric1,
					vpfnumeric2, vpfmoney1, vpfdate1, vpfuser_insert, vpffecha_insert, cDireccion;
			END IF;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/prospescto/sp_consulta_datos_cliente.out';
		--TRACE ON;
		...
		END IF;
				...
				SELECT FIRST 1 tipo_dir INTO cDireccion
		FROM(SELECT tipo_dir, MAX(secuencia)
			FROM bdinteg:si_direcciones_actual
			WHERE numcte = pNumCte 	GROUP BY tipo_dir ORDER BY 1 DESC);
		
		
		-- dbschema -q -f consnumcte_n -d bdinteg
		
		EXECUTE PROCEDURE bdinteg:"informix".consnumcte_n('001', pNumCte) 
		INTO cCodRetSp, vempresa, vnumcte, vstatus_cte, vsucursal, vejecutivo, vtpo_persona, vtipo_cliente, vapell_paterno, vapell_materno,
					vnombre1, vnombre2, vrazon_social, vrfc, vsector, vsegmento, vactividad_princ, vgrupo, vsubgrupo, vresidencia, vfecha_alta, 
					vapell_casada, vdistrito, vnumcte_ref, vstring1, vstring2, vnumeric1, vnumeric2, vmoney1, vdate1, vpuesto_ppes, vfamiliar_ppes, 
					vactividad_esp, vejecut_autoriza, vuser_insert, vfecha_insert, vrfc_alterno, vpfempresa, vpfnumcte, vpffecha_nac, vpflugar_nac,
					vpfnacionalidad, vpfno_fm3, vpfestado_civil, vpfregim_matrimonio, vpfprofesion, vpfsexo, vpfcurp, vpfcodidentifi, vpfnumidentifi,
					vpfno_imss, vpfdependientes, vpftutor, vpfemail, vpfpfnom_conyuge, vpfseguro_defunc, vpfescolaridad, vpfhabita_en, vpfanios_habita,
					vpfnombre_prop, vpfimp_hipo_renta, vpfactividadogiro, vpfnumeroife, vpfnumerotutor, vpfnumeroconyuge, vpfstring1, vpfstring2, vpfnumeric1,
					vpfnumeric2, vpfmoney1, vpfdate1, vpfuser_insert, vpffecha_insert;
		IF cCodRetSp = '800' THEN 
...
DOCUMENT
'AUTOR: Esparza Brenis Fernando Martin',
'Descripcion: Intermedio Funcionalidad Prospecto: inserta las direcciones del cliente prospecto',
'Fecha: 10/06/2014';

CREATE PROCEDURE "informix".sp_consultainformacionctamoral(pUsuario CHAR(8), pIdFuncion CHAR(10), pCuenta CHAR(20))
                RETURNING CHAR(5) AS codret,
        ...
        DEFINE cCodigoproducto CHAR(4);
        DEFINE cDescproducto CHAR(40);
        DEFINE cNumcliente CHAR(20);
        DEFINE cNombrecliente CHAR(60);
        DEFINE cCodregimen CHAR(1);
        DEFINE cRegimendefirmas CHAR(20);
        DEFINE sNumerofirmantes SMALLINT;
        DEFINE cClavefirmante CHAR(20);
        DEFINE cNombrefirmante CHAR(30);
        DEFINE cApellfirmante CHAR(30);
        DEFINE sSecuencia SMALLINT;
        DEFINE cTipofirma CHAR(1);
        DEFINE cCombinacion CHAR(20);
        DEFINE cCodigoprocedenciareca CHAR(2);
        DEFINE cDescprocedenciareca CHAR(60);
        DEFINE cCodigoprocedenciarecm CHAR(2);
        DEFINE cDescprocedenciarecm CHAR(60);
        DEFINE cCodnumerodeposito CHAR(2);
        DEFINE cDescnumerodeposito CHAR(60);
        DEFINE cCodnumeroretiro CHAR(2);
        DEFINE cDescnumeroretiro CHAR(60);
        DEFINE cCodmontodeposito CHAR(2);
        DEFINE cDescmontodeposito CHAR(60);
        DEFINE cCodmontoretiro CHAR(2);
        DEFINE cDescmontoretiro CHAR(60);
        DEFINE cCodmontomensual CHAR(2);
        DEFINE cDescmontomensual CHAR(60);
        ...
        LET cNombreCliente = '';
        LET cCodRegimen = '';
        LET cRegimenDefirmas = '';
        LET sNumeroFirmantes = 0;
        LET cClaveFirmante = '';
        LET cNombreFirmante = '';
        LET cApellFirmante = '';
        LET sSecuencia = 0;
        LET cTipoFirma = '';
        LET cCombinacion = '';
        LET cCodigoProcedenciaReca = '';
        LET cDescProcedenciaReca = '';
        LET cCodigoProcedenciaRecm = '';
        LET cDescProcedenciaRecm = '';
        LET cCodNumeroDeposito = '';
        LET cDescNumeroDeposito = '';
        LET cCodNumeroRetiro = '';
        LET cDescNumeroRetiro = '';
        LET cCodMontoDeposito = '';
        LET cDescMontoDeposito = '';
        LET cCodMontoRetiro = '';
        LET cDescMontoRetiro = '';
        LET cCodMontoMensual = '';
        LET cDescMontoMensual = '';
        LET cNumeroCuenta = '';
        LET cCuentaClabe = '';
        LET cNumeroSucursal = '';
        LET cNombreSucursal = '';
        ...
        BEGIN
                ...
                ON EXCEPTION SET iSqlErr
                        LET cCodRet = iSqlErr;
                        RETURN cCodRet, cCodigoProducto, cDescProducto, cNumCliente, cNombreCliente, cCodRegimen, cRegimenDefirmas, sNumeroFirmantes, 
                                cClaveFirmante, cNombreFirmante, cApellFirmante, sSecuencia, cTipoFirma, cCombinacion, cCodigoProcedenciaReca, 
                                cDescProcedenciaReca, cCodigoProcedenciaRecm, cDescProcedenciaRecm, cCodNumeroDeposito, cDescNumeroDeposito, 
                                cCodNumeroRetiro, cDescNumeroRetiro, cCodMontoDeposito, cDescMontoDeposito, cCodMontoRetiro, cDescMontoRetiro, 
                                cCodMontoMensual, cDescMontoMensual, cNumeroCuenta, cCuentaClabe, cNumeroSucursal, cNombreSucursal;
                END EXCEPTION;
                
                --SET DEBUG FILE TO '/tmp/mfinis/sp_consultainformacionctamoral.out';
                --TRACE ON;
                ...
                FOREACH EXECUTE PROCEDURE bdicheq:"informix".sp_ctamec_consultarinfoctamoral(cEmpresa, pCuenta)
                        INTO cCodRetSp, cMensaje, cCodigoProducto, cDescProducto, cNumCliente, cNombreCliente, cCodRegimen, cRegimenDefirmas, 
                                        sNumeroFirmantes, cClaveFirmante, cNombreFirmante, cApellFirmante, sSecuencia, cTipoFirma, cCombinacion, 
                                        cCodigoProcedenciaReca, cDescProcedenciaReca, cCodigoProcedenciaRecm, cDescProcedenciaRecm, cCodNumeroDeposito, 
                                        cDescNumeroDeposito, cCodNumeroRetiro, cDescNumeroRetiro, cCodMontoDeposito, cDescMontoDeposito, cCodMontoRetiro, 
                                        cDescMontoRetiro, cCodMontoMensual, cDescMontoMensual, cNumeroCuenta, cCuentaClabe, cNumeroSucursal, cNombreSucursal
                
                        LET iCodRetSp = cCodRetSp::INTEGER;
                        IF iCodRetSp < 0 THEN
                                RAISE EXCEPTION iCodRetSp, 0, 'ERROR EN LA EJECUCION DEL SP sp_ctamec_consultarinfoctamoral: '||cMensaje;
                        ELIF iCodRetSp = 110 THEN -- FALTAN PARAMETROS DE ENTRADA
                                LET cCodRet = '00017';
                                RETURN cCodRet, cCodigoProducto, cDescProducto, cNumCliente, cNombreCliente, cCodRegimen, cRegimenDefirmas, sNumeroFirmantes, 
                                        cClaveFirmante, cNombreFirmante, cApellFirmante, sSecuencia, cTipoFirma, cCombinacion, cCodigoProcedenciaReca, 
                                        cDescProcedenciaReca, cCodigoProcedenciaRecm, cDescProcedenciaRecm, cCodNumeroDeposito, cDescNumeroDeposito, 
                                        cCodNumeroRetiro, cDescNumeroRetiro, cCodMontoDeposito, cDescMontoDeposito, cCodMontoRetiro, cDescMontoRetiro, 
                                        cCodMontoMensual, cDescMontoMensual, cNumeroCuenta, cCuentaClabe, cNumeroSucursal, cNombreSucursal;
                        ELIF iCodRetSp = 120 THEN -- NO EXISTE LA CUENTA
                                LET cCodRet = '00070';
                                RETURN cCodRet, cCodigoProducto, cDescProducto, cNumCliente, cNombreCliente, cCodRegimen, cRegimenDefirmas, sNumeroFirmantes, 
                                        cClaveFirmante, cNombreFirmante, cApellFirmante, sSecuencia, cTipoFirma, cCombinacion, cCodigoProcedenciaReca, 
                                        cDescProcedenciaReca, cCodigoProcedenciaRecm, cDescProcedenciaRecm, cCodNumeroDeposito, cDescNumeroDeposito, 
                                        cCodNumeroRetiro, cDescNumeroRetiro, cCodMontoDeposito, cDescMontoDeposito, cCodMontoRetiro, cDescMontoRetiro, 
                                        cCodMontoMensual, cDescMontoMensual, cNumeroCuenta, cCuentaClabe, cNumeroSucursal, cNombreSucursal;
                        ELIF iCodRetSp = 200 THEN -- NO EXISTE EL PRODUCTO
                                LET cCodRet = '00016';
                                RETURN cCodRet, cCodigoProducto, cDescProducto, cNumCliente, cNombreCliente, cCodRegimen, cRegimenDefirmas, sNumeroFirmantes, 
                                        cClaveFirmante, cNombreFirmante, cApellFirmante, sSecuencia, cTipoFirma, cCombinacion, cCodigoProcedenciaReca, 
                                        cDescProcedenciaReca, cCodigoProcedenciaRecm, cDescProcedenciaRecm, cCodNumeroDeposito, cDescNumeroDeposito, 
                                        cCodNumeroRetiro, cDescNumeroRetiro, cCodMontoDeposito, cDescMontoDeposito, cCodMontoRetiro, cDescMontoRetiro, 
                                        cCodMontoMensual, cDescMontoMensual, cNumeroCuenta, cCuentaClabe, cNumeroSucursal, cNombreSucursal;
                        ELIF iCodRetSp = 210 THEN -- NO EXISTE EL CLIENTE
                                LET cCodRet = '00022';
                                RETURN cCodRet, cCodigoProducto, cDescProducto, cNumCliente, cNombreCliente, cCodRegimen, cRegimenDefirmas, sNumeroFirmantes, 
                                        cClaveFirmante, cNombreFirmante, cApellFirmante, sSecuencia, cTipoFirma, cCombinacion, cCodigoProcedenciaReca, 
                                        cDescProcedenciaReca, cCodigoProcedenciaRecm, cDescProcedenciaRecm, cCodNumeroDeposito, cDescNumeroDeposito, 
                                        cCodNumeroRetiro, cDescNumeroRetiro, cCodMontoDeposito, cDescMontoDeposito, cCodMontoRetiro, cDescMontoRetiro, 
                                        cCodMontoMensual, cDescMontoMensual, cNumeroCuenta, cCuentaClabe, cNumeroSucursal, cNombreSucursal;
                        ELIF iCodRetSp = 220 THEN -- NO EXISTE EL CUENTA EN MAENOC
                                LET cCodRet = '00303';
                                RETURN cCodRet, cCodigoProducto, cDescProducto, cNumCliente, cNombreCliente, cCodRegimen, cRegimenDefirmas, sNumeroFirmantes, 
                                        cClaveFirmante, cNombreFirmante, cApellFirmante, sSecuencia, cTipoFirma, cCombinacion, cCodigoProcedenciaReca, 
                                        cDescProcedenciaReca, cCodigoProcedenciaRecm, cDescProcedenciaRecm, cCodNumeroDeposito, cDescNumeroDeposito, 
                        ...
                        RETURN cCodRet, cCodigoProducto, cDescProducto, cNumCliente, cNombreCliente, cCodRegimen, cRegimenDefirmas, sNumeroFirmantes, 
                                        ...
                                        cDescProcedenciaReca, cCodigoProcedenciaRecm, cDescProcedenciaRecm, cCodNumeroDeposito, cDescNumeroDeposito, 
                                        cCodNumeroRetiro, cDescNumeroRetiro, cCodMontoDeposito, cDescMontoDeposito, cCodMontoRetiro, cDescMontoRetiro, 
                                        cCodMontoMensual, cDescMontoMensual, cNumeroCuenta, cCuentaClabe, cNumeroSucursal, cNombreSucursal WITH RESUME;
...
CREATE PROCEDURE "informix".sp_consultaparamdigitalizacion(pUsuario CHAR(8), pIdFuncion CHAR(10), pCodParam CHAR(6))
		RETURNING CHAR(5) AS codret,
				CHAR(100) AS cValor,
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_consultaparamdigitalizacion.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pCodParam = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet, cValor, cDescripcion;
		END IF;
