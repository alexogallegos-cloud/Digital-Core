CREATE PROCEDURE "informix".sp_conssolicitudescredito_movil_credmoto(pTipo INTEGER, pEmpresa CHAR(3), pSucursal CHAR(20),
...
END PROCEDURE
DOCUMENT
'DESCRIPCION: Se crea sp "sp_conssolicitudescredito_movil_credmoto", para anexar el factor_piso en producto 6500 Creditos Motos.',
'AUTOR : 99804879 EDITH MENDOZA BARRAZA',
'FECHA : 24/08/2021',
'Folio : 747.1 - RQM 09 541-2 CrÃ©dito Motos Coppel en Alta Ãnica.',
'BD    : bdisolic';
