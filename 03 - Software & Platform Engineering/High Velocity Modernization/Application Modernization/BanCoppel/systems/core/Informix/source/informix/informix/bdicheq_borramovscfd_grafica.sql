CREATE PROCEDURE "informix".borramovscfd_grafica( pfecha DATE )
RETURNING CHAR(5), INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/borramovscfd_grafica.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    -- SET DEBUG FILE TO "/resplogifx/conciliachq/borramovscfd_grafica.out";
    -- TRACE ON;
    ...
    FOREACH cursor_borra WITH HOLD FOR
        SELECT {+INDEX(sc_grafica_fe idx_graficafe)} fecha_emision
          INTO vfecha_emision
          FROM sc_grafica_fe
