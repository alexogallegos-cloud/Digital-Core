CREATE PROCEDURE "informix".sp_generaredoctaeje_factelect_comp1( pEmpresa char(3) )
RETURNING CHAR(5);
    ...
    ON EXCEPTION SET vsqlerr, iIsamErr, cErrorInfo
        IF vsqlerr != 0 THEN
            SET DEBUG FILE TO "/resplogifx/conciliachq/edoctacfd/sp_generaredoctaeje_factelect_comp1.err";
            TRACE ON;
            LET vcodret = vsqlerr;
    ...
    ---SET DEBUG FILE TO "/resplogifx/conciliachq/edoctacfd/sp_generaredoctaeje_factelect_comp1.out";
	---TRACE ON;
    ...
    -- // obtener la fecha de ultima ejecucion. 
