CREATE PROCEDURE "informix".sp_busqueda_usuario_movil(pUsuario CHAR(8), pIdFuncion CHAR(10), 
													pNoEmpleado CHAR(8), pNombre CHAR(60), pStatus CHAR(1), 
        ...
        BEGIN
                ...
                --SET DEBUG FILE TO '/tmp/mfinis/sp_busqueda_usuario_movil.out';
                --TRACE ON;
                
                IF pUsuario = '' OR pIdFuncion = '' OR (pNoEmpleado = '' AND pNombre = '' AND  pStatus = '' AND pNo_telefono = '') THEN
                        LET cCodRet = '00003';
                        RETURN cCodRet,cNoEmpleado, cNombre, cCentro_costos, cSucursal, cNo_telefono, cStatus, cNombreSuc, cImei;
                END IF;
                ...
                FOREACH
                        SELECT SKIP pNumRegistro FIRST pRecuperacion ejecutivo, activo, nombre, centro_costos, no_telefono, sucursal, imei
                        INTO cNoEmpleado, cStatus, cNombre, cCentro_costos, cNo_telefono, cSucursal, cImei
                        FROM bdinteg:"informix".si_usuario_movil 
                        WHERE ejecutivo LIKE TRIM(CONCAT('%',pNoEmpleado))||'%'  AND
                                  nombre  LIKE TRIM(CONCAT('%',pNombre))||'%'  AND
                                  activo LIKE TRIM(CONCAT('%',pStatus))||'%'  AND 
                                  no_telefono LIKE TRIM(CONCAT('%',pNo_telefono))||'%' 
...
'FECHA: 21/04/2014',
'DESCRIPCION: Busqueda de usuario en tabla si_usuario_movil',
'MODULO: Busqueda de usuario App',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_consulta_imei_app(pUsuario CHAR(8), pIdFuncion CHAR(10), pImei CHAR(20))
		RETURNING CHAR(5) AS codret,
				  CHAR(8) AS cUsuario;	 
	...
	BEGIN
		ON EXCEPTION SET iSqlErr
			LET cCodRet = iSqlErr;
			RETURN cCodRet,cUsuario;
		END EXCEPTION;
		
		--SET DEBUG FILE TO '/tmp/mfinis/sp_consulta_imei_app.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pImei = '' THEN
			LET cCodRet = '00003';
			RETURN cCodRet,cUsuario;
		END IF;
		...
		IF EXISTS(SELECT ejecutivo FROM bdinteg:"informix".si_usuario_movil WHERE imei = pImei) THEN
                     SELECT ejecutivo 
					 INTO cUsuario
					 FROM bdinteg:"informix".si_usuario_movil 
					 WHERE imei = pImei;
...
DOCUMENT 'AUTOR: SAUL ORTIZ BAEZA',
'FECHA: 05/05/2015',
'DESCRIPCION: consulta IMEI en la tabla si_usuario_movil',
'MODULO: Alta de usuario App',
'BD: bdicnweb';

CREATE PROCEDURE "informix".sp_actualizacambiobilletescaja(pUsuario CHAR(8), pIdFuncion CHAR(10), pCodProveedor CHAR(4), pProcedencia CHAR(4), pMonto DECIMAL(14,2),
						pCantidadIng1 DECIMAL(14,2), pCantidadIng2 DECIMAL(14,2), pCantidadIng3 DECIMAL(14,2), pCantidadIng4 DECIMAL(14,2), pCantidadIng5 DECIMAL(14,2),
						pCantidadIng6 DECIMAL(14,2), pCantidadIng7 DECIMAL(14,2), pCantidadIng8 DECIMAL(14,2), pCantidadIng9 DECIMAL(14,2), pCantidadIng10 DECIMAL(14,2),
						pCantidadIng11 DECIMAL(14,2), pCantidadIng12 DECIMAL(14,2), pCantidadIng13 DECIMAL(14,2), pCantidadIng14 DECIMAL(14,2), pCantidadIng15 DECIMAL(14,2),
						pCantidadEgr1 DECIMAL(14,2), pCantidadEgr2 DECIMAL(14,2), pCantidadEgr3 DECIMAL(14,2), pCantidadEgr4 DECIMAL(14,2), pCantidadEgr5 DECIMAL(14,2),
						pCantidadEgr6 DECIMAL(14,2), pCantidadEgr7 DECIMAL(14,2), pCantidadEgr8 DECIMAL(14,2), pCantidadEgr9 DECIMAL(14,2), pCantidadEgr10 DECIMAL(14,2),
						pCantidadEgr11 DECIMAL(14,2), pCantidadEgr12 DECIMAL(14,2), pCantidadEgr13 DECIMAL(14,2), pCantidadEgr14 DECIMAL(14,2), pCantidadEgr15 DECIMAL(14,2),
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_actualizacambiobilletescaja.out';
		--TRACE ON;
		
		IF pUsuario = '' OR pIdFuncion = '' OR pCodProveedor = '' OR pProcedencia = '' OR pMonto IS NULL THEN
			LET cCodRet = '00003';
			RETURN cCodRet;
		END IF;
		...
		-- ACTUALIZACION DE LOS VALORES DE INGRESOS
		UPDATE bdisuc:'informix'.ss_cajageneral
		SET cantidad_1 = cantidad_1 + NVL(pCantidadIng1, 0),
			cantidad_2 = cantidad_2 + NVL(pCantidadIng2, 0),
			cantidad_3 = cantidad_3 + NVL(pCantidadIng3, 0),
			cantidad_4 = cantidad_4 + NVL(pCantidadIng4, 0),
			cantidad_5 = cantidad_5 + NVL(pCantidadIng5, 0),
			cantidad_6 = cantidad_6 + NVL(pCantidadIng6, 0),
			cantidad_7 = cantidad_7 + NVL(pCantidadIng7, 0),
			cantidad_8 = cantidad_8 + NVL(pCantidadIng8, 0),
			cantidad_9 = cantidad_9 + NVL(pCantidadIng9, 0),
			cantidad_10 = cantidad_10 + NVL(pCantidadIng10, 0),
			cantidad_11 = cantidad_11 + NVL(pCantidadIng11, 0),
			cantidad_12 = cantidad_12 + NVL(pCantidadIng12, 0),
			cantidad_13 = cantidad_13 + NVL(pCantidadIng13, 0),
			cantidad_14 = cantidad_14 + NVL(pCantidadIng14, 0),
			cantidad_15 = cantidad_15 + NVL(pCantidadIng15, 0)
		WHERE cod_proveedor = pCodProveedor;
		
		-- ACTUALIZACION DE LOS VALORES DE EGRESOS
		UPDATE bdisuc:'informix'.ss_cajageneral
		SET cantidad_1 = cantidad_1 - NVL(pCantidadEgr1, 0),
			cantidad_2 = cantidad_2 - NVL(pCantidadEgr2, 0),
			cantidad_3 = cantidad_3 - NVL(pCantidadEgr3, 0),
			cantidad_4 = cantidad_4 - NVL(pCantidadEgr4, 0),
			cantidad_5 = cantidad_5 - NVL(pCantidadEgr5, 0),
			cantidad_6 = cantidad_6 - NVL(pCantidadEgr6, 0),
			cantidad_7 = cantidad_7 - NVL(pCantidadEgr7, 0),
			cantidad_8 = cantidad_8 - NVL(pCantidadEgr8, 0),
			cantidad_9 = cantidad_9 - NVL(pCantidadEgr9, 0),
			cantidad_10 = cantidad_10 - NVL(pCantidadEgr10, 0),
			cantidad_11 = cantidad_11 - NVL(pCantidadEgr11, 0),
			cantidad_12 = cantidad_12 - NVL(pCantidadEgr12, 0),
			cantidad_13 = cantidad_13 - NVL(pCantidadEgr13, 0),
			cantidad_14 = cantidad_14 - NVL(pCantidadEgr14, 0),
			cantidad_15 = cantidad_15 - NVL(pCantidadEgr15, 0)
		WHERE cod_proveedor = pCodProveedor;
		
		-- OBTENCIÃN DEL FOLIO
		SET ISOLATION TO DIRTY READ;
		...
		-- ACTUALIZACIÃN DEL PARAMETRO DEL FOLIO
		UPDATE bdisuc:'informix'.ss_param_cajagen 
		SET valor = valor::INTEGER + 1 
		WHERE codigo = '0005';
		
		-- BUSQUEDA DE LA TRANSACCIÃN
		SELECT valor
		INTO cTrans
        FROM bdisuc:'informix'.ss_param_cajagen WHERE codigo = '0031';
		...
		-- FOLIO
		LET cFolio = LPAD(iFolio, 8, 0);
		LET cSucursal = '9250'; -- Sucursal de direcciÃ³n de sistemas, quien ingresa el dato a la tabla
        LET cFolioSucursal = pUsuario || cFolio;
		
		-- Guardado en la tablas
		INSERT INTO bdisuc:'informix'.ss_operaciones(empresa, cod_trans, fecha_operacion, sucursal, folio_sucursal, folio_oper, reversado, usuario, divisa, procedencia, monto, 
		...
		VALUES('001', cTrans, CURRENT, cSucursal, cFolioSucursal, cFolio, '0', pUsuario, '01', pProcedencia, pMonto, 
			pDenominacion1, pDenominacion2, pDenominacion3, pDenominacion4, pDenominacion5, pDenominacion6, pDenominacion7, pDenominacion8, pDenominacion9, pDenominacion10, pDenominacion11, pDenominacion12, pDenominacion13, pDenominacion14, pDenominacion15,
			pCantidadEgr1, pCantidadEgr2, pCantidadEgr3, pCantidadEgr4, pCantidadEgr5, pCantidadEgr6, pCantidadEgr7, pCantidadEgr8, pCantidadEgr9, pCantidadEgr10, pCantidadEgr11, pCantidadEgr12, pCantidadEgr13, pCantidadEgr14, pCantidadEgr15);
...
'FECHA: 03/02/2015',
'DESCRIPCION: ActualizaciÃ³n de los montos y cantidades de billetes disponibles',
'BD: bdicnweb';
...
CREATE PROCEDURE "informix".sp_actualizacentrallincred(pUsuario CHAR(8), pIdFuncion CHAR(10), pNumCredito CHAR(20), pMonto DECIMAL(18,2))
	...
	BEGIN
		...
		ELIF iCodRetSp = 2 THEN -- OCURRIO UN ERROR AL GUARDAR LOS MOVIMIENTOS DEL CREDITO EN EL SP bdicred:genmov
			LET cCodRet = '00278';
		ELIF iCodRetSp = 4 THEN -- OCURRIO UN ERROR AL GUARDAR LA INFORMACIÃN EN LA BITACORA DE AUMENTO DE LINEA DE CRÃDITO
			LET cCodRet = '00279';
		ELIF iCodRetSp = 5 THEN -- OCURRIO UN ERROR AL GUARDAR LA INFORMACIÃN EN LA BITACORA DE AUTORIZACIÃN DE AUMENTO DE LINEA DE CRÃDITO
			LET cCodRet = '00280';
		ELIF iCodRetSp = 1 THEN -- NO ES POSIBLE REALIZAR LA ACTUALIZACION
			LET cCodRet = '00281';
		END IF;
...
DOCUMENT 'AUTOR: Oscar Flores Conde',
'FECHA: 22/04/2014',
'DESCRIPCION: Actualiza el monto de la linea de credito, proceso manual',
'BD: bdicnweb';
