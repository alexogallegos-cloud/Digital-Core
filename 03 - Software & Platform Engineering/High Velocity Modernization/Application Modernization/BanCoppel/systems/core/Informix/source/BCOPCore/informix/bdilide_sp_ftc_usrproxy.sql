CREATE PROCEDURE "informix".sp_ftc_usrproxy(v_periodo CHAR(04))
...
ON EXCEPTION SET iSqlErr
    ...
    SET DEBUG FILE TO "/fatca/sp_ftc_usrproxy.err";
...
--SET DEBUG FILE TO "sp_ftc_usrproxy.out";
--TRACE ON;

LET cVarDataErr = '';
LET v_vlr_prm = '';

--- VALIDACIÓN: USUARIO PROXY ---
...
IF NOT EXISTS (SELECT a.valor
                ...
                WHERE a.cve_param = b.cve_param
                  AND a.cve_param = 3
                  AND a.valor_param = '2.5') THEN

   LET cCodret = '00001';
   LET cVarDataErr = 'ERROR NO EXISTE USUARIO PROXY';
ELSE
   SELECT a.valor
     INTO v_vlr_prm
     FROM bdilide:sl_ftc_prm AS a, bdilide:sl_ftc_cat AS b
