CREATE PROCEDURE "informix".sp_concilatm_carga_archivoseglo_pba(pempresa char(3),psFechaconciliacion DATE)                            
	...
	BEGIN
		...
		SET DEBUG FILE TO "sp_concilatm_carga_archivoseglo_pba.out";
		TRACE ON;
