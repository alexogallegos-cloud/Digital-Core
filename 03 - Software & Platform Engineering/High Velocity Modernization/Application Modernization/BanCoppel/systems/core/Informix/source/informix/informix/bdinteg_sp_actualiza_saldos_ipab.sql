CREATE PROCEDURE "informix".sp_actualiza_saldos_ipab() 
RETURNING CHAR(5), CHAR(5), CHAR(50);
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, cDesErr
        SET DEBUG FILE TO '/resplogifx/conciliachq/ipab/sp_actualiza_saldos_ipab.err';
        TRACE ON;
        LET cCodRet  = iSqlErr;
    ...
    --- SET DEBUG FILE TO '/resplogifx/conciliachq/ipab/sp_actualiza_saldos_ipab.out';
    --- TRACE ON;
    ...
    FOREACH WITH HOLD
        SELECT cta.cve_unica, sdo.cuenta, sdo.producto, sdo.sdo_cuenta, sdo.intereses, pat.ret_impuestos
          INTO cNumCte, cNumCuenta, cProducto, mSdoCuenta, mIntereses, mISR
          FROM si_infctasdo_ipab sdo,
               si_infpattit_ipab pat,
               si_ctaasotit_ipab cta
         WHERE sdo.cuenta = pat.numcta
           AND pat.num_inversion = '0'
           AND cta.numcta = pat.numcta
           AND cta.num_inversion = pat.num_inversion
           AND sdo.producto IN('1100','1300','1700','1400','2000','2900','1800','1900','5000')
        ...
        UPDATE si_infpattit_ipab
           SET cve_producto = cProducto,
               sdo_cuenta = mSdoCuenta,
