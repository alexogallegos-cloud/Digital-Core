CREATE PROCEDURE "informix".sp_consctecte_exp1( pchrSucursal      CHAR(4),
...
RETURNING CHAR(5),  CHAR(100), CHAR(40),      CHAR(20),      CHAR(20),  CHAR(40),
   ...
   -- SET DEBUG FILE TO "/ifxsif01/rsv/sp_consctecte.out";
   -- TRACE ON;
    ...
    ON EXCEPTION SET sql_err, isam_err, desc_err
        ...
        IF sql_err <>  0 THEN
            ...
            RETURN vchrcodret, cVarDataErr, vvchrNombreOrd, vvchrCuentaOrd, vvchrcteOrd,
        ...
        IF lcta > 0 THEN
            ...
            ELIF lcta = 16 THEN 
                ...
                IF TRIM(vcuenta) = '' OR vcuenta IS NULL THEN
                    LET vchrcodret = '031';
                    LET cVarDataErr = "La tarjeta no existe à¸£à¸? no esta activa";
                ELSE
