CREATE PROCEDURE "informix".sp_ftc_ipsoky(v_periodo CHAR(04))
...
ON EXCEPTION SET iSqlErr
    ...
    SET DEBUG FILE TO "/fatca/sp_ftc_ipsoky.err";
...
--SET DEBUG FILE TO "sp_ftc_ipsoky.out";
--TRACE ON;

LET cVarDataErr = '';
LET v_vlr_prm = '';

--- VALIDACIÓN: IP CANAL SOCKET --- 
...
IF NOT EXISTS (SELECT a.valor
   ...
   LET cCodret = '00001';
   LET cVarDataErr = 'ERROR NO EXISTE IP PARA SOCKET';
ELSE
   SELECT a.valor
     INTO v_vlr_prm
     FROM bdilide:sl_ftc_prm AS a, bdilide:sl_ftc_cat AS b
    WHERE a.cve_param = b.cve_param
      ...
      AND a.valor_param = '2';
   LET cCodret = '00000';
   LET cVarDataErr = 'IP SOCKET: '||v_vlr_prm;
END IF;
