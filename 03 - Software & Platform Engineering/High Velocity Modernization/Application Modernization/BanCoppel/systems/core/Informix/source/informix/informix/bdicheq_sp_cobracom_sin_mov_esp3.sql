CREATE PROCEDURE "informix".sp_cobracom_sin_mov_esp3( pEmpresa CHAR(3) )
    RETURNING CHAR(5);
	...
	TRUNCATE TABLE sc_ctrol_com_0495;
    ...
    LET vsql = '';	
		...
		FOREACH WITH HOLD
			--******CONSULTA PRINCIPAL *************
			SELECT a.cuenta, b.sdo_actual - (b.sdo_retenido  + b.sdo_cong + b.imp_chq_sbg), b.sucursal, b.status_cta 
			INTO   vCuenta,  v_sdodisponible,                                               v_sucursal, v_estatus
			FROM   sc_ctas_com_0495  AS a,  
			       sc_maechq         AS b   
