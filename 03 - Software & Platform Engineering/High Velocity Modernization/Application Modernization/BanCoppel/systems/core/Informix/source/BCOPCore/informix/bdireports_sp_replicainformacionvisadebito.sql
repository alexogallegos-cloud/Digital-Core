CREATE PROCEDURE "informix".sp_replicainformacionvisadebito(dFecha1 DATETIME year to fraction(5),dFecha2 DATETIME year to fraction(5),cTrimestre CHAR(5),iMes INTEGER)
returning
char (5),
char(100);
...
SET ISOLATION TO dirty read;
    ...
    and (numtarjeta matches '4169*' or numtarjeta matches '4008*')
    ...
    and (numtarjeta matches '4169*' or numtarjeta matches '4008*')
	and formato <> '0420' and codtran = '01'
	and movconciliado='V' ;
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	/*	select {+INDEX(bdicheq:sc_maechq ix174_4), (bdicheq:sc_maenoc idx_maenoc1)} 
		...
		and b.fecha_alta <= dFechaFin::date
        and (a.producto <> '1100' and a.producto <> '1800')
        and (a.status_cta = '1' or a.status_cta = '3' or a.status_cta = '4');
		--and a.status_cta <> 4;
        ...
        /*Se sustituyo el query anterior para obtener las tarjetas de las cuentas viegentes 17/04/2012 LAGS*/

        Set isolation to dirty read;
        select {+INDEX(bdicheq:sc_maechq idx_maechq1)}
        count(c.cuenta) INTO dNumeroTarjetas
        from  bdicheq:sc_maechq a, bdicheq:sc_maenoc b, bdicheq:sc_tarjeta c
        where a.empresa=b.empresa
        and a.cuenta = b.cuenta
        and a.cuenta = c.cuenta
        and (a.producto <> '1100' and a.producto <> '1800')
        and b.fecha_alta <= dFechaFin 
        and (a.status_cta = '1' or a.status_cta = '3' or a.status_cta = '4');
