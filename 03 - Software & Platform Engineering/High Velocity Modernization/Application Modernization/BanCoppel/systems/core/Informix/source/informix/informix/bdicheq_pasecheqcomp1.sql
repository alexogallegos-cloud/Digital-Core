CREATE PROCEDURE "informix".pasecheqcomp1(pempresa CHAR(3))
RETURNING CHAR(5);
...
BEGIN
    ...
    ON EXCEPTION SET vsqlerr, visamerr, vdescerr
       SET debug FILE TO "/tmp/pasecheqcomp1.err";
       TRACE ON;
       IF vsqlerr <> 0 THEN
	...
	--SET debug FILE TO "/home/c98789058/SPL_ACCENTURE/pasecheqcomp1.out";
    --TRACE ON;
	...
	--//*** Comentar este IF para pruebas de ejecuciÃ³n
    ...
    -- his1: para ramas 1 y 3 --busqueda ok
    ...
    FOREACH CurIni FOR
        ...
        -- Rama 1: usa his1 (ya filtrada por cancelad <> 'S' y NOT IN) --Busqueda OK
