CREATE PROCEDURE "informix".sp_actestatuscaja(pvSucursal VARCHAR(5), pvNumcaja VARCHAR(12),pvStatus VARCHAR(10),pvOpcion VARCHAR(1), pvFecha VARCHAR(10), 
...
BEGIN
    ...
    SET LOCK MODE TO WAIT 3;
			...
			ELIF pvOpcion = '4' THEN
				...
				ELIF Trim(cEstatus) <> 'Activa' AND pvtipopaquete <> 3 THEN
					LET cCod_Ret = "005";
				END IF;
	        END IF;   
