CREATE PROCEDURE "informix".sp_altamasivaempnet_carga( pNombreArchivo CHAR(30) )
RETURNING CHAR(5);
    ...
    DEFINE vno_ext          CHAR(10);
    DEFINE vno_int          CHAR(10);
    ...
    FOREACH WITH HOLD
		...
		IF vcValNulos = '1' AND vcValNumeros = '1' THEN
		...
		IF vcValNulos = '1' AND vcValNumeros = '1' AND vcValFechas = '1' THEN
        ...
        IF vcValNulos = '1' AND vcValNumeros = '1' AND vcValFechas = '1' AND vcValLetras = '1' THEN
           SELECT COUNT(*)
             INTO viExisteCP
