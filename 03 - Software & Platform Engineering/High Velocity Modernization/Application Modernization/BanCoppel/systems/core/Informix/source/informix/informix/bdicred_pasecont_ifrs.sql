...
--SET DEBUG FILE TO '/ifxsif01/aldo/etapas/movdia_ifrs/pasecont_ifrs.out';
--TRACE ON;
...
--         END IF;
	  ...
	  -- IFSR se valida si la bandera estÃ¡ activa, si no se encuentra activa  sigue su proceso normal y i estÃ¡ prendida se crea una tabla temporal con los datos de ifsr
