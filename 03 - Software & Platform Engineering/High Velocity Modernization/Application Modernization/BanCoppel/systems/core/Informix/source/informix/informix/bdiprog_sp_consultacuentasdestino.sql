CREATE PROCEDURE "informix".sp_consultacuentasdestino(p_NumCte CHAR(20), p_CvePago CHAR(2), p_Registros SMALLINT)
RETURNING
     CHAR(6), ---cod_ret
	 CHAR(20), ---cuenta
	 CHAR(100), ---nombre
...
--                    END IF;
            ...
            END IF;
        ELSE
            IF EXISTS (SELECT num_tarjeta FROM bdicred:sd_tarjeta Where numcte == p_NumCte )  THEN
                FOREACH
