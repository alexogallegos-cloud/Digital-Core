create procedure "informix".act_pie_edos(pempresa char(3))
returning char(5);
...
FOREACH WITH HOLD
  ...
  where a.fecha_emision = '06/20/2008'
   ...
   update sd_pie_edocta set tasa_mensual = '4.50',
                            tasa_anual = '54.00',
                            cat = '83.21',
                            tasa_mora  = 90.00,
                            tasa_mensual_mora = 7.50
   where fecha_emision = '06/20/2008' and num_credito = vnum_credito ;
