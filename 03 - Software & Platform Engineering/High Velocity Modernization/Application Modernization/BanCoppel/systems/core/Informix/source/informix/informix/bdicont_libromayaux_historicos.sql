CREATE PROCEDURE "informix".libromayaux_historicos(v_empresa CHAR(4), 
                                        v_fechainicio DATE,
                                        v_fechafin DATE,
                                        v_ccmayor CHAR(10),
                                        v_ccsub CHAR(10),
	...
	--SET DEBUG FILE TO "/home/informix/mmeses/libro/libromayaux_historicos.out";
	--TRACE ON;
	...
	FOREACH
        ...
        WHERE plaza IN(SELECT plaza FROM bdinteg:"informix".si_sucursales WHERE sucursal = tsucursal_sdo AND empresa = v_empresa);
