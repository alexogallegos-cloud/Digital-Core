CREATE PROCEDURE "informix".auxiliares3(pempresa char(3),pccmayor char(4), 
pccsub char(2), pccsubsub char(2), pccssubsub char(2), pccsssubsub char(2), 
psector char(2),pmoneda char(2),psucursal char(4),pnro_auxiliar char(12),
pciudad char(3))
...
--SET DEBUG FILE TO "/pisa/pisabanco/pisa_ftes/contabilidad/auxiliares.out";
--TRACE ON;                                     
