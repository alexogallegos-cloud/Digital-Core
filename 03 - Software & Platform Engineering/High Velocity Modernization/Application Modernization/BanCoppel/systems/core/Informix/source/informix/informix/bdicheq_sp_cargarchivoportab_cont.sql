CREATE PROCEDURE "informix".sp_cargarchivoportab_cont(pfecha_reg date,pnombrearchivo CHAR(30),cod_oper CHAR(2),itotalsol integer)
...
LET vhay  		= '';
  ...
  BEGIN
    ...
    SET DEBUG FILE TO "/resplogifx/conciliachq/portabilidad/sp_cargarchivoportab_cont.out";
	TRACE ON;
					...
					ELSE
						...
						ELSE
							...
							ELSE
																			...
																			-- // SI ESTATUS RESPUESTA ES  
																				...
																				IF  Bandesap = 'V'  THEN
                                                                                        ...
                                                                                        --Validacion de Prestamo Directo de Nomina vigente 
                                                                                            ...
                                                                                            INNER JOIN BDINTEG:si_telefonos t
											...
											IF cod_oper= "20"   THEN			
														EXECUTE PROCEDURE "informix".sp_generarchivoresport_cont(pfecha_reg,cnombarcpar)
