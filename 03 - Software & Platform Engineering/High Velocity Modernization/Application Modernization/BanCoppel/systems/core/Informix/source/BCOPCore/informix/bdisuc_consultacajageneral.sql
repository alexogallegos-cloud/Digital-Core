create procedure "informix".consultacajageneral(pempresa char(3),
       ...
       returning char(5), char (3), char (4), char (2), money (14), money (14), money (14),
                        ...
                        float (8), char (30), char (30), char(3), char(40),float (8),float(8);
   ...
   on exception set vsqlerr
      if vsqlerr <> 0 then
         ...
         return vcodret, vempresa, vcod_proveedor, vdivisa, vsaldo_anterior, vsaldo_asignado, vsaldo_total, vdenominacion_1, vdenominacion_2, vdenominacion_3, vdenominacion_4,
                      ...
                      vnomplaza,vsaldo_disponible,vbill_det;
 ...
 if pcodproveedor = "0000" then
            ...
            foreach
                   ...
                   SELECT   cg.empresa, cg.cod_proveedor, cg.divisa, cg.saldo_anterior, cg.saldo_asignado, cg.saldo_total, cg.denominacion_1, cg.denominacion_2,
                    ...
                    FROM bdisuc:ss_cajageneral cg left join bdisuc:ss_proveedores pro on (pro.cod_proveedor =  cg.cod_proveedor) left join bdinteg:si_divisas div on
                               (div.divisa =  cg.divisa) left join bdinteg:si_plazas_cajagen plz on (plz.codigo_plaza = pro.plaza)
                     ...
                     return vcodret, vempresa, vcod_proveedor, vdivisa, vsaldo_anterior, vsaldo_asignado, vsaldo_total, vdenominacion_1, vdenominacion_2, vdenominacion_3,
                           ...
                           vdescripcion, vdescdivisa, vplaza, vnomplaza, vsaldo_disponible,vbill_det with resume;
            ...
            if exists (select cod_proveedor from ss_proveedores where cod_proveedor = pcodproveedor) Then
                ...
                foreach
                   ...
                   return vcodret, vempresa, vcod_proveedor, vdivisa, vsaldo_anterior, vsaldo_asignado, vsaldo_total, vdenominacion_1, vdenominacion_2, vdenominacion_3,
                          ...
                          vplaza, vnomplaza,vsaldo_disponible,vbill_det with resume;
                   ...
                   return vcodret, vempresa, vcod_proveedor, vdivisa, vsaldo_anterior, vsaldo_asignado, vsaldo_total, vdenominacion_1, vdenominacion_2, vdenominacion_3,
                          ...
                          vdenominacion_12, vdenominacion_13, vdenominacion_14, vdenominacion_15, vcantidad_1, vcantidad_2, vcantidad_3, vcantidad_4, vcantidad_5, vcantidad_6,
                          vcantidad_7, vcantidad_8, vcantidad_9, vcantidad_10, vcantidad_11, vcantidad_12, vcantidad_13, vcantidad_14, vcantidad_15, vdescripcion, vdescdivisa,
                          vplaza, vnomplaza,vsaldo_disponible,vbill_det;
            end if;
end if;
end
end procedure;