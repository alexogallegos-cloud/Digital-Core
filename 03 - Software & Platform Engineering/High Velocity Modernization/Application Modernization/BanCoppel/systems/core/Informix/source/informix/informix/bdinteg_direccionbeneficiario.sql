CREATE PROCEDURE "informix".direccionbeneficiario( cEmpresa      CHAR(3),
                                                   cNumcte       CHAR(20),
...
RETURNING CHAR(5);
    ...
    --| Descripción     : Guarda la dirección del beneficiario del cliente
    --|					: cuando éste vive en el mismo domicilio del cte.
    --*************************************************************************
