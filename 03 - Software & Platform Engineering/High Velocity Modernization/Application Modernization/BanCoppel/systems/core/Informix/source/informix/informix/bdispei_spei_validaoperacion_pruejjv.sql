CREATE PROCEDURE "informix".spei_validaoperacion_pruejjv(pcuenta CHAR(20), pmonto DECIMAL(17,2))
RETURNING CHAR(5),  --CODIGO RETORNO
    ...
    IF cFlagSpei = 0 OR iFlagDiaFeria > 0 THEN   -- horario extendido
        -- EXTRAE MONTO MAXIMO DE OPERACION
        SELECT vchrvalor
          INTO iMontoMax	
          FROM 'informix'.tblparametros
         WHERE vchrcveparametro ='MONTO_HREXT';
