CREATE PROCEDURE "informix".sp_depura_tym()
...
DEFINE dFechaHistorico	DATE;

LET sCodRet         	= "00000";
LET iSqlErr				= 0;
LET dFechaHoy       	= DATE(1);
LET dFechaHistorico 	= DATE(1);
...
BEGIN
    ...
    --SET DEBUG FILE TO "/tmp/cyrv/sp_depura_tym.out";
    --TRACE ON;

	SET ISOLATION TO DIRTY READ;
	SET LOCK MODE TO WAIT 3;
   		
    SELECT fecha_hoy , (fecha_hoy - 60) as fecha_hist
    INTO dFechaHoy, dFechaHistorico
    FROM bdinteg:"informix".si_fechas
	WHERE empresa = '001';
		
	DELETE FROM bdinteg:"informix".si_bit_tiempoymovimientos
	WHERE DATE(fecha_insert) <= dFechaHistorico;
...
END PROCEDURE
DOCUMENT
'Autor: 98178849 Christian Rojas',
'Fecha: 17/04/2018',
'Descripcion: Se elimina el historico de la tabla si_bit_tiempoymovimientos para hacer la consulta de reportes mas rapido.',
'Sustento: RQM 18 113 Reporte de tiempos y movimientos de los proceso de apertura y asignacion de credito, captacion y servicios.',
'BD: bdinteg';
