CREATE PROCEDURE "informix".sp_edoctamovtos_bpi(pEmpresa CHAR(3),
                                            pCuenta CHAR(20),
                                            pFechaInicial DATE,
                                            pFechaFinal DATE,
                                            pRegistro SMALLINT)
...
RETURNING CHAR(5), CHAR(10), CHAR(40), CHAR(200), CHAR(50),
	...
	--// ***************************************************************************
	--//ModificÃ³: Alejandro Sanchez
	--//Fecha: Septiembre-2012
	--//ModificaciÃ³n: se agregÃ³ la consulta a la tabla tblhistpago para traer el concepto de los SPEI
	--// ***************************************************************************
	...
	LET vConceptospei6= "";
    LET vTipoCta	 = "";
	LET vLeyOutBeneficiario = '(Dato no verificado por esta instituciÃ³n)';
   ...
   --TRACE ON;
    ...
    FOREACH
        SELECT SKIP pRegistro FIRST 10
			  {+INDEX(sc_movhis idx_movhisnew4)}
