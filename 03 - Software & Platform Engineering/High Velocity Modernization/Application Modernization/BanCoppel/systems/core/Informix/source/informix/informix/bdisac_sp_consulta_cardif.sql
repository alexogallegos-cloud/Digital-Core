CREATE PROCEDURE "informix".sp_consulta_cardif(pNumcte CHAR(20), pAsegurado_Nombre1 CHAR(26), pAsegurado_Nombre2 CHAR(26), pAsegurado_Apell_Pat CHAR(26), pAsegurado_Apell_Mat CHAR(26), pAsegurado_FechaNac DATE)
...
BEGIN
	...
	IF TRIM(cCodRet) = "00000" THEN
		...
		IF NVL(cEstado,"") = "" OR NVL(cCiudad,"") = "" OR NVL(cColonia,"") = "" OR NVL(cCalle,"") = "" OR NVL(cNumExt,"") = "" OR NVL(cCP,"") = "" THEN
			LET cCodRet = "00005";
		ELSE
			SELECT telefono INTO cCelular FROM bdinteg:"informix".si_telefonos_actual WHERE numcte = pNumcte AND tipo_tel = 2 AND status_tel = "A";
