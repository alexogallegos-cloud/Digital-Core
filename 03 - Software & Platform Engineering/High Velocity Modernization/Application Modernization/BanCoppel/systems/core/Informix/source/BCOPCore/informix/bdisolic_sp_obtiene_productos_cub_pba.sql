CREATE PROCEDURE "informix".sp_obtiene_productos_cub_pba(pEmpresa CHAR(3), pSucursal CHAR(4), pEjecutivo CHAR(8), pPuesto_local CHAR(2), pNumcte CHAR(20), 	
...
--jom-26/11/2018
	...
	SET DEBUG FILE TO 'sp_obtiene_productos.out';
	TRACE ON;
                ...
                IF (B_valida_ife = '1') THEN
                    ...
                    IF ( B_ife <> '1') THEN
                        ...
                        INSERT INTO bdisolic:"informix".ss_bitacora_precal (empresa,fecha,producto,sucursal,nombre,nombre_coppel,num_referencia,ejecutivo,porcentaje,situacion,meses_hist,
                                                                            ...
                                                                            vencidototalropa,vencidoprestamos,abonomuebles,abonoropa,abonoprestamos,puntualidad,grupo)
                        --VALUES (pEmpresa,today,'6001',pSucursal,cnomcte,pEjecutivo,'Validacion IFE/INE','VIF');
                        VALUES (pEmpresa,today,'6001',pSucursal,cnomcte,'','',pEjecutivo,'0','','0','0','B','','005','Validacion IFE/INE','0','0','0','VIF','0','0','0','0','0','0','','');
                    END IF;
                END IF;
            END IF;
...
-- EM 2017/05/25
		...
		-- Valida que NO oferte productos de crÃÂÃÂ¨dito a empleados GC RQM 09 539
		IF pEmp = '1' THEN
		...
		IF cValidaSitEsp = 1 THEN
			...
			IF NVL(cCurp,"") = "" THEN
				SELECT nombre_prod INTO cdescripcion FROM bdicred:"informix".sd_definicion WHERE num_producto = 6500;
