CREATE PROCEDURE  "informix".sp_depuratablascfd_inc( pEmpresa CHAR(3) )
RETURNING CHAR(5);
    ...
    CREATE INDEX idx_encabezado_cte ON sc_encabezado_edocta_factelect(num_cte) IN dbs_movhis_idx5 ONLINE;
    CREATE INDEX idx_encabezado_fe ON sc_encabezado_edocta_factelect(fecha_emision) IN dbs_movhis_idx5 ONLINE;
    CREATE INDEX idx_encabezadofechacuenta_fe ON sc_encabezado_edocta_factelect (fechafinal,num_cuenta) IN dbs_movhis_idx5 ONLINE;
    CREATE UNIQUE INDEX idx_sc_encabezado_com ON sc_encabezado_edocta_factelect (idreg,fecha_emision,num_cuenta) IN dbs_movhis_idx5 ONLINE;
    ...
    CREATE INDEX idx_encabezado2_fe ON sc_encabezado2_edocta_factelect(fecha_emision) IN dbs_movhis_idx6 ONLINE;
    CREATE UNIQUE INDEX idx_encabezado2_com ON sc_encabezado2_edocta_factelect(idreg,fecha_emision,num_cuenta) IN dbs_movhis_idx6 ONLINE;
    ...
    CREATE INDEX idx_detedocta_fe ON sc_detalle_edocta_factelect(fecha_emision) IN dbs_movhis_idx6 ONLINE;
    ...
    CREATE INDEX idx_mensajes_fe ON sc_mensajes_edocta_factelect(fecha_emision) IN dbs_movhis_idx6 ONLINE;
    ...
    CREATE INDEX idx_piepagina_fe ON sc_piepagina_edocta_factelect(fecha_emision) IN dbs_movhis_idx5 ONLINE;
    CREATE INDEX idx_piepagina_fe2 ON sc_piepagina_edocta_factelect(fecha_emision, idreg) IN dbs_movhis_idx5 ONLINE;
    ...
    CREATE INDEX idx_graficafe ON sc_grafica_fe(fecha_emision) IN dbs_movhis_idx5 ONLINE;
