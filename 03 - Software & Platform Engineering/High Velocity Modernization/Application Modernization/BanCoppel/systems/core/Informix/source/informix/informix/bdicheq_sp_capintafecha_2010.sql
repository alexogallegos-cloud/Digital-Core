CREATE PROCEDURE "informix".sp_capintafecha_2010(pCuenta CHAR(20), pFecha  DATE)
RETURNING  CHAR(10), DECIMAL(14,2), DECIMAL(14,2);
    ...
    --- SET DEBUG FILE TO '/tmp/sp_capintafecha_2010.out';
    --- TRACE ON;
    ...
    IF LPAD(cDia,2,'0') = '01' THEN
        ...
        SELECT capvig1, intprovnp1
          ...
          FROM bdicheq:sc_sdodiarioc2010 
