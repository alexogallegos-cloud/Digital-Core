CREATE PROCEDURE "informix".sp_consultarsecausaconalcance(pEmpresa CHAR(3), pSituacion CHAR(1), pCausa INTEGER, pFlagSoloSituaciones CHAR(1), pAlcance SMALLINT)
        ...
        ELSE
            ...
            ELSE
                FOREACH   --SE OBTIENEN TODOS LOS DATOS DE LAS SITUACIONES ESPECIALES
                    ...
                    SELECT {+INDEX (se_catsitesp idx_catsitesp2)} situacion, causa, descripcion, alcance, despliegue, vigente, cveccasociada
                    INTO v_situacion, v_causa, v_cdescripcion, v_alcance, v_despliegue, v_vigente, v_cvecc
                    FROM bdisitesp:se_catsitesp
                    WHERE empresa = pEmpresa
