	...
	IF pFechaAct <> MDY(1,1,1900) OR pFechaAct IS NOT NULL THEN	
		...
		END IF;*/
			...
			FOREACH WITH HOLD
				...
				SELECT DISTINCT {+INDEX(bdisolic:ss_solicitudes ix_soln4)} sss.num_solicitud, sss.numcte, ssa.fecha_entrada, sss.sucursal, sss.fecha_insert,ssa.status_solicitud, ssos.status, ssos.secuenciaos, ssos.fecha_respuesta 
