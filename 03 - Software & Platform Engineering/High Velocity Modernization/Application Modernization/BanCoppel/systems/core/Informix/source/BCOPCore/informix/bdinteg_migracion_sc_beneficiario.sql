CREATE PROCEDURE "informix".migracion_sc_beneficiario()
	RETURNING CHAR(6);
...
--SET DEBUG FILE TO '/tmp/migracion_sc_beneficiario.out';
--TRACE ON;
	...
	BEGIN
        ...
        foreach with hold
            ...
            begin work;
                UPDATE {+ INDEX(bdicheq:sc_beneficiario idx_benefic2)} bdicheq:sc_beneficiario SET parentesco = vparentesco  
