CREATE PROCEDURE "informix".sp_busca_producto_cred_cliente_crd(p_sNumeroCliente CHAR(20), p_skip INT)
	...
	BEGIN
		...
		FOREACH
			SELECT SKIP p_skip DISTINCT bdicred:sd_maecredcrd.num_producto as numeroProducto, nombre_prod AS nombreProducto, num_credito AS cuentaProducto, numtarjeta AS tarjetaProducto
