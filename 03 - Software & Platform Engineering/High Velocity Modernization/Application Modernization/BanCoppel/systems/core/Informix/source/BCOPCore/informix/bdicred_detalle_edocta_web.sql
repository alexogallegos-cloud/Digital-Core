CREATE PROCEDURE "informix".detalle_edocta_web(
					   pEmpresa CHAR(3),
			           pNumCredito CHAR(20),
			           pFechaEmision DATE,
			           pNumRegistros SMALLINT)
RETURNING CHAR(5), DATE , CHAR(20), SMALLINT, SMALLINT,	 CHAR(9), CHAR(255), CHAR(16), CHAR(16);
...
BEGIN
  ...
  -------------------------------------------------------------
	FOREACH 
		SELECT	fecha_emision,num_credito, secuencia, nlinea, fecha_mov, concepto, cargos,	abonos
		INTO	v_fecha_emision, v_num_credito, v_secuencia, v_nlinea, v_fecha_mov, v_concepto, v_cargos, v_abonos
	...
	IF v_Registros = 0 THEN
		LET sCodRet = '00001';
		LET v_fecha_emision = '01/01/1900';
		RETURN sCodRet, v_fecha_emision, NVL(v_num_credito,""),	NVL(v_secuencia,0), NVL(v_nlinea,0), NVL(v_fecha_mov,""), NVL(v_concepto,""), NVL(v_cargos,""),	NVL(v_abonos,"");
	END IF;
