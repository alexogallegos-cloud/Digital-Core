CREATE PROCEDURE "informix".sp_obtieneinfocobranza( Pfecha Date,Psucursal Char (04),Pejecutivo Char (08), PtipoEjecutivo Char (01) , siRegistros SMALLINT)
		...
		IF (PtipoEjecutivo = 'A'  AND dMaxFecha IS NOT NULL) or(PtipoEjecutivo = 'Z'  AND dMaxFecha IS NOT NULL) OR (PtipoEjecutivo = 'E'  AND dMaxFecha IS NOT NULL) OR (PtipoEjecutivo = 'U'  AND dMaxFecha IS NOT NULL) THEN	
			...
			if pfecha = dMaxFecha THEN
				...
				ELSE 
						...
						RETURN '00000005',vFecha,vSucursal,vtpo_reg,vcajero,'No existe información del reporte del cierre diario de la sucursal',vnum_ctes_cvdo, vnum_conv,
			...
			ELSE
				...
				RETURN '00000006',vFecha,vSucursal,vtpo_reg,vcajero,'tipo de usuario no valido',vnum_ctes_cvdo, vnum_conv,
								vtot_mont_conv, vtot_mont_pag, vpag_min_a_recup, vpag_min_recup,vnum_pm, vnum_sin_pm, vvenc_a_recup, vvenc_recup,vnum_vencidos, vnum_sin_vencidos;
