CREATE PROCEDURE "informix".sp_obtiene_guiastoken_bei(pNumSolicitud char(10), pNumCliente char(9), pFechaAtencion char(10),pNumeroGuia char(22),pRegistros smallint)
RETURNING CHAR(5),CHAR(10),CHAR(9), CHAR(1), CHAR(10),CHAR(22); 

   --*************************************************************
	--Objetivo:Obtiene guias admtoken.
   ...
   -- DEFINE
	...
	--SET DEBUG FILE TO '/tmp/sp_obtiene_guiastoken_bei.out';
	--TRACE ON;	
