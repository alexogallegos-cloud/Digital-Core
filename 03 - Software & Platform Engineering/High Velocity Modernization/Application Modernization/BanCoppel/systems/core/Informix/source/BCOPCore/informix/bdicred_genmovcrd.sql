CREATE PROCEDURE "informix".genmovcrd(
   p_empresa                VARCHAR(3),
...
--  Fecha: 27/10/2009
--  Observaciones:  Se agrego el parámetro para recibir la referencia del movimiento.

--  Autor: Paul Ivan Quintero Varela
--  Fecha: 18/11/2009
--  Observaciones:  Se agrega el parámetro para recibir la referencia23 en el caso de SBC e INTERACT.
...
--   LET v_usuario    = substr(v_foliosuc,1,8);
   ...
   INSERT INTO "informix".sd_movdiacrd (EMPRESA        ,
                                        FECHA_MOV      ,
                                        HORA_MOV       ,
                                        SUCURSAL       ,
                                        NUM_CREDITO    ,
