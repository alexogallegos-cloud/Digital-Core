CREATE PROCEDURE "informix".sp_aforebuscararchivosprocesar2(pTipo CHAR(1), pNombreArchivo CHAR(30), pFechaInicial DATE,pFechaFinal DATE,pEstatus CHAR(2), pRegistros INTEGER, pRecuperacion INTEGER)
...
--TRACE ON;
--SET DEBUG FILE TO "/informix/yuridia/bdiprog/liberacion/sp_AforeBuscarArchivosProcesar.out";
...
BEGIN
        ...
        IF pEstatus <> 19 THEN
                ...
                IF pFechaInicial = date(1) and pFechaFinal = date(1) THEN
                        FOREACH WITH HOLD 
                                Select SKIP pRegistros FIRST pRecuperacion tp.descripcion,arc.nombre_arch,arc.fecha_generado,arc.status,arc.tipo
                                ...
                                IF cIdentificador = 'AC' THEN  --DSB 25/03/2014
                                        ...
                                        ELIF  cTipo = 'C'  THEN---Archivo de ConfirmaciÃ³n   trim(cTipoArchivo)
                ...
                ELSE--- si me mandan un a fecha o un rango de fechas
                        FOREACH
                                ...
                                IF cIdentificador = 'AC' THEN  --DSB 25/03/2014
                                        ...
                                        IF cTipo = 'P' THEN --Archivo de Pagos
                                                select total_mov into iNoMovimientos from bdiprog:pp_sumario where pp_sumario.nombre_arch = cNombreArchivo;
                                        ELIF  cTipo = 'C'  THEN--Archivo de ConfirmaciÃ³n
                                                LET cNombre = cNombreArchivo;
                                                LET cNombre = 'PAGOS' || SUBSTR(cNombreArchivo,5,8) || '.ACOPPEL.'|| SUBSTR(cNombreArchivo,22,2);
                                                select no_mov into iNoMovimientos from bdiprog:pp_encabezado where nombre_arch = cNombre;
...
'BD         : BDIPROG',
'DESCRIPCION: Se agregan parametros de paginacion para el manejo desde SOC',
'FECHA      : 03 de Junio de 2015',
'MODIFICO   : Oscar Flores conde - 92599193';
