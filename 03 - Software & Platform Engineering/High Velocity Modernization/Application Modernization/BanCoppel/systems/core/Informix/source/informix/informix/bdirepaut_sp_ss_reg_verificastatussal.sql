CREATE PROCEDURE "informix".sp_ss_reg_verificastatussal(pUsuario CHAR(8), pIdFuncion CHAR(10))
	...
	BEGIN
		...
		--SET DEBUG FILE TO '/tmp/mfinis/sp_ss_reg_verificastatussal.out';
		--TRACE ON;
		...
		FROM bdirepaut:"informix".sw_reg_verificaproceso WHERE usuario = TRIM(pUsuario);
