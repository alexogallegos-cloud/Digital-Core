CREATE PROCEDURE "informix".sp_replicainformacionvisacredito_rep20122(dFecha1 DATETIME year to fraction(5),dFecha2 DATETIME year to fraction(5),cTrimestre cHAR(5),iMes INTEGER)
...
--Esta informacion solo se corre si es final de trimestre
	...
	--Guarda en la base de datos
		...
		LET cCodRet = '001';
 		LET cVarDataErr = 'intercard:movimiento';
		SET ISOLATION TO DIRTY READ;
		FOREACH WITH HOLD 
       ...
       /*
		...
		LET cCodRet = '002';
 		LET cVarDataErr = 'bdicred:sd_maecred';
		Set isolation to dirty read;
        ...
        LET cCodRet = '003';
 		LET cVarDataErr = 'BdiReports:tmpmovimientostrim';		
		...
		LET cCodRet = '004';
 		LET cVarDataErr = 'intercard:tarjeta';
		Set isolation to dirty read;
		...
		LET cCodRet = '006';
 		LET cVarDataErr = 'bdicred:sd_pie_edocta';
		SET ISOLATION TO DIRTY READ;
		SELECT NVL(COUNT(*), 0)
		...
		LET cCodRet = '009';
 		LET cVarDataErr = 'bdicred:sd_maesdoscont';
		...
		LET cCodRet = '010';
 		LET cVarDataErr = 'bdicred:sd_transfun';
		SET ISOLATION TO DIRTY READ;
		FOREACH WITH HOLD
...
/************************       JYDG    **************************/ 			
		    ...
		    LET cCodRet = '011';
 		    LET cVarDataErr = 'insert tmp_replica';
			SET LOCK MODE TO WAIT 3;
		...
		LET cCodRet = '012';
 		LET cVarDataErr = 'BdiReports:tmp_replica';
		...
		LET cCodRet = '013';
 		LET cVarDataErr = 'bdicont:co_histsdodias';
		...
		LET cCodRet = '016';
 		LET cVarDataErr = 'bdicred:sd_maecred mae';
		--Manuel Osuna V.
