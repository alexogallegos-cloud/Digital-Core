CREATE PROCEDURE "informix".sp_capitaliza_creditos_ifsr_18_comple()
    RETURNING CHAR(5);
...
FOREACH WITH HOLD
	...
	and a.fecha_mov = mdy('01','18','2022')
	and b.fecha = mdy('01','18','2022')
	and a.codigo_fun = '605' 
	and a.codigo_ref = 125
	and extend(hora_mov, hour to second) = '10:46:12'  
	...
	BEGIN WORK;
		...
		UPDATE  bdicred:Sd_movhis SET reversado = 'S' where empresa = '001' and fecha_mov = mdy(01,18,2022) and num_credito = vNumCred
