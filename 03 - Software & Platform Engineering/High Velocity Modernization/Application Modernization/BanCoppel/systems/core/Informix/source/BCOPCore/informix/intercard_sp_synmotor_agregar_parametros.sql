CREATE PROCEDURE "informix".sp_synmotor_agregar_parametros(vRegistro INTEGER, vOperacion CHAR(5))
...
BEGIN
  /* Procedure body */
    ...
    ON EXCEPTION SET sql_err
     IF sql_err <> 0 THEN
        LET vCodRet = sql_err;
        RETURN  vCodRet, vEtiqueta,vTipo,vDescripcion1,vCampo,vId_Param,vAntecesor, vId_Campo, vDescripcion2, vId_SPCampo, vValorDefault;
     END IF;
  END EXCEPTION;
