CREATE PROCEDURE "informix".corresp_rev_disp_efec_tdc( psucursal char(4), pusuario char(8), pfolio char(16) )
RETURNING CHAR(5);
    ...
    --- SET DEBUG FILE TO "./corresp_rev_disp_efec_tdc.out";
    --- TRACE ON;
    ...
    ON EXCEPTION SET sql_err, isam_err
        IF (sql_err <> 0) THEN
            --- SET DEBUG FILE TO "./corresp_rev_disp_efec_tdc.err";
            --- TRACE ON;
    ...
    ELSE
        ...
        IF vreversado > 0 THEN
            LET cod_ret1 = '000';
        ELSE
            EXECUTE PROCEDURE bdicred:reversion('001', psucursal, pusuario, pfolio, 'R')
            INTO cod_ret1;
