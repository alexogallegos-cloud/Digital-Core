CREATE PROCEDURE "informix".sp_administrabeneficiarios(pEmpresa CHAR(3),pNumeroCuenta CHAR(20),pNumCte CHAR(20),pNombre CHAR(40), pPorcentaje CHAR(6), pParentesco CHAR(20), pTipOper SMALLINT)
   ...
   --SET DEBUG FILE TO "/respaldosbd/felipe/sp_administrabeneficiarios.out";
   --TRACE ON;
 ...
 BEGIN
	...
	IF EXISTS(SELECT 1 FROM bdinvers:"informix".sv_benefic WHERE empresa = pEmpresa AND cuenta = pNumeroCuenta AND numcte = pNumCte) THEN
		IF pTipOper = 1 OR pTipOper = 2 THEN
