CREATE PROCEDURE "informix".sp_validaimagenescheques_pba(pCveBanco CHAR(3), pCuenta CHAR(20),pNumCheque CHAR(7)) 
RETURNING  CHAR(5) ,CHAR(50), CHAR(3);
    ...
    SELECT {+INDEX(cce_cheques_img idx_cce_cheques_img)}FIRST 1 Imagen, imagen_tam, imagen_formato
