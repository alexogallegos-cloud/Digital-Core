CREATE PROCEDURE "informix".sp_obtienereferenciassolicitud(pEmpresa CHAR(3), pNumSolicitudActual CHAR(20) ,pNumcte CHAR(20))
...
BEGIN
	...
	IF cCodret = '000000' THEN
		...
		IF DBINFO('sqlca.sqlerrd2') = 0 THEN
			LET cCodret = '000005'; --EL NÚMERO DE SOLICITUD NO TIENE REGISTRADAS Referencias
		END IF;
	END IF;
	RETURN cCodret, cNombreRef1,cParentesco1 ,cTelefono1, cNombreRef2 ,cParentesco2 ,cTelefono2 ,iTp_ingreso, iPeriodo_ingreso,NVL(cConyugue,"");
END;
