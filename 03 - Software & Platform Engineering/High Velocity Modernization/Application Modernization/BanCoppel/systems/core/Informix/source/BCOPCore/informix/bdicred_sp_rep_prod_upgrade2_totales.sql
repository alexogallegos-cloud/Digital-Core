CREATE PROCEDURE "informix".sp_rep_prod_upgrade2_totales(pEmpresa CHAR(3),
pFechaIni DATE ,
pFechaFin DATE ,
pTipo CHAR(1) ,
pStatus CHAR(1) ,
...
BEGIN
	...
	--SET DEBUG FILE TO '/tmp/mfinis/sp_rep_prod_upgrade2_totales.out';
	--TRACE ON;
	...
	RETURN cCodRet, cMensajeRet, NVL(iNumRegistros,0);
...
'FECHA 18/04/2017',
'DESCRIPCION: Se crea SPL clon para consultar el número total de registros de reportería para realizar el upgrade de un producto.',
'BD: bdicred';

CREATE PROCEDURE "informix".sp_mostrar_grid_upgrade2_totales(pEmpresa CHAR(3),pnumsolcred CHAR(20),pflagadicional CHAR(1),pNumcte CHAR(20))
RETURNING CHAR(6)         AS codigo_retorno,
		  INTEGER		  AS num_registros;
...
--SET DEBUG FILE TO '/tmp/mfinis/sp_mostrar_grid_upgrade2_totales.out';
--TRACE ON;
...
END IF;
	...
	IF iNumRegistros  = 0 THEN
	   LET cCodRet= '000004';
	   --'No hay datos con la información indicada'
	END IF;
