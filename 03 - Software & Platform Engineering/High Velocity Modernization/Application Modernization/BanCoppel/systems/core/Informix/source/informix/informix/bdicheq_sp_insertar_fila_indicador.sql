CREATE PROCEDURE "informix".sp_insertar_fila_indicador
(
pCuenta 	CHAR(20),
pFechahoy 	DATE, 
pProducto 	CHAR(4), 
...
BEGIN
	...
	--SET DEBUG FILE TO '/informix/moha/sp_insertar_fila_indicador.out';
	--TRACE ON;
	...
	IF cEmpresa = "" THEN
		...
		EXECUTE PROCEDURE "informix".sp_mes_siguiente(pFechahoy, 1, DAY(pFechahoy - 1 UNITS DAY))
		INTO cCodRetMesSig, dtMesiversario, iDiasTransc;
	
		INSERT INTO "informix".sc_indicadores
		(empresa, anio_mes, producto, cuenta, fecha_apertura, sucursal_apertura, fecha_mesiversario) 
		VALUES("001", cAnioMes, pProducto, pCuenta, pFechahoy, pSucursal, dtMesiversario);
	END IF
