create procedure "informix".cons_inv_sdo_pagare(pempresa char(3),
                                     pcuenta   char(20),
			             pdivisa   char(3))
...
--Descripción: Se modifica la validación de vencimiento, ya que anteriormente 
--se tomaba como vencido cuando la fecha de venc fuera diferente a la fecha hoy,
--ahora se tomará como vencido cuando la fecha venc sea menor o igual a la fecha hoy.
...
-- ********************************************************************
   ...
   --- Verifica que la inversion haya vencido incluyendo el dia de hoy
