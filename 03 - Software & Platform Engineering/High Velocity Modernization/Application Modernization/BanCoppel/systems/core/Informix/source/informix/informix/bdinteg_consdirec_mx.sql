create procedure "informix".consdirec_mx(pempresa char(3), pnumcte char(20), pnum_direc smallint)
returning char(5),int,char(1),char(40),char(60),char(40),
	...
	-- Bloque modificacion
		...
		if vsecuenciamax > 5 THEN

			let vsecuenciamin = vsecuenciamax - 5;
...
create procedure "informix".consdirec_juan(pempresa char(3), pnumcte char(20), pnum_direc smallint)
returning char(5),int,char(1),char(40),char(60),char(40),
          char(3),char(2),char(3),char(5),char(5),char(11),char(1),
          char(13),char(1),char(13),char(1),char(13),char(5),char(2),char(3),
          char(4),smallint,char(10),char(10),char(6),int,int,char(1),
