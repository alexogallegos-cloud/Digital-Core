CREATE PROCEDURE "informix".corrige_prov_30112010(pempresa CHAR(3))
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/corrige_prov_30112010.err";
        TRACE ON;
        IF sql_err <> 0 THEN
            LET vcodret = sql_err;
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/corrige_prov_30112010.out";
    --- TRACE ON;
    ...
    UPDATE STATISTICS MEDIUM FOR TABLE "informix".ctasxcorregir;
      
    LET vsql = 'echo "LOAD FROM /resplogifx/conciliachq/provs_30112010.unl INSERT INTO ctasxcorregir" > /resplogifx/conciliachq/ctasxcorreg.sql';
    SYSTEM vsql;
    LET vsql = '';
    ...
    FOREACH WITH HOLD
        SELECT {+INDEX (bdicheq:ctasxcorregir idx_ctasxcorr)} cuenta, monto
          INTO vcuenta, vmonto
          FROM ctasxcorregir
