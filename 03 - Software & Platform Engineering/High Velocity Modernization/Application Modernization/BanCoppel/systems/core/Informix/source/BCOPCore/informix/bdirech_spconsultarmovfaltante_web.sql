CREATE PROCEDURE "informix".spconsultarmovfaltante_web (p_sNumEmpleado CHAR(8), p_sNumSucursal CHAR(4), p_iIdFaltante CHAR(4),
										 p_dFechaInicial DATE, p_dFechaFinal DATE, pRegistro INTEGER)
RETURNING CHAR(5)     AS CodigoRetorno,
		  CHAR(8)     AS NumeroEmpleado,
		  CHAR(4)     AS NumeroSucursal,
		  CHAR(4)     AS IdFaltante,
	...
	--SET DEBUG FILE TO "/datos/francisco/spconsultarmovfaltante.out"; 
	--TRACE ON;	
	BEGIN
		ON EXCEPTION
			SET iSqlErr
		...
		--// ********************************************************************
		--// Valida parametros de entrada, la fecha es obligatria
		--// ********************************************************************
