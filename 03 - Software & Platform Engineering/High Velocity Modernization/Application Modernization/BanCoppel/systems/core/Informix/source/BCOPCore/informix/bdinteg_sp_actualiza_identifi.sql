CREATE PROCEDURE "informix".sp_actualiza_identifi(pNumcte CHAR(20),pCodidentif CHAR(2),pNumidentif CHAR(30))
...
BEGIN
	...
	END EXCEPTION;
	 ...
	 --TRACE ON;
		...
		--Se le update para actualizar IDE
	
			IF pNumcte IS NOT NULL OR pNumcte <> '' THEN
				
				   UPDATE bdinteg:"informix".si_ctepf
				   SET ( codidentifi, numidentifi) = 
					   (  pCodidentif, pNumidentif)
...
"Autor: 		98440021 - Abdon Hernandez",
"Fecha: 		11/07/2023",
"Solicita:		Fernando Rojas",
"Descripcion:   Se crea sp para actualizado de IDE.",
"BD: 			bdinteg";

CREATE PROCEDURE "informix".sp_validarprestamosotorgadoscoppel (pEmpresa CHAR(3), pNumCteCoppel CHAR(20))
RETURNING CHAR(5),  -- Codigo de retorno          
    ...
    BEGIN
        ...
        IF NVL(pEmpresa, '') <> "" AND NVL(pNumCteCoppel, '') <> "" THEN
            ...
            SELECT count(*) as prestamos INTO cRespuesta FROM bdisolic: ss_prestamoscoppel 
            WHERE fecha_contratacion=DATE(dFecha) AND numcte_ref=TRIM(pNumCteCoppel)
...
END PROCEDURE
DOCUMENT
'FOLIO: 849.1 - RQM 09 604 Otorgamiento de PrÃ©stamo Personal Grupo en originaciÃ³n de crÃ©ditos.',
'MODIFICACION: SE CREA PROCEDIMIENTO PARA VALIDAR SI EL CLIENTE CUENTA CON PRESTAMO COPPEL CON FECHA HOY.',
'AUTOR: 97523641- ALBERTO SANCHEZ',
'FECHA: 05/07/2022',
'BD: BDINTEG';

CREATE PROCEDURE "informix".sp_consulsolicporenviarcteprospecto_pbacost(pEmpresa CHAR(3))
	...
	--SET debug FILE TO '/tmp.sp_consulsolicporenviarcteprospecto_pbacost.out';
	--TRACE ON;
