CREATE PROCEDURE "informix".sp_consultasucursalappriza(pNumSucursal CHAR (4),pTipoConsulta CHAR (1))
...
--			 
	...
	LET cLocationUnit		= '';
	LET cNumIntentos		= '';
	LET iCodParamAppriza	= 87102;
	LET iCodParamChanID		= 87103;
	LET iCodParamLocUnit	= 87104;
...
--------------------------------------------------------------------------
--	SET DEBUG FILE TO "/home/sysifx/JesusBueno/Appriza/sp_consultasucursalappriza_aia.out";
--	TRACE ON;
--------------------------------------------------------------------------
...
END EXCEPTION;
	...
	execute procedure bdisac:"informix".sp_sac_consucursales(TRIM(pNumSucursal)) into cSPCodRet,iMensaje,cid_ptf,ccve_pais,cnompais,ccalle,cnum_ext, cnum_int,ccve_col,cnomcol,ccve_mun,cnommunicipio,ccve_localidad,cnomlocalidad,ccp,ccve_ciudad,cnomciudad,ccve_estado,cnomestado,ctel1,ctel2,ctipo;
