	...
	BEGIN 
       ...
       --Si no hay registros genera el archivo vac?
        IF (vTotalRegistros = 0) THEN
			...
			LET vMensaje = 'TERMINO EXITOSO SIN INFORMACIÃN PARA MOSTRAR';
        ELSE
			...
			-- Mensaje para cuando hay informacion para mostrar en los archivos de conciliacion.
			LET vMensaje = 'TERMINO EXITOSO CON INFORMACIÃN PARA MOSTRAR';
...
'Objetivo: GeneraciÃ³n de los archivos con el detalle de las compras de tarjeta de crÃ©dito Coppel MC ',
...
'Fecha de CreaciÃ³n: 15/07/2022',
'#2',
'Fecha de modificaciÃ³n: 16/nov/2022',
'Busqueda de secuencia extendida para compras y devoluciones, asÃ­ como la secuencia de coppel (idmovcoppel)',
'#3',
'Autor: Paul Antonio Garcia Gastelum',
'Objetivo: GeneraciÃ³n de los archivos con el detalle de compras, devoluciones y pagos interbancarios',
'de tarjeta de crÃ©dito Coppel pay con los campos nuevos solicitados y los totales de las transacciones de pagos interbancarios en el archivo',
'de caratula',
'Fecha de modificaciÃ³n: 13/03/2023'
;
