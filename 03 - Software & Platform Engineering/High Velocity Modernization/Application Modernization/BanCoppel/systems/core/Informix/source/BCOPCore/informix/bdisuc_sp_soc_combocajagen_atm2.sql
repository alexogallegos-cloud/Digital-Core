CREATE PROCEDURE "informix".sp_soc_combocajagen_atm2(pRegistros INTEGER, pRecuperacion INTEGER)
...
foreach
	SELECT SKIP pRegistros FIRST pRecuperacion codigo_plaza, descripcion 
...
'FECHA: 08/07/2021',
'MODULO: Gestor Catalogos',
'DESCRIPCION: Se clona SP productivo para añadir paginado',
'BD: bdisuc';
