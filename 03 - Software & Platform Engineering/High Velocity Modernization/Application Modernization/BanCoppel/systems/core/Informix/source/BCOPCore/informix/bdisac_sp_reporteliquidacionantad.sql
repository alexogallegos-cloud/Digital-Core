CREATE PROCEDURE "informix".sp_reporteliquidacionantad(pConvenio CHAR(5))
...
LET iCuantos	= 0;
	...
	--SET DEBUG FILE TO '/RESPALDOS/sp_reporteliquidacionantad.out';
	--TRACE ON;
	...
	BEGIN
		ON EXCEPTION SET iSqlErr, iIsamErr, cInfoErr
			IF iSqlErr <> 0 THEN
				...
				EXECUTE PROCEDURE "informix".sp_sac_GuardaMensajeerror (iSqlErr, iIsamErr, cInfoErr, "sp_reporteliquidacionantad");
			END IF;
		END EXCEPTION;
