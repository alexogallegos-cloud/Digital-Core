CREATE PROCEDURE "informix".sp_reportediarioacl_paralelo(num_reporte_inicial SMALLINT, num_reporte_final SMALLINT) returning char(7);
  ...
  --DEFINE ejecuta 					char(256);
	...
	DEFINE pen_vNumerCta 			VARCHAR(20);
  ...
  BEGIN
	...
	SET LOCK MODE TO WAIT 3;
  	...
  	--SET DEBUG FILE TO "/resplogifx/repaclaracionessp_reportediarioacl_paralelo_"||num_reporte_inicial||".out";
	--TRACE ON;
...
--let p_fecha_sistema = "04/01/2022";
    ...
    IF p_fechahoy <> (p_fecha_sistema -1) THEN
    	LET p_fechahoy = p_fecha_sistema -1;
    END IF;
...
DOCUMENT
'Sp para generacion de Reporte Diario Aclaraciones',
'Es llamado desde desde la opcion 172 del menu de produccion',
'Aclaraciones',
'AUTOR : Bernardo Beltran Herrera',
...
'Se modifico para mostrar el campo fecha_predictamen de las aclaraciones con cierre forzado',
...
'Se modifica para implementar nuevo archivo del CAT',
'Se modifico para generar un archivo extra referente a las solicitudes ingresadas por el CAT y se agregaron en pendientes los apos de canal,telefono y correo',
'en el reporte diario',
'Autor: Rey David Zavala Garcia',
'Fecha: 08/11/2018',
'Version WAR: 11.0.0',
'BD    :  bdiaclaracion',
'Se modifica para implementar CAT',

'{+OPTIMIZACION STK202405}',
'-- Reingenieria: Softtek / A.Canseco 05.2024',
'{+OPTIMIZACION STK202405}';
