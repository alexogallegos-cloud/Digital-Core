CREATE PROCEDURE "informix".sp_consultaliminteredo( pParametro CHAR(20) )
RETURNING CHAR(5), CHAR(60);
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/altamasempnet/sp_consultaliminteredo.out";
    --- TRACE ON;
    
    BEGIN
    
    ON EXCEPTION SET viSqlErr, viIsamErr, vcDescErr
        SET DEBUG FILE TO "/resplogifx/conciliachq/altamasempnet/sp_consultaliminteredo.err";
        TRACE ON;
        IF viSqlErr <> 0 THEN
