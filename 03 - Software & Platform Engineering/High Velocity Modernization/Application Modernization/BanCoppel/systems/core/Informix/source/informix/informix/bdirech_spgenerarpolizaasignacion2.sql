CREATE PROCEDURE "informix".spgenerarpolizaasignacion2 (p_dFechaActual DATE, p_sNumEmpleado CHAR(8), p_sUsuario CHAR(8))
  ...
  -- SET DEBUG FILE TO  "/tmp/mfinis/Prueba.out"; 
   --TRACE ON;
    ...
    BEGIN
		...
		IF v_sCodRet = '00000' THEN
			...
			AND fecharegistro = p_dFechaActual AND numempleado = p_sNumEmpleado AND contable = '0' GROUP BY 1, 2
				...
				v_sAuxiliar, v_sNumSucursal, v_sCCRecHumanos, 'C', v_sMontoTotal::CHAR(20), 'ABONO POR ASIGNACION DE DAÃOS', '0') 
