CREATE PROCEDURE "informix".sp_obtieneinfoproductividad( Pfecha Date,Psucursal Char (04),Pejecutivo Char (08), PtipoEjecutivo Char (01), siRegistros SMALLINT )
		...
		IF (PtipoEjecutivo = 'A'  AND dMaxFecha IS NOT NULL) OR (PtipoEjecutivo = 'Z'  AND dMaxFecha IS NOT NULL) OR (PtipoEjecutivo = 'E'  AND dMaxFecha IS NOT NULL) OR (PtipoEjecutivo = 'U'  AND dMaxFecha IS NOT NULL) THEN	
			...
			if pfecha = dMaxFecha THEN
				...
				ELSE 
						...
						RETURN '00000005',vFecha,vSucursal,vtpo_reg,vEjecutivo,'No existe información del reporte del cierre diario de la sucursal',vProducto,vcapcuentas,vcapMeta,
