CREATE PROCEDURE "informix".sp_consulta_cte_huella_exp1(pNumcte CHAR(20))
...
RETURNING CHAR(5) AS  cCodRet,
		...
		--DEFINICION DE VARIABLES
		 ...
		 --SET DEBUG FILE TO '/home/sysifx/Aracely/bdinteg/sp_consulta_cte_huella.out';
		--TRACE ON;
		 
BEGIN
	ON EXCEPTION SET iSqlErr
	IF iSqlErr !=0 THEN
		RETURN TRIM (isqlerr),cTemplate2,cTemplate7,sSecuencia;
	END IF
	END EXCEPTION

        SET DEBUG FILE TO '/tmp/traceHuella.txt';
        TRACE ON;
	...
	IF NVL(pNumcte,'') = '' THEN
	LET cCodRet = '00001'; 
			 RETURN cCodRet,cTemplate2,cTemplate7,sSecuencia;
	ELSE
	...
	END	IF;
		...
		INTO cTemplate2,cTemplate7,sSecuencia
...
'BD: bdinteg',
'Descripcion: Se crea sp para consulta de huellas actuales de cliente, 2 huellas',
'Peticion: 399 - ImplementaciÃÂ³n 442 para verificaciÃÂ³n y enrolamiento';

CREATE PROCEDURE "informix".sp_consulta_cte_huella(pNumcte CHAR(20))
...
BEGIN
	ON EXCEPTION SET iSqlErr
	IF iSqlErr !=0 THEN
		RETURN isqlerr,cTemplate2,cTemplate7,sSecuencia;
	END IF
	END EXCEPTION

	 --SET DEBUG FILE TO '/informix/LIP/cub/sp_consulta_cte_huella.out';
	 --TRACE ON;
	...
	END	IF;
		...
		SELECT FIRST 1 dmapa, imapa, secuencia 
		INTO cTemplate2,cTemplate7,sSecuencia
		FROM "informix".si_cte_huella
		WHERE estado = 'A'
        AND	numcte = pNumcte;
	...
	IF dbinfo('sqlca.sqlerrd2') = 0 THEN
		...
		RETURN  TRIM(NVL(cCodRet,"")),cTemplate2,cTemplate7,sSecuencia;
END
END PROCEDURE
DOCUMENT
'Creacion: Aracely UreÃÂÃÂ±a',
'BD: bdinteg',
'Descripcion: Se crea sp para consulta de huellas actuales de cliente, 2 huellas',
'Peticion: 399 - ImplementaciÃÂÃÂ³n 442 para verificaciÃÂÃÂ³n y enrolamiento';
