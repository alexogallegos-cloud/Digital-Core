CREATE PROCEDURE "informix".sp_calcularrfc_m(pNombre CHAR(100), pFechaNacimiento DATE)
        RETURNING CHAR(5) AS codret,CHAR(13) AS rfc;
        ...
        DEFINE cPrimerLetra CHAR(1);
        DEFINE cSegundaLetra CHAR(1);
        DEFINE cTercerLetra CHAR(1);
        ...
        BEGIN
                ...
                SET DEBUG FILE TO '/tmp/mfinis/sp_calcularrfc_m.out';
                TRACE ON;
                ...
                FOR i = 0 TO LENGTH(TRIM(pNombre))
                        LET cCaracter = SUBSTR(TRIM(pNombre), i, 1);
                         ...
                         LET iAscii = ASCII(cCaracter);
		
						IF NOT ((iAscii >= 97 AND iAscii <= 122)  OR (iAscii >= 65 AND iAscii <= 90) OR (iAscii >= 44 AND iAscii <= 57) OR iAscii = 32 OR iAscii = 209) THEN
						LET bEsLetraNumero = 'f';
						END IF; 

                        IF NOT bEsLetraNumero THEN
                ...
                IF TRIM(pNombre) <> '' THEN
                        ...
                        LET iCom = CHARINDEX(',',TRIM(pNombre));
                        IF  nvl(iCom,0) = 0 THEN
                        LET pNombre= TRIM(pNombre) || ',';
                       
                        END IF;
                                    
						LET cNombre= substr(pNombre,0,CHARINDEX(',',TRIM(pNombre))-1);
                        LET cNombre =  REPLACE(cNombre,' DE ',' ');
                        LET cNombre =  REPLACE(cNombre,'DE ',' ');
                        LET cNombre =  REPLACE(cNombre,'LA ','');
                        LET cNombre =  REPLACE(cNombre,'LAS ',' ');
                        LET cNombre =  REPLACE(cNombre,' LA ',' ');
                        LET cNombre =  REPLACE(cNombre,' Y ',' ');                        
                        LET cNombre =  REPLACE(cNombre,' LAS ',' ');
                        LET cNombre =  REPLACE(cNombre,' DEL ',' ');
                        LET cNombre =  REPLACE(cNombre,' EL ',' ');
                        LET cNombre =  REPLACE(cNombre,'EL ',' ');
                        LET cNombre =  REPLACE(cNombre,' LOS ',' ');
                        LET cNombre =  REPLACE(cNombre,'LOS ',' ');
                        LET cNombre =  REPLACE(cNombre,' UN ',' ');
                        LET cNombre =  REPLACE(cNombre,'UN ',' ');
                        LET cNombre =  REPLACE(cNombre,' A ',' ');
                        LET cNombre =  REPLACE(cNombre,' E ',' ');
                        LET cNombre =  REPLACE(cNombre,' VAN ',' ');
                        LET cNombre =  REPLACE(cNombre,' VON ',' ');
                        LET cNombre =  REPLACE(cNombre,'VAN ',' ');
                        LET cNombre =  REPLACE(cNombre,'VON ',' ');
                        LET cNombre =  REPLACE(cNombre,' PARA ',' ');
                        LET cNombre =  REPLACE(cNombre,' DU ',' ');
                        LET cNombre =  REPLACE(cNombre,'DU ',' ');
                        LET cNombre =  REPLACE(cNombre,'CIA. ',' ');
                        LET cNombre =  REPLACE(cNombre,' CIA ',' ');
                        LET cNombre =  REPLACE(cNombre,' CIA. ',' ');
                        LET cNombre =  REPLACE(cNombre,' S.A.',' ');
                        LET cNombre =  REPLACE(cNombre,' SA ',' ');
                        LET cNombre =  REPLACE(cNombre,' S.A. ',' ');
                        LET cNombre =  REPLACE(cNombre,' S.A',' ');
                        LET cNombre =  REPLACE(cNombre,' C.V.',' ');
                        LET cNombre =  REPLACE(cNombre,' CV ',' ');
                        LET cNombre =  REPLACE(cNombre,' C.V. ',' ');
                        LET cNombre =  REPLACE(cNombre,' C.V',' ');
                        LET cNombre =  REPLACE(cNombre,' R.L.',' ');
                        LET cNombre =  REPLACE(cNombre,' RL ',' ');
                        LET cNombre =  REPLACE(cNombre,' R.L. ',' ');
                        LET cNombre =  REPLACE(cNombre,' R.L',' ');
                        LET cNombre =  REPLACE(cNombre,'COMPAÑIA ',' ');
                        LET cNombre =  REPLACE(cNombre,' COMPAÑIA ',' ');
                        LET cNombre =  REPLACE(cNombre,'COMPAÑIA ',' ');
                        LET cNombre =  REPLACE(cNombre,'SOCIEDAD ',' ');
                        LET cNombre =  REPLACE(cNombre,' SOCIEDAD ',' ');
                        LET cNombre =  REPLACE(cNombre,'SOCIEDAD ',' ');
                        LET cNombre =  REPLACE(cNombre,'COOPERATIVA ',' ');
                        LET cNombre =  REPLACE(cNombre,' COOPERATIVA ',' ');
                        LET cNombre =  REPLACE(cNombre,'COOPERATIVA ',' ');
                        LET cNombre =  REPLACE(cNombre,'.',' ');

                        FOREACH 
                        
                        EXECUTE FUNCTION bdinteg:"informix".sp_split_cadena_m(cNombre, ' ') INTO lPalabra 
						LET f = f+1;
                        END FOREACH;
                        ...
                        IF g = 1 THEN 
                        LET cPrimerLetra =substr(lPalabra,0,1);
                      
                        END IF;

                        IF g = 2 THEN
                        LET cSegundaLetra =substr(lPalabra,0,1);
                      
                        END IF;

                        IF g = 3 THEN
                        LET cTercerLetra =substr(lPalabra,0,1);
                        ...
                        IF g = 2 THEN
                        LET cSegundaLetra =substr(lPalabra,0,1);
                        LET cTercerLetra =substr(lPalabra,2,1);
                        END IF;
                        ...
                        IF LENGTH(cNombre)>=3 THEN

                        LET cPrimerLetra =substr(cNombre,0,1);
                        LET cSegundaLetra =substr(cNombre,2,1);
                        LET cTercerLetra =substr(cNombre,3,1);
                        END IF;
                        
                        IF LENGTH(cNombre)=2 THEN
               ...
               LET cFecha =TO_CHAR(pFechaNacimiento, '%y%m%d');
               LEt cFecha = SUBSTR(cFecha,1,6);
               
               LET pNombre =  REPLACE(pNombre,'.','');
               LET pNombre = pNombre;
               
               EXECUTE FUNCTION  bdinteg:"informix".sp_obtenerhomoclave_m(REPLACE(pNombre,',','')) INTO cHomoclave;
               LET cHomoclave = TRIM(cHomoclave);

                LET cRFC =cPrimerLetra||cSegundaLetra||cTercerLetra||TRIM(cFecha)||cHomoclave;

                EXECUTE FUNCTION  bdinteg:"informix".sp_obtienedigitoverificador_rfc_m(TRIM(cRFC)) INTO cDigitoVerificador;
                 LET cRFC =cPrimerLetra||cSegundaLetra||cTercerLetra||TRIM(cFecha)||cHomoclave||cDigitoVerificador;
                RETURN cCodRet, cRfc;
        END;
...
'FECHA: 01/05/2021',
'DESCRIPCION: Genera el RFC de un cliente';
