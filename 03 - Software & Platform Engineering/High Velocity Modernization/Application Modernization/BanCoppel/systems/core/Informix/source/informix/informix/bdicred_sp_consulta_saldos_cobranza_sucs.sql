...
'Fecha: 14/04/2020',
'DESCRIPCION: Se agregan productos [6800,8100,8500] a la validaciÃÂ³n de saldo vencido.',
'Solicita: Marco Campos',
'Folio: 658',
'BD: bdicred';

CREATE PROCEDURE "informix".sp_graba_prod_upgradetdcoro(pEmpresa CHAR(3),
pCredito CHAR(20) ,
pNumCte CHAR(20) ,
pNumTar CHAR(20) ,
pTit CHAR(3),
