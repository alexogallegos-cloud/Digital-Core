CREATE PROCEDURE "informix".sp_capintafecha_2011(pCuenta CHAR(20), pFecha  DATE)
RETURNING  CHAR(10), DECIMAL(14,2), DECIMAL(14,2);
    ...
    --- SET DEBUG FILE TO './sp_capintafecha_2011.out';
    --- TRACE ON;
    ...
    SELECT DECODE( vdia,  '1', capvig1,   '2', capvig2,   '3', capvig3,   '4', capvig4,   '5', capvig5,
                         ...
                         '31', capvig31 ), 
           DECODE( vdia,  '1', intprovnp1,   '2', intprovnp2,   '3', intprovnp3,   '4', intprovnp4,   '5', intprovnp5,
                          '6', intprovnp6,   '7', intprovnp7,   '8', intprovnp8,   '9', intprovnp9,  '10', intprovnp10,
                         '11', intprovnp11, '12', intprovnp12, '13', intprovnp13, '14', intprovnp14, '15', intprovnp15,
                         '16', intprovnp16, '17', intprovnp17, '18', intprovnp18, '19', intprovnp19, '20', intprovnp20,
                         '21', intprovnp21, '22', intprovnp22, '23', intprovnp23, '24', intprovnp24, '25', intprovnp25,
                         '26', intprovnp26, '27', intprovnp27, '28', intprovnp28, '29', intprovnp29, '30', intprovnp30,
                         '31', intprovnp31 ) 
