CREATE PROCEDURE "informix".sp_eliminar_nominaplantillaempleados_bpi(pNumCliente VARCHAR(9),   pNumEmpleado CHAR(30))
    ...
    DEFINE vCantPlantillas INTEGER; 
	...
	BEGIN
		ON EXCEPTION SET sql_err
		  IF sql_err <> 0 THEN
				let vCodRet = sql_err;
				RETURN vCodRet, vCantPlantillas ;
		  END IF ;
		END EXCEPTION ;
		
		LET vCodRet = '00000';
     
        LET vCantPlantillas    = 0; 
		
		SET LOCK MODE TO WAIT 5;
        
          		SELECT  count(num_empleado) INTO vCantPlantillas FROM  bdicheq:sc_nominaplantillaempleados_bpi  
                where num_cte = pNumCliente  AND num_empleado = pNumEmpleado;
              
                IF ( vCantPlantillas>0)    THEN --Eliminar 
              	  	DELETE FROM bdicheq:sc_nominaplantillaempleados_bpi  WHERE 
	                num_cte = pNumCliente AND  num_empleado = pNumEmpleado;
...
'AUTOR.........: Solser',
'FECHA.........: 13-12-2021',
'MODIFICACION..: Baja empleados: validar Plantillas dispersiÃ³n de nÃ³mina.',
