CREATE PROCEDURE "informix".paseconthis(pempresa   CHAR(3),
                          fecha_pase DATE,
                          pusuario   CHAR(8))
...
--         END IF;
      ...
      SELECT a.regional,
	     b.secuencia, b.suc_origen, b.num_producto, b.codigo_fun,
             ...
             c.transacc, f.abreviatura, b.divisa, monto monto,
	     b.sucursal
...
DOCUMENT
"Programa de Pase contable, lee de sd_movhis y graba en bdicont:co_poliza",
