CREATE PROCEDURE "informix".sp_regordenctecte_exp1( pEmpresa  CHAR(3),               --- EMPRESA
...
RETURNING CHAR(5), char(100), CHAR(30);
	...
	--SET debug file to "sp_regordenctecte.out";
	--TRACE ON;
    ...
    ---SET debug file to "/tmp/sp_regordenctecte.out";
    ---TRACE ON;
