CREATE PROCEDURE "informix".sp_consulta_datos_detalle_bei(pIdMancomunidad Integer)
...
--**************************************************************************************************************
   ...
   END IF ;
	...
	Select manc.tipo_mov, us.usuario_bei as elaboro, manc.id_usuario, manc.ns_token,tkn.ns_token, manc.id_status_token
    ...
    Select us.usuario_bei, u.nombre, u.tel_celular,u.e_mail
