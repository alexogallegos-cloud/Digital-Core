CREATE PROCEDURE "informix".sp_arqueossuc_atm(pempresa CHAR(3), psucursal CHAR(4),
											pcajeroprincipal CHAR(8), pfolio_suc CHAR(16),
                                            ptransacc CHAR(4), pdivisa CHAR(2),
                                            psaldototal money(14,2), pfecha DATE,
...
LET vcodret = "000";
	...
	ELSE
		...
		IF EXISTS (SELECT sucursal FROM "informix".ss_saldossuc WHERE sucursal = psucursal and fecha = pfecha) THEN
