# SP Profile: `califica_scoring_cjunk_precal_opt`
...
El SP `califica_scoring_cjunk_precal_opt` implementa la logica de califica scoring crediticio en el dominio Solicitudes de Credito (base de datos `bdisolic`). Comprende 2,307 lineas de codigo, 55 tablas consultadas, 3 autores historicos. Delega logica a: `bdisolic`, `bdimnsj`, `bdinteg`.
...
| Vista HTML interactiva | [../../portal/sp-detail/sp-detail-califica_scoring_cjunk_precal_opt.html](../../portal/sp-detail/sp-detail-califica_scoring_cjunk_precal_opt.html) |
...
El nombre contiene tokens sinteticos (`cjunk`, `?_p`, `?al_opt`), lo que indica que el alcance original fue parcialmente documentado por el equipo historico.
