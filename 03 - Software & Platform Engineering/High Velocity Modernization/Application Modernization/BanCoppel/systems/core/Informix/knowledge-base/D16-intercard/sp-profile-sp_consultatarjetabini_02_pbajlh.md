# SP Profile: `sp_consultatarjetabini_02_pbajlh`
...
El SP `sp_consultatarjetabini_02_pbajlh` implementa la logica de consulta tarjeta (sufijo de SPs para Pruebas; confirmado por SME) en el dominio Intercard (base de datos `intercard`). Comprende 1,333 lineas de codigo, 3 tablas consultadas. 
...
| Vista HTML interactiva | [../../portal/sp-detail/sp-detail-sp_consultatarjetabini_02_pbajlh.html](../../portal/sp-detail/sp-detail-sp_consultatarjetabini_02_pbajlh.html) |
...
```mermaid
flowchart TD
    A["sp_consultatarjetabini_02_pbajlh\nRecibe parámetros de entrada"]
...
sequenceDiagram
    ...
    participant SP as sp_consultatarjetabini_02_p.
    CL->>SP: invoca sp_consultatarjetabini_02_p.
...
El nombre contiene tokens sinteticos (`?bini_02_`, `?jlh`), lo que indica que el alcance original fue parcialmente documentado por el equipo historico.
