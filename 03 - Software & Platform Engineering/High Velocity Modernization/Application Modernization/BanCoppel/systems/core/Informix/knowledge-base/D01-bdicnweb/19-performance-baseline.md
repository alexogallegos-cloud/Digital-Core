# D01 · Canal Digital Web — Baseline de Performance

> **Componente:** Informix · SPE-AM-001 · TEST Phase
> **Base de datos:** `bdicnweb` · IBM Informix IDS 14.10 POWER-AIX → Aurora PostgreSQL
...
-- Instrumentar el SP que llama a bdicnweb:sp_nombre() para registrar:
...
|----|-----------------|---------|---------|---------|---------|
| `sp_split_cadena` | 857 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_ope_consultarutalmacenamientoxml` | 372 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_bitacora` | 345 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_generararchivo_rst` | 345 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_obtieneencabezadomasivo` | 314 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
...
| Patrón | Impacto en `bdicnweb` | Preparación |
|--------|-------------------|------------|
...
export default function() {
  ...
  let res = http.post('https://api.target/bdicnweb/v1/endpoint', payload);
