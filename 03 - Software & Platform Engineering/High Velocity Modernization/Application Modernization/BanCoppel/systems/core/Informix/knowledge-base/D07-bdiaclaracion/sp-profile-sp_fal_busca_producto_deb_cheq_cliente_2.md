# SP Profile: `sp_fal_busca_producto_deb_cheq_cliente_2`
...
El SP `sp_fal_busca_producto_deb_cheq_cliente_2` implementa la logica de busca producto, cheque y cliente (débito) en el dominio Aclaraciones (base de datos `bdiaclaracion`). Comprende 11,752 lineas de codigo, 1 tablas consultadas. 
...
| Vista HTML interactiva | [../../portal/sp-detail/sp-detail-sp_fal_busca_producto_deb_cheq_cliente_2.html](../../portal/sp-detail/sp-detail-sp_fal_busca_producto_deb_cheq_cliente_2.html) |
