...
| `sp_actualiza_respuestacoppel_cteprosp` | 49 | 0 tablas | 2 tablas | Sufijo _resp indica copia de prueba/desarrollo |
...
| `sp_apercredcoppel2` | 104 | R:5 W:2 | Fan-in=0 — validar con DBA |
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/BCOPCore/informix/bdisolic_*.sql (análisis estático de 70 archivos SQL) · callgraph-data.json (fan_in) + análisis de nombres*
