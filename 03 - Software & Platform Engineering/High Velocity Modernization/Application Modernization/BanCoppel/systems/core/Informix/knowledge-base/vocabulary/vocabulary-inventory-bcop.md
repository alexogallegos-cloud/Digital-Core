...
| `usuario` | entidad | usuario | 🟢 Alta | 36 | 2244 |
| `idfuncion` | entidad | id de funcionalidad | 🟢 Alta | 0 | 2114 |
| `consulta` | acción | consulta / proyecta estado de entidad; sp_consulta_saldos_general (bdicred, fi=435) devuelve 47 campos del snapshot financiero de un crédito (cap vig/trans/vdo, int, IVA, comisiones, línea disponible, bloqueos) usando DIRTY READ | 🟢 Alta | 822 | 12 |
| `registros` | entidad | registros | 🟢 Alta | 12 | 536 |
| `recuperacion` | acción | recuperación (cobranza) | 🟢 Alta | 6 | 529 |
| `empresa` | entidad | empresa (entidad bancaria) | 🟢 Alta | 1 | 494 |
| `cons` | acción | consulta | 🟢 Alta | 417 | 0 |
| `sucursal` | entidad | sucursal | 🟢 Alta | 54 | 299 |
| `os` | entidad | OS — Originación de Solicitudes / subsistema de ofertas (sp_os_*, sp_calcula_estatus_os — bdisolic) | 🟢 Alta | 288 | 0 |
| `fechafin` | entidad | fecha fin | 🟢 Alta | 0 | 277 |
| `totales` | modificador | totales | 🟢 Alta | 245 | 0 |
| `ro` | entidad | ro — Rol Operativo (subsistema sp_sw_ro_* — bdicnweb) | 🟢 Alta | 227 | 0 |
| `fecha` | entidad | fecha | 🟢 Alta | 33 | 174 |
| `tipo` | modificador | tipo de | 🟢 Alta | 80 | 117 |
| `ope` | acción | operación | 🟢 Alta | 189 | 0 |
| `cuenta` | entidad | cuenta | 🟢 Alta | 58 | 130 |
| `reporte` | entidad | reporte | 🟢 Alta | 169 | 4 |
| `rep` | acción | reporte | 🟢 Alta | 172 | 0 |
| `valida` | acción | valida acceso o condición antes de proceder; sp_valida_perfil_usuario (bdinteg, fi=388) consulta si_perfil_ejecut para perfiles 602/707/109/2001 y determina qué reporte muestra el ejecutivo; patrón: NVL check → tabla referencia → código+mensaje+bandera | 🟢 Alta | 170 | 2 |
| `detalle` | entidad | detalle | 🟢 Alta | 158 | 0 |
| `cte` | entidad | cliente | 🟢 Alta | 151 | 4 |
...
| `producto` | entidad | producto | 🟢 Alta | 27 | 107 |
| `archivo` | entidad | archivo | 🟢 Alta | 113 | 13 |
...
| `bandera` | modificador | bandera / flag (técnico) | 🟢 Alta | 3 | 101 |
...
| `ejecutivo` | entidad | ejecutivo | 🟢 Alta | 4 | 92 |
...
| `estatus` | entidad | estado de un objeto de negocio; en bdicred: estatus_cred (activo/bloqueado/vencido), en bdinteg: status_alerta (veredicto antifraude en si_bitacora_comparaciones), en bdicnweb: estatus de solicitud y proceso; valor siempre CHAR(1-2) codificado | 🟢 Alta | 30 | 42 |
...
| `credito` | entidad | crédito | 🟢 Alta | 51 | 13 |
...
| `mes` | entidad | mes | 🟢 Alta | 19 | 43 |
| `esp` | modificador | especial | 🟢 Alta | 61 | 0 |
| `sol` | entidad | solicitud | 🟢 Alta | 61 | 0 |
| `arch` | entidad | archivo | 🟢 Alta | 60 | 0 |
| `folio` | entidad | folio | 🟢 Alta | 15 | 45 |
| `ss` | entidad | ss — subsistema / canal de monitoreo (abreviación — envia_monitorsol_*_ss_* — bdisolic) | 🟢 Alta | 60 | 0 |
| `secuencia` | entidad | secuencia | 🟢 Alta | 3 | 56 |
| `tarjeta` | entidad | tarjeta | 🟢 Alta | 24 | 35 |
| `transaccion` | entidad | transacción | 🟢 Alta | 31 | 28 |
| `codigo` | entidad | código | 🟢 Alta | 8 | 50 |
...
| `numsolicitud` | entidad | número de solicitud | 🟢 Alta | 1 | 48 |
...
| `operacion` | acción | operación | 🟢 Alta | 17 | 30 |
| `alta` | acción | da de alta / registra | 🟢 Alta | 40 | 6 |
| `ctes` | entidad | clientes | 🟢 Alta | 46 | 0 |
| `param` | entidad | parámetro | 🟢 Alta | 44 | 2 |
| `productos` | entidad | productos | 🟢 Alta | 46 | 0 |
| `coppel` | entidad | Coppel (grupo) | 🟢 Alta | 39 | 6 |
| `rcda` | entidad | RCDA — producto de captación/ahorro (apertura, incremento de saldo, acumulación mensual); gestionado en bdmis (sp_rcda_apert, sp_rcda_acumsdo_mes) | 🟡 Media | 45 | 0 |
| `atms` | entidad | cajeros automáticos (ATM) | 🟢 Alta | 44 | 0 |
| `canal` | entidad | canal (de distribución) | 🟢 Alta | 10 | 34 |
...
| `importe` | entidad | importe | 🟢 Alta | 1 | 39 |
| `mov` | entidad | movimiento | 🟢 Alta | 40 | 0 |
| `envio` | acción | envía | 🟢 Alta | 36 | 3 |
| `suc` | modificador | sucursal | 🟢 Alta | 35 | 4 |
...
| `causa` | entidad | causa / motivo | 🟢 Alta | 13 | 25 |
| `error` | entidad | error | 🟢 Alta | 32 | 6 |
| `ins` | acción | insertar | 🟢 Alta | 38 | 0 |
| `por` | modificador | por (criterio) | 🟢 Alta | 38 | 0 |
| `sms` | entidad | SMS | 🟢 Alta | 38 | 0 |
| `spei` | prefijo | familia SPEI — pagos interbancarios certificados Banxico; sp_cons_spei_aud (bdinteg, fi=122) audita transacciones por rango de fecha devolviendo folio+monto+referencia con paginación (skip/límite); bdispei contiene recepción de errores CoDi y devoluciones | 🟢 Alta | 37 | 1 |
| `tar` | entidad | Tarjeta (abreviación — bdicheq/bdicred: cons_cta_o_tar, mover_his_tar, obtener_cta_con_num_tar) | 🟢 Alta | 38 | 0 |
| `desc` | entidad | [polisemia] Descripción (sp_desc_ret: devuelve descripción del código de retorno) | Descarga (sp_desc_archivos_cfdi/conc: descarga archivos CFDI y conciliación) | 🟢 Alta | 34 | 3 |
| `fc` | entidad | fc — Fuentes Combinadas (subsistema sp_fc_*; biométricos — bdicnweb) | 🟢 Alta | 37 | 0 |
| `opcion` | entidad | opción | 🟢 Alta | 0 | 37 |
...
| `estado` | entidad | estado (entidad federativa / estatus) | 🟢 Alta | 13 | 23 |
| `archivos` | entidad | archivos | 🟢 Alta | 35 | 0 |
| `elimina` | acción | elimina | 🟢 Alta | 35 | 0 |
| `linea` | entidad | línea (de crédito) | 🟢 Alta | 32 | 3 |
| `reg` | acción | registro | 🟢 Alta | 34 | 1 |
| `rfc` | entidad | RFC (registro fiscal) | 🟢 Alta | 8 | 27 |
| `cancela` | acción | cancela | 🟢 Alta | 34 | 0 |
| `cheque` | entidad | cheque | 🟢 Alta | 17 | 17 |
| `saldos` | entidad | saldos | 🟢 Alta | 33 | 1 |
...
| `banco` | entidad | banco | 🟢 Alta | 27 | 4 |
| `clave` | entidad | clave | 🟢 Alta | 10 | 21 |
...
| `historico` | modificador | histórico | 🟢 Alta | 27 | 1 |
...
| `calle` | entidad | calle (domicilio) | 🟢 Alta | 7 | 17 |
| `concilia` | acción | conciliación | 🟢 Alta | 24 | 0 |
| `empleado` | entidad | empleado | 🟢 Alta | 15 | 9 |
...
| `tel` | entidad | teléfono | 🟢 Alta | 23 | 1 |
| `divisa` | entidad | divisa | 🟢 Alta | 2 | 21 |
...
| `huella` | entidad | huella biométrica | 🟢 Alta | 15 | 8 |
| `pagos` | entidad | pagos (plural) | 🟢 Alta | 23 | 0 |
| `ruta` | entidad | ruta (de archivo) | 🟢 Alta | 5 | 18 |
...
| `expediente` | entidad | expediente | 🟢 Alta | 21 | 1 |
...
| `fusion` | acción | fusiona cuentas | 🟢 Alta | 18 | 2 |
| `ingreso` | entidad | ingreso (del solicitante) | 🟢 Alta | 10 | 10 |
| `rol` | entidad | rol / perfil | 🟢 Alta | 18 | 2 |
...
| `pais` | entidad | país | 🟢 Alta | 5 | 13 |
| `parametro` | entidad | parámetro | 🟢 Alta | 11 | 7 |
| `plaza` | entidad | plaza (regional) | 🟢 Alta | 8 | 10 |
| `valor` | entidad | valor | 🟢 Alta | 4 | 14 |
...
| `periodicidad` | modificador | periodicidad | 🟢 Alta | 2 | 15 |
...
| `ejecuta` | acción | ejecuta (verbo — proceso / operación) | 🟡 Media | 15 | 0 |
...
| `colonia` | entidad | colonia — colonia postal para validación de domicilio (sp_consultacoloniascp fan_in=281) | 🟢 Alta | 1 | 13 |
...
| `ciudad` | entidad | ciudad | 🟢 Alta | 1 | 12 |
...
| `grupo` | entidad | grupo | 🟢 Alta | 4 | 9 |
| `identificacion` | entidad | identificación | 🟢 Alta | 5 | 8 |
| `num` | entidad | número (de) | 🟢 Alta | 12 | 1 |
...
| `cadena` | entidad | cadena — string / cadena de texto (sp_split_cadena) | 🟢 Alta | 4 | 8 |
...
| `debito` | entidad | débito | 🟢 Alta | 11 | 1 |
...
| `docto` | entidad | documento | 🟢 Alta | 2 | 9 |
...
| `registro` | entidad | registro | 🟢 Alta | 7 | 4 |
...
| `concepto` | entidad | concepto de pago | 🟢 Alta | 2 | 7 |
...
| `digi` | acción | digitalización | 🟡 Media | 9 | 0 |
...
| `inicio` | modificador | inicio | 🟢 Alta | 5 | 4 |
...
| `validacion` | acción | validación | 🟢 Alta | 7 | 1 |
...
| `nacionalidad` | entidad | nacionalidad | 🟢 Alta | 1 | 5 |
| `parametrico` | entidad | paramétrico — parametrización de modelos (envío paramétrico) | 🟡 Media | 6 | 0 |
...
| `respaldo` | entidad | respaldo / garantía de crédito (aval) | 🟡 Media | 6 | 0 |
| `supervision` | entidad | supervisión | 🟢 Alta | 6 | 0 |
| `trae` | acción | trae / recupera (verbo — sp_*_trae — bdisuc) | 🟡 Media | 6 | 0 |
| `traspas` | acción | traspaso | 🟡 Media | 6 | 0 |
| `vencimiento` | entidad | vencimiento | 🟢 Alta | 6 | 0 |
| `acceso` | entidad | acceso | 🟡 Media | 5 | 0 |
...
| `nomina` | entidad | nómina | 🟢 Alta | 4 | 1 |
| `parentesco` | entidad | parentesco (referencia) | 🟢 Alta | 0 | 5 |
...
| `beneficiario` | entidad | beneficiario (receptor del pago SPEI) | 🟢 Alta | 3 | 1 |
...
| `rst` | entidad | rst — formato RST (sp_generararchivo_rst fan_in=345 — NO_VERIFICABLE) | 🔴 Ambigua | 3 | 0 |
...
| `pasa` | acción | pasa / mueve (verbo — pasamovshist* — archiva movimientos a histórico) | 🟡 Media | 2 | 0 |
...
| `auxiliar` | entidad | auxiliar contable — sub-ledger contable (sdos_auxiliar, sp_validaauxiliar) | 🟢 Alta | 0 | 1 |
...
|---|---|---|---|--:|--:|
| `numcte` | num + cte | número de cliente | 🟢 Alta | 1 | 291 |
| `fechainicio` | fecha + inicio | fecha inicio | 🟢 Alta | 0 | 182 |
| `fechainicial` | fecha + inicial | fecha inicial | 🟢 Alta | 0 | 91 |
| `numcuenta` | num + cuenta | número de cuenta | 🟢 Alta | 0 | 67 |
