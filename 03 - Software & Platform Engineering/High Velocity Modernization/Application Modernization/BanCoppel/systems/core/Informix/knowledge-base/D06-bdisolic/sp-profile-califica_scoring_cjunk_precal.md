# SP Profile: `califica_scoring_cjunk_precal`
...
El SP `califica_scoring_cjunk_precal` implementa la logica de califica scoring crediticio en el dominio Solicitudes de Credito (base de datos `bdisolic`). Comprende 2,281 lineas de codigo, 52 tablas consultadas, 17 autores historicos. Es invocado por 1 callers en el sistema, lo que lo convierte en un componente de alta dependencia. Delega logica a: `bdisolic`, `bdimnsj`, `bdinteg`.
...
| Vista HTML interactiva | [../../portal/sp-detail/sp-detail-califica_scoring_cjunk_precal.html](../../portal/sp-detail/sp-detail-califica_scoring_cjunk_precal.html) |
...
El nombre contiene tokens sinteticos (`cjunk`, `?_p`, `?al`), lo que indica que el alcance original fue parcialmente documentado por el equipo historico.
