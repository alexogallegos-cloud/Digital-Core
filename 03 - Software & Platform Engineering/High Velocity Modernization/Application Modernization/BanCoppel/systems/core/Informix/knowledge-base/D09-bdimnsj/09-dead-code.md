...
> **[SME-PENDING]** Confirmar con DBA BanCoppel que ninguno de estos SPs es invocado desde algún proceso no documentado (job scheduler, script externo, Latinia callback).
