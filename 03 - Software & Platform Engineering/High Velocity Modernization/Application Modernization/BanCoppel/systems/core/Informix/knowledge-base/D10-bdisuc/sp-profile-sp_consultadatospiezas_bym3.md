# SP Profile: `sp_consultadatospiezas_bym3`

> **Base de datos**: `bdisuc` · Dominio D10 — Sucursales
> **Tipo de artefacto**: Perfil funcional · Gemelo Cognitivo — Capa 4: Intencion
> **Ultima actualizacion**: 2026-08-03
> **Estado**: ACTIVO · 381 callers en produccion

---

## Historia Funcional

El SP `sp_consultadatospiezas_bym3` implementa la logica de consulta datos, piezas de efectivo y Billetes y Monedas en el dominio Sucursales (base de datos `bdisuc`). Comprende 1,298 lineas de codigo, 13 tablas consultadas. Es invocado por 381 callers en el sistema, lo que lo convierte en un componente de alta dependencia. 
...
| Vista HTML interactiva | [../../portal/sp-detail/sp-detail-sp_consultadatospiezas_bym3.html](../../portal/sp-detail/sp-detail-sp_consultadatospiezas_bym3.html) |
...
```mermaid
flowchart TD
    A["Entrada: sp_consultadatospiezas_bym3"]
    B["Proceso principal"]
    A --> B
    Z["Salida"]
    B --> Z
...
sequenceDiagram
    ...
    Note over SP,CL: vocab: bym3, consulta, cons, datos
