# D08 · SPEI — Baseline de Performance

> **Componente:** Informix · SPE-AM-001 · TEST Phase
> **Base de datos:** `bdispei` · IBM Informix IDS 14.10 POWER-AIX → Aurora PostgreSQL
...
-- Instrumentar el SP que llama a bdispei:sp_nombre() para registrar:
...
|----|-----------------|---------|---------|---------|---------|
| `sp_validafecha` | 52 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `spei_recerrorescodi` | 27 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_regordenctecte_pp` | 9 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `spei_recdevolucion` | 2 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `spei_recextemporanea` | 2 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
...
| Patrón | Impacto en `bdispei` | Preparación |
|--------|-------------------|------------|
...
export default function() {
  ...
  let res = http.post('https://api.target/bdispei/v1/endpoint', payload);
