# SP Profile: `califica_scoring_cjunk`

> **Base de datos**: `bdisolic` · Dominio D06 — Solicitudes de Credito
> **Tipo de artefacto**: Perfil funcional · Gemelo Cognitivo — Capa 4: Intencion
> **Ultima actualizacion**: 2026-08-03
> **Estado**: ACTIVO · 6 callers en produccion

---

## Historia Funcional

El SP `califica_scoring_cjunk` implementa la logica de califica scoring crediticio en el dominio Solicitudes de Credito (base de datos `bdisolic`). Comprende 2,798 lineas de codigo, 59 tablas consultadas, 5 autores historicos. Es invocado por 6 callers en el sistema, lo que lo convierte en un componente de alta dependencia. Delega logica a: `bdisolic`, `bdimnsj`, `bdinteg`.
...
| Vista HTML interactiva | [../../portal/sp-detail/sp-detail-califica_scoring_cjunk.html](../../portal/sp-detail/sp-detail-califica_scoring_cjunk.html) |
...
```mermaid
flowchart TD
    A["Entrada: califica_scoring_cjunk"]
    N1["CALL: solicitud"]
    A --> N1
