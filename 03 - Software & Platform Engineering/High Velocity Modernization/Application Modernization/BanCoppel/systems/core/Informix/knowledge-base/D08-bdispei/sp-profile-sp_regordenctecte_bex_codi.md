# SP Profile: `sp_regordenctecte_bex_codi`
...
El SP `sp_regordenctecte_bex_codi` implementa la logica de orden y cliente · CoDi — Cobro Digital en el dominio SPEI / CoDi (base de datos `bdispei`). Comprende 2,291 lineas de codigo, 16 tablas consultadas. Delega logica a: `spei_recerrorescodi`, `sp_validaspei_bpi`, `spei_validaoperacion`.
...
| Vista HTML interactiva | [../../portal/sp-detail/sp-detail-sp_regordenctecte_bex_codi.html](../../portal/sp-detail/sp-detail-sp_regordenctecte_bex_codi.html) |
...
```mermaid
flowchart TD
    A["Entrada: sp_regordenctecte_bex_codi"]
...
|----|------|-----------|-------|--------|------------|
| BR-V2-1684 | FÓRMULA | CALCULO_FINANCIERO | 259 | `intBancoOrd = (vchrparametro * 1)` | — |
| BR-V2-1685 | UMBRAL | OPERACIONAL | 1120 | `IF pmnyImporte > 100000.00 THEN` | — |
