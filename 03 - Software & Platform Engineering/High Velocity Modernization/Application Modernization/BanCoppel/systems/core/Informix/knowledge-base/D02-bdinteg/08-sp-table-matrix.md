...
| `sp_actstatusctecopnvoparam_club` | 1360 | 0 | `BDICHEQ:`  ⚠️ext, `BDINTEG:`  ⚠️ext, `BDINTEG:SI_CLIENTE`  ⚠️ext, `BDINTEG:SI_FUSCLIENTE`  ⚠️ext, `BdInteg:tmpxmlarchclientecoppel`  ⚠️ext, `bdicheq:`  ⚠️ext | `bdinteg:`  ⚠️ext, `bdinteg:cte_coppel_huella`  ⚠️ext, `bdinteg:sp_temphuella`  ⚠️ext, `clientes_coppel_envia_xml` |
...
- `BdInteg:tmpxmlarchclientecoppel` (R) — desde `sp_actstatusctecopnvoparam_club`
...
- `bdinteg:cte_coppel_huella` (R+W) — desde `sp_actstatusctecopnvoparam_club`
