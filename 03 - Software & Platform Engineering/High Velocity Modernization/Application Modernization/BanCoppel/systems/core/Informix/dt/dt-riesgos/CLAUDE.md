# DT-Riesgos — Digital Twin · Informix
...
|-----|------|---------------|-----------------------|
| Specialist — Informix SPL Analysis | `Informix/dt/dt-spl-analysis/` | 1.0.0 | Detección de riesgos técnicos — dead code, transacciones no atómicas, dependencias implícitas |
...
- **Fuente primaria**: `Informix/knowledge-base/migration-risk-register.md` — documento vivo v1.2.0 con los 11 riesgos de producción/integración + 44 riesgos de equivalencia en `05-risks.md` por dominio
...
| RK-05 | No existe `migration-risk-register.md` en la raíz de `Informix/` (el archivo canónico vive en `knowledge-base/`) | WARN |

---

*v1.1.0 · 2026-08-03 · Informix project DT — DISCOVER · Risk register v1.2.0; R001/R002 reclasificados como dependencias DESIGN; R009/R010 añadidos (confirmados en código)*
