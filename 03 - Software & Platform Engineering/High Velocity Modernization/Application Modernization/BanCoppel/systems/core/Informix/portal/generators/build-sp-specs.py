...
DOMS = {
    ...
    "d13": dict(db="bditef",       name="TEF",                 folder="D13-bditef"),
    "d14": dict(db="bdibei",       name="BEI",                 folder="D14-bdibei"),
    "d15": dict(db="bdilide",      name="LIDE / PLD",          folder="D15-bdilide"),
    "d16": dict(db="intercard",    name="Tarjetas",            folder="D16-intercard"),
}
