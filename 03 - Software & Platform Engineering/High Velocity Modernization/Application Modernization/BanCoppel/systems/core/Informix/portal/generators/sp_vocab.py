...
CAT = {
 ...
 "spei":("PREFIJO","familia SPEI (pagos interbancarios)","conf"),
 "cont":("PREFIJO","familia contabilidad","conf"),"cam":("PREFIJO","cámara / captura contable","inf"),
 "fal":("PREFIJO","faltantes / documentación de expediente","inf"),
 "acl":("PREFIJO","familia aclaraciones","conf"),"ciloc":("PREFIJO","consulta local de cobranza","inf"),
 "cnsif":("PREFIJO","consulta SIF (bus de integración)","inf"),"cac":("PREFIJO","familia crédito (CAC)","inf"),
 "mon":("PREFIJO","monitor / módulo","inf"),"dicta":("PREFIJO","dictamen (aclaraciones/crédito)","inf"),
 ...
 "chi":("PREFIJO","CHI — integración con Buró de Crédito (Credit History Interface)","inf"),
 ...
 "reporte":     ("ENTIDAD","reporte — reporte/informe operativo (sp_*genreporte* — bdicnweb)","conf"),
 "cg":          ("ENTIDAD","cg — Canal/Cuenta General (subsistema sp_cg_* — bdicnweb)","gap"),
 "sw":          ("ENTIDAD","sw — SoftWare/Switch (subsistema sp_sw_ro_* — bdicnweb)","gap"),
 "ro":          ("ENTIDAD","ro — Rol Operativo (subsistema sp_sw_ro_* — bdicnweb)","gap"),
 "fc":          ("ENTIDAD","fc — Fuentes Combinadas (subsistema sp_fc_*; biométricos — bdicnweb)","gap"),
 "cc":          ("ENTIDAD","cc — cuenta corriente (sp_*_cc_* — bdicnweb)","inf"),
 "masivo":      ("ENTIDAD","masivo — proceso masivo/batch (sp_obtieneencabezadomasivo fan_in=314)","inf"),
 ...
 "regex":       ("ENTIDAD","regex — motor de expresiones regulares Informix SPL (infraestructura bdinteg — 8 SPs ~34MB EXCLUIR de análisis)","gap"),
 ...
 "folio":       ("ENTIDAD","folio — número de referencia / comprobante de operación","conf"),
 "clabe":       ("ENTIDAD","CLABE — Clave Bancaria Estandarizada (18 dígitos — Banxico — digverclabe)","conf"),
 "digver":      ("ENTIDAD","dígito verificador (abreviación — digverclabe NO_VERIFICABLE)","inf"),
 "portab":      ("ENTIDAD","portabilidad — portabilidad de nómina (sp_generarchivoportab_*, sp_notif_cambios_portacec)","conf"),
 "pasa":        ("ACCION", "pasa / mueve (verbo — pasamovshist* — archiva movimientos a histórico)","inf"),
 "borra":       ("ACCION", "borra / elimina registros (borramovs_movhis, borramovscfd*)","inf"),
 "inv":         ("ENTIDAD","inv — inversión (abreviación — calsdoinvcrec, cierrechqinvcrec)","inf"),
 "dispersion":  ("ENTIDAD","dispersión — dispersión de nómina (sp_dispercionnomina_bpi)","conf"),
 "disper":      ("ENTIDAD","disper — dispersión (abreviación — sp_dispercionnomina_*)","inf"),
 ...
 "dv":          ("ENTIDAD","dv — divisa (abreviación — bdisac)","inf"),
 "gdf":         ("ENTIDAD","gdf — código geográfico / Gobierno CDMX (abreviación — bdisac)","gap"),
 ...
 "sv":          ("ENTIDAD","sv — supervisión/servicio (abreviación — bdiaclaracion)","gap"),
 "bym":         ("ENTIDAD","BYM — Bienes y Mercancías (sistema de inventario sucursal — sp_*_bym* — bdisuc)","inf"),
 "piezas":      ("ENTIDAD","piezas — unidades de mercancía en sucursal (sp_consultadatospiezas_bym*)","conf"),
 "dictamen":    ("ENTIDAD","dictamen — resolución/clasificación de bien o crédito","conf"),
 "trae":        ("ACCION", "trae / recupera (verbo — sp_*_trae — bdisuc)","inf"),
 ...
 "cobranza":    ("ENTIDAD","cobranza — gestión de recuperación de cartera vencida","conf"),
 ...
 "ctb":         ("ENTIDAD","ctb — contabilidad (abreviación interfaz — sp_ctbcpl_* D11↔D12)","inf"),
 ...
 "generar":     ("ACCION", "generar (infinitivo — sp_generarbalanza*)","inf"),
 "balp":        ("ENTIDAD","balp — balance preventivo / balanza preventiva (gen_balprev*)","gap"),
 "consolidada": ("MODIF",  "consolidada / consolidado — cifras consolidadas (balanza diaria/mensual consolidada)","inf"),
 # términos descubiertos en grounding pass D06+D03 re-run Round 4 (2026-07-11)
 "os":         ("ENTIDAD","OS — Originación de Solicitudes / subsistema de ofertas (sp_os_*, sp_calcula_estatus_os — bdisolic)","inf"),
 "respalda":   ("ACCION", "respalda / garantiza — aval o garantía de crédito (respalda_creditocrd, respaldacrd)","inf"),
 "respaldo":   ("ENTIDAD","respaldo / garantía de crédito (aval)","inf"),
 "indicador":  ("ENTIDAD","indicador — marcador de estado o condición (sp_ambientar_indicador_*, sp_actualiza_indicadorcred)","inf"),
 "exec":       ("ACCION", "exec — ejecuta / execute (abreviación — execmuestraedocta, executaedocta)","inf"),
 "edocta":     ("ENTIDAD","edo cta — estado de cuenta (abreviación compuesta — execmuestraedocta, generaedosctacrd)","inf"),
 "ss":         ("ENTIDAD","ss — subsistema / canal de monitoreo (abreviación — envia_monitorsol_*_ss_* — bdisolic)","gap"),
 ...
 "cobrar":     ("ACCION", "cobrar (infinitivo)","conf"),
 "mueve":      ("ACCION", "mueve / traslada (verbo complemento de mover)","inf"),
 "ejecuta":    ("ACCION", "ejecuta (verbo — proceso / operación)","inf"),
 "ejecutar":   ("ACCION", "ejecutar (infinitivo)","inf"),
 "tc":         ("ENTIDAD","tc — Tarjeta de Crédito (abreviación en solicitudes y crédito)","conf"),
 "mc":         ("ENTIDAD","mc — Mesa de Control (abreviación — sp_cons_empleado_mc)","conf"),
 ...
 "maquila":    ("ENTIDAD","maquila — proceso de externalización de solicitudes TDC","inf"),
 ...
 "reevaluacion":("ACCION","reevaluación de crédito","inf"),
 "proyeccion": ("ENTIDAD","proyección de cartera / saldo","inf"),
 "parametrico":("ENTIDAD","paramétrico — parametrización de modelos (envío paramétrico)","inf"),
 "sd":         ("ENTIDAD","sd — saldo disponible (abreviación en código de crédito)","inf"),
 "quebr":      ("ACCION", "quebranto — write-off de cartera vencida (bdicred)","inf"),
 ...
 "enavipro":  ("ENTIDAD","ENAVIPRO — tipo de mensaje SPEI (Envío de Aviso en Proceso / Banxico)","inf"),
 "paq":       ("ENTIDAD","paquete — paquete de pago SPEI (bloque/lote de órdenes de transferencia)","inf"),
 "liq":       ("ENTIDAD","liquidación (abreviación — sp_marcaliqpago, spei_recliquidacion)","inf"),
 "habil":     ("ENTIDAD","día hábil — día bancario operativo (spei_validafecha, sp_cambio_fecha)","conf"),
 "realiza":   ("ACCION", "realiza / ejecuta una operación SPEI","inf"),
 "calcula":   ("ACCION", "calcula (verbo activo — spei_calculointeres)","conf"),
 "calcular":  ("ACCION", "calcula (infinitivo)","conf"),
 "speich":    ("ENTIDAD","SPEI-CH — tipo de movimiento SPEI de compensación/cheque (actualizamovspeich, pasemovspeich)","gap"),
 "oxo":       ("ENTIDAD","OXXO (abreviación — spei_entordenespago_oxo)","inf"),
 "pp":        ("ENTIDAD","PP — Pago Programado / domiciliación (apercred1_pp, generaedosctacrd_pp — D03; envia_monitorsol_pp — D06)","conf"),
 "tbl":       ("ENTIDAD","tbl — tabla (abreviación — sp_depura_tbl_registro_msj)","inf"),
 # términos descubiertos en grounding pass D09 (bdimnsj) 2026-07-11
 "ckpt":      ("MODIF",  "checkpoint — evento de checkpointing del motor Informix","inf"),
 "msj":       ("ENTIDAD","mensaje — abreviación corta de mnsj (sp_validacion_msj)","inf"),
 "6dig":      ("MODIF",  "OTP/token de 6 dígitos — autenticación fuerte SMS","inf"),
 "innovattia":("ENTIDAD","Innovattia — proveedor externo de notificaciones SMS/email para BanCoppel","inf"),
 "monitoreo": ("ENTIDAD","monitoreo — proceso de vigilancia/seguimiento operativo","inf"),
 "mover":     ("ACCION", "mueve / archiva (operación de paso a histórico)","inf"),
 "invalido":  ("MODIF",  "inválido — dato o estado no válido","inf"),
 # ── ACCIONES (verbos) ──
 "consulta":("ACCION","consulta / lee","conf"),"consuta":("ACCION","consulta [typo]","conf"),
 "cons":("ACCION","consulta","conf"),"con":("ACCION","consulta","inf"),"cns":("ACCION","consulta","inf"),
 "consreportes":("ACCION","consulta reportes","conf"),"consreporte":("ACCION","consulta reporte","conf"),
 "obtiene":("ACCION","obtiene / recupera","conf"),"obtener":("ACCION","obtiene / recupera","conf"),
 "obten":("ACCION","obtiene / recupera","conf"),"obt":("ACCION","obtiene","inf"),
 "recupera":("ACCION","recupera estado","conf"),"busca":("ACCION","busca / localiza","conf"),
 "aplica":("ACCION","aplica / ejecuta","conf"),"aplicar":("ACCION","aplica / ejecuta","conf"),
 "rec":("ACCION","recepción / recibe","conf"),"valida":("ACCION","valida","conf"),
 "validacion":("ACCION","validación","conf"),"valid":("ACCION","valida","inf"),
 "carga":("ACCION","carga / ingresa","conf"),"inserta":("ACCION","inserta / registra","conf"),
 "registra":("ACCION","registra","conf"),"genera":("ACCION","genera / produce","conf"),
 "gen":("ACCION","genera / general","inf"),"confirma":("ACCION","confirma","conf"),
 "elimina":("ACCION","elimina","conf"),"modifica":("ACCION","modifica","conf"),
 "modificacion":("ACCION","modificación","conf"),"actualiza":("ACCION","actualiza","conf"),
 "act":("ACCION","actualiza","conf"),"asigna":("ACCION","asigna","conf"),
 "bloqueo":("ACCION","bloquea cuenta","conf"),"bloquea":("ACCION","bloquea cuenta","conf"),
 "desbloqueo":("ACCION","desbloquea cuenta","conf"),"desb":("ACCION","desbloqueo","inf"),
 "desbloquea":("ACCION","desbloquea cuenta","conf"),"cancelacion":("ACCION","cancela","conf"),
 "cancela":("ACCION","cancela","conf"),"devolucion":("ACCION","devuelve","conf"),
 "dev":("ACCION","devolución","conf"),"reversion":("ACCION","reversa / rollback","conf"),
 "forma":("ACCION","construye / arma","inf"),"cierre":("ACCION","cierre","conf"),
 ...
 "fusionados":("ACCION","fusión de cuentas","conf"),"fus":("ACCION","fusión de cuentas","inf"),
 "traspaso":("ACCION","traspaso entre cuentas","conf"),"traspas":("ACCION","traspaso","inf"),
 "digitalizar":("ACCION","digitaliza documento","conf"),"digi":("ACCION","digitalización","inf"),
 # ── ENTIDADES (objetos de negocio) ──
 "ordenpago":("ENTIDAD","orden de pago","conf"),"orden":("ENTIDAD","orden","conf"),"pago":("ENTIDAD","pago","conf"),
 "saldo":("ENTIDAD","saldo","conf"),"saldos":("ENTIDAD","saldos","conf"),"sdo":("ENTIDAD","saldo","conf"),
 "sdodisp":("ENTIDAD","saldo disponible","conf"),"movimiento":("ENTIDAD","movimiento","conf"),
 "movto":("ENTIDAD","movimiento","conf"),"cuenta":("ENTIDAD","cuenta","conf"),"cta":("ENTIDAD","cuenta","conf"),
 "ctas":("ENTIDAD","cuentas","conf"),"ctaclabe":("ENTIDAD","cuenta CLABE","conf"),"clabe":("ENTIDAD","CLABE interbancaria","conf"),
 "cliente":("ENTIDAD","cliente","conf"),"cte":("ENTIDAD","cliente","conf"),"ctes":("ENTIDAD","clientes","conf"),
 "beneficiarios":("ENTIDAD","beneficiarios","conf"),"bts":("ENTIDAD","Bancomer Transfer Services — canal de transferencias BBVA; base de datos propia bdibts; confirmado por SME (2026-08-02)","conf"),
 "documentos":("ENTIDAD","documentos","conf"),"documento":("ENTIDAD","documento","conf"),
 "doctos":("ENTIDAD","documentos","conf"),"docto":("ENTIDAD","documento","conf"),
 "pagares":("ENTIDAD","pagarés","conf"),"pagare":("ENTIDAD","pagaré","conf"),
 "producto":("ENTIDAD","producto","conf"),"productos":("ENTIDAD","productos","conf"),
 "prod":("ENTIDAD","producto","inf"),"subproducto":("ENTIDAD","sub-producto","conf"),
 "catalogo":("ENTIDAD","catálogo","conf"),"cat":("ENTIDAD","catálogo","conf"),
 "divisas":("ENTIDAD","divisas","conf"),"firmas":("ENTIDAD","firmas mancomunadas","conf"),
 "cheques":("ENTIDAD","cheques","conf"),"cheq":("ENTIDAD","cheque","conf"),"folio":("ENTIDAD","folio","conf"),
 "nomina":("ENTIDAD","nómina","conf"),"nom":("ENTIDAD","nómina","inf"),"evento":("ENTIDAD","evento/notificación","conf"),
 "bitacora":("ENTIDAD","bitácora","conf"),"msjafore":("ENTIDAD","mensaje AFORE","inf"),"afore":("ENTIDAD","AFORE (Afore Coppel — 2ª mayor de México, ~14.5M cuentas)","conf"),
 "perfil":("ENTIDAD","perfil de usuario","conf"),"usuario":("ENTIDAD","usuario","conf"),"usuarios":("ENTIDAD","usuarios","conf"),
 "ejecutivo":("ENTIDAD","ejecutivo","conf"),"marcas":("ENTIDAD","marcas de cuenta","conf"),"marca":("ENTIDAD","marca","conf"),
 "alertas":("ENTIDAD","alertas","conf"),"alerta":("ENTIDAD","alerta","conf"),"situaciones":("ENTIDAD","situaciones de cuenta","conf"),
 "ciudades":("ENTIDAD","ciudades (catálogo)","conf"),"colonias":("ENTIDAD","colonias (catálogo domicilio)","conf"),
 "cp":("ENTIDAD","código postal","inf"),"dictamen":("ENTIDAD","dictamen","conf"),
 "piezas":("ENTIDAD","piezas de efectivo (billetes y monedas)","conf"),"pieza":("ENTIDAD","pieza de efectivo (billete/moneda)","conf"),
 "denominacion":("ENTIDAD","denominación (valor facial del billete/moneda)","conf"),"denominaciones":("ENTIDAD","denominaciones","conf"),
 "catdenominacion":("ENTIDAD","catálogo de denominaciones","conf"),"efectivo":("ENTIDAD","efectivo","conf"),"boveda":("ENTIDAD","bóveda","conf"),
 "estatussolic":("ENTIDAD","estatus de solicitud","conf"),
 "estatus":("ENTIDAD","estatus","conf"),"status":("ENTIDAD","estatus","conf"),"solicitud":("ENTIDAD","solicitud","conf"),
 "solic":("ENTIDAD","solicitud","conf"),"sol":("ENTIDAD","solicitud","inf"),"solin":("ENTIDAD","solicitud de crédito","inf"),
 "lincred":("ENTIDAD","línea de crédito","conf"),"lin":("ENTIDAD","línea (de crédito)","inf"),
 "credito":("ENTIDAD","crédito","conf"),"cred":("ENTIDAD","crédito","conf"),"cre":("ENTIDAD","crédito","inf"),
 "scoring":("ENTIDAD","scoring crediticio","conf"),"motor":("ENTIDAD","motor de decisión","conf"),
 "buro":("ENTIDAD","Buró de Crédito","conf"),"etiqueta":("ENTIDAD","etiqueta","conf"),"xml":("ENTIDAD","XML","conf"),
 "fecha":("ENTIDAD","fecha","conf"),"fechas":("ENTIDAD","fechas","conf"),"datos":("ENTIDAD","datos","conf"),
 ...
 "rpt":("ENTIDAD","reporte","conf"),"reporte":("ENTIDAD","reporte","conf"),"reportes":("ENTIDAD","reportes","conf"),
 ...
 "poliza":("ENTIDAD","póliza","inf"),"politica":("ENTIDAD","política de crédito","inf"),
 "huellas":("ENTIDAD","huellas biométricas","conf"),"huella":("ENTIDAD","huella biométrica","conf"),
 "medioacceso":("ENTIDAD","medio de acceso","conf"),"acceso":("ENTIDAD","acceso","inf"),
 "frecpago":("ENTIDAD","frecuencia de pago","conf"),"telefonos":("ENTIDAD","teléfonos","conf"),
 "telefono":("ENTIDAD","teléfono","conf"),"nombre":("ENTIDAD","nombre","conf"),
 # ── MODIFICADORES ──
 "diarios":("MODIF","diarios","conf"),"diario":("MODIF","diario","conf"),"masivo":("MODIF","masivo","conf"),
 "preventivo":("MODIF","preventivo","conf"),"inmediato":("MODIF","inmediato","conf"),"general":("MODIF","general","conf"),
 "manual":("MODIF","manual","conf"),"extemporanea":("MODIF","extemporánea","conf"),"faltantes":("MODIF","faltantes","conf"),
 "baja":("MODIF","de baja","conf"),"max":("MODIF","máximo","conf"),"visual":("MODIF","visual","conf"),
 "por":("MODIF","por (criterio)","conf"),"x":("MODIF","por (criterio)","conf"),"forzada":("MODIF","forzada","conf"),
 "esp":("MODIF","especial","conf"),"comp":("MODIF","complemento","conf"),
 "tp":("MODIF","tipo","conf"),"dia":("MODIF","del día","conf"),"deb":("MODIF","débito","conf"),
 "web":("MODIF","canal web","conf"),"mvl":("MODIF","canal móvil","conf"),"sub":("MODIF","sub-","inf"),
 "inactivas":("MODIF","inactivas (art.61)","conf"),"inactiv":("MODIF","inactiva","conf"),
 "activos":("MODIF","activos","conf"),"totales":("MODIF","totales","conf"),"ultimas":("MODIF","últimas","inf"),
 ...
 "b3":("MODIF","sufijo de versión de SP (Bloque/Build 3) — patrón Informix: no existe ALTER PROCEDURE, se crea nueva versión con sufijo _b3/_b4/_b5","inf"),
 "b4":("MODIF","sufijo de versión de SP (Bloque/Build 4)","inf"),"b5":("MODIF","sufijo de versión de SP (Bloque/Build 5)","inf"),
 "bym":("ENTIDAD","Billetes y Monedas (efectivo en sucursal — evidencia: 'piezas' + 'denominación')","inf"),
 "bym2":("ENTIDAD","Billetes y Monedas (v2)","inf"),"bym3":("ENTIDAD","Billetes y Monedas (v3)","inf"),
 "sac":("ENTIDAD","Servicios de Atención al Cliente — subsistema de atención en sucursal (ventanilla, domiciliación, abonos ATM, remesas WU); base de datos propia bdisac: con tabla sac_movimientoshistorial; confirmado por SME (2026-08-02)","conf"),"ref":("AMBIGUO","referencia","inf"),
 ...
 "ccl":("ENTIDAD","módulo de Cédulas de Captación e inversión — pagaré, ISR, saldos diarios, inversión auto-creciente (bdicnweb:sp_ccl_*)","inf"),"fus2":("AMBIGUO","fusión v2","inf"),
 ...
 "conscedulas":("ACCION","consulta cédulas","conf"),"cedulacontable":("ENTIDAD","cédula contable","inf"),
 # ── TÉRMINOS DE PARÁMETROS (minados del código fuente — mine-source.py) ──
 "empresa":("ENTIDAD","empresa (entidad bancaria)","conf"),"sucursal":("ENTIDAD","sucursal","conf"),
 "numcte":("ENTIDAD","número de cliente","conf"),"numerocliente":("ENTIDAD","número de cliente","conf"),
 "numsol":("ENTIDAD","número de solicitud","conf"),"idfuncion":("ENTIDAD","id de funcionalidad","conf"),
 "referencia":("ENTIDAD","referencia","conf"),"ingreso":("ENTIDAD","ingreso (del solicitante)","conf"),
 ...
 "importe":("ENTIDAD","importe","conf"),"claverastreo":("ENTIDAD","clave de rastreo SPEI (hasta 30 posiciones alfanuméricas, Banxico)","conf"),
 "rastreo":("ENTIDAD","rastreo (SPEI)","conf"),"transacc":("ENTIDAD","código de transacción","conf"),
 "divisa":("ENTIDAD","divisa","conf"),"monto":("ENTIDAD","monto","conf"),"cheque":("ENTIDAD","cheque","conf"),
 "tarjeta":("ENTIDAD","tarjeta","conf"),"docto":("ENTIDAD","documento","conf"),"concepto":("ENTIDAD","concepto de pago","conf"),
 "concentradora":("ENTIDAD","cuenta concentradora","conf"),"hipotecario":("ENTIDAD","crédito hipotecario","conf"),
 "sbc":("ENTIDAD","saldo básico de cuenta (SBC)","inf"),"folsuc":("ENTIDAD","folio de sucursal","conf"),
 "region":("ENTIDAD","región","conf"),"aval":("ENTIDAD","aval / garante","conf"),"garantia":("ENTIDAD","garantía","conf"),
 "periodicidad":("MODIF","periodicidad","conf"),"firme":("MODIF","monto firme","inf"),
 "remanente":("MODIF","remanente","inf"),"autoriza":("ACCION","autoriza","conf"),
 ...
 "numcliente":("ENTIDAD","número de cliente","conf"),"numcredito":("ENTIDAD","número de crédito","conf"),
 ...
 # acciones
 "operacion":("ACCION","operación","conf"),"ope":("ACCION","operación","inf"),
 "verifica":("ACCION","verifica","conf"),"guarda":("ACCION","guarda / almacena","conf"),
 "graba":("ACCION","graba / almacena","conf"),"alta":("ACCION","da de alta / registra","conf"),
 "notifica":("ACCION","notifica","conf"),"notifi":("ACCION","notifica","inf"),
 "envio":("ACCION","envía","conf"),"envia":("ACCION","envía","conf"),"upgrade":("ACCION","actualiza producto (upgrade)","inf"),
 "conciliacion":("ACCION","conciliación","conf"),"concentracion":("ACCION","concentración de fondos","conf"),
 # entidades / objetos de negocio
 "detalle":("ENTIDAD","detalle","conf"),
 "oficio":("ENTIDAD","oficio (requerimiento judicial/autoridad)","conf"),"ofi":("ENTIDAD","oficio","inf"),
 ...
 "archivo":("ENTIDAD","archivo","conf"),"arch":("ENTIDAD","archivo","inf"),
 ...
 "sms":("ENTIDAD","SMS","conf"),"msi":("ENTIDAD","meses sin intereses (MSI)","conf"),
 "cartera":("ENTIDAD","cartera de crédito","conf"),"biometrico":("ENTIDAD","biométrico","conf"),
 "domiciliacion":("ENTIDAD","domiciliación","conf"),"domi":("ENTIDAD","domiciliación","inf"),
 "pos":("ENTIDAD","punto de venta (POS)","conf"),"auditoria":("ENTIDAD","auditoría","conf"),"aud":("ENTIDAD","auditoría","inf"),
 "convenio":("ENTIDAD","convenio (nómina/empresarial)","conf"),"venio":("ENTIDAD","convenio","inf"),
 "parametros":("ENTIDAD","parámetros","conf"),"param":("ENTIDAD","parámetro","conf"),"parametro":("ENTIDAD","parámetro","conf"),
 "estado":("ENTIDAD","estado (entidad federativa / estatus)","inf"),"edo":("ENTIDAD","estado","inf"),
 "registros":("ENTIDAD","registros","conf"),"lote":("ENTIDAD","lote (proceso batch)","conf"),
 "secuencia":("ENTIDAD","secuencia","conf"),"origen":("ENTIDAD","origen","conf"),"codigo":("ENTIDAD","código","conf"),
 "codigos":("ENTIDAD","códigos","conf"),"codificacion":("ENTIDAD","codificación","conf"),
 "decodifica":("ACCION","decodifica","conf"),"decodificar":("ACCION","decodifica","conf"),
 "opcion":("ENTIDAD","opción","conf"),"canal":("ENTIDAD","canal","conf"),"descripcion":("ENTIDAD","descripción","conf"),
 "rfc":("ENTIDAD","RFC (registro fiscal)","conf"),"causa":("ENTIDAD","causa / motivo","conf"),
 "periodo":("ENTIDAD","periodo","conf"),"clave":("ENTIDAD","clave","conf"),"sistema":("ENTIDAD","sistema","conf"),
 "plantilla":("ENTIDAD","plantilla","conf"),"ruta":("ENTIDAD","ruta (de archivo)","conf"),"descarga":("ENTIDAD","descarga","conf"),
 "titulo":("ENTIDAD","título","conf"),"empleado":("ENTIDAD","empleado","conf"),"mac":("ENTIDAD","dirección MAC","conf"),
 "empresarial":("ENTIDAD","empresarial (nómina)","conf"),"respuesta":("ENTIDAD","respuesta","conf"),
 ...
 "fechaconsulta":("ENTIDAD","fecha de consulta","conf"),"inicio":("MODIF","inicio","conf"),"final":("MODIF","final","conf"),
 # modificadores
 "total":("MODIF","total","conf"),"totales":("MODIF","totales","conf"),"moral":("MODIF","persona moral","conf"),
 ...
 "movil":("MODIF","canal móvil","conf"),"suc":("MODIF","sucursal","inf"),"aumento":("MODIF","aumento","inf"),"aum":("MODIF","aumento","inf"),
 # ambiguos — requieren SME/DBA
 ...
 "cnt":("ENTIDAD","CNT — módulo de convenios y control de descuentos de nómina de empleados (sp_cnt_catconvenio, detallefaltdescemp, genreportesolcred — bdicnweb)","inf"),"adn":("ACCION","Adelanto de Nómina — producto de crédito al consumo liquidable vía descuento automático de nómina (cierre diario + cobro automático sobre bdicred)","conf"),
 "cjunk":("AMBIGUO","variable temporal (ruido de código, se ignora)","gap"),
 ...
 "cantidad":("ENTIDAD","cantidad","conf"),"cant":("ENTIDAD","cantidad","conf"),
 "busqueda":("ACCION","búsqueda","conf"),"ejecucion":("ENTIDAD","ejecución (de proceso)","conf"),
 "proceso":("ENTIDAD","proceso","conf"),"proc":("ENTIDAD","proceso","inf"),
 "registro":("ENTIDAD","registro","conf"),"monitor":("ENTIDAD","monitor","conf"),
 ...
 "reinicia":("ACCION","reinicia / resetea","conf"),"reinicio":("ACCION","reinicio","conf"),
 "inicia":("ACCION","inicia","conf"),"inicializa":("ACCION","inicializa","conf"),
 "inicializar":("ACCION","inicializa","conf"),"inicial":("MODIF","inicial","conf"),
 ...
 "poliza":("ENTIDAD","póliza contable","conf"),"mayor":("ENTIDAD","mayor contable","inf"),
 "asiento":("ENTIDAD","asiento contable","conf"),
 "propuesta":("ENTIDAD","propuesta","conf"),"trans":("ENTIDAD","[polisemia] Transferencia (bditransfer, bditrans: transferencias y remesas con campos pbco_dest/ppais_dest) | Transacción (sufijo genérico en SPs de reversión y procesamiento)","conf"),
 ...
 "banco":("ENTIDAD","banco","conf"),"coppel":("ENTIDAD","Coppel (grupo)","conf"),
 "hoy":("MODIF","de hoy / fecha actual","conf"),"anio":("ENTIDAD","año","conf"),"mes":("ENTIDAD","mes","conf"),
 "hora":("ENTIDAD","hora","conf"),"mensual":("MODIF","mensual","conf"),
 "ord":("ENTIDAD","ordenante / orden (SPEI)","conf"),"mov":("ENTIDAD","movimiento","conf"),
 "motivo":("ENTIDAD","motivo / causa","conf"),"apellido":("ENTIDAD","apellido","conf"),"apell":("ENTIDAD","apellido","inf"),
 "error":("ENTIDAD","error","conf"),"ciudad":("ENTIDAD","ciudad","conf"),"atm":("ENTIDAD","cajero automático (ATM)","conf"),
 "token":("ENTIDAD","token (autenticación)","conf"),"zona":("ENTIDAD","zona","conf"),"calle":("ENTIDAD","calle (domicilio)","conf"),
 "domicilio":("ENTIDAD","domicilio","conf"),"expediente":("ENTIDAD","expediente","conf"),
 "identificacion":("ENTIDAD","identificación","conf"),"categoria":("ENTIDAD","categoría","conf"),
 "vencimiento":("ENTIDAD","vencimiento","conf"),"venc":("ENTIDAD","vencimiento","inf"),
 "analista":("ENTIDAD","analista","conf"),"pais":("ENTIDAD","país","conf"),"tel":("ENTIDAD","teléfono","conf"),
 "cel":("ENTIDAD","celular","conf"),"emisor":("ENTIDAD","emisor","conf"),"grupo":("ENTIDAD","grupo","conf"),
 "plaza":("ENTIDAD","plaza (regional)","conf"),"puntos":("ENTIDAD","puntos (recompensas)","conf"),
 "valor":("ENTIDAD","valor","conf"),"destino":("ENTIDAD","destino","conf"),"servicio":("ENTIDAD","servicio","conf"),
 "titular":("ENTIDAD","titular de cuenta","conf"),"mensaje":("ENTIDAD","mensaje","conf"),"local":("MODIF","local","conf"),
 "bloq":("ACCION","bloqueo","inf"),"rol":("ENTIDAD","rol / perfil","conf"),"gral":("MODIF","general","conf"),
 ...
 "interes":("ENTIDAD","interés","conf"),"intereses":("ENTIDAD","intereses","conf"),
 "int":("ENTIDAD","interés","inf"),
 ...
 "presenta":("ACCION","presenta","conf"),"presentacion":("ENTIDAD","presentación","conf"),
 ...
 "conciliadora":("ENTIDAD","conciliadora","inf"),"receptor":("ENTIDAD","receptor","conf"),
 "tasa":("ENTIDAD","tasa (de interés)","conf"),"inf":("ENTIDAD","información","inf"),
 # ── palabras completas (auditoría exhaustiva 2026-07-06 — el longest-match las prefiere y elimina falsos de tokens cortos) ──
 "retiro":("ENTIDAD","retiro","conf"),"retiros":("ENTIDAD","retiros","conf"),"resultado":("ENTIDAD","resultado","conf"),
 "captura":("ACCION","captura","conf"),"consecutivo":("ENTIDAD","consecutivo","conf"),"liquidacion":("ENTIDAD","liquidación","conf"),
 "nacionalidad":("ENTIDAD","nacionalidad","conf"),"direccion":("ENTIDAD","dirección","conf"),"direcciones":("ENTIDAD","direcciones","conf"),
 ...
 "encabezado":("ENTIDAD","encabezado","conf"),"central":("MODIF","central","conf"),"depura":("ACCION","depura / limpia","conf"),
 "depuracion":("ACCION","depuración","conf"),"apertura":("ENTIDAD","apertura (de cuenta/crédito)","conf"),"sorteo":("ENTIDAD","sorteo","conf"),
 "primer":("MODIF","primer","conf"),"cita":("ENTIDAD","cita","conf"),"citas":("ENTIDAD","citas","conf"),
 "factura":("ENTIDAD","factura","conf"),"facturacion":("ENTIDAD","facturación","conf"),"autenticacion":("ENTIDAD","autenticación","conf"),
 "digito":("ENTIDAD","dígito verificador","conf"),"intercambio":("ENTIDAD","intercambio (interbancario)","conf"),
 "reverso":("ACCION","reverso","conf"),"apoderado":("ENTIDAD","apoderado","conf"),"dormidas":("MODIF","cuentas dormidas (inactivas)","conf"),
 "agendadas":("MODIF","agendadas","conf"),"determina":("ACCION","determina","conf"),"telefonico":("MODIF","telefónico","conf"),
 "fusionados":("MODIF","fusionados","conf"),"movimientos":("ENTIDAD","movimientos","conf"),"ordenes":("ENTIDAD","órdenes","conf"),
 "linea":("ENTIDAD","línea (de crédito)","conf"),"procede":("ACCION","procede","conf"),"procesa":("ACCION","procesa","conf"),
 "activar":("ACCION","activar","conf"),"activa":("ACCION","activa","conf"),"masiva":("MODIF","masiva","conf"),
 "salida":("ENTIDAD","salida","conf"),"declaracion":("ENTIDAD","declaración","conf"),"corresponsal":("ENTIDAD","corresponsal","conf"),
 "producto":("ENTIDAD","producto","conf"),"promocion":("ENTIDAD","promoción","conf"),"proceso":("ENTIDAD","proceso","conf"),
 ...
 "arr":("ENTIDAD","ARR — producto de ahorro/inversión recurrente (CLABE, interés acumulado, inversión creciente, pago de interés — bdicheq:arr_*)","inf"),
 "dinya":("ENTIDAD","DINYA — sistema/plataforma de remesas domésticas en sucursal; retorna nombre_remitente, sucursal_origen, importe_eviado (bdicnweb:sp_*dinya*)","inf"),
 "sps":("PREFIJO","sps — prefijo alternativo de SP en bdibei (posiblemente 'stored procedure set' o convención local del equipo; vs el 'sp' estándar)","inf"),
 "sif":("ENTIDAD","SIF — canal de estado de cuenta (aclaraciones_edocta_sif, detalle_edocta_sif); procesa aclaraciones de TDC por tarjeta+fecha de emisión","inf"),
 "cnc":("ENTIDAD","CNC — sistema de configuración de planes fijos de Tarjetas Coppel (plazos_fijos, Buen Fin, carga de archivos, stat06 — bditarjeta:sp_cnc_*)","inf"),
 "cpl":("ENTIDAD","CPL — segmento o producto de cliente (sp_dictamina_ctes_cpl, sp_afore_ctes_cpl, sp_situacionespecialcte_cpl — bdinteg)","inf"),
 "mib":("ENTIDAD","MIB — módulo/canal de integración para cheques y tarjeta (cargo_ref_mib, cancelar_activar_cheque_mib — bdicheq + bdibpi)","inf"),
 "cnr":("ENTIDAD","CNR — tipo o formato de consulta al Buró de Crédito para personas físicas (bdiburo:burofisicas_cnr; vcredito_maximo)","inf"),
 "ftc":("ENTIDAD","FTC — módulo de configuración de transferencia de archivos (SFTP/FTP IPs, passwords de proxy, SFTP depósito — bdilide:sp_ftc_*)","inf"),
 ...
 "rem":("ENTIDAD","remesa (forma corta)","inf"),"tarjetas":("ENTIDAD","tarjetas (plural)","conf"),
 "indicadores":("ENTIDAD","indicadores","conf"),"aut":("ACCION","autorización","inf"),
 "buscar":("ACCION","búsqueda/buscar","conf"),"ins":("ACCION","insertar","inf"),
 "consultar":("ACCION","consultar","conf"),"ant":("MODIF","anterior","conf"),
 "cuentas":("ENTIDAD","cuentas (plural)","conf"),"hist":("MODIF","histórico/historial","conf"),
 "his":("MODIF","histórico","inf"),"clientes":("ENTIDAD","clientes (plural)","conf"),
 "crd":("ENTIDAD","crédito (abreviación)","inf"),"pagos":("ENTIDAD","pagos (plural)","conf"),
 ...
 "mensajes":("ENTIDAD","mensajes","conf"),"envios":("ENTIDAD","envíos","conf"),
 "cobranza":("ENTIDAD","cobranza","conf"),"operaciones":("ENTIDAD","operaciones (plural)","conf"),
 "batch":("MODIF","proceso batch (por lotes)","conf"),"debito":("ENTIDAD","débito","conf"),
 "canales":("ENTIDAD","canales (de distribución)","conf"),"cobro":("ACCION","cobro","conf"),
 "correos":("ENTIDAD","correos electrónicos (email)","conf"),"archivos":("ENTIDAD","archivos","conf"),
 "cambio":("ENTIDAD","cambio (de estatus, domicilio, etc.)","conf"),"reproceso":("ACCION","reproceso","conf"),
 "portabilidad":("ENTIDAD","portabilidad (de nómina o número)","conf"),"reserva":("ENTIDAD","reserva","conf"),
 "corte":("ENTIDAD","corte (fecha de corte / período)","conf"),"det":("ENTIDAD","detalle","inf"),
 "dep":("ENTIDAD","depósito","inf"),"movs":("ENTIDAD","movimientos (abreviación)","inf"),
 "sdos":("ENTIDAD","saldos (abreviación)","inf"),"upd":("ACCION","actualiza (update)","inf"),
 "calif":("ENTIDAD","calificación","inf"),"situacion":("ENTIDAD","situación","conf"),
 "retenido":("MODIF","retenido (fondos en retención)","conf"),"tels":("ENTIDAD","teléfonos (plural)","inf"),
 "debcred":("ENTIDAD","débito/crédito (movimiento)","inf"),"prospectos":("ENTIDAD","prospectos (nuevos clientes potenciales)","conf"),
 "avatar":("ENTIDAD","avatar (foto de perfil del usuario en app)","conf"),"reg":("ACCION","registro","inf"),
 ...
 "evc":("ENTIDAD","EVC — Evaluación/Cartera a Quebrantar (write-off de cartera vencida; sp_evc_cartera_quebrantar, sp_evc_consexclusionlote — bdicnweb)","inf"),
 "camp":("ENTIDAD","Campaña — campaña de cobranza o crédito (sp_envio_camp_ctes, sp_actvig_camp — bdicobranza + bdicred)","conf"),
 "synmotor":("ENTIDAD","SynMotor — motor de procesamiento de Syndein (empresa externa fintech); gestiona campos, parámetros y WSDL (intercard:sp_synmotor_*)","inf"),
 "credisoluciones":("ENTIDAD","CrediSoluciones — producto/segmento de crédito BanCoppel (sp_carga_ctes_credisoluciones, sp_credisoluciones_crd — bdicred)","inf"),
 "proac":("ENTIDAD","PROAC — producto de cuenta de ahorro con inscripción y ciclo anual (sp_proac_consultarincripcioncuentaproac, sp_proac_calc_proximoanio — bdicheq)","inf"),
 ...
 "ics":("ENTIDAD","ICS — sistema de cuotas/mensualidades de crédito (sp_ics_cuotas, sp_ics_compara_secuencias, sp_ics_genera_control — bdicred)","inf"),
 "bccc":("ENTIDAD","BCCC — formato o protocolo de consulta al Buró de Crédito (bdiburo:sp_reenvio_sols_bccc9; catproducto, catcomentario)","inf"),
 "chq":("ENTIDAD","cheque (abreviación — bdicheq)","inf"),
 "adm":("ACCION","administración/administrar (abreviación de admin)","inf"),
 ...
 "concreing":("ENTIDAD","Conciliación de Reingresos — proceso de conciliación de tarjetas reingresadas (bditarjeta:sp_concreing_*; gestiona archivos ATM, usuarios, horarios, parámetros)","inf"),
 "bex":("ENTIDAD","BEX — canal o plataforma de Banca Por Internet (bdibpi); gestiona sesiones, preguntas de seguridad, cuentas cap/cred (sp_*_bex, sp_ini_session_bex)","inf"),
 "rcda":("ENTIDAD","RCDA — producto de captación/ahorro (apertura, incremento de saldo, acumulación mensual); gestionado en bdmis (sp_rcda_apert, sp_rcda_acumsdo_mes)","inf"),
 "iccat":("ENTIDAD","ICCAT — canal de atención al cliente en BPI; gestiona solicitudes de entrega y reposición de token, desbloqueo de acceso (bdibpi:sp_iccat_*, sp_*_iccat)","inf"),
 ...
 "cal":("ENTIDAD","[polisemia] Cálculo (cal_fecha, cal_riesgo_cliente, cal_tradicion — operaciones matemáticas financieras) | Calendario (cal_habil_ant — días hábiles bancarios; bdicheq)","inf"),
 "exp":("MODIF","sufijo Exportar — SP genera/exporta archivo de salida (sp_*_exp: generaarchivocuentasnomina_exp, perfisica_listanegra_exp, reversion_exp)","inf"),
 ...
 "chi":("ENTIDAD","CHI — formato/protocolo de consulta al Buró de Crédito (bdiburo/bdicred:sp_chi_cre_consulta_sic, sp_chi_cre_layout_sics, sp_chi_cre_result_consulta_sic; SICS = Sociedad de Información Crediticia)","inf"),
 "tar":("ENTIDAD","Tarjeta (abreviación — bdicheq/bdicred: cons_cta_o_tar, mover_his_tar, obtener_cta_con_num_tar)","inf"),
 ...
 "stat06":("ENTIDAD","Stat06 — tipo/código de archivo de carga en procesamiento de tarjetas Coppel (bditarjeta:sp_cnc_cga_stat06; parámetros: ruta, nombre archivo, sistema, layout)","inf"),
 ...
 "rev":("ACCION","reversión (abreviación de reversa/reverso)","inf"),
 "clon":("ENTIDAD","[polisemia] Clon de SP (réplica funcional para variante de entorno o canal — similar a _pba; bdiburo:burofisicas_clon, bdibpi:sp_consultarctepmempresanet_clon) | Clonación fraudulenta (bdiauditor:sp_pld_chq_addfolio_clon — fraude de clonación de cheques/documentos en PLD)","inf"),
 ...
 "corrige":("ACCION","corrige — acción de corrección de datos (bdicred:sp_corrige_*)","inf"),
 "auto":("MODIF","automático (proceso automático / batch — sp_*_auto)","inf"),
 "principal":("ENTIDAD","principal — capital principal de deuda / titular principal de cuenta","conf"),
 "edocuenta":("ENTIDAD","Estado de Cuenta (variante ortográfica de edocta — bdicheq/bdisolic:sp_*edocuenta*)","inf"),
 "obtenerctas":("ACCION","obtener cuentas (bdicheq:sp_obtenerctas_*)","inf"),
}
