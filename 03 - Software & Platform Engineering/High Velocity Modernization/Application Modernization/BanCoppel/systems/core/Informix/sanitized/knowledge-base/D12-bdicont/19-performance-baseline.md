...
-- Instrumentar el SP que llama a bdicont:sp_nombre() para registrar:
...
|----|-----------------|---------|---------|---------|---------|
| `sp_consultaparametrosgenerales2` | 16 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_datosdiahoy_cod47_2` | 16 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_ope_catalogomotivos2` | 16 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_si_empresasb4` | 1 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_cam_asigna_rev_firmasb3` | 0 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
...
| Patrón | Impacto en `bdicont` | Preparación |
|--------|-------------------|------------|
...
export default function() {
  ...
  let res = http.post('https://api.target/bdicont/v1/endpoint', payload);
