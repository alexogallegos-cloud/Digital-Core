# D09 · Mensajería — Diccionario de Datos
...
Diccionario de datos del dominio `bdimnsj` construido a partir del análisis estático de los headers `CREATE PROCEDURE / FUNCTION` en 47 archivos SQL. Incluye la firma de los SPs más significativos y el inventario de tipos de datos Informix utilizados.
...
|--------------|----------------------|----------------------|---------------------|
| `CHAR` | 772 ocurrencias | CHAR(n) | 🟢 BAJO |
| `INTEGER` | 196 ocurrencias | INTEGER | 🟢 BAJO |
| `VARCHAR` | 176 ocurrencias | VARCHAR(n) | 🟢 BAJO |
| `DATE` | 97 ocurrencias | DATE | 🟢 BAJO |
| `DATETIME` | 83 ocurrencias | TIMESTAMP(n) WITHOUT TIME ZONE | 🟠 ALTO |
| `MONEY` | 73 ocurrencias | NUMERIC(p,s) | 🔴 CRÍTICO |
| `SMALLINT` | 27 ocurrencias | SMALLINT | 🟢 BAJO |
| `DECIMAL` | 10 ocurrencias | NUMERIC(p,s) | 🟡 MEDIO |
| `INTERVAL` | 1 ocurrencias | INTERVAL | 🟡 MEDIO |
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdimnsj_*.sql*
