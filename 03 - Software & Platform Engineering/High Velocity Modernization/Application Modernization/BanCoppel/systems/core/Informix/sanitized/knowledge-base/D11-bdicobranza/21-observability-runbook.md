# D11 · Cobranza — Observabilidad y Runbook

> **Componente:** LegacyCore · SPE-AM-001 · OPERATE Phase
> **Microservicio target:** CobranzaService
...
|---------------------|--------------------|--------------------|-----|
| `sp_inserta_bitacora_cob` | `legacycore.bdicobranza.inserta_bitacora_cob.latency` | `legacycore.bdicobranza.inserta_bitacora_cob.errors` | [SME-PENDING] ms |
| `sp_cat_graba_telefono_adicional` | `legacycore.bdicobranza.cat_graba_telefono_adicional.latency` | `legacycore.bdicobranza.cat_graba_telefono_adicional.errors` | [SME-PENDING] ms |
| `sp_cat_gen_info_admin` | `legacycore.bdicobranza.cat_gen_info_admin.latency` | `legacycore.bdicobranza.cat_gen_info_admin.errors` | [SME-PENDING] ms |
...
| `legacycore.bdicobranza.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdicobranza.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdicobranza", "latency.p50"], ["legacycore/bdicobranza", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdicobranza", "errors.total"], ["legacycore/bdicobranza", "errors.l4"]]},
  {"title": "Throughput", "type": "metric",
    "metrics": [["AWS/Lambda", "Invocations", "FunctionName", "bdicobranza-service"]]},
  {"title": "Aurora connections", "type": "metric",
    "metrics": [["AWS/RDS", "DatabaseConnections", "DBInstanceIdentifier", "bdicobranza-aurora"]]},
...
### INC-D11-01: Alta latencia en endpoints
...
### INC-D11-02: Divergencias financieras (L4)

```
DETECTAR: Alarma legacycore.bdicobranza.errors.l4 > 0
ACCIÓN INMEDIATA:
  1. ROLLBACK automático: AppConfig feature flag al 0%
  2. Tráfico vuelve a Informix
  3. Notificación a: QA Lead + Domain Expert LegacyCore + Program Manager
...
### INC-D11-03: Falla total del microservicio
