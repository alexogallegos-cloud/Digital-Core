...
|---------------------|--------------------|--------------------|-----|
| `sp_cnsif_confirmaejecutivo` | `legacycore.bdinteg.cnsif_confirmaejecutivo.latency` | `legacycore.bdinteg.cnsif_confirmaejecutivo.errors` | [SME-PENDING] ms |
| `sp_cnsif_permisosejecutivo` | `legacycore.bdinteg.cnsif_permisosejecutivo.latency` | `legacycore.bdinteg.cnsif_permisosejecutivo.errors` | [SME-PENDING] ms |
| `sp_valida_perfil_usuario` | `legacycore.bdinteg.valida_perfil_usuario.latency` | `legacycore.bdinteg.valida_perfil_usuario.errors` | [SME-PENDING] ms |
...
| `legacycore.bdinteg.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdinteg.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdinteg", "latency.p50"], ["legacycore/bdinteg", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdinteg", "errors.total"], ["legacycore/bdinteg", "errors.l4"]]},
...
```
DETECTAR: Alarma legacycore.bdinteg.errors.l4 > 0
ACCIÓN INMEDIATA:
