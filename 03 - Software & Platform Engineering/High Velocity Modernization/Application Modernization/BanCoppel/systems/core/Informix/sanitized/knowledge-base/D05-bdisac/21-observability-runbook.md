# D05 · Saldos y Cuentas — Observabilidad y Runbook

> **Componente:** LegacyCore · SPE-AM-001 · OPERATE Phase
> **Microservicio target:** Saldos y CuentasService
...
```
[Saldos y CuentasService (Lambda/ECS)]
...
|---------------------|--------------------|--------------------|-----|
| `sp_sac_guardamensajeerror` | `legacycore.bdisac.sac_guardamensajeerror.latency` | `legacycore.bdisac.sac_guardamensajeerror.errors` | [SME-PENDING] ms |
| `sp_validanombenefbts` | `legacycore.bdisac.validanombenefbts.latency` | `legacycore.bdisac.validanombenefbts.errors` | [SME-PENDING] ms |
| `sp_sac_consucursales` | `legacycore.bdisac.sac_consucursales.latency` | `legacycore.bdisac.sac_consucursales.errors` | [SME-PENDING] ms |
...
| `legacycore.bdisac.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdisac.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdisac", "latency.p50"], ["legacycore/bdisac", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdisac", "errors.total"], ["legacycore/bdisac", "errors.l4"]]},
...
### INC-D05-01: Alta latencia en endpoints
...
### INC-D05-02: Divergencias financieras (L4)

```
DETECTAR: Alarma legacycore.bdisac.errors.l4 > 0
ACCIÓN INMEDIATA:
...
### INC-D05-03: Falla total del microservicio
