...
Diccionario de datos del dominio `bdispei` construido a partir del análisis estático de los headers `CREATE PROCEDURE / FUNCTION` en 197 archivos SQL. Incluye la firma de los SPs más significativos y el inventario de tipos de datos Informix utilizados.
...
|--------------|----------------------|----------------------|---------------------|
| `CHAR` | 6,644 ocurrencias | CHAR(n) | 🟢 BAJO |
| `INTEGER` | 1,996 ocurrencias | INTEGER | 🟢 BAJO |
| `VARCHAR` | 830 ocurrencias | VARCHAR(n) | 🟢 BAJO |
| `DECIMAL` | 574 ocurrencias | NUMERIC(p,s) | 🟡 MEDIO |
| `SMALLINT` | 439 ocurrencias | SMALLINT | 🟢 BAJO |
| `DATE` | 413 ocurrencias | DATE | 🟢 BAJO |
| `MONEY` | 343 ocurrencias | NUMERIC(p,s) | 🔴 CRÍTICO |
| `DATETIME` | 122 ocurrencias | TIMESTAMP(n) WITHOUT TIME ZONE | 🟠 ALTO |
| `BYTE` | 10 ocurrencias | BYTEA | 🟢 BAJO |
| `TEXT` | 3 ocurrencias | TEXT | 🟢 BAJO |
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdispei_*.sql*
