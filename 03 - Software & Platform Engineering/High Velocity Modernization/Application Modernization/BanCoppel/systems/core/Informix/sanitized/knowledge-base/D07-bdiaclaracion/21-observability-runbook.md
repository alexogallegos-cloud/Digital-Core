# D07 · Aclaraciones — Observabilidad y Runbook
...
|---------------------|--------------------|--------------------|-----|
| `sp_fal_cancelacion_cuenta_credito` | `legacycore.bdiaclaracion.fal_cancelacion_cuenta_credito.latency` | `legacycore.bdiaclaracion.fal_cancelacion_cuenta_credito.errors` | [SME-PENDING] ms |
| `sp_fal_cancelacion_cuenta_debito` | `legacycore.bdiaclaracion.fal_cancelacion_cuenta_debito.latency` | `legacycore.bdiaclaracion.fal_cancelacion_cuenta_debito.errors` | [SME-PENDING] ms |
| `sp_fal_liquidacion_asignar_analista` | `legacycore.bdiaclaracion.fal_liquidacion_asignar_analista.latency` | `legacycore.bdiaclaracion.fal_liquidacion_asignar_analista.errors` | [SME-PENDING] ms |
...
| `legacycore.bdiaclaracion.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdiaclaracion.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdiaclaracion", "latency.p50"], ["legacycore/bdiaclaracion", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdiaclaracion", "errors.total"], ["legacycore/bdiaclaracion", "errors.l4"]]},
...
### INC-D07-01: Alta latencia en endpoints
...
### INC-D07-02: Divergencias financieras (L4)

```
DETECTAR: Alarma legacycore.bdiaclaracion.errors.l4 > 0
ACCIÓN INMEDIATA:
...
### INC-D07-03: Falla total del microservicio
