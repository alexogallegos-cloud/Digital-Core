# D05 · Saldos y Cuentas — Mapeo de Tipos Informix → PostgreSQL
...
Este documento es la **referencia canónica de conversión de tipos** para el dominio `bdisac`. Cada desarrollador que migre un SP de este dominio debe seguir esta tabla sin excepción. Las decisiones inconsistentes en tipos de datos son la causa #1 de divergencias financieras en producción.
...
## Riesgo principal para `bdisac`: MONEY rounding
