...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdisac_*.sql (análisis estático de 58 archivos SQL) · callgraph-data.json (fan_in) + análisis de nombres*
