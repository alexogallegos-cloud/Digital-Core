# D05 · Saldos y Cuentas — Diccionario de Datos
...
Diccionario de datos del dominio `bdisac` construido a partir del análisis estático de los headers `CREATE PROCEDURE / FUNCTION` en 563 archivos SQL. Incluye la firma de los SPs más significativos y el inventario de tipos de datos Informix utilizados.
...
|--------------|----------------------|----------------------|---------------------|
| `CHAR` | 93,696 ocurrencias | CHAR(n) | 🟢 BAJO |
| `INTEGER` | 29,427 ocurrencias | INTEGER | 🟢 BAJO |
| `MONEY` | 22,232 ocurrencias | NUMERIC(p,s) | 🔴 CRÍTICO |
| `DATE` | 15,043 ocurrencias | DATE | 🟢 BAJO |
| `VARCHAR` | 2,835 ocurrencias | VARCHAR(n) | 🟢 BAJO |
| `DATETIME` | 2,607 ocurrencias | TIMESTAMP(n) WITHOUT TIME ZONE | 🟠 ALTO |
| `DECIMAL` | 1,894 ocurrencias | NUMERIC(p,s) | 🟡 MEDIO |
| `SMALLINT` | 1,462 ocurrencias | SMALLINT | 🟢 BAJO |
| `INTERVAL` | 171 ocurrencias | INTERVAL | 🟡 MEDIO |
| `SERIAL` | 6 ocurrencias | IDENTITY / SEQUENCE | 🟠 ALTO |
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdisac_*.sql*
