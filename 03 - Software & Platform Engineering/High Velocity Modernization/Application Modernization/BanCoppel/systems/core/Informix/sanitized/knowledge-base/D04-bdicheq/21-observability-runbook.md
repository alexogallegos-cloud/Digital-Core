# D04 · Cheques / Cuentas — Observabilidad y Runbook

> **Componente:** LegacyCore · SPE-AM-001 · OPERATE Phase
> **Microservicio target:** Cheques / CuentasService
...
```
[Cheques / CuentasService (Lambda/ECS)]
...
|---------------------|--------------------|--------------------|-----|
| `cargo_ref` | `legacycore.bdicheq.cargo_ref.latency` | `legacycore.bdicheq.cargo_ref.errors` | [SME-PENDING] ms |
| `abono_ref` | `legacycore.bdicheq.abono_ref.latency` | `legacycore.bdicheq.abono_ref.errors` | [SME-PENDING] ms |
| `reversion` | `legacycore.bdicheq.reversion.latency` | `legacycore.bdicheq.reversion.errors` | [SME-PENDING] ms |
...
| `legacycore.bdicheq.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdicheq.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdicheq", "latency.p50"], ["legacycore/bdicheq", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdicheq", "errors.total"], ["legacycore/bdicheq", "errors.l4"]]},
  {"title": "Throughput", "type": "metric",
    "metrics": [["AWS/Lambda", "Invocations", "FunctionName", "bdicheq-service"]]},
...
### INC-D04-01: Alta latencia en endpoints
...
### INC-D04-02: Divergencias financieras (L4)

```
DETECTAR: Alarma legacycore.bdicheq.errors.l4 > 0
ACCIÓN INMEDIATA:
...
### INC-D04-03: Falla total del microservicio
