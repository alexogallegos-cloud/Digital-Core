# D12 · Contabilidad — Observabilidad y Runbook

> **Componente:** LegacyCore · SPE-AM-001 · OPERATE Phase
> **Microservicio target:** ContabilidadService
...
```
[ContabilidadService (Lambda/ECS)]
...
|---------------------|--------------------|--------------------|-----|
| `sp_consultaparametrosgenerales2` | `legacycore.bdicont.consultaparametrosgenerales2.latency` | `legacycore.bdicont.consultaparametrosgenerales2.errors` | [SME-PENDING] ms |
| `sp_datosdiahoy_cod47_2` | `legacycore.bdicont.datosdiahoy_cod47_2.latency` | `legacycore.bdicont.datosdiahoy_cod47_2.errors` | [SME-PENDING] ms |
| `sp_ope_catalogomotivos2` | `legacycore.bdicont.ope_catalogomotivos2.latency` | `legacycore.bdicont.ope_catalogomotivos2.errors` | [SME-PENDING] ms |
...
| `legacycore.bdicont.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdicont.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdicont", "latency.p50"], ["legacycore/bdicont", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdicont", "errors.total"], ["legacycore/bdicont", "errors.l4"]]},
  {"title": "Throughput", "type": "metric",
    "metrics": [["AWS/Lambda", "Invocations", "FunctionName", "bdicont-service"]]},
  {"title": "Aurora connections", "type": "metric",
    "metrics": [["AWS/RDS", "DatabaseConnections", "DBInstanceIdentifier", "bdicont-aurora"]]},
...
### INC-D12-01: Alta latencia en endpoints
...
### INC-D12-02: Divergencias financieras (L4)

```
DETECTAR: Alarma legacycore.bdicont.errors.l4 > 0
ACCIÓN INMEDIATA:
...
### INC-D12-03: Falla total del microservicio
