# D12 · Contabilidad — Diccionario de Datos
...
Diccionario de datos del dominio `bdicont` construido a partir del análisis estático de los headers `CREATE PROCEDURE / FUNCTION` en 168 archivos SQL. Incluye la firma de los SPs más significativos y el inventario de tipos de datos Informix utilizados.
...
|--------------|----------------------|----------------------|---------------------|
| `CHAR` | 9,637 ocurrencias | CHAR(n) | 🟢 BAJO |
| `INTEGER` | 2,164 ocurrencias | INTEGER | 🟢 BAJO |
| `DATE` | 1,578 ocurrencias | DATE | 🟢 BAJO |
| `MONEY` | 924 ocurrencias | NUMERIC(p,s) | 🔴 CRÍTICO |
| `SMALLINT` | 454 ocurrencias | SMALLINT | 🟢 BAJO |
| `DECIMAL` | 137 ocurrencias | NUMERIC(p,s) | 🟡 MEDIO |
| `VARCHAR` | 119 ocurrencias | VARCHAR(n) | 🟢 BAJO |
| `DATETIME` | 101 ocurrencias | TIMESTAMP(n) WITHOUT TIME ZONE | 🟠 ALTO |
