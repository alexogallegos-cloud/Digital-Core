...
|---------------------|--------------------|--------------------|-----|
| `sp_consulta_saldos_general` | `legacycore.bdicred.consulta_saldos_general.latency` | `legacycore.bdicred.consulta_saldos_general.errors` | [SME-PENDING] ms |
| `sp_mon_buro_conssolcredlincred2` | `legacycore.bdicred.mon_buro_conssolcredlincred2.latency` | `legacycore.bdicred.mon_buro_conssolcredlincred2.errors` | [SME-PENDING] ms |
| `sp_inserta_productos` | `legacycore.bdicred.inserta_productos.latency` | `legacycore.bdicred.inserta_productos.errors` | [SME-PENDING] ms |
...
| `legacycore.bdicred.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdicred.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdicred", "latency.p50"], ["legacycore/bdicred", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdicred", "errors.total"], ["legacycore/bdicred", "errors.l4"]]},
...
```
DETECTAR: Alarma legacycore.bdicred.errors.l4 > 0
ACCIÓN INMEDIATA:
