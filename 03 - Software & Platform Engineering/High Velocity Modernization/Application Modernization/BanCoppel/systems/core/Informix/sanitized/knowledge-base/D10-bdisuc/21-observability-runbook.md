# D10 · Sucursales — Observabilidad y Runbook

> **Componente:** LegacyCore · SPE-AM-001 · OPERATE Phase
> **Microservicio target:** SucursalesService
...
|---------------------|--------------------|--------------------|-----|
| `sp_consultadatospiezas_bym3` | `legacycore.bdisuc.consultadatospiezas_bym3.latency` | `legacycore.bdisuc.consultadatospiezas_bym3.errors` | [SME-PENDING] ms |
| `sp_consutacat_dictamen_bym` | `legacycore.bdisuc.consutacat_dictamen_bym.latency` | `legacycore.bdisuc.consutacat_dictamen_bym.errors` | [SME-PENDING] ms |
| `sp_consultadatospiezas_bym3_totales` | `legacycore.bdisuc.consultadatospiezas_bym3_totales.latency` | `legacycore.bdisuc.consultadatospiezas_bym3_totales.errors` | [SME-PENDING] ms |
...
| `legacycore.bdisuc.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdisuc.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdisuc", "latency.p50"], ["legacycore/bdisuc", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdisuc", "errors.total"], ["legacycore/bdisuc", "errors.l4"]]},
  {"title": "Throughput", "type": "metric",
    "metrics": [["AWS/Lambda", "Invocations", "FunctionName", "bdisuc-service"]]},
  {"title": "Aurora connections", "type": "metric",
    "metrics": [["AWS/RDS", "DatabaseConnections", "DBInstanceIdentifier", "bdisuc-aurora"]]},
...
### INC-D10-01: Alta latencia en endpoints
...
### INC-D10-02: Divergencias financieras (L4)

```
DETECTAR: Alarma legacycore.bdisuc.errors.l4 > 0
ACCIÓN INMEDIATA:
...
### INC-D10-03: Falla total del microservicio
