# D06 · Solicitudes — Observabilidad y Runbook

> **Componente:** LegacyCore · SPE-AM-001 · OPERATE Phase
> **Microservicio target:** SolicitudesService
...
|---------------------|--------------------|--------------------|-----|
| `sp_asigna_solicitud_soc` | `legacycore.bdisolic.asigna_solicitud_soc.latency` | `legacycore.bdisolic.asigna_solicitud_soc.errors` | [SME-PENDING] ms |
| `determina_lincred_tc_cjunk` | `legacycore.bdisolic.determina_lincred_tc_cjunk.latency` | `legacycore.bdisolic.determina_lincred_tc_cjunk.errors` | [SME-PENDING] ms |
| `sp_obtienegrupo` | `legacycore.bdisolic.obtienegrupo.latency` | `legacycore.bdisolic.obtienegrupo.errors` | [SME-PENDING] ms |
...
| `legacycore.bdisolic.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdisolic.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdisolic", "latency.p50"], ["legacycore/bdisolic", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdisolic", "errors.total"], ["legacycore/bdisolic", "errors.l4"]]},
...
### INC-D06-01: Alta latencia en endpoints
...
### INC-D06-02: Divergencias financieras (L4)

```
DETECTAR: Alarma legacycore.bdisolic.errors.l4 > 0
ACCIÓN INMEDIATA:
...
### INC-D06-03: Falla total del microservicio
