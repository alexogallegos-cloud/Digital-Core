...
CAT = {
 ...
 "fusionados":("ACCION","fusión de cuentas","conf"),"fus":("ACCION","fusión de cuentas","conf"),
 ...
 "medioacceso":("ENTIDAD","medio de acceso","conf"),"acceso":("ENTIDAD","acceso","conf"),
 ...
 "periodicidad":("MODIF","periodicidad","conf"),"remanente":("MODIF","remanente","conf"),"autoriza":("ACCION","autoriza","conf"),
 ...
 "notifica":("ACCION","notifica","conf"),"notifi":("ACCION","notifica","conf"),
 ...
 "movil":("MODIF","canal móvil","conf"),"suc":("MODIF","sucursal","conf"),"aumento":("MODIF","aumento","conf"),# ambiguos — requieren SME/DBA
 ...
 "proceso":("ENTIDAD","proceso","conf"),"proc":("ENTIDAD","proceso","conf"),
 ...
 "vencimiento":("ENTIDAD","vencimiento","conf"),"venc":("ENTIDAD","vencimiento","conf"),
