...
DOMS = {
 ...
 "d13": dict(db="bditef",       name="TEF",                color="#7A5B18", wave=3, reg=["Banxico","CNBV"]),
 "d14": dict(db="bdibei",       name="BEI",                color="#2A6B7A", wave=4, reg=["CNBV","CONDUSEF"]),
 "d15": dict(db="bdilide",      name="LIDE / PLD",         color="#6B1A1A", wave=2, reg=["UIF","CNBV"]),
 "d16": dict(db="intercard",    name="Tarjetas",           color="#1A5A3A", wave=4, reg=["CNBV","Banxico"]),
}
