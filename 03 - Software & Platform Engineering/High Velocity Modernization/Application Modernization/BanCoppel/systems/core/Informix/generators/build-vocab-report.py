...
<title>Informix · Reporte de Vocabulario SPL</title>
<style>
...
<header>
  ...
  <div class="meta">
    <div class="breadcrumb">Informix · <span>SPE-AM-001</span> · Gemelo Cognitivo del Sistema</div>
...
open(BASE + "old/vocabulary-report-bcop.html", "w", encoding="utf-8").write(HTML)
