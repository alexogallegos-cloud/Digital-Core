...
<title>BCOPCore · Arquetipos SPL</title>
...
(function buildSPLDiagram() {
  ...
  svg.append('text').attr('x',16).attr('y',32).attr('fill','#e6edf3').attr('font-size',18).attr('font-weight',700).text('BCOPCore — Arquetipos Batch: Mapa de Interacciones');
