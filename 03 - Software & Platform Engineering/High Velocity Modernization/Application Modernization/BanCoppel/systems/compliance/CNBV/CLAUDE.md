# CNBV — Sistema Descubierto (Application Modernization)
# togaf_type: compliance
# togaf_state: external
# togaf_system_of: record
# togaf_abb: banking-regulator

> **Descubierto por:** BCOPCore Informix seed — [cnbv-seed.json](../../core/Informix/digital-brain/seeds/cnbv-seed.json)
...
| Volumen conocido | 179 endpoints |
| Criticidad | `high` |
| Dominios Informix involucrados | D15, D13, D16 |
| Regulación aplicable | CNBV, SAT, CONDUSEF |
| Descripción | Informix genera reporteria regulatoria automatizada para CNBV (D36 bdirepaut). Incluye Serie R, CUB Anexo 33-36, reportes PLD/LIDE. |
