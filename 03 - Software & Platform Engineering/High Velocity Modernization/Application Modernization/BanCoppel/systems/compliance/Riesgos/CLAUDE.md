# Sistema Riesgos — Sistema Descubierto (Application Modernization)
# togaf_type: compliance
# togaf_state: discovered
# togaf_system_of: record
# togaf_abb: risk-management

> **Descubierto por:** BCOPCore Informix seed — [sistema-riesgos-seed.json](../../core/Informix/digital-brain/seeds/sistema-riesgos-seed.json)
...
| Volumen conocido | 7 jobs CTM |
| Criticidad | `unknown` |
| Dominios Informix involucrados | D48 |
...
|--------|---------|-------|-----------------|
| `informix` | `BCOPCore v1.8.0` | 2026-08-12 | `digital-brain/brain.db::ctm_jobs (folder=PRO_RIESGOS_001)` |
