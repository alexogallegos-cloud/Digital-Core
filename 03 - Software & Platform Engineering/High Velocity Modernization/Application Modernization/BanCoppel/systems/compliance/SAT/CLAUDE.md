# SAT fiscal — Sistema Descubierto (Application Modernization)
# togaf_type: compliance
# togaf_state: external
# togaf_system_of: record
# togaf_abb: tax-authority

> **Descubierto por:** BCOPCore Informix seed — [sat-fiscal-seed.json](../../core/Informix/digital-brain/seeds/sat-fiscal-seed.json)
...
| Volumen conocido | 367 endpoints |
| Criticidad | `unknown` |
