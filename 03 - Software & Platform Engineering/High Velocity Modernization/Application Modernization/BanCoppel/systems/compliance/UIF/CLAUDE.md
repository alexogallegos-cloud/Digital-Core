# UIF/PLD — Sistema Descubierto (Application Modernization)
# togaf_type: compliance
# togaf_state: external
# togaf_system_of: record
# togaf_abb: financial-intelligence

> **Descubierto por:** BCOPCore Informix seed — [uif-pld-seed.json](../../core/Informix/digital-brain/seeds/uif-pld-seed.json)
...
| Volumen conocido | 137 endpoints |
| Criticidad | `unknown` |
