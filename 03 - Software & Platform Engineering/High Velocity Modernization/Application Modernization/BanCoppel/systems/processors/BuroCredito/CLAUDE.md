# Buró de Crédito — Sistema Descubierto (Application Modernization)
# togaf_type: processors
# togaf_state: external
# togaf_system_of: record
# togaf_abb: credit-bureau

> **Descubierto por:** BCOPCore Informix seed — [buro-de-credito-seed.json](../../core/Informix/digital-brain/seeds/buro-de-credito-seed.json)
...
| Volumen conocido | 448 endpoints |
| Criticidad | `unknown` |
