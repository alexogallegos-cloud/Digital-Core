# MoneyGram — Sistema Descubierto (Application Modernization)
# togaf_type: processors
# togaf_state: external
# togaf_system_of: record
# togaf_abb: remittance

> **Descubierto por:** Informix Informix seed — [moneygram-seed.json](../../core/Informix/digital-brain/seeds/moneygram-seed.json)
