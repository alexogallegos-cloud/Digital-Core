# mulesoft — Sistema Descubierto (Application Modernization)
# togaf_type: integration
# togaf_state: discovered
# togaf_system_of: innovation
# togaf_abb: api-integration

> **Descubierto por:** BCOPCore Informix seed — [mulesoft-seed.json](../../core/Informix/digital-brain/seeds/mulesoft-seed.json)
...
| Descripción | MuleSoft/ESB invoca los SPs de Informix expuestos como endpoints (bdicnweb, bdinteg). Los 166 journeys online son el catalogo de endpoints accesibles via ESB. |
