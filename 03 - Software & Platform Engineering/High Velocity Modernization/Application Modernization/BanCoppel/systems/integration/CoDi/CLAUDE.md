# CoDi · Banxico — Sistema Descubierto (Application Modernization)
# togaf_type: integration
# togaf_state: external
# togaf_system_of: innovation
# togaf_abb: instant-payments

> **Descubierto por:** BCOPCore Informix seed — [codi-banxico-seed.json](../../core/Informix/digital-brain/seeds/codi-banxico-seed.json)
...
| Volumen conocido | 215 endpoints |
| Criticidad | `unknown` |
