# SPEI · Banxico — Sistema Descubierto (Application Modernization)
# togaf_type: integration
# togaf_state: external
# togaf_system_of: innovation
# togaf_abb: interbank-transfers

> **Descubierto por:** BCOPCore Informix seed — [spei-banxico-seed.json](../../core/Informix/digital-brain/seeds/spei-banxico-seed.json)
...
| Volumen conocido | 657 endpoints |
| Criticidad | `unknown` |
| Dominios Informix involucrados | D13, D14, D08 |
| Regulación aplicable | Banxico SPEI, CNBV CUB |
| Descripción | — |
