# Banca x Internet — Sistema Descubierto (Application Modernization)
# togaf_type: channels
# togaf_state: discovered
# togaf_system_of: differentiation
# togaf_abb: digital-banking-web

> **Descubierto por:** BCOPCore Informix seed — [banca-x-internet-seed.json](../../core/Informix/digital-brain/seeds/banca-x-internet-seed.json)
