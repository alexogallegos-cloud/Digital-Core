# IST/ATM — Sistema Descubierto (Application Modernization)
# togaf_type: channels
# togaf_state: discovered
# togaf_system_of: differentiation
# togaf_abb: atm-cash-management

> **Descubierto por:** BCOPCore Informix seed — [ist-atm-seed.json](../../core/Informix/digital-brain/seeds/ist-atm-seed.json)
...
| Volumen conocido | 11 jobs CTM |
| Criticidad | `unknown` |
| Dominios Informix involucrados | D04 |
...
|--------|---------|-------|-----------------|
| `informix` | `BCOPCore v1.8.0` | 2026-08-12 | `digital-brain/brain.db::ctm_jobs (folder=PRO_ATM_IST_001)` |
