...
> **Descubierto por:** Informix Informix seed — [ist-atm-seed.json](../../core/Informix/digital-brain/seeds/ist-atm-seed.json)
...
|--------|---------|-------|-----------------|
| `informix` | `Informix v1.8.0` | 2026-08-12 | `digital-brain/brain.db::ctm_jobs (folder=PRO_ATM_IST_001)` |
