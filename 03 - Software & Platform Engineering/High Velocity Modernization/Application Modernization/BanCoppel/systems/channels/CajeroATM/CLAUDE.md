# Cajero/ATM — Sistema Descubierto (Application Modernization)
# togaf_type: channels
# togaf_state: discovered
# togaf_system_of: differentiation
# togaf_abb: atm-cash-management

> **Descubierto por:** BCOPCore Informix seed — [cajero-atm-seed.json](../../core/Informix/digital-brain/seeds/cajero-atm-seed.json)
...
| Volumen conocido | 813 endpoints |
| Criticidad | `unknown` |
