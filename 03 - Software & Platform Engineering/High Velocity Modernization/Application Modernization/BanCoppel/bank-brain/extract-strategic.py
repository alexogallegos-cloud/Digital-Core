...
KNOWN_STAKEHOLDERS = [
    ...
    ("arcadio",              "Arcadio",                 "Líder Arquitectura",              "bancoppel",  "manager",  "Arquitectura",     "decision-maker"),
    ...
    ("pablo-lorenzo",        "Pablo Lorenzo Diaz",      "Global Expert / Director ACN",    "accenture",  "director", "Delivery",         "decision-maker"),
    ("lukasz-pietrzyk",      "Lukasz Pietrzyk",         "Global Architect",                "accenture",  "director", "Arquitectura",     "contributor"),
    ...
    ("luis-barragan",        "Luis Barragán",           "Director BCP Unity (por confirmar)","bancoppel","director", "Unity",            "decision-maker"),
