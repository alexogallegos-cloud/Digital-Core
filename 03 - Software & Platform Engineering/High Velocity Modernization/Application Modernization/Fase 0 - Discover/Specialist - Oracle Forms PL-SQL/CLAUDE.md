...
2. Construir el **extractor Oracle** que emite el JSON normalizado (§6 del método) — reutiliza el **renderer cognitivo** (tech-agnóstico) de la instancia de referencia `../../BanCoppel/BCOPCore/`.
