# PROSA switch — Sistema Descubierto (Application Modernization)
# togaf_type: processors
# togaf_state: external
# togaf_system_of: record
# togaf_abb: card-processing

> **Descubierto por:** Informix Informix seed — [prosa-switch-seed.json](../../core/Informix/digital-brain/seeds/prosa-switch-seed.json)
