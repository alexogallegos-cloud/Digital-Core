...
> **Descubierto por:** Informix Informix seed — [grandata-seed.json](../../core/Informix/digital-brain/seeds/grandata-seed.json)
...
|--------|---------|-------|-----------------|
| `informix` | `Informix v1.8.0` | 2026-08-12 | `digital-brain/brain.db::ctm_jobs (folder=PRO_GRANDATA_001)` |
