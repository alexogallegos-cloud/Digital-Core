# Western Union — Sistema Descubierto (Application Modernization)
# togaf_type: processors
# togaf_state: external
# togaf_system_of: record
# togaf_abb: remittance

> **Descubierto por:** Informix Informix seed — [western-union-seed.json](../../core/Informix/digital-brain/seeds/western-union-seed.json)
...
| Volumen conocido | 343 endpoints |
| Criticidad | `unknown` |
| Dominios Informix involucrados | D09, D10 |
| Regulación aplicable | Banxico, CNBV Remesas |
| Descripción | — |
