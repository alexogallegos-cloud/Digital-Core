...
> **Descubierto por:** Informix Informix seed — [sistema-riesgos-seed.json](../../core/Informix/digital-brain/seeds/sistema-riesgos-seed.json)
...
|--------|---------|-------|-----------------|
| `informix` | `Informix v1.8.0` | 2026-08-12 | `digital-brain/brain.db::ctm_jobs (folder=PRO_RIESGOS_001)` |
