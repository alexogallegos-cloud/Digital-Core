...
|----|----|----|  
| `sp_actualiza_respuestagrupo_cteprosp` | `bdiprospectos:` | R |
| `sp_apercredgrupo2` | `bdiprospectos:` | R |
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdisolic_*.sql (análisis estático de 70 archivos SQL) · análisis estático de archivos SQL*
