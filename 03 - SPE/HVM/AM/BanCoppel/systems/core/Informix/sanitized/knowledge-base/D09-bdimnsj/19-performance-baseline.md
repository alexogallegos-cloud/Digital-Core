# D09 · Mensajería — Baseline de Performance

> **Componente:** LegacyCore · SPE-AM-001 · TEST Phase
> **Base de datos:** `bdimnsj` · IBM Informix IDS 14.10 POWER-AIX → Aurora PostgreSQL
...
-- Instrumentar el SP que llama a bdimnsj:sp_nombre() para registrar:
...
|----|-----------------|---------|---------|---------|---------|
| `sp_registra_evento` | 1,404 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
...
| Patrón | Impacto en `bdimnsj` | Preparación |
|--------|-------------------|------------|
...
export default function() {
  ...
  let res = http.post('https://api.target/bdimnsj/v1/endpoint', payload);
