...
| [D02](D02-bdinteg/) | `bdinteg` | Integración y Auth | 3 | 🟢 BAJO | `bdisolic:sp_obtienegrupo`, `bdisolic:sp_actualiza_status_sol`, `bdisolic:sp_valida_cliente_grupo` |
...
| `bdinteg:ctemoral` | `bdisolic:sp_valida_cliente_grupo` | 28 fan-in | [SME-PENDING] |
