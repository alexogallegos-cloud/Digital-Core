...
|-----------|-------|----------------------------------|----------|
| **CNBV** | Circular 6/2017 — notificaciones transaccionales | LegacyCore tiene obligación de notificar a los clientes por cada transacción relevante (cargos, abonos, pagos). El target debe garantizar que ninguna notificación se pierde durante el cutover. Las 10 tablas notif_online_* deben migrarse completamente y el patrón de partición debe reemplazarse por EventBridge en AWS. | 🔴 CRÍTICO |
