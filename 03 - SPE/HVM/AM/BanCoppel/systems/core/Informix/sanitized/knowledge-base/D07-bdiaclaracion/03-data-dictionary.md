# D07 · Aclaraciones — Diccionario de Datos
...
Diccionario de datos del dominio `bdiaclaracion` construido a partir del análisis estático de los headers `CREATE PROCEDURE / FUNCTION` en 232 archivos SQL. Incluye la firma de los SPs más significativos y el inventario de tipos de datos Informix utilizados.
...
|--------------|----------------------|----------------------|---------------------|
| `CHAR` | 42,827 ocurrencias | CHAR(n) | 🟢 BAJO |
| `INTEGER` | 14,313 ocurrencias | INTEGER | 🟢 BAJO |
| `MONEY` | 4,786 ocurrencias | NUMERIC(p,s) | 🔴 CRÍTICO |
| `DATE` | 4,131 ocurrencias | DATE | 🟢 BAJO |
| `SMALLINT` | 3,471 ocurrencias | SMALLINT | 🟢 BAJO |
| `VARCHAR` | 3,377 ocurrencias | VARCHAR(n) | 🟢 BAJO |
| `DATETIME` | 1,904 ocurrencias | TIMESTAMP(n) WITHOUT TIME ZONE | 🟠 ALTO |
| `DECIMAL` | 833 ocurrencias | NUMERIC(p,s) | 🟡 MEDIO |
| `FLOAT` | 10 ocurrencias | DOUBLE PRECISION | 🟢 BAJO |
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdiaclaracion_*.sql*
