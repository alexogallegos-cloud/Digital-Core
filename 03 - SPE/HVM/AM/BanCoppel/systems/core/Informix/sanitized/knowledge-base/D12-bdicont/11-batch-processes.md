...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdicont_*.sql (análisis estático de 70 archivos SQL) · análisis de patrones de nombres + código*
