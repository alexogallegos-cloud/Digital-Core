...
| Atributo | Valor |
|----------|-------|
| Rol | Plataforma externa de envío de SMS y email a clientes LegacyCore |
...
**Plan de acción:**
- [ ] Confirmar si StrikeIron sigue activo en producción LegacyCore
...
**Plan de acción:**
- [ ] Confirmar con LegacyCore si Innovattia sigue siendo proveedor activo
...
| Atributo | Valor |
|----------|-------|
| Rol | Confirmación de transacciones POS/ATM con tarjeta LegacyCore |
...
| Innovattia | ❓ Validar si activo | Confirmar con LegacyCore | Domain Expert |
