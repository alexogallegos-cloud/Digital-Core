...
Catálogo de excepciones del dominio `bdicont` extraídas del análisis estático de 168 archivos SQL. Incluye:
...
|----|---------|-------------------------------|
| `sp_cont_cargamovimientob3` | 12 bloque(s) | [SME-PENDING] |
| `sp_cont_conssaldosdiariosb4` | 12 bloque(s) | [SME-PENDING] |
| `sp_cont_productotransaccionb5` | 12 bloque(s) | [SME-PENDING] |
| `sp_cont_catalogob3` | 11 bloque(s) | [SME-PENDING] |
| `sp_cont_divisasb4` | 10 bloque(s) | [SME-PENDING] |
| `sp_cont_empresasb3` | 9 bloque(s) | [SME-PENDING] |
| `sp_si_empresasb4` | 8 bloque(s) | [SME-PENDING] |
| `sp_cam_cargamanualb3` | 7 bloque(s) | [SME-PENDING] |
| `sp_cam_monitorarchivosb3` | 7 bloque(s) | [SME-PENDING] |
| `sp_gen_devob3` | 7 bloque(s) | [SME-PENDING] |
| `sp_monitor_cheques_propios_b3` | 7 bloque(s) | [SME-PENDING] |
| `sp_cam_asigna_rev_firmasb3` | 6 bloque(s) | [SME-PENDING] |
| `sp_cam_datosdia` | 6 bloque(s) | [SME-PENDING] |
| `sp_cam_devforzadab3` | 6 bloque(s) | [SME-PENDING] |
| `sp_cam_firmas_visual_chequesb3` | 6 bloque(s) | [SME-PENDING] |
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdicont_*.sql*
