...
| `sp_actualiza_respuestagrupo_cteprosp` | 49 | 0 | — | `bdiprospectos:`  ⚠️ext, `bdisolic:`  ⚠️ext |
...
| `sp_apercredgrupo` | 70 | 0 | `bdinteg:`  ⚠️ext, `bdisolic:`  ⚠️ext | `bdinteg:`  ⚠️ext, `bdisolic:`  ⚠️ext, `bdisolic:ss_autorizacion`  ⚠️ext |
| `sp_apercredgrupo2` | 104 | 0 | `bdinteg:`  ⚠️ext, `bdiprospectos:`  ⚠️ext, `bdisolic:ss_autorizacion`  ⚠️ext, `bdisolic:ss_nuevo_parametrico`  ⚠️ext, `bdisolic:ss_param`  ⚠️ext | `bdinteg:`  ⚠️ext, `bdisolic:`  ⚠️ext |
...
- **`bdisolic:`**: escrita por `sp_adn_incrementa_lincred_pbajj`, `sp_apercredgrupo2`, `sp_actualiza_info_cac`, `sp_actualiza_respuestagrupo_cteprosp`, `actualiza_solos_pba` ... y 12 más
...
- `bdiprospectos:` (R+W) — desde `sp_actualiza_respuestagrupo_cteprosp`, `sp_apercredgrupo2`, `sp_actualiza_status_sol`
...
- `bdisolic:ss_autorizacion` (R+W) — desde `sp_apercredgrupo`, `sp_apercredgrupo2`, `sp_actualiza_status_sol`
...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/LegacyCore/informix/bdisolic_*.sql (análisis estático de 70 archivos SQL) · análisis estático de cláusulas FROM/INSERT/UPDATE/DELETE*
