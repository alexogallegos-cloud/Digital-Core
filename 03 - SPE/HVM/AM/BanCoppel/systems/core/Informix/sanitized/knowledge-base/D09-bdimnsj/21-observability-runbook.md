...
|---------------------|--------------------|--------------------|-----|
| `sp_registra_evento` | `legacycore.bdimnsj.registra_evento.latency` | `legacycore.bdimnsj.registra_evento.errors` | [SME-PENDING] ms |
...
| `legacycore.bdimnsj.requests.total` | Custom | Total de requests al microservicio |
...
| `legacycore.bdimnsj.errors.l4` (divergencias financieras) | > 0 | 🔴 CRITICAL (rollback) |
...
[
  {"title": "Latencia p50/p95/p99", "type": "metric",
    "metrics": [["legacycore/bdimnsj", "latency.p50"], ["legacycore/bdimnsj", "latency.p99"]]},
  {"title": "Error rate", "type": "metric",
    "metrics": [["legacycore/bdimnsj", "errors.total"], ["legacycore/bdimnsj", "errors.l4"]]},
...
```
DETECTAR: Alarma legacycore.bdimnsj.errors.l4 > 0
ACCIÓN INMEDIATA:
