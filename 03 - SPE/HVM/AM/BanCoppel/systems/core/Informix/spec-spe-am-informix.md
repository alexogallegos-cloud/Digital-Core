...
| **Nombre** | Informix — Core bancario BanCoppel (Informix SPL) |
...
|---|---|---|
| Canales digitales BanCoppel | Invocan Informix vía JDBC / ODBC directamente sobre SPs | Upstream |
| Plataforma SPEI / CoDi (Banxico) | Genera eventos de pago que Informix registra y reconcilia | Upstream |
| Sistema contable / ERP BanCoppel | Informix provee movimientos para contabilidad | Downstream |
| Reportería CNBV Serie R | Datos de cuentas, crédito y pagos extraídos de Informix | Downstream |
...
| Impacto de falla | **Sistémico** — falla en Informix paraliza todas las operaciones de BanCoppel |
...
|---|---|---|
| 0.1 | Código fuente SPL disponible — cargado en `source/informix/` | ☐ Pendiente carga |
...
- [ ] Código fuente SPL disponible en `source/informix/`
