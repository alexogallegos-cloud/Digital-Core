# DT-SPL Analysis — Digital Twin · Informix
...
| Schema del BCOPBrain (brain.db) | `build-brain.py` + `brain.py` en `Informix/digital-brain/` | 1.0.0 |

---

## GESTIÓN DE CONOCIMIENTO (Regla 14)

- **Corpus de análisis**: `Informix/digital-brain/brain.db` — la fuente de verdad del código analizado
- **Scripts de construcción**: `build-brain.py` (extrae edges) · `brain.py` (API de consulta) — viven en `Informix/digital-brain/`
...
*v1.1.0 · 2026-08-03 · Informix project DT — DISCOVER · Orquestador del Gemelo Cognitivo · Corrección: 5→6 DTs supervisados; scope D01-D49*