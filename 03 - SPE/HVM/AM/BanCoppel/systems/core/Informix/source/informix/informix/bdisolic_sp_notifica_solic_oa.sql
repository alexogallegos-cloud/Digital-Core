CREATE PROCEDURE "informix".sp_notifica_solic_oa ()
...
BEGIN
    ...
    ON EXCEPTION SET SQL_ERR, ISAM_ERR, ERROR_INFO
		...
		LET COD_RET = P_COD_RET;	
		LET P_MENSAJE = 'Error al ejecutar el proceso.';
		RETURN COD_RET,P_MENSAJE;		
		
		CALL bdicred:"informix".sp_inserta_bitacora(v_empresa, vproceso, P_COD_RET, cMensaje, '02') RETURNING SCOD_RET;
		...
		IF SCOD_RET != '000000' THEN
			LET P_COD_RET = SUBSTRING(P_COD_RET FROM 2 FOR 5);
			LET COD_RET = P_COD_RET;
  ...
  --SET debug FILE TO "/informix/sp_notif_solic_oa.out";
  --TRACE ON;
  
    LET cMensaje = 'PROCESO AUTOMATICO INICIALIZADO SOLICITUDES OA';
    CALL bdicred:"informix".sp_inserta_bitacora(v_empresa, vproceso, P_COD_RET, cMensaje, '01') RETURNING SCOD_RET;
	...
	CALL bdicred:"informix".sp_inserta_bitacora(v_empresa, vproceso, P_COD_RET, TRIM(cMensaje), '02') RETURNING SCOD_RET;
	IF SCOD_RET = '000000' THEN LET COD_RET = '00000'; END IF;
	...
	CALL bdicred:"informix".sp_inserta_bitacora(v_empresa, vproceso, P_COD_RET, cMensaje, '03') RETURNING SCOD_RET;
	IF SCOD_RET = '000000' THEN LET COD_RET = '00000'; END IF;
