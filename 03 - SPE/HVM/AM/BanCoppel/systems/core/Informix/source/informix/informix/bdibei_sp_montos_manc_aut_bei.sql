CREATE PROCEDURE "informix".sp_montos_manc_aut_bei(
												pNumCliente char(9),
												pIdUser integer,
												pNoReg integer,
												pRegIni integer)
...
--**************************************************************************************************************
          ...
          FOREACH
            ...
            Select SKIP pRegIni FIRST pNoReg  distinct mt.id_admin_manco, us.usuario_bei, mm.restricc
           ...
           RETURN cod_ret, iTotalReg,iIdMancomunidad,sUserNom,sTipoOperacion WITH RESUME;
          END FOREACH;
