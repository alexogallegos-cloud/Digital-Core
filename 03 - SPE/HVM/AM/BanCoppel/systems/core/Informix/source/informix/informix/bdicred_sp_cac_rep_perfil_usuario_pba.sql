CREATE PROCEDURE "informix".sp_cac_rep_perfil_usuario_pba(pFechaIni CHAR (10), pFechaFin CHAR(10))
...
----se obtiene el total de registros de solicitudes atendidas.
	...
	SELECT {+INDEX(sd_historica_cac_aumlincred idx_historica_cac_aumlincred2)} COUNT( b.num_solicitud) --total atendidas 
	INTO iTotalReg
	...
	FOREACH WITH HOLD	
		SELECT {+INDEX(sd_historica_cac_aumlincred idx_historica_cac_aumlincred2)} h.puesto,h.ejecutivo,COUNT( b.num_solicitud), --total atendidas por usuario	
...
CREATE PROCEDURE "informix".sp_consulta_gral_aumlincred_aut_pba	(pFechaInicial 	CHAR(10),pFechaFinal 	CHAR(10),	pStatus CHAR(2)	)
	RETURNING CHAR(6)  		AS codigo_retorno,
			  CHAR(80) 		AS mensaje_retorno,     
