CREATE PROCEDURE "informix".sp_consulta_tdcbcfrecuentes(p_NumCte CHAR(20), p_CvePago CHAR(2), p_Registros SMALLINT)
RETURNING
...
BEGIN
   ...
   ON EXCEPTION
	...
	--SET DEBUG FILE TO "/home/informix/bibiana/sp_consulta_tdcbcfrecuentes.out";
	--TRACE ON;
