CREATE PROCEDURE "informix".abono_ctas_18112010(pempresa CHAR(3))
RETURNING CHAR(5), CHAR(5), INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/abono_ctas_18112010.err";
        TRACE ON;
        IF sql_err <> 0 THEN
            LET vcodret = sql_err;
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/abono_ctas_18112010.out";
    --- TRACE ON;
    ...
    LET vsql = 'echo "LOAD FROM /resplogifx/conciliachq/abonos_correc_18112010.unl DELIMITER ''","'' INSERT INTO ctasxabonar" > /resplogifx/conciliachq/aboncorrec.sql';
    SYSTEM vsql;
    LET vsql = '';
    LET vsql = '/ifxsif01/bin/dbaccess bdicheq /resplogifx/conciliachq/aboncorrec.sql';
    --- LET vsql = 'dbaccess bdicheq /resplogifx/conciliachq/aboncorrec.sql';
    SYSTEM vsql;
    LET vsql = '';
