...
RETURNING char(5);
	...
	LET vfecha_operacion = TODAY;
     ...
     --set debug file to "/informix/moha/devotrobco.out";
     --trace on;
    ...
    FOREACH
        ...
        ELSE
            ...
            IF vsigue = "1" THEN 
                ...
                -- // Obtiene la fecha del último cheque --MOHA
                ...
                IF btipoctarel <> "1" THEN
                    CALL diasretcta(pempresa,pcuenta,pimporte,pnro_docto,pbanco, pusuario, "D") 
                    RETURNing vcodret;
                ELSE
    ...
    IF vsigue = "1" THEN
        ...
        IF btipoctarel <> "1" THEN
            ...
            ********************************************************************* }
            ...
            -- // Inserta transacción el el movdia
            insert into sc_movdia 
