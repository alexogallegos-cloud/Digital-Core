CREATE PROCEDURE "informix".sp_listaltabancos_web(pSkip INTEGER, ptipoconsulta CHAR(1))

	RETURNING  CHAR(5), CHAR(5), CHAR(20);   -- codigo retorno
...
--			TRACE ON;
		...
		IF ptipoconsulta = '1' THEN   -- CONSUTA TODOS
			...
			FOREACH
				...
				RETURN vCodRet, vclave, vbanco with resume;
		...
		ELSE
		   LET vCodRet='00001';  -- TIPO DE CONSULTA INCORRECTA
