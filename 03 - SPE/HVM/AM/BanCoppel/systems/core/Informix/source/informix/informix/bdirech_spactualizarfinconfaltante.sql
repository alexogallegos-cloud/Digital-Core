CREATE PROCEDURE "informix".spactualizarfinconfaltante (p_sNumEmpleado CHAR(8), p_sNumSucursal CHAR(4), p_iIdFaltante SMALLINT, p_mDescuento MONEY(10,0),
...
RETURNING CHAR(5) AS CodigoRetorno
    ...
    --SET DEBUG FILE TO  "spactualizarfinconfaltante.out"; 
    --TRACE ON;
    ...
    BEGIN
        ...
        IF v_mSaldoActual IS NOT NULL AND v_iIdConcepto <> 3 THEN
            IF v_mSaldoActual = p_mDescuento THEN
                ...
                SET idrecupera = 3, -- Finiquito
                fechaliquida = p_dFecha,
