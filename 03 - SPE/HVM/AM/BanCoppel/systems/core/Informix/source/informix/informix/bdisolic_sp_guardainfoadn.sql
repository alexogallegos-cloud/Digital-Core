CREATE PROCEDURE "informix".sp_guardainfoadn(pEmpresa CHAR(3), pNum_solicitud  CHAR(20),pNumcte CHAR(20),pCuenta CHAR(20),pFrecuencia INTEGER,pDiaPago INTEGER)
