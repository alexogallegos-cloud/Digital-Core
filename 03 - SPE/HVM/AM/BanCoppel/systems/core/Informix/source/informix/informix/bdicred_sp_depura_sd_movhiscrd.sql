CREATE PROCEDURE "informix".sp_depura_sd_movhiscrd()
       RETURNING char(6);
...
DEFINE dFecha		DATE;	
	...
	--SET DEBUG FILE TO "/informix/c91691184/sp_depura_sd_movhiscrd_trace.out";
    --TRACE ON; 
    ...
    FOREACH WITH HOLD
		...
		BEGIN WORK;
			...
			DELETE FROM bdicred:"informix".sd_movhiscrd 
			WHERE empresa = '001' and  num_credito = VlNumCredito and fecha_mov <= dFecha;
			delete from "informix".temp_creditos_depurar2 where num_credito = VlNumCredito;
