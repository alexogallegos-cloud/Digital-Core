CREATE PROCEDURE "informix".sp_obtenerconceptospagosmanuales()
RETURNING
	CHAR(5), ---cod_ret
	...
	DEFINE sConcepto			VARCHAR(50);
	DEFINE sTransaccion 		CHAR(4);
...
BEGIN
	...
	---TRACE ON;
	FOREACH
		SELECT CONCEPTO, TRANSACC
		INTO sConcepto, sTransaccion
		FROM bdicred: sd_conceptospagomanual
        WHERE codigo in ('01','02','03','04','05','06','07','08','09')

		RETURN v_cod_ret, sConcepto, sTransaccion WITH RESUME;
...
'DESCRIPCION: Procedimiento que obtiene el catálogo de los Conceptos de Pago y Transacciones.',
'Crédito',
'FECHA : Enero de 2010',
'VERSION: 20100121.1910',
'BD    : BDICRED';
