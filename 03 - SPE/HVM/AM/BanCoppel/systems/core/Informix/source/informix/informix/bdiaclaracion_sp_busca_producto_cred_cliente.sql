CREATE PROCEDURE "informix".sp_busca_producto_cred_cliente(p_sNumeroCliente CHAR(20), p_skip INT)
	...
	--SET DEBUG FILE TO "/informix/resplogifx/tdccoppel/sp_busca_producto_cred_cliente.out";
	--TRACE ON;
	...
	BEGIN
		...
		FOREACH
			SELECT SKIP p_skip DISTINCT bdicred:sd_maecred.num_producto as numeroProducto, nombre_prod AS nombreProducto, bdicred:sd_maecred.num_credito AS cuentaProducto, intercard:tarjetacuenta.numtarjeta AS tarjetaProducto, codstatustarjeta AS estatusTarjeta
		...
		FOREACH
			SELECT SKIP p_skip DISTINCT intercard:binproducto.codprodcta as numeroProducto, intercard:binproducto.desccodprodcta AS nombreProducto, intercard:tarjetacuenta.numcuenta AS cuentaProducto, intercard:tarjetacuenta.numtarjeta AS tarjetaProducto, intercard:tarjeta.codstatustarjeta AS estatusTarjeta
			INTO resultado_numeroProducto,resultado_nombreProducto, resultado_numeroCuenta, resultado_numeroTarjeta, cStatusTarjeta
            ...
            WHERE intercard:tarjeta.numcliente = p_sNumeroCliente
            AND intercard:tarjeta.codstatustarjeta IN ('ACT','BLO','BLT','CAN','DAN','EXT','FAL','INA','ROB')
