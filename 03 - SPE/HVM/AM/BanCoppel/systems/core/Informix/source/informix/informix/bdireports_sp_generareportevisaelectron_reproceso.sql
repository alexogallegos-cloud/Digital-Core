CREATE PROCEDURE "informix".sp_generareportevisaelectron_reproceso(dFechaIn DATETIME year to fraction(5),dFechaFin DATETIME year to fraction(5),cTrimestre CHAR(5),iMes INTEGER)
returning
char (5),
char(100);
...
--Set debug file to "/informix/pruebasconciliacion/sp_generareportevisaelectron.sql";
--trace on;
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		WHERE b.fecha_alta <= dFechaFin AND a.producto NOT IN ('1100','1800') AND a.status_cta IN ('1','3','4');*/
		LET dTotalCuentasDeb = 9652207 ;
		...
		LET dNumeroTarjetasChip = 2212030 ;
		...
		('1100','1800') AND a.status_cta IN ('1','3','4');*/
		LET dNumeroTarjetasChip2 = 974804 ;
		...
		AND producto NOT IN ('1100','1800') AND status_cta IN ('1','3','4') ;*/
		LET dTotalCuentasPerDep = 3191345 ;
		SET LOCK  MODE TO WAIT 3;
		--Inserta en la base de datos
