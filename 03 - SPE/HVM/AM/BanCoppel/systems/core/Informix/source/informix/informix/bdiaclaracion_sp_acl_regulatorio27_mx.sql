CREATE PROCEDURE "informix".sp_acl_regulatorio27_mx (pFechaCap_Ini DATE,pFechaCap_Fin DATE)
...
--SET DEBUG FILE TO "/RESPALDOSNEW/sp_ext_reporte27.out";
--TRACE ON;
...
--------------------------------------------------------------------------------------------------------------------------------------------
	...
	INSERT INTO acl_regulatorio27 VALUES (v_folio_csuac, v_fechacaptura, v_fechahora, v_numero_cuenta, v_numero_tarjeta, v_pky_tipo_producto, v_des_tipo_producto, v_origen_evento, v_desc_origen, v_pky_tipo_evento, v_desc_evento, v_importereclamado, v_fky_estatus_aclaracion, v_desc_aclaracion, v_procede, v_fecha_dictamen, v_fecha_abono, v_codigo_resolucion, v_desc_resolucion, v_montoprocedente, v_importe_rec, v_quebranto_inst, v_fecha_inicio, v_fecha_fin, current);
