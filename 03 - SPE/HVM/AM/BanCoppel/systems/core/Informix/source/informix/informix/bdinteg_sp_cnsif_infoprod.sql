CREATE PROCEDURE "informix".sp_cnsif_infoprod(cID_USUARIOC char(08),cID_FUNCIONC CHAR(10),cPRODUCTO CHAR(4))
...
BEGIN
	ON EXCEPTION SET iSql_err
		...
		END IF;
	END EXCEPTION;
	--  SET DEBUG FILE TO "/tmp/CNSIF/sp_cnsif_infoprod.out";
	--  TRACE ON;
