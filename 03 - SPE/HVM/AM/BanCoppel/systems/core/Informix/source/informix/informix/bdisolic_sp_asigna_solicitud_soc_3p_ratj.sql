CREATE PROCEDURE "informix".sp_asigna_solicitud_soc_3p_ratj(pEmpresa CHAR(3), pEjecutivoAtiende CHAR(8), pBandera CHAR(1))
RETURNING
	CHAR(6) 		AS CodRet,
...
BEGIN
    ...
    --SET DEBUG FILE TO "/informix/Malena/INC27205/sp_asigna_solicitud_soc.out";
	--TRACE ON; 
...
--            SYSTEM cSQL;
        ...
        -- VALIDAR SI EL CLIENTE AFIRMO TRAER COMPROBANTE DE INGRESO EN EL PARAMÃTRICO Y SE ENCUENTRA DIGITALIZADO, DE CASO CONTRARIO CONTINUA FOREACH
            SELECT elemento
            ...
            IF iCompingreso = 0 AND cCompParametrico <> 1  THEN
                CONTINUE FOREACH;
            END IF;
