create procedure "informix".auditor_ant(pempresa char(3))
returning char(5);
    ...
    delete from sv_auditerr 
     where empresa = pempresa;
     
    foreach
        select empresa,mayor,sub,subsub,ssubsub,sssubsub,sector,auxiliar,producto,transacc,sum(monto_tot)
        ...
        if vc_tipo_cuenta is null then
            ...
            values(vempresa,vccmayor,vccsub,vccsubsub,vccssubsub,vccsssubsub,vsector,vauxiliar,vproducto,vtransacc,vcodret,vmonto_tot);
