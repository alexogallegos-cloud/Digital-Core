CREATE PROCEDURE "informix".sp_reppagaresipab_temp( pNumCliente CHAR(20), 
                                                    pFechaIni   DATE, 
                                                    pFechaFin   DATE, 
...
RETURNING CHAR(5);
    ...
    DEFINE cFechaContratacion, cFechaCorte CHAR(8);
    ...
    DEFINE dTasa, dTasa2, dSdo_PromInv DECIMAL(9,6); 
    ...
    LET cFechaContratacion = ''; LET cFechaCorte = '';
    ...
    LET dPorcentaje = 0; 
    LET dTasa = 0; LET dTasa2 = 0; LET dSdo_PromInv = NULL;
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, cDesErr
        SET DEBUG FILE TO '/resplogifx/conciliachq/jivan/sp_reppagaresipab_temp.err';
        TRACE ON;
        LET cCodRet = iSqlErr;
    ...
    --- SET DEBUG FILE TO '/resplogifx/conciliachq/jivan/sp_reppagaresipab_temp.out';
    --- TRACE ON;
    
    SET ISOLATION TO DIRTY READ;
    SET LOCK MODE TO WAIT 3;
    
	LET cFechaCorte = TO_CHAR(pFechaIni,'%Y%m%d');
    ...
    FOREACH
        ...
        */
        ...
        ( cNumCuenta, cCtaInversion, cNumProducto, cTpoCuenta, cRegFiscal, dPorcentaje, iSucursal, mCapital, mInt_Proy, mISR_Proy, 0.00, 
          mSdo_Inv_Proy, iDivisa, cFechaCorte, cFechaContratacion, iPlazo, iTipoTasa, dTasa, cInstbase, cSobretasa, cOperArit, dtFechaSigCorte, 
          dSdo_PromInv, iDias_Ini, mSdo_Ini, mSdo_Prom_Ini, mInt_al_Inicio, dImp_Isr_Ini, iDias_Proy, mCapital, mSdo_Prom_Fin, mInt_Proy, mISR_Proy, '1', '' );
