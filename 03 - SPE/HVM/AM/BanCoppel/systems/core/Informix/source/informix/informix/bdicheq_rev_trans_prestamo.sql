...
END PROCEDURE
DOCUMENT
'reversa transferencia por consumo el servicio wstransferenciascloud',
'AUTOR : Luis Fernando Trapero Soto',
'FECHA :MAYO/2024',
'BD    : bdicheq';

CREATE PROCEDURE "informix".sp_confirma_prestamo_cpl(pFolioSuc CHAR(16))
RETURNING CHAR(3);
    ...
    ON EXCEPTION SET sql_err, isam_err
        --SET DEBUG FILE TO "/resplogifx/sp_confirma_prestamo_cpl.err";
        --TRACE ON;
        IF sql_err <> 0 THEN
            LET vcodret = sql_err;
            RETURN vcodret;
    ...
    END EXCEPTION;
        ...
        select folio_suc into sValor
          from sc_movdia where empresa='001' and folio_suc= pFolioSuc and transacc='0283';
...
END PROCEDURE
DOCUMENT
'Consulta las traferencias exitosas para el servicio wstransferenciascloud',
'AUTOR : Luis Fernando Trapero Soto',
'FECHA :MAYO/2024',
'BD    : bdicheq';
