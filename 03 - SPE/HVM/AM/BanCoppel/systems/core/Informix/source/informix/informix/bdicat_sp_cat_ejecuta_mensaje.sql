...
LET cVAR_E1 = "";	LET cVAR_E2 = "";	LET cVAR_E3 = "";	LET cVAR_E4 = "";
LET cVAR_E5 = "";	LET cVAR_E6 = "";	LET cVAR_E7 = "";	LET cVAR_E8 = "";
LET cVAR_E9 = "";	LET cVAR_E10 = "";	LET cVAR_E11 = "";	LET cVAR_E12 = "";
LET cVAR_E13 = "";	LET cVAR_E14 = "";	LET cVAR_E15 = "";	LET cVAR_E16 = "";
...
-- SET DEBUG FILE TO "/aplicacion/FavMartinez/sp_cat_ejecuta_mensaj.out";
--TRACE ON;   
...
IF NVL(cTramaEntrada,"") = "" THEN
    LET cCodRet = "106001";
    SELECT TRIM(descripcion) INTO cDescErrorCtrl FROM bdicobranza: cb_errores WHERE origen = pOrigen AND codigo_error = cCodRet;
...
--insert into bdicobranza:cb_bitacora (mensaje) values ('iPosicion:'||iPosicion||':iPosicionTotal:'||cTramaEntrada);
    IF iPosicion = -1 THEN
        LET  cCodRet = "106002";
        SELECT TRIM(descripcion) INTO cDescErrorCtrl FROM bdicobranza: cb_errores WHERE origen = pOrigen AND codigo_error = cCodRet;
        LET cCuerpoSal = cCuerpoSal || bdicobranza: fn_FormarEtiquetaXML(NVL(cDescErrorCtrl,cCodRet), "error");
...
IF cCodRetVTD::INTEGER <> 0 THEN
    ...
    LET cSalida = cEncabezadoSal || cCuerpoSal || cColaSal;
    LET cSalida = SUBSTR(cSalida,1,LENGTH(cSalida));
--insert into bdicobranza:cb_bitacora (MENSAJE) VALUES ('MENSAJE'||Substr(cValorCampo,1,10));
    RETURN cCodRet, cSalida;
...
SELECT TRIM(funcion), registra_bitacora, tipo_acceso INTO cNomMensaje, cRegistraBit, sTipoAccesso 
FROM bdicobranza: cb_cat_mensaje WHERE sistema = "4" AND cve_mensaje = pNumMensaje;
...
IF NOT EXISTS (SELECT ejecutivo FROM bdicobranza: cb_cat_acceso_ejecutivo WHERE tipo_cobranza = cTipoCobranza AND ejecutivo = pEjecutivo AND status_ejecutivo = "AC" AND tipo_acceso = sTipoAccesso) THEN
...
LET cNumProceso = DECODE(pNumMensaje,"10001","0020","10002","0021","10003","0022","10004","0023","10005","0024","10006","0025","100007","0026","10008","0027","10009","0028" ); --Validar
...
IF pNumMensaje = "10001" THEN
      FOREACH
        ...
        INTO cVAR_S1,cVAR_S2,cVAR_S3,cVAR_S4,cVAR_S5,cVAR_S6,cVAR_S7,cVAR_S8,cVAR_S9,cVAR_S10,cVAR_S11,cVAR_S12,cVAR_S13,cVAR_S14,cVAR_S15,cVAR_S16,cVAR_S17,cVAR_S18
         IF cVAR_S1::INTEGER <> 0 THEN
            IF cRegistraBit = "S" THEN                                
                IF cVAR_S1::INTEGER > 0 THEN
                    SELECT TRIM(descripcion) INTO cDescErrorCtrl FROM bdicobranza: cb_errores WHERE origen = pOrigen AND codigo_error = cVAR_S1;
                END IF                                
        ...
        LET cVAR_S13 = SUBSTR(cVAR_S13,1,LENGTH(cVAR_S13));LET cVAR_S14 = SUBSTR(cVAR_S14,1,LENGTH(cVAR_S14));LET cVAR_S15 = SUBSTR(cVAR_S15,1,LENGTH(cVAR_S15));LET cVAR_S16 = SUBSTR(cVAR_S16,1,LENGTH(cVAR_S16));LET cVAR_S17 = SUBSTR(cVAR_S17,1,LENGTH(cVAR_S17));
        LET cVAR_S18 = SUBSTR(cVAR_S18,1,LENGTH(cVAR_S18)); 
        ...
        FOREACH
            ...
            LET cCuerpoSal = cCuerpoSal || bdicobranza: fn_FormarEtiquetaXML(DECODE(i,1,cVAR_S1,2,cVAR_S2,3,cVAR_S3,4,cVAR_S4,5,cVAR_S5,6,cVAR_S6,7,cVAR_S7,8,cVAR_S8,9,cVAR_S9,10,cVAR_S10,11,cVAR_S11,12,cVAR_S12,13,cVAR_S13,14,cVAR_S14,15,cVAR_S15,16,cVAR_S16,17,cVAR_S17,18,cVAR_S18), cCMParametro);
            LET i = i + 1;
        END FOREACH
    ...
    FOREACH
        ...
        IF cVAR_S1::INTEGER <> 0 THEN
            IF cRegistraBit = "S" THEN                                
                ...
                IF cCodRetIB::INTEGER <> 0 THEN
                    LET cCodRet = "106010";
                    SELECT TRIM(descripcion) INTO cDescErrorCtrl FROM bdicobranza: cb_errores 
...
ELIF pNumMensaje = "10008" THEN
    FOREACH    
        ...
        LET cCuerpoSal = cCuerpoSal || "</parametros>";
    END FOREACH
ELIF pNumMensaje = "10009" THEN
    FOREACH    
        EXECUTE PROCEDURE bdinteg:"informix".sp_registra_correos(cVAR_E1,cVAR_E2,cVAR_E3,1,1,USER)
        INTO cVAR_S1 -- ,cVAR_S2
--insert into bdicobranza:cb_bitacora (mensaje) values ('Llega al Email');
        ...
        IF cVAR_S1::INTEGER <> 0 THEN
            ...
            LET cSalida = SUBSTR(cSalida,1,LENGTH(cSalida));
            RETURN cCodRet, cSalida;		
		ELIF cVAR_S1='00000' then LET cVAR_S1 = '000000';	
        END IF
        -- SE ARMA EL ENCABEZADO
        LET cEncabezadoSal = '<?xml version="1.0" encoding="utf-8" ?>';
        LET cNomServicioSal = '<RegistroDeCompromisos_Respuesta xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns="http://cobtelbancoppel.coppel.com">';
        ...
        -- SE QUITAN LOS ESPACIOS QUE PUEDIERAN ESTAR A LA DERECHA
        LET cVAR_S1 = SUBSTR(cVAR_S1,1,LENGTH(cVAR_S1));
        LET cVAR_S2 = SUBSTR(cVAR_S2,1,LENGTH(cVAR_S2));
        FOREACH
            SELECT TRIM(parametro) INTO cCMParametro FROM bdicobranza: cb_cat_configura_mensaje WHERE sistema = "4" AND cve_mensaje = pNumMensaje AND tipo_parametro = "S" ORDER BY secuencia
            LET cCuerpoSal = cCuerpoSal || bdicobranza: fn_FormarEtiquetaXML(DECODE(i,1,cVAR_S1,2,cVAR_S2), cCMParametro);
            LET i = i + 1;
...
IF cRegistraBit = "S" AND cCodRet::INTEGER = 0 THEN
    IF cBand1 = "T" THEN
        SELECT TRIM(descripcion) INTO cDescErrorCtrl FROM bdicobranza: cb_errores WHERE origen = pOrigen AND codigo_error = "102013";
...
grant  execute on function "informix".sp_cat_ejecuta_mensaje (char) to "all_role_bdicat" as "informix";
grant  execute on function "informix".sp_cat_ejecuta_mensaje (char) to "select_role_bdisac" as "informix";
grant  execute on function "informix".sp_cat_ejecuta_mensaje (char) to "public" as "informix";
