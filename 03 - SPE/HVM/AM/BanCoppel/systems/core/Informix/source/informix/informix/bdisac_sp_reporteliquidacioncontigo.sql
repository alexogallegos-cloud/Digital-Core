CREATE PROCEDURE "informix".sp_reporteliquidacioncontigo(pConvenio CHAR(5))
...
LET iCuantos	= 0;
	...
	--SET DEBUG FILE TO '/respaldosbd/hugovaz/sp_reporteliquidacioncontigo.out';
	--TRACE ON;
	...
	BEGIN
		ON EXCEPTION SET iSqlErr, iIsamErr, cInfoErr
			IF iSqlErr <> 0 THEN
				...
				EXECUTE PROCEDURE "informix".sp_sac_GuardaMensajeerror (iSqlErr, iIsamErr, cInfoErr, "sp_reporteliquidacioncontigo");
			END IF;
		END EXCEPTION;
