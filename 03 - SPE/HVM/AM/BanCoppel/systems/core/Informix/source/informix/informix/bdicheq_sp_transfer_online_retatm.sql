CREATE PROCEDURE "informix".sp_transfer_online_retatm( pTranTrfn CHAR(5),
                                                       pCuenta   CHAR(20), 
                                                       pFolioSuc CHAR(16), 
                                                       pMonto    DECIMAL(14,2), 
                                                       pUsuario  CHAR(8) )
RETURNING CHAR(5), INTEGER;
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, cDesErr
        SET DEBUG FILE TO "/resplogifx/conciliachq/sp_transfer_online_retatm.err";
        TRACE ON;
        IF iSqlErr <> 0 THEN
            LET cCodRet  = iSqlErr;
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/sp_transfer_online_retatm.out";
    --- TRACE ON;
