CREATE PROCEDURE "informix".sp_conciliachq_esp_2010(pempresa CHAR(3), pcuenta CHAR(20), pfecha DATE)
RETURNING CHAR(5), CHAR(5), INTEGER, INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq//sp_conciliachq_esp_2010.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    --- SET DEBUG FILE TO "./sp_conciliachq_esp_2010.out";
    --- TRACE ON;
    ...
    FOREACH WITH HOLD
        ...
        EXECUTE PROCEDURE sp_capintafecha_2010(vcuenta, vfecha_ant) 
        ...
        EXECUTE PROCEDURE sp_capintafecha_2010(vcuenta, vfecha_hoy) 
