CREATE PROCEDURE "informix".sp_conciliachq_2011(pempresa CHAR(3), pcuenta CHAR(20), pfecha DATE)
RETURNING CHAR(5), CHAR(5), INTEGER, INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/sp_conciliachq_2011.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/sp_conciliachq_2011.out";
    --- TRACE ON;
    ...
    FOREACH WITH HOLD
        ...
        EXECUTE PROCEDURE sp_capintafecha_2011(vcuenta, vfecha_hoy) 
