CREATE PROCEDURE "informix".sp_depurar_tempomovs()
	...
	BEGIN
		...
		TRUNCATE TABLE bdinteg:"informix".si_tempomovs_2;
		
		RETURN cCodRet;
	END;
END PROCEDURE
DOCUMENT 'Descripcion: SP para depurar la tabla "si_tempomovs_2" es llenada durante el proceso del SP sp_cnsif_genarchmovimientos_masivo, ejecutado por el JOB 1109, desde el sp sp_depurar_genarchmovtos_masivo',
'Autor: Uriel Amador Islas',
'Area: Sitemas',
'Gerencia de Mtto y Soporte IV',
'Coordinador: Eduardo Martinez Martinez',
'Fecha: 30/10/2024',
'Version: 1.0.0',
'BD: bdinteg';
