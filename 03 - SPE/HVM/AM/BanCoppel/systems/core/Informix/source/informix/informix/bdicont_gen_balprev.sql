CREATE PROCEDURE "informix".gen_balprev(pempresa char(3), w_fecha date,w_usuario char(10))
...
if v_numregs > 0 then
   foreach
      ...
      sum(saldo_fin_de_dia),naturaleza_cta,nombre,tipo_cuenta
      ...
      GROUP BY 1,2,3,4,5,6,7,8,13,15,14
