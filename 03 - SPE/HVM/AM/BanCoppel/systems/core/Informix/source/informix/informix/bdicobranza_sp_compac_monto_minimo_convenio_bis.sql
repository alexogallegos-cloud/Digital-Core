CREATE PROCEDURE "informix".sp_compac_monto_minimo_convenio_bis( pEmpresa CHAR(3), 
															 pNumCuenta CHAR(20))
...
--Valida si existen creditos con estatus 'FF' y 'cv' en la tabla sd_maecredcrd DSB VP
...
'BD    : BDICOBRANZA',
'-------------------------------------------',
'Se obtiene el total de cuentas de credito del cliente de la tabla sd_maecredcrd, validadas con estatus "FF","CV"',
