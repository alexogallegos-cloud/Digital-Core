create procedure "informix".sp_transfer_mconadmin_success2_totales (
					pdfechaini   date,
					pdfechafin   date,
					pstransacc   char(5),
					psnaturaleza char(1)					
...
--set debug file to "/informix/HomeInformix/rrm/sp_transfer_mconadmin_success2_totales.out";
--trace on;
