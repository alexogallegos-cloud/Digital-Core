CREATE PROCEDURE "informix".sp_reportediarioacl_2day() RETURNING CHAR(7);
...
BEGIN
	...
	--SET DEBUG FILE TO "/resplogifx/repaclaraciones/sp_reportediarioacl_2day.out";
	--TRACE ON;
	...
	execute procedure sp_reportediarioacl_paralelo_2day(0,-1) into codigo_res;
	...
	while num_reporte <= num_reportes
		...
		let ejecuta = 'echo "echo \"execute procedure \"informix\".sp_reportediarioacl_paralelo_2day('||num_reporte_inicial||','||num_reporte||
