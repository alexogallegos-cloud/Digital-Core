create procedure "informix".sp_refdirecciones_pros( pempresa char(3),
                                                    pfuncion char(1),
                                                    pnumcte char(20),
                                                    psecuencia integer,
                                                    ptipodir char(1),
...
returning char(5);
    ...
    --- SET DEBUG FILE TO "/tmp/sp_refdirecciones_pros.out";
    --- TRACE ON;
    ...
    if pfuncion = "A" then
        ...
        ( numcte_pros, secuencia, tipo_dir, calle, colonia, entre_calles, pais, estado, ciudad, municipio, cod_postal, apart_postal,
          ...
          numerociudad, numeroextcalle, numerointcalle, departamento, numerocalle, numerocolonia, puntocardinal, unidadhabitac, 
          manzana, otros, andador, etapa, lote, edificio, entrada, observaciones, user_insert, fecha_insert, numcte_banco )
        values
        ( pnumcte, psecuencia, ptipodir, pcalle, pcolonia, pentre_calles, ppais, pentidad, plocalidad, pmunicipio, pcodpostal, "",
          ptipotel1, ptelefono1, ptipotel2, ptelefono2, ptipotel3, ptelefono3, pextension, pestado_inegi, pmunicipio_inegi, plocalidad_inegi,
          pnociudad, pnoext, pnoint, pdepto, pnocalle, pnocolonia, ppuntocar,punihabi, 
          pmanz, ppotros, pandador, petapa, plote, pedif, pentrada, pobserva, puser_insert, pfecha_insert, numcte_banco );
