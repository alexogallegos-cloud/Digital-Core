CREATE PROCEDURE "informix".sp_trxscargotransfersoc( pEmpresa CHAR(3) )
RETURNING CHAR(5), CHAR(4), CHAR(80);
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, cDesErr
        SET DEBUG FILE TO "/tmp/sp_trxscargotransfersoc.err";
        TRACE ON;
        IF iSqlErr <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/tmp/sp_trxscargotransfersoc.out";
    --- TRACE ON;
