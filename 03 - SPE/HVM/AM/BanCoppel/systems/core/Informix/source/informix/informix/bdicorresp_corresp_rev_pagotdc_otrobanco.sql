CREATE PROCEDURE "informix".corresp_rev_pagotdc_otrobanco
( 
psucursal char(4), 
pusuario char(8), 
pfolio char(16) 
...
RETURNING CHAR(5);
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/corresp_rev_pagotdc_otrobanco.out";
    --- TRACE ON;
    ...
    ON EXCEPTION SET sql_err, isam_err
        IF (sql_err <> 0) THEN
            --- SET DEBUG FILE TO "/resplogifx/conciliachq/corresp_rev_pagotdc_otrobanco.err";
            --- TRACE ON;
