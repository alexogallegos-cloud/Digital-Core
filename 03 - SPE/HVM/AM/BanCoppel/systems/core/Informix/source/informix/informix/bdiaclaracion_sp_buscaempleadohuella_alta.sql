...
END PROCEDURE
DOCUMENT
'Sp				:	sp_buscaempleadohuella_alta',
...
CREATE PROCEDURE "informix".sp_acl_consulta_ciudades(p_skip INT, p_Estado CHAR(2))
...
CREATE PROCEDURE "informix".sp_consulta_cat_motivo_bloqueo_deb()

    RETURNING CHAR(2) AS clave,VARCHAR(50) AS descripcion;
    
    DEFINE local_clave CHAR(2);
    DEFINE local_descripcion VARCHAR(50);
    DEFINE iSqlErr      		INTEGER;
			
    LET local_clave = null;
    LET local_descripcion='';
	BEGIN
       
        ON EXCEPTION
            SET iSqlErr
            IF iSqlErr <> 0 THEN
				RETURN  iSqlErr,'Error'; --RETURNING
			END IF;
        END EXCEPTION;

    --SET DEBUG FILE TO "/aplicacion/pisabanco/pisa_ftes/syndein/img/InterAct/cfg/sp_consulta_cat_motivo_bloqueo_deb_34.out"; --> TRACE DESDE APP
    --TRACE ON;
    ...
    FOREACH 
        ...
        INTO local_clave,local_descripcion
        FROM bdicheq:sc_bloqueo
    
   
        RETURN local_clave,'*'||local_descripcion
        WITH RESUME;
...
END PROCEDURE
DOCUMENT
'Sp				:	sp_consulta_cat_motivo_bloqueo_deb',
'Sistema		:	Aclaraciones',
'AUTOR			:	Root',
'Area			:	Sistemas Administrativos y Perifericos',
					'Gerencia de Mtto y Soporte IV',
...
CREATE PROCEDURE "informix".sp_consulta_cat_motivo_bloqueo_crd()
    ...
    --SET DEBUG FILE TO "/aplicacion/pisabanco/pisa_ftes/syndein/img/InterAct/cfg/sp_consulta_cat_motivo_bloqueo_crd_34.out"; --> TRACE DESDE APP
    --TRACE ON;


    FOREACH 

        SELECT DISTINCT (cod_causa),causa_bloq
        INTO local_clave,local_descripcion
...
END PROCEDURE
DOCUMENT
'Sp				:	sp_consulta_cat_motivo_bloqueo_crd',
'Sistema		:	Aclaraciones',
'AUTOR			:	Root',
'Area			:	Sistemas Administrativos y Perifericos',
					'Gerencia de Mtto y Soporte IV',
...
CREATE PROCEDURE "informix".sp_consulta_cat_tipo_bloqueo_deb()

    RETURNING INTEGER AS clave,VARCHAR(60) AS descripcion;
    
    DEFINE local_clave INTEGER;
    DEFINE local_descripcion VARCHAR(60);
    DEFINE iSqlErr      		INTEGER;
    ...
    --SET DEBUG FILE TO "/aplicacion/pisabanco/pisa_ftes/syndein/img/InterAct/cfg/sp_consulta_cat_tipo_bloqueo_deb_34.out"; --> TRACE DESDE APP
    --TRACE ON;
...
END PROCEDURE
DOCUMENT
'Sp				:	sp_consulta_cat_tipo_bloqueo_deb',
'Sistema		:	Aclaraciones',
'AUTOR			:	Root',
'Area			:	Sistemas Administrativos y Perifericos',
					'Gerencia de Mtto y Soporte IV',
...
CREATE PROCEDURE "informix".sp_consulta_cat_tipo_bloqueo_crd()
    ...
    --SET DEBUG FILE TO "/aplicacion/pisabanco/pisa_ftes/syndein/img/InterAct/cfg/sp_consulta_cat_tipo_bloqueo_crd.out"; --> TRACE DESDE APP
    --TRACE ON;
        ...
        FOREACH 
            ...
            RETURN local_clave,'*'||local_descripcion WITH RESUME;
...
END PROCEDURE
DOCUMENT
'Sp				:	sp_consulta_cat_tipo_bloqueo_crd',
'Sistema		:	Aclaraciones',
'AUTOR			:	Root',
'Area			:	Sistemas Administrativos y Perifericos',
					'Gerencia de Mtto y Soporte IV',
...
CREATE PROCEDURE "informix".sp_consulta_estatus_cuenta(p_cuenta CHAR(20),p_cliente CHAR(9),p_producto SMALLINT)

    RETURNING CHAR(50) AS estatus_cta;
    
    DEFINE iSqlErr      	  INTEGER;

    DEFINE estatus_cuenta     NVARCHAR(50);

    DEFINE producto_debito    SMALLINT;
    DEFINE producto_credito   SMALLINT;
	...
	BEGIN
        ...
        IF(p_producto = producto_credito) THEN 

            LET estatus_cuenta = (SELECT tc.descripcion FROM bdicred:sd_maecred mcrd
        ...
        IF (p_producto = producto_debito) THEN 
            ...
            LET estatus_cuenta = (SELECT mst.descripcion FROM bdicheq:sc_maechq mchq
