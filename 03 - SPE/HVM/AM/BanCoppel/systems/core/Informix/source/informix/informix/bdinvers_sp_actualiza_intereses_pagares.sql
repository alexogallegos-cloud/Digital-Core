CREATE PROCEDURE "informix".sp_actualiza_intereses_pagares(pempresa CHAR(3))
RETURNING CHAR(5), CHAR(5), INTEGER, INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/sp_actualiza_intereses_pagares.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/sp_actualiza_intereses_pagares.out";
    --- TRACE ON;
    ...
    CREATE RAW TABLE "informix".invxactualizar
      (
        ...
        monto_int   decimal(18,2)   not null
      )
    EXTENT SIZE 32 NEXT SIZE 32 LOCK MODE ROW;
    CREATE INDEX "informix".idx_intspags ON "informix".invxactualizar(cuenta) USING BTREE;
    ...
    FOREACH WITH HOLD
        ...
        UPDATE bdinvers:"informix".sv_provdia
           SET ipa_dia24 = vmonto_int
         WHERE aniomes = '201110'
           AND cuenta = vcuenta
