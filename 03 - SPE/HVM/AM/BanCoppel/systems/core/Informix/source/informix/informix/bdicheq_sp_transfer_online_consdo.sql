CREATE PROCEDURE "informix".sp_transfer_online_consdo( pTranTrfn CHAR(5),
                                                       pCuenta   CHAR(20), 
                                                       pFolioSuc CHAR(16), 
                                                       pUsuario  CHAR(8),
...
RETURNING CHAR(5), INTEGER;
    ...
    DEFINE cIdATM       CHAR(16);
    DEFINE cLocATM      CHAR(40);
    DEFINE cComision    CHAR(17);
    ...
    ON EXCEPTION SET iSqlErr, iSamErr, cDesErr
        SET DEBUG FILE TO "/resplogifx/conciliachq/sp_transfer_online_consdo.err";
        TRACE ON;
        IF iSqlErr <> 0 THEN
            LET cCodRet  = iSqlErr;
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/sp_transfer_online_consdo.out";
    --- TRACE ON;
    ...
    SELECT valor
      ...
      FROM sc_param
     WHERE empresa = '001'
       AND codparam = 'WSCanalATMTransfer';
    ...
    IF   LENGTH(TRIM(cCuenta))  = 16 THEN
        LET cTpoCuenta = '103';
    ELSE
        LET cTpoCuenta = '101';
        RETURN cCodRet, iSerial;
