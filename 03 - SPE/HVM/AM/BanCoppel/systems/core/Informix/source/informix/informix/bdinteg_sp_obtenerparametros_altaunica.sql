CREATE PROCEDURE "informix".sp_obtenerparametros_altaunica(pEmpresa CHAR(3), pSucursal CHAR(4))
	...
	BEGIN
		...
		SELECT valor INTO sValor8 FROM bdinteg:si_param WHERE empresa = pEmpresa AND cod_param =  68; --TotalRegisPaginación
