CREATE PROCEDURE "informix".sp_comisionreposicion(pEmpresa CHAR(3), pSucursal CHAR(4), pTipo CHAR(1), pNumCuenta CHAR(20))
...
--SET DEBUG FILE TO "/tmp/sp_ComisionReposicion";
--TRACE ON;
...
CREATE PROCEDURE "informix".sp_comisionreposicion(pEmpresa CHAR(3), pSucursal CHAR(4), pTipo CHAR(1), pNumCuenta CHAR(20), ptransaccion char(04))
