CREATE PROCEDURE "informix".borramovscfd_edocta2( pfecha DATE )
RETURNING CHAR(5), INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/borramovscfd_edocta2.err";
        TRACE ON;
        IF sql_err <> 0 THEN
    ...
    -- SET DEBUG FILE TO "/resplogifx/conciliachq/borramovscfd_edocta2.out";
    -- TRACE ON;
    ...
    FOREACH cursor_borra WITH HOLD FOR
        SELECT {+INDEX(sc_encabezado2_edocta_factelect idx_encabezado2_fe)} idreg, fecha_emision, num_cuenta
