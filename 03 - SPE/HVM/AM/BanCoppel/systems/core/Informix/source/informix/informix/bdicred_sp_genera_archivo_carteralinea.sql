CREATE PROCEDURE "informix".sp_genera_archivo_carteralinea(pEmpresa char(3), pServicio char(1))

RETURNING  CHAR(6) AS Cod_Ret,  CHAR(80) AS Mens_Ret;

--Creado por: Abrham Lopez L. 05/08/2011. Proceso para la generaciÃÂÃÂ³n del archivo de Cartera en Linea
-- Modificado por: MAHR Octubre 2011. Se agregan al proceso productos de colocaciÃÂÃÂ²n ademÃÂÃÂ s de la Tarjeta de CrÃÂÃÂ¨dito PrÃÂÃÂ¨stamo Personal y Reestructura.
...
BEGIN
    ...
    */
	...
	-- Validacion de parÃÂÃÂ¡metros de entrada
