CREATE PROCEDURE "informix".sp_insertar_registros_indicadores_1()
RETURNING
	CHAR(6),
	CHAR(80)
...
BEGIN
	...
	--SET DEBUG FILE TO '/informix/moha/sp_insertar_registros_indicadores_1.out';
	--TRACE ON;
	...
	FROM "informix".sc_param
	WHERE empresa = "001"
	AND codparam = "UltCtaInsertIndic1";
...
CREATE PROCEDURE "informix".sp_insertar_registros_indicadores_2()
RETURNING
	CHAR(6),
	CHAR(80)
...
BEGIN
	...
	--SET DEBUG FILE TO '/informix/moha/sp_insertar_registros_indicadores_2.out';
	--TRACE ON;
	...
	FROM "informix".sc_param
	WHERE empresa = "001"
	AND codparam = "UltCtaInsertIndic2";
