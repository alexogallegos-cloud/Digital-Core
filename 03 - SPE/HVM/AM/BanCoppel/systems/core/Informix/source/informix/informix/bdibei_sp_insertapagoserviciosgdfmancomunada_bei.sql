CREATE PROCEDURE "informix".sp_insertapagoserviciosgdfmancomunada_bei(
    pempresa CHAR(3),
    ...
    pGen3 char(40),
    pGen4 char(40),
    pTipoServicio char(6),
    pConcepto char(200),
    pListaCampos char(250)
)
...
BEGIN
    ...
    EXECUTE PROCEDURE sp_insertaoperacionesmancomunadasoperador_bei(
        ...
        Update bdibei:bei_operacionesmancomunadasoperador
        Set    pGen1 = pGen1, pGen2 = pGen2, pGen3 = pGen3, pGen4 = pGen4,  tipo_servicio = pTipoServicio, concepto = pConcepto, campos_adicionales = pListaCampos
        Where  id_operacion = sIdOper;
