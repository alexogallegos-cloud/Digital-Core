CREATE PROCEDURE "informix".recibe_infoingegre(r_empresa CHAR(3),
				    r_num_solicitud CHAR(20),
				    r_col1_1  SMALLINT,    -- secuencia REG 1
				    r_col2_1  CHAR(3),     -- cod concepto
				    r_col3_1  MONEY(14,2), -- valor presta
				    r_col4_1  MONEY(14,2), -- valor copresta
				    r_col1_2  SMALLINT,    -- secuencia REG 2
				    r_col2_2  CHAR(3),     -- cod concepto
				    r_col3_2  MONEY(14,2), -- valor presta
				    r_col4_2  MONEY(14,2), -- valor copresta
				    r_col1_3  SMALLINT,    -- secuencia REG 3
				    r_col2_3  CHAR(3),     -- cod concepto
				    r_col3_3  MONEY(14,2), -- valor presta
				    r_col4_3  MONEY(14,2), -- valor copresta
				    r_col1_4  SMALLINT,    -- secuencia REG 4
				    r_col2_4  CHAR(3),     -- cod concepto
				    r_col3_4  MONEY(14,2), -- valor presta
				    r_col4_4  MONEY(14,2), -- valor copresta
				    r_col1_5  SMALLINT,    -- secuencia REG 5
				    r_col2_5  CHAR(3),     -- cod concepto
				    r_col3_5  MONEY(14,2), -- valor presta
				    r_col4_5  MONEY(14,2)) -- valor copresta
RETURNING CHAR(5);
...
-- *************************************************************************
	...
	-- Inserta Ocurrencia 1
     IF r_col1_1 <> 0 THEN
	INSERT INTO ss_info_ingegre
	  (empresa,      num_solicitud,     secuencia,        
	   cod_concepto, valor_prestatario, valor_coprestatario)
	 VALUES
