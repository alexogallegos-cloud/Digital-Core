create procedure "informix".sp_sw_ro_bitacoraresultados(pUsuario char(8), pIdBusqueda int, pIdOficio int, 
	...
	begin
		...
		insert into sw_ro_resulper(id_busqueda, id_oficio, apell_paterno, apell_materno, nombre1, nombre2,
