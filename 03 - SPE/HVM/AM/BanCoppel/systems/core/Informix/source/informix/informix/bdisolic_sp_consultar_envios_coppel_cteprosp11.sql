CREATE PROCEDURE "informix".sp_consultar_envios_coppel_cteprosp11(pTipoConsulta SMALLINT)
...
BEGIN
	...
	IF pTipoConsulta IN (1,3) THEN
		...
		FOREACH WITH HOLD
            ...
            --and sucursal > '0815'
			and sucursal between '1266' and  '6668' 
	...
	END IF;
		...
		IF iNumreg = 0 THEN
			LET cCodRet = "000001";
			LET cMensajeRet = "No se encontro informaciÃ?Â?Ã?Â³n";
			RETURN TRIM(cCodRet), TRIM(cMensajeRet),"","","","";
		END IF;
END;
END PROCEDURE
