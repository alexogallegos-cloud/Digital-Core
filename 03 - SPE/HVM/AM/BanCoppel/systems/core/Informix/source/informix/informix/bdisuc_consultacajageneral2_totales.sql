create procedure "informix".consultacajageneral2_totales(pempresa char(3),
...
document 'SPL Clonado de bdisuc:consultacajageneral para el manejo de conteo de total de registros',
'AUTOR: Oscar Flores Conde'

;

CREATE PROCEDURE "informix".sp_consul_dotacion_pba(eEmpresa    CHAR(3),
                                               eTipo       CHAR(1), 
                                               eProveedor  CHAR(4),
                                               eSucursal   CHAR(4),
                                               eFecInicio  DATE,
