CREATE PROCEDURE "informix".sp_cobra_int_pp(pFechaCuota DATE,pPagoInt DECIMAL(18,2),pPagoIvaInt DECIMAL(18,2),pCapitalStatus CHAR(1))
...
-- Fecha: 21/01/2010
-- Comentario: Se agrega la actualizaciÃÂ³n al campo sdo_global_int

    select nvl(campo_trabajo3,'')campo_trabajo3
      into bBnderaCobro
   ...
   END IF;
	...
	UPDATE "informix".sd_amortiza_creditocrd
	   SET interes_pagado     = interes_pagado + pPagoInt,
		   interes_fecha_pago = g_dtFechaHoy,
		   iva_pagado         = iva_pagado + pPagoIvaInt,
		   iva_fecha_pago     = g_dtFechaHoy
	 WHERE empresa     = g_Empresa
       AND num_credito = g_NumCred
       AND fecha_cuota = pFechaCuota;
   ...
   ELIF (dStatusCred='E1' OR dStatusCred='E2' OR dStatusCred='E3') THEN
      ...
      IF (pCapitalStatus IN ('1','7','2') and bBnderaCobro = '') THEN
         -- Se actualiza el maestro de saldos
         UPDATE "informix".sd_maesdoscrd
            SET sdo_no_exig    = sdo_no_exig - pPagoInt,
                  mto_finan_vdo  = mto_finan_vdo - pPagoIvaInt
   ...
   END IF;
		...
		ELSE
         ...
         IF (dStatusCred='AA' OR dStatusCred='BA' OR dStatusCred='BT') THEN
            ...
            ELIF pCapitalStatus = "7" THEN
               LET dCodRef    = 6;
               LET dCodRefIva = 10;
            ELIF pCapitalStatus = "2" and bBnderaCobro <> 'V' THEN
               LET dCodRef    = 7;
               LET dCodRefIva = 12;
            ELIF pCapitalStatus = "2" and bBnderaCobro = 'V' THEN
               LET dCodRef    = 17;
               LET dCodRefIva = 18;
            ELIF pCapitalStatus = "6" and bBnderaCobro <> 'V' THEN
               LET dCodRef    = 970;
               LET dCodRefIva = 971;
            ELIF pCapitalStatus = "6" and bBnderaCobro = 'V' THEN
               LET dCodRef    = 972;
         ...
         ELIF (dStatusCred='E1' OR dStatusCred='E2' OR dStatusCred='E3') THEN
            ...
            ELIF pCapitalStatus = "2" and bBnderaCobro = 'V' THEN
               LET dCodRef    = 968;
               LET dCodRefIva = 969;
            ELIF pCapitalStatus = "6" and bBnderaCobro <> 'V' and dStatusCred='E2' THEN
               LET dCodRef    = 966;
               LET dCodRefIva = 967;
            ELIF pCapitalStatus = "6" and bBnderaCobro = 'V' and dStatusCred='E2' THEN
               LET dCodRef    = 968;
               LET dCodRefIva = 969;
            ELIF pCapitalStatus = "6" and bBnderaCobro <> 'V' and dStatusCred='E3' THEN
               LET dCodRef    = 970;
               LET dCodRefIva = 971;
            ELIF pCapitalStatus = "6" and bBnderaCobro = 'V' and dStatusCred='E3' THEN
               LET dCodRef    = 972;
    ...
    IF pPagoInt > 0 THEN
		IF g_TransaccSuc = '9888' and dCodRef = 5 THEN
			LET dCodRef = 64;
		ELIF g_TransaccSuc = '9888' and dCodRef = 6 THEN
			LET dCodRef = 70;
		ELIF g_TransaccSuc = '9888' and dCodRef = 7 THEN
			LET dCodRef = 71;
		/*ELIF g_TransaccSuc = '9888' and dCodRef = 17 THEN
			LET dCodRef = ;
		ELIF g_TransaccSuc = '9888' and dCodRef = 970 THEN
			LET dCodRef = ;*/
		ELIF g_TransaccSuc = '9888' and dCodRef = 972 THEN
			LET dCodRef = 64;
		ELIF g_TransaccSuc = '4320' and dCodRef = 972 THEN
			LET dCodRef = 113;
		ELIF g_TransaccSuc = '9888' and dCodRef = 962 THEN
			LET dCodRef = 64;
		ELIF g_TransaccSuc = '4320' and dCodRef = 962 THEN
			LET dCodRef = 113;
		ELIF g_TransaccSuc = '9888' and dCodRef = 964 THEN
			LET dCodRef = 68;
		ELIF g_TransaccSuc = '4320' and dCodRef = 964 THEN
			LET dCodRef = 117;
		ELIF g_TransaccSuc = '9888' and dCodRef = 966 THEN
			LET dCodRef = 68;
		ELIF g_TransaccSuc = '4320' and dCodRef = 966 THEN
			LET dCodRef = 117;
		ELIF g_TransaccSuc = '9888' and dCodRef = 968 THEN
			LET dCodRef = 68;
		ELIF g_TransaccSuc = '4320' and dCodRef = 968 THEN
			LET dCodRef = 117;
		ELIF g_TransaccSuc = '9888' and dCodRef = 970 THEN
			LET dCodRef = 68;
		ELIF g_TransaccSuc = '4320' and dCodRef = 970 THEN
			LET dCodRef = 117;
		ELIF g_TransaccSuc = '9888' and dCodRef = 972 THEN
			LET dCodRef = 69;
		END IF;
        CALL "informix".genmovcrd(g_Empresa,g_NumCred,g_NumProd,dCodRef,g_CodFun,g_dtFechaHoy,pPagoInt,
    ...
    IF pPagoIvaInt > 0 THEN
		/*IF g_TransaccSuc = '9888' and dCodRefIva = 8 THEN
			LET dCodRefIva = ;
		ELIF g_TransaccSuc = '9888' and dCodRefIva = 10 THEN
			LET dCodRefIva = ;
		EL*/IF g_TransaccSuc = '9888' and dCodRefIva = 12 THEN
			LET dCodRefIva = 71;
		/*ELIF g_TransaccSuc = '9888' and dCodRefIva = 18 THEN
			LET dCodRefIva = ;*/
		ELIF g_TransaccSuc = '9888' and dCodRefIva = 971 THEN
			LET dCodRefIva = 69;
		ELIF g_TransaccSuc = '4320' and dCodRefIva = 971 THEN
			LET dCodRefIva = 118;
		ELIF g_TransaccSuc = '9888' and dCodRefIva = 973 THEN
			LET dCodRefIva = 69;
		ELIF g_TransaccSuc = '4320' and dCodRefIva = 973 THEN
			LET dCodRefIva = 118;
		ELIF g_TransaccSuc = '9888' and dCodRefIva = 963 THEN
			LET dCodRefIva = 64;
		ELIF g_TransaccSuc = '4320' and dCodRefIva = 963 THEN
			LET dCodRefIva = 113;
		ELIF g_TransaccSuc = '9888' and dCodRefIva = 965 THEN
			LET dCodRefIva = 69;
		ELIF g_TransaccSuc = '4320' and dCodRefIva = 965 THEN
			LET dCodRefIva = 118;
		ELIF g_TransaccSuc = '9888' and dCodRefIva = 967 THEN
			LET dCodRefIva = 69;
		ELIF g_TransaccSuc = '4320' and dCodRefIva = 967 THEN
			LET dCodRefIva = 118;
		ELIF g_TransaccSuc = '9888' and dCodRefIva = 969 THEN
			LET dCodRefIva = 69;
		ELIF g_TransaccSuc = '4320' and dCodRefIva = 969 THEN
			LET dCodRefIva = 118;
		END IF;
        CALL "informix".genmovcrd(g_Empresa,g_NumCred,g_NumProd,dCodRefIva,g_CodFun,g_dtFechaHoy,pPagoIvaInt,
                       g_Folio,g_Sucursal, g_Divisa, g_TransaccSuc,g_NumPago,"") 
             RETURNING cCodRet, cMensajeRet;
