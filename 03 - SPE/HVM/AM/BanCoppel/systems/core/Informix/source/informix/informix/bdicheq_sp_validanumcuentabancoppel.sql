CREATE PROCEDURE "informix".sp_validanumcuentabancoppel(cNumCuenta CHAR(20))
	...
	BEGIN
		...
		IF EXISTS(SELECT {INDEX (bdicheq:sc_tarjeta ix_tarjeta2)} 1 FROM bdicheq:sc_tarjeta where empresa='001' AND num_tarjeta = cNumCuenta) THEN
			LET cCodRet = "002";
...
END PROCEDURE
DOCUMENT
"Valida si el número de tarjeta es de BanCoppel",
