CREATE PROCEDURE "informix".sp_ftc_ptosftp(v_periodo CHAR(04))
...
ON EXCEPTION SET iSqlErr
    ...
    SET DEBUG FILE TO "/fatca/sp_ftc_ptosftp.err";
...
--SET DEBUG FILE TO "sp_ftc_ptosftp.out";
--TRACE ON;
...
IF NOT EXISTS (SELECT a.valor
   ...
   LET cCodret = '00001';
   LET cVarDataErr = 'ERROR NO EXISTE PUERTO PARA SFTP';
ELSE
   SELECT a.valor
     INTO v_vlr_prm
     FROM bdilide:sl_ftc_prm AS a, bdilide:sl_ftc_cat AS b
