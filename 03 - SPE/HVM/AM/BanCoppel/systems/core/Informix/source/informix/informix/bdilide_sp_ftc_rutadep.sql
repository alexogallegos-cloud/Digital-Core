CREATE PROCEDURE "informix".sp_ftc_rutadep(v_periodo CHAR(04))
...
ON EXCEPTION SET iSqlErr
    ...
    SET DEBUG FILE TO "/fatca/sp_ftc_rutadep.err";
...
--SET DEBUG FILE TO "sp_ftc_rutadep.out";
--TRACE ON;
...
IF NOT EXISTS (SELECT a.valor
   ...
   LET cCodret = '00001';
   LET cVarDataErr = 'ERROR NO EXISTE RUTA DEPÓSITO XML';
ELSE
   SELECT a.valor
     INTO v_vlr_prm
     FROM bdilide:sl_ftc_prm AS a, bdilide:sl_ftc_cat AS b
    WHERE a.cve_param = b.cve_param
      ...
      AND a.valor_param = '1';
   LET cCodret = '00000';
   LET cVarDataErr = 'RUTA DEPÓSITO XML: '||v_vlr_prm;
END IF;
