CREATE PROCEDURE "informix".sp_conciliachqcomp5( pempresa CHAR(3) )
RETURNING CHAR(5), CHAR(5), CHAR(50), INTEGER, INTEGER;
    ...
    ON EXCEPTION SET sql_err, isam_err, desc_err
      SET DEBUG FILE TO "/resplogifx/conciliachq/sp_conciliachqcomp5.err";
      TRACE ON;
    ...
    --- SET DEBUG FILE TO "/home/c98789058/SPL_ACCENTURE/sp_conciliachqcomp5.out";
    --- TRACE ON;
	...
	--Se quitan directivas,B̼squeda OK con INDEX PATH
