CREATE PROCEDURE "informix".spei_enaviprocodi_exp1() 
RETURNING CHAR(1500);
	...
	ON EXCEPTION SET sql_err, isam_err, desc_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/spei_enaviprocodi.err";
        --SET DEBUG FILE TO "/informix/Priscilla/spei_enaviprocodi.err";
        TRACE ON;
		IF sql_err <> 0 THEN
            LET vcodret  = sql_err;
	...
	--SET DEBUG FILE TO "/informix/ifg/spei_enaviprocodi.out";
    --SET DEBUG FILE TO "/informix/Priscilla/spei_enaviprocodi.out";
    --TRACE ON;
