CREATE PROCEDURE "informix".sp_credisoluciones_crd_jom(pempresa CHAR(3), pproducto CHAR(4), pFechaFin date)
...
LET vcargoserr       = 0;
 ...
 --SET DEBUG FILE TO "/tmp/sp_credisoluciones_crd.out";
 --TRACE ON;
