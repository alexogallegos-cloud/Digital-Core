CREATE PROCEDURE "informix".borramovshistesp( pfecha_ini DATE, pfecha_fin DATE )
RETURNING CHAR(5), CHAR(5), CHAR(60), INTEGER, INTEGER;
    ...
    ON EXCEPTION SET vsql_err, visam_err, vdesc_err
        SET DEBUG FILE TO "/resplogifx/conciliachq/borramovshistesp.sql.err";
        TRACE ON;
        IF vsql_err <> 0 THEN
    ...
    --- SET DEBUG FILE TO "/resplogifx/conciliachq/borramovshistesp.sql.out";
    --- TRACE ON;
    ...
    -- // OBTIENE EL NUMERO DE REGISTROS A ELIMINAR
    SELECT COUNT(*)
      INTO vcontador1
      FROM sc_movhis_old2
    ...
    IF vcontador2 = 0 THEN
        LET vcodret1 = '000'; 
        LET vcodret2 = '000';
        LET vcodret3 = 'SE ELIMINARON TODOS LOS REGISTROS';
    ELSE  
        LET vcodret1 = '999'; 
        LET vcodret2 = '999';
        LET vcodret3 = 'NO SE ELIMINARON TODOS LOS REGISTROS';
    END IF;
