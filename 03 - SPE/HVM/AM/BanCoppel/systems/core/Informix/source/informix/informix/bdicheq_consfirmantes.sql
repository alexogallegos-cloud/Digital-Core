CREATE PROCEDURE "informix".consfirmantes(pEmpresa char(3), pNumeroCuenta char(20))
	...
	FOREACH
		SELECT DISTINCT
			si_cte.numcte, si_cte.apell_paterno, si_cte.apell_materno, si_cte.nombre1, si_cte.nombre2,
                        sc_fir.secuencia,sc_fir.parentesco, sc_fir.tipo_firma
		INTO
			vNumCte, vApePat, vApeMat, vNombre1, vNombre2, vSec, vparen, vTipo_firma
		FROM
