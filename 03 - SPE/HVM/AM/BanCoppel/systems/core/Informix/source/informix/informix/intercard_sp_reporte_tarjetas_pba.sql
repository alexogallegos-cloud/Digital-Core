...
--1) 
	   ...
	   --2)Gneración
			...
			SET ISOLATION TO DIRTY READ;
			INSERT INTO asignadastar (total_asignacion,clave_sucursal,clave_tipotarjeta)
            ...
            let vsql = ''; 	   
			let vsql = 'echo "Total Asignadas|Clave Sucursal|Clave Tipo Tarjeta|">/resplogifx/Reporte_Asignadas'|| day(vfecha_hoy)||LPAD (MONTH(vfecha_hoy),2,"0")||year(vfecha_hoy)||'.unl';
			system vsql;
			let vsql = '';
			let vsql = '';
