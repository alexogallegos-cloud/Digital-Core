create procedure "informix".sp_consejecutivomac_pba(pejecutivo char(8), pmac char(12))
...
CREATE procedure "informix".sp_consejecutivomac_pba(pejecutivo char(8), pmac char(12), p_sTipo char(1))
    returning char(5),char(1) ;
