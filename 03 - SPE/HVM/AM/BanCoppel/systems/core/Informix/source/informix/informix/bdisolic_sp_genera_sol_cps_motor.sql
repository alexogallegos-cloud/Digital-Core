CREATE PROCEDURE "informix".sp_genera_sol_cps_motor(P_EMPRESA CHAR(3),o_numsol CHAR(20),o_numcte CHAR(20),
...
DEFINE	rev_scorepuntualidad		 INTEGER; ---Autor: Jesus Manuel(FINAL)	27/09/2021
...
set lock mode to wait 3;
	...
	-- ****************************************************************************	
			...
			EXECUTE PROCEDURE "informix".califica_scoring_cjunk_motor(p_empresa,aux_sol_revalua,'',''
