CREATE PROCEDURE "informix".cancelatarjeta_web(pEmpresa CHAR(3), 
...
'DESCRIPCION: Se agrega nuevo parametro de salida, retornando el folio de cancelacion, consultandolo en la tabla sd_param.', 
