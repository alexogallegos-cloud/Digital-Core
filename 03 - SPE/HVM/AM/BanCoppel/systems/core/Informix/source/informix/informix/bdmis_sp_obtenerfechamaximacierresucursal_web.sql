CREATE PROCEDURE "informix".sp_obtenerfechamaximacierresucursal_web(cSucursal CHAR(4))
...
END PROCEDURE
DOCUMENT
'AUTOR : Dulce Karely Ramirez Sanchez',
'FUNCIONALIDAD: se encarga obtener la fecha maxima de generacion de cifras de cierre de una sucursal',
'FECHA : Marzo-2009',
'VERSION: 20090312',
'BD    : BDMIS';
