CREATE PROCEDURE "informix".grabaactualizabeneficiario_web(pEmpresa CHAR(3), pNumeroCuenta CHAR(20), pNombre CHAR(40), pParentesco CHAR(20),  pPorcentaje SMALLINT, pNumeroCliente CHAR(20))
