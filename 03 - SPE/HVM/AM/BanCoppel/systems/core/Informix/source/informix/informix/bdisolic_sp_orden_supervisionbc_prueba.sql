CREATE PROCEDURE "informix".sp_orden_supervisionbc_prueba(lsecuencia INTEGER)
RETURNING 
char(5) as CodRet,
...
BEGIN
	...
	AND fechasolicitud > mdy('04','06','2020') AND secuencia < '9000000' -- Se tomaran solo las solicitudes de este anio y con secuencia menor a la que se tiene actualmente en el puente 
