...
---
*Generado por: Specialist — Informix SPL Analysis · 2026-07-03 · Evidencia: source/informix/bdicred_*.sql (análisis estático de 70 archivos SQL) · análisis de patrones de nombres + código*
...
|----------|-------------------|---------------------|
| `RemesasAPPRIZAAutomaticas` | `GetOrder_20260424_142153` | — |
