# D07 · Aclaraciones — Baseline de Performance

> **Componente:** Informix · SPE-AM-001 · TEST Phase
> **Base de datos:** `bdiaclaracion` · IBM Informix IDS 14.10 POWER-AIX → Aurora PostgreSQL
...
-- Instrumentar el SP que llama a bdiaclaracion:sp_nombre() para registrar:
...
|----|-----------------|---------|---------|---------|---------|
| `sp_fal_cancelacion_cuenta_credito` | 40 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_fal_cancelacion_cuenta_debito` | 40 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_fal_liquidacion_asignar_analista` | 34 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_fal_obtener_saldo_debito` | 33 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
| `sp_fal_asignar_analista_credito` | 21 | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] ms | [SME-PENDING] TPS |
...
| Patrón | Impacto en `bdiaclaracion` | Preparación |
|--------|-------------------|------------|
...
export default function() {
  ...
  let res = http.post('https://api.target/bdiaclaracion/v1/endpoint', payload);
