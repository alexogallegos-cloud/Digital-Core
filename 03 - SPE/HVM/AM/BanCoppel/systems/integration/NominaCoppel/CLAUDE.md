# Nómina Coppel — Sistema Descubierto (Application Modernization)
# togaf_type: integration
# togaf_state: discovered
# togaf_system_of: innovation
# togaf_abb: payroll-integration

> **Descubierto por:** Informix Informix seed — [nomina-coppel-seed.json](../../core/Informix/digital-brain/seeds/nomina-coppel-seed.json)
...
| Volumen conocido | 935 endpoints |
| Criticidad | `unknown` |
| Dominios Informix involucrados | D03, D05 |
